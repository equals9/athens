...
var open_QMARK_ = (function (){var G__61065 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61065) : re_frame.core.subscribe.call(null,G__61065));
})();
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61066 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61067 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61066,G__61067) : posh.reagent.q.call(null,G__61066,G__61067));
})())));
...
var G__61068 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
var G__61069 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61069) : re_frame.core.dispatch.call(null,G__61069));
...
cljs.core.chunk_append(b__61074,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61073,vec__61075,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61074,s__61072__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__61073,vec__61075,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61074,s__61072__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__61090 = (i__61073 + (1));
i__61073 = G__61090;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61074),athens$devcards$left_sidebar$left_sidebar_$_iter__61071(cljs.core.chunk_rest(s__61072__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61074),null);
}
} else {
var vec__61078 = cljs.core.first(s__61072__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61078,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61078,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61078,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61078,_order,title,uid,s__61072__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61078,_order,title,uid,s__61072__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61071(cljs.core.rest(s__61072__$2)));
}
} else {
return null;
}
...
var G__61081 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-local-storage-db","get-local-storage-db",381131920)], null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082 = (function (meta61083){
this.meta61083 = meta61083;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61084,meta61083__$1){
var self__ = this;
var _61084__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082(meta61083__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61084){
var self__ = this;
var _61084__$1 = this;
return self__.meta61083;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__61085 = athens.db.dsdb;
var G__61086 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61085,G__61086) : posh.reagent.transact_BANG_.call(null,G__61085,G__61086));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61082");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61082");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61082.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61082 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61082(meta61083){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082(meta61083));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61082(null));
})()
