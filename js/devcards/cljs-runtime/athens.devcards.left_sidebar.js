...
var G__61080 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
...
var G__61081 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("athena","toggle","athena/toggle",2028366801)], null);
...
var G__61082 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
...
cljs.core.chunk_append(b__61090,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__61089,vec__61091,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61090,s__61088__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(i__61089,vec__61091,_order,title,uid,c__4580__auto__,size__4581__auto__,b__61090,s__61088__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__61107 = (i__61089 + (1));
i__61089 = G__61107;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61090),athens$devcards$left_sidebar$left_sidebar_$_iter__61087(cljs.core.chunk_rest(s__61088__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61090),null);
}
} else {
var vec__61094 = cljs.core.first(s__61088__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61094,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61094,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61094,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61094,_order,title,uid,s__61088__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61094,_order,title,uid,s__61088__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61087(cljs.core.rest(s__61088__$2)));
}
} else {
return null;
}
...
var G__61097 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61097) : re_frame.core.dispatch.call(null,G__61097));
})], null)], null)], null)], null);
}
});
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098 = (function (meta61099){
this.meta61099 = meta61099;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61100,meta61099__$1){
var self__ = this;
var _61100__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098(meta61099__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61100){
var self__ = this;
var _61100__$1 = this;
return self__.meta61099;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
var G__61101 = athens.db.dsdb;
var G__61102 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61101,G__61102) : posh.reagent.transact_BANG_.call(null,G__61101,G__61102));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61099","meta61099",1040032066,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61098");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61098");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61098.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61098 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61098(meta61099){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098(meta61099));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61098(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104 = (function (meta61105){
this.meta61105 = meta61105;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61106,meta61105__$1){
var self__ = this;
var _61106__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104(meta61105__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61106){
var self__ = this;
var _61106__$1 = this;
return self__.meta61105;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61105","meta61105",1593682094,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61104");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61104");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61104.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61104 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61104(meta61105){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104(meta61105));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61104(null));
})()
