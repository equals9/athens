...
var open_QMARK_ = (function (){var G__60781 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
...
var G__60782 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60782) : re_frame.core.dispatch.call(null,G__60782));
...
var G__60783 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
...
var vec__60789 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60787);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60789,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60789,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60789,(2),null);
cljs.core.chunk_append(b__60788,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__60787,vec__60789,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60788,s__60786__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(i__60787,vec__60789,_order,title,uid,c__4580__auto__,size__4581__auto__,b__60788,s__60786__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60803 = (i__60787 + (1));
i__60787 = G__60803;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60788),athens$devcards$left_sidebar$left_sidebar_$_iter__60785(cljs.core.chunk_rest(s__60786__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60788),null);
}
} else {
var vec__60792 = cljs.core.first(s__60786__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60792,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60792,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60792,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60792,_order,title,uid,s__60786__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60792,_order,title,uid,s__60786__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60785(cljs.core.rest(s__60786__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795 = (function (meta60796){
this.meta60796 = meta60796;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60797,meta60796__$1){
var self__ = this;
var _60797__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795(meta60796__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60797){
var self__ = this;
var _60797__$1 = this;
return self__.meta60796;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60798,G__60799) : posh.reagent.transact_BANG_.call(null,G__60798,G__60799));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60796","meta60796",-1065972342,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60795");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60795");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60795.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60795 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60795(meta60796){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795(meta60796));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60795(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800 = (function (meta60801){
this.meta60801 = meta60801;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60802,meta60801__$1){
var self__ = this;
var _60802__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800(meta60801__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60802){
var self__ = this;
var _60802__$1 = this;
return self__.meta60801;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60800");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60800");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60800.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60800 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60800(meta60801){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800(meta60801));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60800(null));
})()
