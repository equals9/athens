...
var open_QMARK_ = (function (){var G__61022 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61022) : re_frame.core.subscribe.call(null,G__61022));
})();
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61023 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61024 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61023,G__61024) : posh.reagent.q.call(null,G__61023,G__61024));
})())));
...
var G__61025 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
var G__61026 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61026) : re_frame.core.dispatch.call(null,G__61026));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61031),athens$devcards$left_sidebar$left_sidebar_$_iter__61028(cljs.core.chunk_rest(s__61029__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61031),null);
}
} else {
var vec__61035 = cljs.core.first(s__61029__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61035,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61035,_order,title,uid,s__61029__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61035,_order,title,uid,s__61029__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61028(cljs.core.rest(s__61029__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038 = (function (meta61039){
this.meta61039 = meta61039;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61040,meta61039__$1){
var self__ = this;
var _61040__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038(meta61039__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61040){
var self__ = this;
var _61040__$1 = this;
return self__.meta61039;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__61041 = athens.db.dsdb;
var G__61042 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61041,G__61042) : posh.reagent.transact_BANG_.call(null,G__61041,G__61042));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61039","meta61039",1731447800,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61038");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61038");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61038.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61038 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61038(meta61039){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038(meta61039));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61038(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046 = (function (meta61047){
this.meta61047 = meta61047;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61048,meta61047__$1){
var self__ = this;
var _61048__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046(meta61047__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61048){
var self__ = this;
var _61048__$1 = this;
return self__.meta61047;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61046");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61046");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61046.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61046 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61046(meta61047){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046(meta61047));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61046(null));
})()
