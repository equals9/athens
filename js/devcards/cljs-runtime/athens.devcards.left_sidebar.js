...
var open_QMARK_ = (function (){var G__60793 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60793) : re_frame.core.subscribe.call(null,G__60793));
})();
...
var G__60794 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60794) : re_frame.core.dispatch.call(null,G__60794));
...
var G__60795 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60795) : re_frame.core.dispatch.call(null,G__60795));
...
var G__60796 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60796) : re_frame.core.dispatch.call(null,G__60796));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60800),athens$devcards$left_sidebar$left_sidebar_$_iter__60797(cljs.core.chunk_rest(s__60798__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60800),null);
}
} else {
var vec__60804 = cljs.core.first(s__60798__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60804,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60804,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60804,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60804,_order,title,uid,s__60798__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid(uid);
});})(vec__60804,_order,title,uid,s__60798__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60797(cljs.core.rest(s__60798__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807 = (function (meta60808){
this.meta60808 = meta60808;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60809,meta60808__$1){
var self__ = this;
var _60809__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807(meta60808__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60809){
var self__ = this;
var _60809__$1 = this;
return self__.meta60808;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
var G__60810 = athens.db.dsdb;
var G__60811 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60810,G__60811) : posh.reagent.transact_BANG_.call(null,G__60810,G__60811));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60808","meta60808",-1144845789,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60807");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60807");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60807.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60807 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60807(meta60808){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807(meta60808));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60807(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812 = (function (meta60813){
this.meta60813 = meta60813;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60814,meta60813__$1){
var self__ = this;
var _60814__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812(meta60813__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60814){
var self__ = this;
var _60814__$1 = this;
return self__.meta60813;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60813","meta60813",-2119908641,null)], null);
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60812");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60812");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60812.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60812 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60812(meta60813){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812(meta60813));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60812(null));
})()
