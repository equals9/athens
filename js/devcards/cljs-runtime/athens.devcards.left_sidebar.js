...
var open_QMARK_ = (function (){var G__60782 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"left-sidebar","left-sidebar",-1413634357)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__60782) : re_frame.core.subscribe.call(null,G__60782));
})();
...
var G__60783 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__60783) : re_frame.core.dispatch.call(null,G__60783));
...
var G__60784 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-athena","toggle-athena",102452770)], null);
...
var G__60785 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-left-sidebar","toggle-left-sidebar",-468830841)], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60789),athens$devcards$left_sidebar$left_sidebar_$_iter__60786(cljs.core.chunk_rest(s__60787__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60789),null);
}
} else {
var vec__60793 = cljs.core.first(s__60787__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60793,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60793,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60793,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__60793,_order,title,uid,s__60787__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__60793,_order,title,uid,s__60787__$2,temp__5735__auto__,sorted_shortcuts,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__60786(cljs.core.rest(s__60787__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796 = (function (meta60797){
this.meta60797 = meta60797;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60798,meta60797__$1){
var self__ = this;
var _60798__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796(meta60797__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60798){
var self__ = this;
var _60798__$1 = this;
return self__.meta60797;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
var G__60799 = athens.db.dsdb;
var G__60800 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__60799,G__60800) : posh.reagent.transact_BANG_.call(null,G__60799,G__60800));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60796");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60796");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60796.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60796 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60796(meta60797){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796(meta60797));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60796(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801 = (function (meta60802){
this.meta60802 = meta60802;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60803,meta60802__$1){
var self__ = this;
var _60803__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801(meta60802__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60803){
var self__ = this;
var _60803__$1 = this;
return self__.meta60802;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60801");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60801");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60801.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60801 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60801(meta60802){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801(meta60802));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60801(null));
})()
