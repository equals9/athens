...
var open_QMARK_ = (function (){var G__61078 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","open","left-sidebar/open",-686633270)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__61078) : re_frame.core.subscribe.call(null,G__61078));
})();
var shortcuts = cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.seq(cljs.core.deref((function (){var G__61079 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?title","?title",-835622503,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Symbol(null,"?title","?title",-835622503,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__61080 = athens.db.dsdb;
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$2(G__61079,G__61080) : posh.reagent.q.call(null,G__61079,G__61080));
})())));
...
var G__61081 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
...
var G__61082 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("athena","toggle","athena/toggle",2028366801)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61082) : re_frame.core.dispatch.call(null,G__61082));
...
var G__61083 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("left-sidebar","toggle","left-sidebar/toggle",212949860)], null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61087),athens$devcards$left_sidebar$left_sidebar_$_iter__61084(cljs.core.chunk_rest(s__61085__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61087),null);
}
} else {
var vec__61091 = cljs.core.first(s__61085__$2);
var _order = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61091,(0),null);
var title = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61091,(1),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61091,(2),null);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li>a","li>a",-1587586072),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(athens.devcards.left_sidebar.shortcut_style,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__61091,_order,title,uid,s__61085__$2,temp__5735__auto__,open_QMARK_,shortcuts){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid);
});})(vec__61091,_order,title,uid,s__61085__$2,temp__5735__auto__,open_QMARK_,shortcuts))
], null)),title], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$left_sidebar$left_sidebar_$_iter__61084(cljs.core.rest(s__61085__$2)));
}
} else {
return null;
}
...
var G__61094 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("get-db","init","get-db/init",-642889137)], null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095 !== 'undefined')){
} else {
...
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095 = (function (meta61096){
this.meta61096 = meta61096;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61097,meta61096__$1){
var self__ = this;
var _61097__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095(meta61096__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61097){
var self__ = this;
var _61097__$1 = this;
return self__.meta61096;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
var G__61098 = athens.db.dsdb;
var G__61099 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("page","sidebar","page/sidebar",32416927),n,new cljs.core.Keyword("node","title","node/title",628940777),["Page ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join(''),new cljs.core.Keyword("block","uid","block/uid",-1623585167),["uid",cljs.core.str.cljs$core$IFn$_invoke$arity$1(n)].join('')], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__61098,G__61099) : posh.reagent.transact_BANG_.call(null,G__61098,G__61099));
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61095");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61095");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61095.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61095 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61095(meta61096){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095(meta61096));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61095(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100 = (function (meta61101){
this.meta61101 = meta61101;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61102,meta61101__$1){
var self__ = this;
var _61102__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100(meta61101__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61102){
var self__ = this;
var _61102__$1 = this;
return self__.meta61101;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61100");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61100");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar61100.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar61100 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar61100(meta61101){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100(meta61101));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar61100(null));
})()
