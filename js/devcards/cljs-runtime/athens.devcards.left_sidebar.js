...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.left_sidebar !== 'undefined') && (typeof athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153 = (function (meta60154){
this.meta60154 = meta60154;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60155,meta60154__$1){
var self__ = this;
var _60155__$1 = this;
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153(meta60154__$1));
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60155){
var self__ = this;
var _60155__$1 = this;
return self__.meta60154;
}));

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47717__auto__,devcard_opts__47718__auto__){
var self__ = this;
var this__47717__auto____$1 = this;
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.getBasis = (function (){
...
(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.cljs$lang$type = true);

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.cljs$lang$ctorStr = "athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60153");

(athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60153");
}));

/**
 * Positional factory function for athens.devcards.left-sidebar/t_athens$devcards$left_sidebar60153.
 */
athens.devcards.left_sidebar.__GT_t_athens$devcards$left_sidebar60153 = (function athens$devcards$left_sidebar$__GT_t_athens$devcards$left_sidebar60153(meta60154){
return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153(meta60154));
});

}

return (new athens.devcards.left_sidebar.t_athens$devcards$left_sidebar60153(null));
})()
