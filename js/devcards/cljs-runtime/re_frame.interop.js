...
return [(function (){var pred__45699 = cljs.core.instance_QMARK_;
var expr__45700 = reactive_val;
if(cljs.core.truth_((pred__45699.cljs$core$IFn$_invoke$arity$2 ? pred__45699.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45700) : pred__45699.call(null,reagent.ratom.RAtom,expr__45700)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45699.cljs$core$IFn$_invoke$arity$2 ? pred__45699.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45700) : pred__45699.call(null,reagent.ratom.RCursor,expr__45700)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45699.cljs$core$IFn$_invoke$arity$2 ? pred__45699.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45700) : pred__45699.call(null,reagent.ratom.Reaction,expr__45700)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45699.cljs$core$IFn$_invoke$arity$2 ? pred__45699.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45700) : pred__45699.call(null,reagent.ratom.Track,expr__45700)))){
return "tr";
} else {
return "other";
}
