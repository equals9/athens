...
return [(function (){var pred__45424 = cljs.core.instance_QMARK_;
var expr__45425 = reactive_val;
if(cljs.core.truth_((pred__45424.cljs$core$IFn$_invoke$arity$2 ? pred__45424.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45425) : pred__45424.call(null,reagent.ratom.RAtom,expr__45425)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45424.cljs$core$IFn$_invoke$arity$2 ? pred__45424.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45425) : pred__45424.call(null,reagent.ratom.RCursor,expr__45425)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45424.cljs$core$IFn$_invoke$arity$2 ? pred__45424.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45425) : pred__45424.call(null,reagent.ratom.Reaction,expr__45425)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45424.cljs$core$IFn$_invoke$arity$2 ? pred__45424.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45425) : pred__45424.call(null,reagent.ratom.Track,expr__45425)))){
return "tr";
} else {
return "other";
}
