...
return [(function (){var pred__45457 = cljs.core.instance_QMARK_;
var expr__45458 = reactive_val;
if(cljs.core.truth_((pred__45457.cljs$core$IFn$_invoke$arity$2 ? pred__45457.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__45458) : pred__45457.call(null,reagent.ratom.RAtom,expr__45458)))){
return "ra";
} else {
if(cljs.core.truth_((pred__45457.cljs$core$IFn$_invoke$arity$2 ? pred__45457.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__45458) : pred__45457.call(null,reagent.ratom.RCursor,expr__45458)))){
return "rc";
} else {
if(cljs.core.truth_((pred__45457.cljs$core$IFn$_invoke$arity$2 ? pred__45457.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__45458) : pred__45457.call(null,reagent.ratom.Reaction,expr__45458)))){
return "rx";
} else {
if(cljs.core.truth_((pred__45457.cljs$core$IFn$_invoke$arity$2 ? pred__45457.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__45458) : pred__45457.call(null,reagent.ratom.Track,expr__45458)))){
return "tr";
} else {
return "other";
}
