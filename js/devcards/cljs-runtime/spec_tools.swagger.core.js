...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__48819){
var map__48820 = p__48819;
var map__48820__$1 = (((((!((map__48820 == null))))?(((((map__48820.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48820.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__48820):map__48820);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48820__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48820__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__48822 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48822,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48822,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__48827 = cljs.core.get_global_hierarchy;
return (fexpr__48827.cljs$core$IFn$_invoke$arity$0 ? fexpr__48827.cljs$core$IFn$_invoke$arity$0() : fexpr__48827.call(null));
})());
...
var map__48828 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48828__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48828__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__48830){
var vec__48831 = p__48830;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48831,(0),null);
var map__48834 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48831,(1),null);
...
var schema = map__48834__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48834__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__48836 = cljs.core.get_global_hierarchy;
return (fexpr__48836.cljs$core$IFn$_invoke$arity$0 ? fexpr__48836.cljs$core$IFn$_invoke$arity$0() : fexpr__48836.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__48837(s__48838){
...
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48841,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48841,(1),null);
cljs.core.chunk_append(b__48840,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__48840),spec_tools$swagger$core$iter__48837(cljs.core.chunk_rest(s__48838__$2)));
} else {
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__48837(cljs.core.rest(s__48838__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__48848){
var vec__48849 = p__48848;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48849,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48849,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__48852,p){
var vec__48853 = p__48852;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48853,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48853,(1),null);
var acc__$1 = vec__48853;
