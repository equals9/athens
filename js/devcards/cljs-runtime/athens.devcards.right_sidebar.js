...
return (function (){
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.right_sidebar.right_sidebar_style),(function (){var iter__4582__auto__ = (function athens$devcards$right_sidebar$right_sidebar_$_iter__60303(s__60304){
...
var map__60307 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60305);
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60307__$1,new cljs.core.Keyword("node","title","node/title",628940777));
cljs.core.chunk_append(b__60306,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),title], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)));

var G__60314 = (i__60305 + (1));
i__60305 = G__60314;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60306),athens$devcards$right_sidebar$right_sidebar_$_iter__60303(cljs.core.chunk_rest(s__60304__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60306),null);
}
} else {
var map__60309 = cljs.core.first(s__60304__$2);
...
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60309__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60309__$1,new cljs.core.Keyword("node","title","node/title",628940777));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),title], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$right_sidebar$right_sidebar_$_iter__60303(cljs.core.rest(s__60304__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.right_sidebar !== 'undefined') && (typeof athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311 !== 'undefined')){
} else {
...
*/
athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311 = (function (meta60312){
this.meta60312 = meta60312;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60313,meta60312__$1){
var self__ = this;
var _60313__$1 = this;
return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311(meta60312__$1));
}));

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60313){
var self__ = this;
var _60313__$1 = this;
return self__.meta60312;
}));

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.getBasis = (function (){
...
(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.cljs$lang$type = true);

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.cljs$lang$ctorStr = "athens.devcards.right-sidebar/t_athens$devcards$right_sidebar60311");

(athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.right-sidebar/t_athens$devcards$right_sidebar60311");
}));

/**
 * Positional factory function for athens.devcards.right-sidebar/t_athens$devcards$right_sidebar60311.
 */
athens.devcards.right_sidebar.__GT_t_athens$devcards$right_sidebar60311 = (function athens$devcards$right_sidebar$__GT_t_athens$devcards$right_sidebar60311(meta60312){
return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311(meta60312));
});

}

return (new athens.devcards.right_sidebar.t_athens$devcards$right_sidebar60311(null));
})()
