...
var vec__29096 = cljs.core.first(pull_map);
...
var G__29116 = schema;
var G__29117 = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__29094_SHARP_);
var G__29118 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([((r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__29094_SHARP_], 0));
return (posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_datoms_for_pull_map.cljs$core$IFn$_invoke$arity$3(G__29116,G__29117,G__29118) : posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,G__29116,G__29117,G__29118));
...
)),(function (){var G__29126 = schema;
var G__29127 = entity_id;
var G__29128 = cljs.core.rest(pull_map);
...
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0)):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,v], null)], null)),(function (){var G__29132 = schema;
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__29196 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29196.cljs$core$IFn$_invoke$arity$2 ? fexpr__29196.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__29196.call(null,db,ent_id));
})());
...
return (fexpr__29217.cljs$core$IFn$_invoke$arity$2 ? fexpr__29217.cljs$core$IFn$_invoke$arity$2(db,p1__29211_SHARP_) : fexpr__29217.call(null,db,p1__29211_SHARP_));
}),ent_ids);
