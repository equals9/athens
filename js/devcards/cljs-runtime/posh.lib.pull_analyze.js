...
var entity_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__24012_SHARP_){
return ((cljs.core.map_QMARK_(p1__24012_SHARP_)) || (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","id","db/id",-1388397098),p1__24012_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__24013_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_(p1__24013_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_(schema,p1__24013_SHARP_)));
}),entity_keys);
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__24032,pull_pattern,ent_id){
