...
var ref_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29153,(0),null);
var ref_pull = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29153,(1),null);
...
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(ref_key.cljs$core$IFn$_invoke$arity$1 ? ref_key.cljs$core$IFn$_invoke$arity$1(affected_pull) : ref_key.call(null,affected_pull))], 0)):(function (){var G__29163 = schema;
var G__29164 = ref_pull;
var G__29165 = (ref_key.cljs$core$IFn$_invoke$arity$2 ? ref_key.cljs$core$IFn$_invoke$arity$2(affected_pull,refs_only_QMARK_) : ref_key.call(null,affected_pull,refs_only_QMARK_));
return (posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3 ? posh.lib.pull_analyze.tx_pattern_for_pull.cljs$core$IFn$_invoke$arity$3(G__29163,G__29164,G__29165) : posh.lib.pull_analyze.tx_pattern_for_pull.call(null,G__29163,G__29164,G__29165));
})()
)));
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__29192,pull_pattern,ent_ids){
var map__29193 = p__29192;
var map__29193__$1 = (((((!((map__29193 == null))))?(((((map__29193.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29193.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29193):map__29193);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29193__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29193__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29193__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__29202 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__29202.cljs$core$IFn$_invoke$arity$2 ? fexpr__29202.cljs$core$IFn$_invoke$arity$2(db,p1__29185_SHARP_) : fexpr__29202.call(null,db,p1__29185_SHARP_));
}),ent_ids);
