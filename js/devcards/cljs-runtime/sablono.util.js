...
var sablono$util$ToString$to_str$dyn_45110 = (function (x){
...
return sablono$util$ToString$to_str$dyn_45110(x);
}
});
...
var sablono$util$ToURI$to_uri$dyn_45115 = (function (x){
var x__4428__auto__ = (((x == null))?null:x);
...
return sablono$util$ToURI$to_uri$dyn_45115(x);
}
});
...
/** @this {Function} */
(sablono.util.as_str.cljs$lang$applyTo = (function (seq45069){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq45069));
}));
...
var vec__45072 = cljs.core.name(k).split("-");
...
var first_word = first__45074;
var words = seq__45073__$1;
...
var m__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__45079){
var vec__45082 = p__45079;
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__45085,new cljs.core.Keyword(null,"style","style",-496642736),sablono.util.camel_case_keys);
} else {
return G__45085;
}
} else {
