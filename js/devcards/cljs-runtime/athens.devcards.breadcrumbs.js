...
var len__4789__auto___58007 = arguments.length;
var i__4790__auto___58008 = (0);
while(true){
if((i__4790__auto___58008 < len__4789__auto___58007)){
args__4795__auto__.push((arguments[i__4790__auto___58008]));

var G__58009 = (i__4790__auto___58008 + (1));
i__4790__auto___58008 = G__58009;
continue;
} else {
}
break;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993 = (function (meta57994){
this.meta57994 = meta57994;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_57995,meta57994__$1){
var self__ = this;
var _57995__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993(meta57994__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_57995){
var self__ = this;
var _57995__$1 = this;
return self__.meta57994;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta57994","meta57994",899313339,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57993");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57993");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57993.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs57993 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs57993(meta57994){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993(meta57994));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57993(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
