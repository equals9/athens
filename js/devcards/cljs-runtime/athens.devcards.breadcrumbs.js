...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumbs_list.cljs$lang$applyTo = (function (seq57984){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57984));
}));
...
(athens.devcards.breadcrumbs.breadcrumb.cljs$core$IFn$_invoke$arity$variadic = (function (p__57987,label){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57988__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumb.cljs$lang$applyTo = (function (seq57985){
var G__57986 = cljs.core.first(seq57985);
var seq57985__$1 = cljs.core.next(seq57985);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57986,seq57985__$1);
}));
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57990.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998 = (function (meta57999){
this.meta57999 = meta57999;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58000,meta57999__$1){
var self__ = this;
var _58000__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998(meta57999__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58000){
var self__ = this;
var _58000__$1 = this;
return self__.meta57999;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta57999","meta57999",-1537967657,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57998");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57998");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs57998.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs57998 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs57998(meta57999){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998(meta57999));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs57998(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009 = (function (meta58010){
this.meta58010 = meta58010;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58011,meta58010__$1){
var self__ = this;
var _58011__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009(meta58010__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58011){
var self__ = this;
var _58011__$1 = this;
return self__.meta58010;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58010","meta58010",-802489693,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58009");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58009");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58009.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58009 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58009(meta58010){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009(meta58010));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58009(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
