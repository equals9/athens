...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumbs_list.cljs$lang$applyTo = (function (seq58021){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58021));
}));
...
(athens.devcards.breadcrumbs.breadcrumb.cljs$core$IFn$_invoke$arity$variadic = (function (p__58024,label){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58025__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
/** @this {Function} */
(athens.devcards.breadcrumbs.breadcrumb.cljs$lang$applyTo = (function (seq58022){
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.breadcrumbs !== 'undefined') && (typeof athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033 = (function (meta58034){
this.meta58034 = meta58034;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58035,meta58034__$1){
var self__ = this;
var _58035__$1 = this;
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033(meta58034__$1));
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58035){
var self__ = this;
var _58035__$1 = this;
return self__.meta58034;
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta58034","meta58034",293853602,null)], null);
}));

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.cljs$lang$type = true);

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.cljs$lang$ctorStr = "athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58033");

(athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58033");
}));

/**
 * Positional factory function for athens.devcards.breadcrumbs/t_athens$devcards$breadcrumbs58033.
 */
athens.devcards.breadcrumbs.__GT_t_athens$devcards$breadcrumbs58033 = (function athens$devcards$breadcrumbs$__GT_t_athens$devcards$breadcrumbs58033(meta58034){
return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033(meta58034));
});

}

return (new athens.devcards.breadcrumbs.t_athens$devcards$breadcrumbs58033(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
