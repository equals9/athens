...
var G__58436_58508 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),value,new cljs.core.Keyword("edit","time","edit/time",1384867476),athens.util.now_ts()], null)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58436_58508) : re_frame.core.dispatch.call(null,G__58436_58508));
...
var now_58510 = athens.util.now_ts();
var uid_58511__$1 = athens.util.gen_block_uid();
var G__58439_58512 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"transact","transact",-267998670),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword("node","title","node/title",628940777),inner_title,new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid_58511__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476),now_58510,new cljs.core.Keyword("create","time","create/time",-1563077754),now_58510], null)], null)], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58439_58512) : re_frame.core.dispatch.call(null,G__58439_58512));
} else {
}
...
while (G__58513__i < G__58513__a.length) {G__58513__a[G__58513__i] = arguments[G__58513__i + 0]; ++G__58513__i;}
  title = new cljs.core.IndexedSeq(G__58513__a,0,null);
} 
return G__58509__delegate.call(this,title);};
G__58509.cljs$lang$maxFixedArity = 0;
G__58509.cljs$lang$applyTo = (function (arglist__58514){
var title = cljs.core.seq(arglist__58514);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.views.dropdown.menu_item_style,((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index,i))?athens.views.dropdown.menu_item_active_style:null)], 0)),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (vec__58460,i,map__58463,map__58463__$1,title,string,uid,s__58452__$2,temp__5735__auto__,map__58449,map__58449__$1,page,block,query,results,index){
return (function (){
return cljs.core.prn.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expand"], 0));
...
var G__58467 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040),uid], null);
...
return (function (p__58468,state){
...
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58469__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var open = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58469__$1,new cljs.core.Keyword("block","open","block/open",-1875254829));
...
var atom_string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58471__$1,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204));
...
var G__58473 = atom_string;
var G__58474 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(block);
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58473,G__58474) : athens.views.blocks.db_on_change.call(null,G__58473,G__58474));
} else {
return null;
}
}));
...
var edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58475__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
...
var map__58476 = cljs.core.deref(state);
...
var dragging = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58476__$1,new cljs.core.Keyword(null,"dragging","dragging",1185097613));
var drag_target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58476__$1,new cljs.core.Keyword(null,"drag-target","drag-target",2017061919));
var state_edit_time = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58476__$1,new cljs.core.Keyword("edit","time","edit/time",1384867476));
var is_editing = cljs.core.deref((function (){var G__58479 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","is-editing","editing/is-editing",-1509220484),uid], null);
...
var is_selected = cljs.core.deref((function (){var G__58480 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("selected","is-selected","selected/is-selected",689082595),uid], null);
...
var new_state_58518 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword("edit","time","edit/time",1384867476),edit_time,new cljs.core.Keyword(null,"atom-string","atom-string",-1067323204),string], null);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(state,cljs.core.merge,new_state_58518);
} else {
}
...
var G__58481_58519 = new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"drop-bullet","drop-bullet",1177869489),source_uid,uid,drag_target], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58481_58519) : re_frame.core.dispatch.call(null,G__58481_58519));
...
})())?(function (){var iter__4582__auto__ = (function athens$views$blocks$block_el_$_iter__58482(s__58483){
return (new cljs.core.LazySeq(null,(function (){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58485),athens$views$blocks$block_el_$_iter__58482(cljs.core.chunk_rest(s__58483__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58485),null);
}
} else {
var child = cljs.core.first(s__58483__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"32px"], null),new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null)], null),athens$views$blocks$block_el_$_iter__58482(cljs.core.rest(s__58483__$2)));
}
} else {
return null;
}
