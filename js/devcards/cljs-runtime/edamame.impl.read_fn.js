...
return cljs.core.with_meta((function (){var G__59073 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59073) : outer.call(null,G__59073));
})(),cljs.core.meta(form));
} else {
if(cljs.core.map_entry_QMARK_(form)){
var G__59074 = (new cljs.core.MapEntry((function (){var G__59075 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__59075) : inner.call(null,G__59075));
})(),(function (){var G__59076 = cljs.core.val(form);
...
return cljs.core.with_meta((function (){var G__59077 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59077) : outer.call(null,G__59077));
})(),cljs.core.meta(form));
} else {
if(cljs.core.record_QMARK_(form)){
var G__59078 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,x){
...
var G__59079 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.empty(form),cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
...
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59091,(1),null);
...
var n_59095 = parseInt(m);
state.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,cljs.core.update.cljs$core$IFn$_invoke$arity$4(state.cljs$core$IDeref$_deref$arity$1(null),new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124),cljs.core.max,n_59095));
...
var map__59090 = cljs.core.deref(state);
...
var var_args_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59090__$1,new cljs.core.Keyword(null,"var-args?","var-args?",-1630678710));
var fixed_names = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59087_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["%",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59087_SHARP_)].join(''));
