...
return cljs.core.with_meta((function (){var G__59016 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59016) : outer.call(null,G__59016));
})(),cljs.core.meta(form));
} else {
if(cljs.core.map_entry_QMARK_(form)){
var G__59017 = (new cljs.core.MapEntry((function (){var G__59018 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__59018) : inner.call(null,G__59018));
})(),(function (){var G__59019 = cljs.core.val(form);
...
return cljs.core.with_meta((function (){var G__59020 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59020) : outer.call(null,G__59020));
})(),cljs.core.meta(form));
} else {
if(cljs.core.record_QMARK_(form)){
var G__59021 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,x){
...
var G__59022 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.empty(form),cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
...
var vec__59025 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59025,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59025,(1),null);
...
var n_59029 = parseInt(m);
state.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,cljs.core.update.cljs$core$IFn$_invoke$arity$4(state.cljs$core$IDeref$_deref$arity$1(null),new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124),cljs.core.max,n_59029));
...
var map__59024 = cljs.core.deref(state);
...
var max_fixed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59024__$1,new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124));
var var_args_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59024__$1,new cljs.core.Keyword(null,"var-args?","var-args?",-1630678710));
var fixed_names = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59023_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["%",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__59023_SHARP_)].join(''));
