...
return cljs.core.with_meta((function (){var G__59022 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59022) : outer.call(null,G__59022));
})(),cljs.core.meta(form));
} else {
if(cljs.core.map_entry_QMARK_(form)){
var G__59023 = (new cljs.core.MapEntry((function (){var G__59024 = cljs.core.key(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__59024) : inner.call(null,G__59024));
})(),(function (){var G__59025 = cljs.core.val(form);
return (inner.cljs$core$IFn$_invoke$arity$1 ? inner.cljs$core$IFn$_invoke$arity$1(G__59025) : inner.call(null,G__59025));
})(),null));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59023) : outer.call(null,G__59023));
} else {
if(cljs.core.seq_QMARK_(form)){
return cljs.core.with_meta((function (){var G__59026 = cljs.core.doall.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
return (outer.cljs$core$IFn$_invoke$arity$1 ? outer.cljs$core$IFn$_invoke$arity$1(G__59026) : outer.call(null,G__59026));
})(),cljs.core.meta(form));
} else {
if(cljs.core.record_QMARK_(form)){
var G__59027 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,x){
...
var G__59028 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.empty(form),cljs.core.map.cljs$core$IFn$_invoke$arity$2(inner,form));
...
var vec__59040 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59040,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59040,(1),null);
...
var n_59044 = parseInt(m);
state.cljs$core$IVolatile$_vreset_BANG_$arity$2(null,cljs.core.update.cljs$core$IFn$_invoke$arity$4(state.cljs$core$IDeref$_deref$arity$1(null),new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124),cljs.core.max,n_59044));
...
var map__59035 = cljs.core.deref(state);
...
var max_fixed = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59035__$1,new cljs.core.Keyword(null,"max-fixed","max-fixed",166770124));
var var_args_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59035__$1,new cljs.core.Keyword(null,"var-args?","var-args?",-1630678710));
