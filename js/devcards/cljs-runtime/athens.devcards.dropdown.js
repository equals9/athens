...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__55798 = (function (){var G__55799 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__55799) : garden.selectors.not.call(null,G__55799));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__55798) : garden.selectors._AMPERSAND_.call(null,G__55798));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__55800 = (function (){var G__55801 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__55801) : garden.selectors.not.call(null,G__55801));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__55800) : garden.selectors._AMPERSAND_.call(null,G__55800));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__55802){
var map__55803 = p__55802;
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55803__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55803__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__55805){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55806__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55806__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__55808){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55809__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55809__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55809__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Slash-Menu",new cljs.core.Keyword(null,"documentation","documentation",1889593999),"Should we have separate files for the components that are created from `athens.devcards.dropdown` primitives?\n\n  [localhost](/cards.html#!/athens.devcards.slash_menu)\n\n  [github.io/athens](/athens/cards.html#!/athens.devcards.slash_menu)",new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown55811 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown55811 = (function (meta55812){
this.meta55812 = meta55812;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown55811.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55813,meta55812__$1){
var self__ = this;
var _55813__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55811(meta55812__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55813){
var self__ = this;
var _55813__$1 = this;
return self__.meta55812;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.slash_menu_component], null);
...
(athens.devcards.dropdown.t_athens$devcards$dropdown55811.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55812","meta55812",-1497915894,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown55811");

(athens.devcards.dropdown.t_athens$devcards$dropdown55811.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown55811");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown55811.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown55811 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown55811(meta55812){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55811(meta55812));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown55811(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
devcards.core.register_card(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athens.devcards.dropdown","athens.devcards.dropdown",1847323484),new cljs.core.Keyword(null,"Context-Menu","Context-Menu",-1217879005)], null),new cljs.core.Keyword(null,"func","func",-238706040),(function (){
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"Context-Menu",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown55814 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown55814 = (function (meta55815){
this.meta55815 = meta55815;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown55814.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55816,meta55815__$1){
var self__ = this;
var _55816__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55814(meta55815__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55816){
var self__ = this;
var _55816__$1 = this;
return self__.meta55815;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.context_menu_component], null);
if(cljs.core.fn_QMARK_(v__41695__auto__)){
return (function (data_atom__41696__auto__,owner__41697__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__41695__auto__,data_atom__41696__auto__,owner__41697__auto__], null));
});
...
(athens.devcards.dropdown.t_athens$devcards$dropdown55814.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55815","meta55815",1754228703,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown55814");

(athens.devcards.dropdown.t_athens$devcards$dropdown55814.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown55814");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown55814.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown55814 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown55814(meta55815){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55814(meta55815));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown55814(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown55817 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown55817 = (function (meta55818){
this.meta55818 = meta55818;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown55817.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55819,meta55818__$1){
var self__ = this;
var _55819__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55817(meta55818__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55817.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55819){
var self__ = this;
var _55819__$1 = this;
return self__.meta55818;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown55817.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown55817.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.dropdown,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"width","width",-384071477),"20em",new cljs.core.Keyword(null,"height","height",1025178622),"20em"], null),new cljs.core.Keyword(null,"content","content",15833224),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.dropdown.menu_heading,"Filters"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.filters.filters_el,"((some-uid))",athens.devcards.filters.items], null)], null)], null)], null);
if(cljs.core.fn_QMARK_(v__41695__auto__)){
return (function (data_atom__41696__auto__,owner__41697__auto__){
return reagent.core.as_element(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [v__41695__auto__,data_atom__41696__auto__,owner__41697__auto__], null));
});
...
(athens.devcards.dropdown.t_athens$devcards$dropdown55817.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown55817.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown55817.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown55817");

(athens.devcards.dropdown.t_athens$devcards$dropdown55817.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown55817");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown55817.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown55817 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown55817(meta55818){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown55817(meta55818));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown55817(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
