...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61047 = (function (){var G__61048 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61048) : garden.selectors.not.call(null,G__61048));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61047) : garden.selectors._AMPERSAND_.call(null,G__61047));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__61049 = (function (){var G__61050 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__61050) : garden.selectors.not.call(null,G__61050));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__61049) : garden.selectors._AMPERSAND_.call(null,G__61049));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__61051){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61052__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61052__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__61054){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61055__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61057){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61058__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61058__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61058__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61060 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61060 = (function (meta61061){
this.meta61061 = meta61061;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61060.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61062,meta61061__$1){
var self__ = this;
var _61062__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61060(meta61061__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61062){
var self__ = this;
var _61062__$1 = this;
return self__.meta61061;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61060.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61061","meta61061",698132456,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61060");

(athens.devcards.dropdown.t_athens$devcards$dropdown61060.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61060");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61060.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61060 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61060(meta61061){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61060(meta61061));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61060(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61063 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61063 = (function (meta61064){
this.meta61064 = meta61064;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61063.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61065,meta61064__$1){
var self__ = this;
var _61065__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61063(meta61064__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61065){
var self__ = this;
var _61065__$1 = this;
return self__.meta61064;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61063.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61064","meta61064",914666533,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61063");

(athens.devcards.dropdown.t_athens$devcards$dropdown61063.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61063");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61063.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61063 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61063(meta61064){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61063(meta61064));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61063(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61066 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61066 = (function (meta61067){
this.meta61067 = meta61067;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61066.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61068,meta61067__$1){
var self__ = this;
var _61068__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61066(meta61067__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61068){
var self__ = this;
var _61068__$1 = this;
return self__.meta61067;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61066.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61067","meta61067",-798631309,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61066");

(athens.devcards.dropdown.t_athens$devcards$dropdown61066.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61066");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61066.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61066 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61066(meta61067){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61066(meta61067));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61066(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
