...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60991 = (function (){var G__60992 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60992) : garden.selectors.not.call(null,G__60992));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60991) : garden.selectors._AMPERSAND_.call(null,G__60991));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60993 = (function (){var G__60994 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__60995){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60996__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60996__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__60998){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60999__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60999__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__61001){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61002__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61002__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61002__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61004 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61004 = (function (meta61005){
this.meta61005 = meta61005;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61004.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61006,meta61005__$1){
var self__ = this;
var _61006__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61004(meta61005__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61004.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61006){
var self__ = this;
var _61006__$1 = this;
return self__.meta61005;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61004.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61004.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61004.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61004.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61004.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61004");

(athens.devcards.dropdown.t_athens$devcards$dropdown61004.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61004");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61004.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61004 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61004(meta61005){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61004(meta61005));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61004(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61007 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61007 = (function (meta61008){
this.meta61008 = meta61008;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61007.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61009,meta61008__$1){
var self__ = this;
var _61009__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61007(meta61008__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61009){
var self__ = this;
var _61009__$1 = this;
return self__.meta61008;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61007.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61008","meta61008",-1907726831,null)], null);
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61007");

(athens.devcards.dropdown.t_athens$devcards$dropdown61007.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61007");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61007.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61007 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61007(meta61008){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61007(meta61008));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61007(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown61010 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown61010 = (function (meta61011){
this.meta61011 = meta61011;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown61010.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61012,meta61011__$1){
var self__ = this;
var _61012__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61010(meta61011__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61010.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61012){
var self__ = this;
var _61012__$1 = this;
return self__.meta61011;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown61010.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown61010.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61010.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown61010.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown61010.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown61010");

(athens.devcards.dropdown.t_athens$devcards$dropdown61010.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown61010");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown61010.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown61010 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown61010(meta61011){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown61010(meta61011));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown61010(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
