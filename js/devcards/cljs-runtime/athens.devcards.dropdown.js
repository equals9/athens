...
athens.devcards.dropdown.menu_style = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"display","display",242065432),"grid",new cljs.core.Keyword(null,"grid-gap","grid-gap",1083581064),"2px",new cljs.core.Keyword(null,"min-width","min-width",1926193728),"9em",new cljs.core.Keyword(null,"align-items","align-items",-267946462),"stretch",new cljs.core.Keyword(null,"grid-auto-flow","grid-auto-flow",-1754873684),"row",new cljs.core.Keyword(null,"overflow","overflow",2058931880),"auto",new cljs.core.Keyword("stylefy.core","manual","stylefy.core/manual",-1053755369),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60798 = (function (){var G__60799 = (garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.first_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.first_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60799) : garden.selectors.not.call(null,G__60799));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60798) : garden.selectors._AMPERSAND_.call(null,G__60798));
})(),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-block-start","margin-block-start",1770237075),"4px"], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__60800 = (function (){var G__60801 = (garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0 ? garden.selectors.last_child.cljs$core$IFn$_invoke$arity$0() : garden.selectors.last_child.call(null));
return (garden.selectors.not.cljs$core$IFn$_invoke$arity$1 ? garden.selectors.not.cljs$core$IFn$_invoke$arity$1(G__60801) : garden.selectors.not.call(null,G__60801));
})();
return (garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1 ? garden.selectors._AMPERSAND_.cljs$core$IFn$_invoke$arity$1(G__60800) : garden.selectors._AMPERSAND_.call(null,G__60800));
...
athens.devcards.dropdown.dropdown = (function athens$devcards$dropdown$dropdown(p__60802){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60803__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60803__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu = (function athens$devcards$dropdown$menu(p__60805){
...
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60806__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60806__$1,new cljs.core.Keyword(null,"content","content",15833224));
...
athens.devcards.dropdown.menu_item = (function athens$devcards$dropdown$menu_item(p__60808){
...
var disabled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60809__$1,new cljs.core.Keyword(null,"disabled","disabled",-1529784218));
var label = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60809__$1,new cljs.core.Keyword(null,"label","label",1718410804));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60809__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60811 !== 'undefined')){
} else {
...
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60811 = (function (meta60812){
this.meta60812 = meta60812;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60811.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60813,meta60812__$1){
var self__ = this;
var _60813__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60811(meta60812__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60811.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60813){
var self__ = this;
var _60813__$1 = this;
return self__.meta60812;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60811.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60811.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60811.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60811.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60811.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60811");

(athens.devcards.dropdown.t_athens$devcards$dropdown60811.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60811");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60811.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60811 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60811(meta60812){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60811(meta60812));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60811(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60814 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60814 = (function (meta60815){
this.meta60815 = meta60815;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60814.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60816,meta60815__$1){
var self__ = this;
var _60816__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60814(meta60815__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60814.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60816){
var self__ = this;
var _60816__$1 = this;
return self__.meta60815;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60814.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60814.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60814.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60814.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60814.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60814");

(athens.devcards.dropdown.t_athens$devcards$dropdown60814.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60814");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60814.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60814 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60814(meta60815){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60814(meta60815));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60814(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.dropdown !== 'undefined') && (typeof athens.devcards.dropdown.t_athens$devcards$dropdown60817 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.dropdown.t_athens$devcards$dropdown60817 = (function (meta60818){
this.meta60818 = meta60818;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.dropdown.t_athens$devcards$dropdown60817.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60819,meta60818__$1){
var self__ = this;
var _60819__$1 = this;
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60817(meta60818__$1));
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60817.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60819){
var self__ = this;
var _60819__$1 = this;
return self__.meta60818;
}));

(athens.devcards.dropdown.t_athens$devcards$dropdown60817.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.dropdown.t_athens$devcards$dropdown60817.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60817.getBasis = (function (){
...
(athens.devcards.dropdown.t_athens$devcards$dropdown60817.cljs$lang$type = true);

(athens.devcards.dropdown.t_athens$devcards$dropdown60817.cljs$lang$ctorStr = "athens.devcards.dropdown/t_athens$devcards$dropdown60817");

(athens.devcards.dropdown.t_athens$devcards$dropdown60817.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.dropdown/t_athens$devcards$dropdown60817");
}));

/**
 * Positional factory function for athens.devcards.dropdown/t_athens$devcards$dropdown60817.
 */
athens.devcards.dropdown.__GT_t_athens$devcards$dropdown60817 = (function athens$devcards$dropdown$__GT_t_athens$devcards$dropdown60817(meta60818){
return (new athens.devcards.dropdown.t_athens$devcards$dropdown60817(meta60818));
});

}

return (new athens.devcards.dropdown.t_athens$devcards$dropdown60817(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
