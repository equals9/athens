...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44256,style_created_handler){
var map__44258 = p__44256;
...
var style = map__44258__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44258__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44258__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44261_44333 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44261_44333) : style_created_handler.call(null,G__44261_44333));

var seq__44263 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44264 = null;
var count__44265 = (0);
var i__44266 = (0);
while(true){
if((i__44266 < count__44265)){
var sub_style = chunk__44264.cljs$core$IIndexed$_nth$arity$2(null,i__44266);
var G__44273_44334 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44274_44335 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44273_44334,G__44274_44335) : stylefy.impl.styles.create_style_BANG_.call(null,G__44273_44334,G__44274_44335));


var G__44338 = seq__44263;
var G__44339 = chunk__44264;
var G__44340 = count__44265;
var G__44341 = (i__44266 + (1));
seq__44263 = G__44338;
chunk__44264 = G__44339;
count__44265 = G__44340;
i__44266 = G__44341;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44263);
if(temp__5735__auto__){
var seq__44263__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44263__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44263__$1);
var G__44343 = cljs.core.chunk_rest(seq__44263__$1);
var G__44344 = c__4556__auto__;
var G__44345 = cljs.core.count(c__4556__auto__);
var G__44346 = (0);
seq__44263 = G__44343;
chunk__44264 = G__44344;
count__44265 = G__44345;
i__44266 = G__44346;
continue;
} else {
var sub_style = cljs.core.first(seq__44263__$1);
var G__44276_44347 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44277_44348 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44276_44347,G__44277_44348) : stylefy.impl.styles.create_style_BANG_.call(null,G__44276_44347,G__44277_44348));


var G__44351 = cljs.core.next(seq__44263__$1);
var G__44352 = null;
var G__44353 = (0);
var G__44354 = (0);
seq__44263 = G__44351;
chunk__44264 = G__44352;
count__44265 = G__44353;
i__44266 = G__44354;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44278_SHARP_){
return ((typeof p1__44278_SHARP_ === 'string') || ((p1__44278_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44278_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44278#] (or (string? p1__44278#) (keyword? p1__44278#) (nil? p1__44278#))) class)))"].join('')));
}
});
/**
...
while(true){
if((i__4737__auto___44371 < len__4736__auto___44369)){
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44295_SHARP_,p2__44296_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__44295_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__44296_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq44298){
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__44309){
var map__44311 = p__44309;
var map__44311__$1 = (((((!((map__44311 == null))))?(((((map__44311.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44311.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44311):map__44311);
var options = map__44311__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44311__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_44376__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44314_44377 = cljs.core.seq(styles_44376__$1);
var chunk__44315_44378 = null;
var count__44316_44379 = (0);
var i__44317_44380 = (0);
while(true){
if((i__44317_44380 < count__44316_44379)){
var style_44381 = chunk__44315_44378.cljs$core$IIndexed$_nth$arity$2(null,i__44317_44380);
stylefy.impl.styles.use_style_BANG_(style_44381,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44382 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44381));
if(cljs.core.truth_(temp__5735__auto___44382)){
var sub_styles_44383 = temp__5735__auto___44382;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44383,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44385 = seq__44314_44377;
var G__44386 = chunk__44315_44378;
var G__44387 = count__44316_44379;
var G__44388 = (i__44317_44380 + (1));
seq__44314_44377 = G__44385;
chunk__44315_44378 = G__44386;
count__44316_44379 = G__44387;
i__44317_44380 = G__44388;
continue;
} else {
var temp__5735__auto___44389 = cljs.core.seq(seq__44314_44377);
if(temp__5735__auto___44389){
var seq__44314_44390__$1 = temp__5735__auto___44389;
if(cljs.core.chunked_seq_QMARK_(seq__44314_44390__$1)){
var c__4556__auto___44391 = cljs.core.chunk_first(seq__44314_44390__$1);
var G__44392 = cljs.core.chunk_rest(seq__44314_44390__$1);
var G__44393 = c__4556__auto___44391;
var G__44394 = cljs.core.count(c__4556__auto___44391);
var G__44395 = (0);
seq__44314_44377 = G__44392;
chunk__44315_44378 = G__44393;
count__44316_44379 = G__44394;
i__44317_44380 = G__44395;
continue;
} else {
var style_44397 = cljs.core.first(seq__44314_44390__$1);
stylefy.impl.styles.use_style_BANG_(style_44397,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44398__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44397));
if(cljs.core.truth_(temp__5735__auto___44398__$1)){
var sub_styles_44399 = temp__5735__auto___44398__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44399,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44400 = cljs.core.next(seq__44314_44390__$1);
var G__44401 = null;
var G__44402 = (0);
var G__44403 = (0);
seq__44314_44377 = G__44400;
chunk__44315_44378 = G__44401;
count__44316_44379 = G__44402;
i__44317_44380 = G__44403;
continue;
}
} else {
}
