...
var map__44291 = p__44288;
var map__44291__$1 = (((((!((map__44291 == null))))?(((((map__44291.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__44291.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__44291):map__44291);
var style = map__44291__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44291__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44291__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44295_44379 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44295_44379) : style_created_handler.call(null,G__44295_44379));
...
var G__44310_44382 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44311_44383 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44310_44382,G__44311_44383) : stylefy.impl.styles.create_style_BANG_.call(null,G__44310_44382,G__44311_44383));
...
var G__44313_44395 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44314_44396 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44313_44395,G__44314_44396) : stylefy.impl.styles.create_style_BANG_.call(null,G__44313_44395,G__44314_44396));
...
var G__44430 = (i__4737__auto___44428 + (1));
i__4737__auto___44428 = G__44430;
continue;
} else {
}
break;
...
var styles_44435__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44360_44436 = cljs.core.seq(styles_44435__$1);
var chunk__44361_44437 = null;
var count__44362_44438 = (0);
var i__44363_44439 = (0);
while(true){
if((i__44363_44439 < count__44362_44438)){
var style_44441 = chunk__44361_44437.cljs$core$IIndexed$_nth$arity$2(null,i__44363_44439);
stylefy.impl.styles.use_style_BANG_(style_44441,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44442 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44441));
if(cljs.core.truth_(temp__5735__auto___44442)){
var sub_styles_44443 = temp__5735__auto___44442;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44443,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44444 = seq__44360_44436;
var G__44445 = chunk__44361_44437;
var G__44446 = count__44362_44438;
var G__44447 = (i__44363_44439 + (1));
seq__44360_44436 = G__44444;
chunk__44361_44437 = G__44445;
count__44362_44438 = G__44446;
i__44363_44439 = G__44447;
continue;
} else {
var temp__5735__auto___44448 = cljs.core.seq(seq__44360_44436);
if(temp__5735__auto___44448){
var seq__44360_44449__$1 = temp__5735__auto___44448;
if(cljs.core.chunked_seq_QMARK_(seq__44360_44449__$1)){
var c__4556__auto___44450 = cljs.core.chunk_first(seq__44360_44449__$1);
var G__44451 = cljs.core.chunk_rest(seq__44360_44449__$1);
var G__44452 = c__4556__auto___44450;
var G__44453 = cljs.core.count(c__4556__auto___44450);
var G__44454 = (0);
seq__44360_44436 = G__44451;
chunk__44361_44437 = G__44452;
count__44362_44438 = G__44453;
i__44363_44439 = G__44454;
continue;
} else {
var style_44456 = cljs.core.first(seq__44360_44449__$1);
stylefy.impl.styles.use_style_BANG_(style_44456,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44457__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44456));
if(cljs.core.truth_(temp__5735__auto___44457__$1)){
var sub_styles_44458 = temp__5735__auto___44457__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44458,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44459 = cljs.core.next(seq__44360_44449__$1);
var G__44460 = null;
var G__44461 = (0);
var G__44462 = (0);
seq__44360_44436 = G__44459;
chunk__44361_44437 = G__44460;
count__44362_44438 = G__44461;
i__44363_44439 = G__44462;
continue;
}
} else {
}
