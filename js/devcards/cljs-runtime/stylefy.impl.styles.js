...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__38750,style_created_handler){
...
var style = map__38751__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38751__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38751__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38754_38820 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38754_38820) : style_created_handler.call(null,G__38754_38820));

var seq__38755 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__38756 = null;
var count__38757 = (0);
var i__38758 = (0);
while(true){
if((i__38758 < count__38757)){
var sub_style = chunk__38756.cljs$core$IIndexed$_nth$arity$2(null,i__38758);
var G__38769_38823 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38770_38824 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38769_38823,G__38770_38824) : stylefy.impl.styles.create_style_BANG_.call(null,G__38769_38823,G__38770_38824));


var G__38826 = seq__38755;
var G__38827 = chunk__38756;
var G__38828 = count__38757;
var G__38829 = (i__38758 + (1));
seq__38755 = G__38826;
chunk__38756 = G__38827;
count__38757 = G__38828;
i__38758 = G__38829;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__38755);
if(temp__5735__auto__){
var seq__38755__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__38755__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__38755__$1);
var G__38831 = cljs.core.chunk_rest(seq__38755__$1);
var G__38832 = c__4609__auto__;
var G__38833 = cljs.core.count(c__4609__auto__);
var G__38834 = (0);
seq__38755 = G__38831;
chunk__38756 = G__38832;
count__38757 = G__38833;
i__38758 = G__38834;
continue;
} else {
var sub_style = cljs.core.first(seq__38755__$1);
var G__38772_38836 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38773_38837 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38772_38836,G__38773_38837) : stylefy.impl.styles.create_style_BANG_.call(null,G__38772_38836,G__38773_38837));


var G__38838 = cljs.core.next(seq__38755__$1);
var G__38839 = null;
var G__38840 = (0);
var G__38841 = (0);
seq__38755 = G__38838;
chunk__38756 = G__38839;
count__38757 = G__38840;
i__38758 = G__38841;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38777_SHARP_){
return ((typeof p1__38777_SHARP_ === 'string') || ((p1__38777_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38777_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38777#] (or (string? p1__38777#) (keyword? p1__38777#) (nil? p1__38777#))) class)))"].join('')));
}
});
/**
...
var len__4789__auto___38861 = arguments.length;
var i__4790__auto___38862 = (0);
while(true){
if((i__4790__auto___38862 < len__4789__auto___38861)){
args__4795__auto__.push((arguments[i__4790__auto___38862]));

var G__38864 = (i__4790__auto___38862 + (1));
i__4790__auto___38862 = G__38864;
continue;
} else {
}
break;
...
var styles_38879__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__38815_38880 = cljs.core.seq(styles_38879__$1);
var chunk__38816_38881 = null;
var count__38817_38882 = (0);
var i__38818_38883 = (0);
while(true){
if((i__38818_38883 < count__38817_38882)){
var style_38885 = chunk__38816_38881.cljs$core$IIndexed$_nth$arity$2(null,i__38818_38883);
stylefy.impl.styles.use_style_BANG_(style_38885,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38887 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38885));
if(cljs.core.truth_(temp__5735__auto___38887)){
var sub_styles_38888 = temp__5735__auto___38887;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38888,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38890 = seq__38815_38880;
var G__38891 = chunk__38816_38881;
var G__38892 = count__38817_38882;
var G__38893 = (i__38818_38883 + (1));
seq__38815_38880 = G__38890;
chunk__38816_38881 = G__38891;
count__38817_38882 = G__38892;
i__38818_38883 = G__38893;
continue;
} else {
var temp__5735__auto___38894 = cljs.core.seq(seq__38815_38880);
if(temp__5735__auto___38894){
var seq__38815_38895__$1 = temp__5735__auto___38894;
if(cljs.core.chunked_seq_QMARK_(seq__38815_38895__$1)){
var c__4609__auto___38896 = cljs.core.chunk_first(seq__38815_38895__$1);
var G__38898 = cljs.core.chunk_rest(seq__38815_38895__$1);
var G__38899 = c__4609__auto___38896;
var G__38900 = cljs.core.count(c__4609__auto___38896);
var G__38901 = (0);
seq__38815_38880 = G__38898;
chunk__38816_38881 = G__38899;
count__38817_38882 = G__38900;
i__38818_38883 = G__38901;
continue;
} else {
var style_38902 = cljs.core.first(seq__38815_38895__$1);
stylefy.impl.styles.use_style_BANG_(style_38902,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38903__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38902));
if(cljs.core.truth_(temp__5735__auto___38903__$1)){
var sub_styles_38904 = temp__5735__auto___38903__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38904,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38905 = cljs.core.next(seq__38815_38895__$1);
var G__38906 = null;
var G__38907 = (0);
var G__38908 = (0);
seq__38815_38880 = G__38905;
chunk__38816_38881 = G__38906;
count__38817_38882 = G__38907;
i__38818_38883 = G__38908;
continue;
}
} else {
}
