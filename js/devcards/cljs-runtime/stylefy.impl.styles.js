...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38727_SHARP_){
return ((typeof p1__38727_SHARP_ === 'string') || ((p1__38727_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38727_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38727#] (or (string? p1__38727#) (keyword? p1__38727#) (nil? p1__38727#))) class)))"].join('')));
}
});
/**
...
var sub_styles_38828 = temp__5735__auto___38826;
