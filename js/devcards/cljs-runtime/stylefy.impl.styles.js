...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44275,style_created_handler){
...
var style = map__44276__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44276__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44276__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44280_44364 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44280_44364) : style_created_handler.call(null,G__44280_44364));

var seq__44281 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44282 = null;
var count__44283 = (0);
var i__44284 = (0);
while(true){
if((i__44284 < count__44283)){
var sub_style = chunk__44282.cljs$core$IIndexed$_nth$arity$2(null,i__44284);
var G__44292_44365 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44293_44366 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44292_44365,G__44293_44366) : stylefy.impl.styles.create_style_BANG_.call(null,G__44292_44365,G__44293_44366));


var G__44367 = seq__44281;
var G__44368 = chunk__44282;
var G__44369 = count__44283;
var G__44370 = (i__44284 + (1));
seq__44281 = G__44367;
chunk__44282 = G__44368;
count__44283 = G__44369;
i__44284 = G__44370;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44281);
if(temp__5735__auto__){
var seq__44281__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44281__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44281__$1);
var G__44372 = cljs.core.chunk_rest(seq__44281__$1);
var G__44373 = c__4556__auto__;
var G__44374 = cljs.core.count(c__4556__auto__);
var G__44375 = (0);
seq__44281 = G__44372;
chunk__44282 = G__44373;
count__44283 = G__44374;
i__44284 = G__44375;
continue;
} else {
var sub_style = cljs.core.first(seq__44281__$1);
var G__44297_44376 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44298_44377 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44297_44376,G__44298_44377) : stylefy.impl.styles.create_style_BANG_.call(null,G__44297_44376,G__44298_44377));


var G__44379 = cljs.core.next(seq__44281__$1);
var G__44380 = null;
var G__44381 = (0);
var G__44382 = (0);
seq__44281 = G__44379;
chunk__44282 = G__44380;
count__44283 = G__44381;
i__44284 = G__44382;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44301_SHARP_){
return ((typeof p1__44301_SHARP_ === 'string') || ((p1__44301_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44301_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44301#] (or (string? p1__44301#) (keyword? p1__44301#) (nil? p1__44301#))) class)))"].join('')));
}
});
/**
...
var len__4736__auto___44400 = arguments.length;
var i__4737__auto___44401 = (0);
while(true){
if((i__4737__auto___44401 < len__4736__auto___44400)){
args__4742__auto__.push((arguments[i__4737__auto___44401]));

var G__44403 = (i__4737__auto___44401 + (1));
i__4737__auto___44401 = G__44403;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44341_SHARP_,p2__44342_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__44341_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__44342_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq44343){
var G__44344 = cljs.core.first(seq44343);
var seq44343__$1 = cljs.core.next(seq44343);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44344,seq44343__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__44351){
...
var options = map__44352__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44352__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_44412__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44357_44413 = cljs.core.seq(styles_44412__$1);
var chunk__44358_44414 = null;
var count__44359_44415 = (0);
var i__44360_44416 = (0);
while(true){
if((i__44360_44416 < count__44359_44415)){
var style_44417 = chunk__44358_44414.cljs$core$IIndexed$_nth$arity$2(null,i__44360_44416);
stylefy.impl.styles.use_style_BANG_(style_44417,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44418 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44417));
if(cljs.core.truth_(temp__5735__auto___44418)){
var sub_styles_44419 = temp__5735__auto___44418;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44419,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44422 = seq__44357_44413;
var G__44423 = chunk__44358_44414;
var G__44424 = count__44359_44415;
var G__44425 = (i__44360_44416 + (1));
seq__44357_44413 = G__44422;
chunk__44358_44414 = G__44423;
count__44359_44415 = G__44424;
i__44360_44416 = G__44425;
continue;
} else {
var temp__5735__auto___44427 = cljs.core.seq(seq__44357_44413);
if(temp__5735__auto___44427){
var seq__44357_44429__$1 = temp__5735__auto___44427;
if(cljs.core.chunked_seq_QMARK_(seq__44357_44429__$1)){
var c__4556__auto___44430 = cljs.core.chunk_first(seq__44357_44429__$1);
var G__44431 = cljs.core.chunk_rest(seq__44357_44429__$1);
var G__44432 = c__4556__auto___44430;
var G__44433 = cljs.core.count(c__4556__auto___44430);
var G__44434 = (0);
seq__44357_44413 = G__44431;
chunk__44358_44414 = G__44432;
count__44359_44415 = G__44433;
i__44360_44416 = G__44434;
continue;
} else {
var style_44437 = cljs.core.first(seq__44357_44429__$1);
stylefy.impl.styles.use_style_BANG_(style_44437,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44438__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44437));
if(cljs.core.truth_(temp__5735__auto___44438__$1)){
var sub_styles_44439 = temp__5735__auto___44438__$1;
...
var G__44441 = cljs.core.next(seq__44357_44429__$1);
var G__44442 = null;
var G__44443 = (0);
var G__44444 = (0);
seq__44357_44413 = G__44441;
chunk__44358_44414 = G__44442;
count__44359_44415 = G__44443;
i__44360_44416 = G__44444;
continue;
}
} else {
}
