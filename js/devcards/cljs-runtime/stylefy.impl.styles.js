...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44270,style_created_handler){
...
var style = map__44272__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44272__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44272__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__44274_44355 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44274_44355) : style_created_handler.call(null,G__44274_44355));

var seq__44275 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44276 = null;
var count__44277 = (0);
var i__44278 = (0);
while(true){
if((i__44278 < count__44277)){
var sub_style = chunk__44276.cljs$core$IIndexed$_nth$arity$2(null,i__44278);
var G__44285_44357 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44286_44358 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44285_44357,G__44286_44358) : stylefy.impl.styles.create_style_BANG_.call(null,G__44285_44357,G__44286_44358));


var G__44359 = seq__44275;
var G__44360 = chunk__44276;
var G__44361 = count__44277;
var G__44362 = (i__44278 + (1));
seq__44275 = G__44359;
chunk__44276 = G__44360;
count__44277 = G__44361;
i__44278 = G__44362;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44275);
if(temp__5735__auto__){
var seq__44275__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44275__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44275__$1);
var G__44363 = cljs.core.chunk_rest(seq__44275__$1);
var G__44364 = c__4556__auto__;
var G__44365 = cljs.core.count(c__4556__auto__);
var G__44366 = (0);
seq__44275 = G__44363;
chunk__44276 = G__44364;
count__44277 = G__44365;
i__44278 = G__44366;
continue;
} else {
var sub_style = cljs.core.first(seq__44275__$1);
var G__44289_44368 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44290_44369 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44289_44368,G__44290_44369) : stylefy.impl.styles.create_style_BANG_.call(null,G__44289_44368,G__44290_44369));


var G__44370 = cljs.core.next(seq__44275__$1);
var G__44371 = null;
var G__44372 = (0);
var G__44373 = (0);
seq__44275 = G__44370;
chunk__44276 = G__44371;
count__44277 = G__44372;
i__44278 = G__44373;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44294_SHARP_){
return ((typeof p1__44294_SHARP_ === 'string') || ((p1__44294_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44294_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44294#] (or (string? p1__44294#) (keyword? p1__44294#) (nil? p1__44294#))) class)))"].join('')));
}
});
/**
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq44322){
var G__44323 = cljs.core.first(seq44322);
var seq44322__$1 = cljs.core.next(seq44322);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44323,seq44322__$1);
}));
...
var G__44393 = seq__44343_44386;
var G__44394 = chunk__44344_44387;
var G__44395 = count__44345_44388;
var G__44396 = (i__44346_44389 + (1));
seq__44343_44386 = G__44393;
chunk__44344_44387 = G__44394;
count__44345_44388 = G__44395;
i__44346_44389 = G__44396;
continue;
} else {
var temp__5735__auto___44397 = cljs.core.seq(seq__44343_44386);
if(temp__5735__auto___44397){
var seq__44343_44398__$1 = temp__5735__auto___44397;
if(cljs.core.chunked_seq_QMARK_(seq__44343_44398__$1)){
var c__4556__auto___44399 = cljs.core.chunk_first(seq__44343_44398__$1);
var G__44400 = cljs.core.chunk_rest(seq__44343_44398__$1);
var G__44401 = c__4556__auto___44399;
var G__44402 = cljs.core.count(c__4556__auto___44399);
var G__44403 = (0);
seq__44343_44386 = G__44400;
chunk__44344_44387 = G__44401;
count__44345_44388 = G__44402;
i__44346_44389 = G__44403;
continue;
} else {
var style_44404 = cljs.core.first(seq__44343_44398__$1);
...
var G__44408 = cljs.core.next(seq__44343_44398__$1);
var G__44409 = null;
var G__44410 = (0);
var G__44411 = (0);
seq__44343_44386 = G__44408;
chunk__44344_44387 = G__44409;
count__44345_44388 = G__44410;
i__44346_44389 = G__44411;
continue;
}
} else {
}
