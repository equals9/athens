...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__44257,style_created_handler){
...
var G__44263_44333 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__44263_44333) : style_created_handler.call(null,G__44263_44333));

var seq__44264 = cljs.core.seq(cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(props)));
var chunk__44265 = null;
var count__44266 = (0);
var i__44267 = (0);
while(true){
if((i__44267 < count__44266)){
var sub_style = chunk__44265.cljs$core$IIndexed$_nth$arity$2(null,i__44267);
var G__44273_44336 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44274_44337 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44273_44336,G__44274_44337) : stylefy.impl.styles.create_style_BANG_.call(null,G__44273_44336,G__44274_44337));


var G__44339 = seq__44264;
var G__44340 = chunk__44265;
var G__44341 = count__44266;
var G__44342 = (i__44267 + (1));
seq__44264 = G__44339;
chunk__44265 = G__44340;
count__44266 = G__44341;
i__44267 = G__44342;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__44264);
if(temp__5735__auto__){
var seq__44264__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__44264__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__44264__$1);
var G__44344 = cljs.core.chunk_rest(seq__44264__$1);
var G__44345 = c__4556__auto__;
var G__44346 = cljs.core.count(c__4556__auto__);
var G__44347 = (0);
seq__44264 = G__44344;
chunk__44265 = G__44345;
count__44266 = G__44346;
i__44267 = G__44347;
continue;
} else {
var sub_style = cljs.core.first(seq__44264__$1);
var G__44276_44349 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__44277_44350 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__44276_44349,G__44277_44350) : stylefy.impl.styles.create_style_BANG_.call(null,G__44276_44349,G__44277_44350));


var G__44353 = cljs.core.next(seq__44264__$1);
var G__44354 = null;
var G__44355 = (0);
var G__44356 = (0);
seq__44264 = G__44353;
chunk__44265 = G__44354;
count__44266 = G__44355;
i__44267 = G__44356;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__44279_SHARP_){
return ((typeof p1__44279_SHARP_ === 'string') || ((p1__44279_SHARP_ instanceof cljs.core.Keyword)) || ((p1__44279_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__44279#] (or (string? p1__44279#) (keyword? p1__44279#) (nil? p1__44279#))) class)))"].join('')));
}
});
/**
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__44299_SHARP_,p2__44300_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__44299_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__44300_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq44302){
var G__44303 = cljs.core.first(seq44302);
var seq44302__$1 = cljs.core.next(seq44302);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44303,seq44302__$1);
}));
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__44312){
...
var options = map__44313__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44313__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_44376__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__44315_44378 = cljs.core.seq(styles_44376__$1);
var chunk__44316_44379 = null;
var count__44317_44380 = (0);
var i__44318_44381 = (0);
while(true){
if((i__44318_44381 < count__44317_44380)){
var style_44382 = chunk__44316_44379.cljs$core$IIndexed$_nth$arity$2(null,i__44318_44381);
stylefy.impl.styles.use_style_BANG_(style_44382,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___44383 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_44382));
if(cljs.core.truth_(temp__5735__auto___44383)){
var sub_styles_44384 = temp__5735__auto___44383;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_44384,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__44385 = seq__44315_44378;
var G__44386 = chunk__44316_44379;
var G__44387 = count__44317_44380;
var G__44388 = (i__44318_44381 + (1));
seq__44315_44378 = G__44385;
chunk__44316_44379 = G__44386;
count__44317_44380 = G__44387;
i__44318_44381 = G__44388;
continue;
} else {
var temp__5735__auto___44390 = cljs.core.seq(seq__44315_44378);
if(temp__5735__auto___44390){
var seq__44315_44391__$1 = temp__5735__auto___44390;
if(cljs.core.chunked_seq_QMARK_(seq__44315_44391__$1)){
var c__4556__auto___44392 = cljs.core.chunk_first(seq__44315_44391__$1);
var G__44393 = cljs.core.chunk_rest(seq__44315_44391__$1);
var G__44394 = c__4556__auto___44392;
var G__44395 = cljs.core.count(c__4556__auto___44392);
var G__44396 = (0);
seq__44315_44378 = G__44393;
chunk__44316_44379 = G__44394;
count__44317_44380 = G__44395;
i__44318_44381 = G__44396;
continue;
} else {
var style_44397 = cljs.core.first(seq__44315_44391__$1);
...
var G__44400 = cljs.core.next(seq__44315_44391__$1);
var G__44401 = null;
var G__44402 = (0);
var G__44403 = (0);
seq__44315_44378 = G__44400;
chunk__44316_44379 = G__44401;
count__44317_44380 = G__44402;
i__44318_44381 = G__44403;
continue;
}
} else {
}
