...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__38723,style_created_handler){
...
var style = map__38724__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38724__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38724__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__38727_38796 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__38727_38796) : style_created_handler.call(null,G__38727_38796));
...
var G__38739_38797 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__38740_38798 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__38739_38797,G__38740_38798) : stylefy.impl.styles.create_style_BANG_.call(null,G__38739_38797,G__38740_38798));


var G__38799 = seq__38728;
var G__38800 = chunk__38729;
var G__38801 = count__38730;
var G__38802 = (i__38731 + (1));
seq__38728 = G__38799;
chunk__38729 = G__38800;
count__38730 = G__38801;
i__38731 = G__38802;
continue;
} else {
...
var G__38803 = cljs.core.chunk_rest(seq__38728__$1);
var G__38804 = c__4609__auto__;
var G__38805 = cljs.core.count(c__4609__auto__);
var G__38806 = (0);
seq__38728 = G__38803;
chunk__38729 = G__38804;
count__38730 = G__38805;
i__38731 = G__38806;
continue;
} else {
...
var G__38809 = cljs.core.next(seq__38728__$1);
var G__38810 = null;
var G__38811 = (0);
var G__38812 = (0);
seq__38728 = G__38809;
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__38751_SHARP_){
return ((typeof p1__38751_SHARP_ === 'string') || ((p1__38751_SHARP_ instanceof cljs.core.Keyword)) || ((p1__38751_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__38751#] (or (string? p1__38751#) (keyword? p1__38751#) (nil? p1__38751#))) class)))"].join('')));
}
});
/**
...
(stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2 = (function (styles,p__38789){
...
var options = map__38790__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38790__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_38840__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__38792_38841 = cljs.core.seq(styles_38840__$1);
var chunk__38793_38842 = null;
var count__38794_38843 = (0);
var i__38795_38844 = (0);
while(true){
if((i__38795_38844 < count__38794_38843)){
var style_38845 = chunk__38793_38842.cljs$core$IIndexed$_nth$arity$2(null,i__38795_38844);
...
var sub_styles_38848 = temp__5735__auto___38846;
...
var G__38850 = seq__38792_38841;
var G__38851 = chunk__38793_38842;
var G__38852 = count__38794_38843;
var G__38853 = (i__38795_38844 + (1));
seq__38792_38841 = G__38850;
chunk__38793_38842 = G__38851;
count__38794_38843 = G__38852;
i__38795_38844 = G__38853;
continue;
} else {
var temp__5735__auto___38855 = cljs.core.seq(seq__38792_38841);
if(temp__5735__auto___38855){
var seq__38792_38856__$1 = temp__5735__auto___38855;
if(cljs.core.chunked_seq_QMARK_(seq__38792_38856__$1)){
var c__4609__auto___38857 = cljs.core.chunk_first(seq__38792_38856__$1);
var G__38858 = cljs.core.chunk_rest(seq__38792_38856__$1);
var G__38859 = c__4609__auto___38857;
var G__38860 = cljs.core.count(c__4609__auto___38857);
var G__38861 = (0);
seq__38792_38841 = G__38858;
chunk__38793_38842 = G__38859;
count__38794_38843 = G__38860;
i__38795_38844 = G__38861;
continue;
} else {
var style_38862 = cljs.core.first(seq__38792_38856__$1);
stylefy.impl.styles.use_style_BANG_(style_38862,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___38864__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_38862));
if(cljs.core.truth_(temp__5735__auto___38864__$1)){
var sub_styles_38865 = temp__5735__auto___38864__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_38865,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__38866 = cljs.core.next(seq__38792_38856__$1);
var G__38867 = null;
var G__38868 = (0);
var G__38869 = (0);
seq__38792_38841 = G__38866;
chunk__38793_38842 = G__38867;
count__38794_38843 = G__38868;
i__38795_38844 = G__38869;
continue;
}
} else {
}
