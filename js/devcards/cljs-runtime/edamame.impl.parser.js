...
var cond_splice_QMARK_ = (function (){var G__58955 = next_val;
var G__58955__$1 = (((G__58955 == null))?null:cljs.core.meta(G__58955));
if((G__58955__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765).cljs$core$IFn$_invoke$arity$1(G__58955__$1);
}
})();
...
var seq__58956_59073 = cljs.core.seq(next_val);
var chunk__58957_59074 = null;
var count__58958_59075 = (0);
var i__58959_59076 = (0);
while(true){
if((i__58959_59076 < count__58958_59075)){
var v_59077 = chunk__58957_59074.cljs$core$IIndexed$_nth$arity$2(null,i__58959_59076);
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,v_59077);


var G__59078 = seq__58956_59073;
var G__59079 = chunk__58957_59074;
var G__59080 = count__58958_59075;
var G__59081 = (i__58959_59076 + (1));
seq__58956_59073 = G__59078;
chunk__58957_59074 = G__59079;
count__58958_59075 = G__59080;
i__58959_59076 = G__59081;
continue;
} else {
var temp__5735__auto___59082 = cljs.core.seq(seq__58956_59073);
...
if(("\\" === ch)){
var ch_59098__$1 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_59098__$1 == null)){
edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Error while parsing regex");
} else {
}

sb.append(ch_59098__$1);
} else {
}

var G__59099 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__59099;
continue;
}
}
...
var iter__4582__auto__ = (function edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__58970(s__58971){
return (new cljs.core.LazySeq(null,(function (){
var s__58971__$1 = s__58971;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58971__$1);
if(temp__5735__auto__){
var s__58971__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58971__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58971__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58973 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58972 = (0);
while(true){
if((i__58972 < size__4581__auto__)){
var vec__58974 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58972);
...
if((freq > (1))){
cljs.core.chunk_append(b__58973,id);

var G__59100 = (i__58972 + (1));
i__58972 = G__59100;
continue;
} else {
var G__59101 = (i__58972 + (1));
i__58972 = G__59101;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58973),edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__58970(cljs.core.chunk_rest(s__58971__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58973),null);
}
} else {
var vec__58977 = cljs.core.first(s__58971__$2);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58977,(0),null);
var freq = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58977,(1),null);
if((freq > (1))){
return cljs.core.cons(id,edamame$impl$parser$duplicate_keys_error_$_duplicates_$_iter__58970(cljs.core.rest(s__58971__$2)));
} else {
var G__59102 = cljs.core.rest(s__58971__$2);
s__58971__$1 = G__59102;
continue;
}
}
} else {
...
if(match_QMARK_){
var G__59103 = (edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader));
match = G__59103;
continue;
} else {
var G__58982_59104 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ctx,new cljs.core.Keyword("edamame.impl.parser","suppress","edamame.impl.parser/suppress",1718484755),true);
var G__58983_59105 = reader;
(edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(G__58982_59104,G__58983_59105) : edamame.impl.parser.parse_next.call(null,G__58982_59104,G__58983_59105));
...
var G__58985 = cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4((edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2 ? edamame.impl.parser.parse_next.cljs$core$IFn$_invoke$arity$2(ctx,reader) : edamame.impl.parser.parse_next.call(null,ctx,reader)),cljs.core.assoc,new cljs.core.Keyword("edamame","read-cond-splicing","edamame/read-cond-splicing",-1992728777),splice_QMARK_);
return (opt.cljs$core$IFn$_invoke$arity$1 ? opt.cljs$core$IFn$_invoke$arity$1(G__58985) : opt.call(null,G__58985));
} else {
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
if(splice_QMARK_){
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(match,(function (p1__58984_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58984_SHARP_,new cljs.core.Keyword("edamame.impl.parser","cond-splice","edamame.impl.parser/cond-splice",1534599765),true);
}));
} else {
return match;
...
var G__58990 = c;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58990)){
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("\"",G__58990)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("_",G__58990)){
reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
...
var ks_59109 = cljs.core.take_nth.cljs$core$IFn$_invoke$arity$2((2),elements);
if(cljs.core.truth_(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.distinct_QMARK_,ks_59109))){
} else {
edamame.impl.parser.throw_dup_keys(reader,start_loc,new cljs.core.Keyword(null,"map","map",1371690461),ks_59109);
}
} else {
}
...
var token = (function (){var G__58991 = reader;
var G__58992 = new cljs.core.Keyword(null,"keyword","keyword",811389747);
var G__58993 = init_c;
return (edamame.impl.parser.read_token.cljs$core$IFn$_invoke$arity$3 ? edamame.impl.parser.read_token.cljs$core$IFn$_invoke$arity$3(G__58991,G__58992,G__58993) : edamame.impl.parser.read_token.call(null,G__58991,G__58992,G__58993));
})();
...
var vec__58994 = (edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1 ? edamame.impl.parser.parse_symbol.cljs$core$IFn$_invoke$arity$1(token__$1) : edamame.impl.parser.parse_symbol.call(null,token__$1));
var token_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58994,(0),null);
var token_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58994,(1),null);
...
var G__58997 = c;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__58997)){
return new cljs.core.Keyword("edamame.impl.parser","eof","edamame.impl.parser/eof",720552006);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("@",G__58997)){
...
if(cljs.core.truth_(temp__5735__auto__)){
var map__59004 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59004__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59004__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59004__$1,new cljs.core.Keyword(null,"char","char",-641587586));
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__59012 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59012__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59012__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59012__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$4(reader,["Unmatched delimiter: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(c),(cljs.core.truth_(expected)?[", expected: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expected),(function (){var temp__5735__auto__ = new cljs.core.Keyword("edamame.impl.parser","opened-delimiter","edamame.impl.parser/opened-delimiter",1199661648).cljs$core$IFn$_invoke$arity$1(ctx);
if(cljs.core.truth_(temp__5735__auto__)){
var map__59020 = temp__5735__auto__;
...
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59020__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59020__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var char$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59020__$1,new cljs.core.Keyword(null,"char","char",-641587586));
return [" to match ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(char$)," at ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [row,col], null))].join('');
} else {
return null;
}
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(obj,(function (p1__59022_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(p1__59022_SHARP_,new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(loc),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(loc),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(end_loc),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(ctx),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(end_loc)], 0));
}));
} else {
return obj;
}
...
(edamame.impl.parser.Options.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k59025,else__4442__auto__){
var self__ = this;
...
(edamame.impl.parser.Options.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this59026,other59027){
var self__ = this;
var this59026__$1 = this;
return (((!((other59027 == null)))) && ((this59026__$1.constructor === other59027.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.dispatch,other59027.dispatch)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.deref,other59027.deref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.syntax_quote,other59027.syntax_quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.unquote,other59027.unquote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.unquote_splicing,other59027.unquote_splicing)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.quote,other59027.quote)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.fn,other59027.fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.var,other59027.var)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.read_eval,other59027.read_eval)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.regex,other59027.regex)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.row_key,other59027.row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.col_key,other59027.col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.end_row_key,other59027.end_row_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.end_col_key,other59027.end_col_key)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this59026__$1.__extmap,other59027.__extmap)));
}));
...
(edamame.impl.parser.Options.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__59024){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__59035 = cljs.core.keyword_identical_QMARK_;
var expr__59036 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__59038 = new cljs.core.Keyword(null,"dispatch","dispatch",1319337009);
...
return (new edamame.impl.parser.Options(G__59024,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59040 = new cljs.core.Keyword(null,"deref","deref",-145586795);
var G__59041 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59040,G__59041) : pred__59035.call(null,G__59040,G__59041));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,G__59024,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59042 = new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847);
var G__59043 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59042,G__59043) : pred__59035.call(null,G__59042,G__59043));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,G__59024,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59044 = new cljs.core.Keyword(null,"unquote","unquote",1649741032);
var G__59045 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59044,G__59045) : pred__59035.call(null,G__59044,G__59045));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,G__59024,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59046 = new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556);
var G__59047 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59046,G__59047) : pred__59035.call(null,G__59046,G__59047));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,G__59024,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59048 = new cljs.core.Keyword(null,"quote","quote",-262615245);
var G__59049 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59048,G__59049) : pred__59035.call(null,G__59048,G__59049));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,G__59024,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59050 = new cljs.core.Keyword(null,"fn","fn",-1175266204);
var G__59051 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59050,G__59051) : pred__59035.call(null,G__59050,G__59051));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,G__59024,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59052 = new cljs.core.Keyword(null,"var","var",-769682797);
var G__59053 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59052,G__59053) : pred__59035.call(null,G__59052,G__59053));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,G__59024,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59054 = new cljs.core.Keyword(null,"read-eval","read-eval",1788733932);
var G__59055 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59054,G__59055) : pred__59035.call(null,G__59054,G__59055));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,G__59024,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59056 = new cljs.core.Keyword(null,"regex","regex",939488856);
var G__59057 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59056,G__59057) : pred__59035.call(null,G__59056,G__59057));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,G__59024,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59058 = new cljs.core.Keyword(null,"row-key","row-key",-1189010712);
var G__59059 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59058,G__59059) : pred__59035.call(null,G__59058,G__59059));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,G__59024,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59060 = new cljs.core.Keyword(null,"col-key","col-key",-2009675766);
var G__59061 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59060,G__59061) : pred__59035.call(null,G__59060,G__59061));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,G__59024,self__.end_row_key,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59062 = new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680);
var G__59063 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59062,G__59063) : pred__59035.call(null,G__59062,G__59063));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,G__59024,self__.end_col_key,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__59064 = new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304);
var G__59065 = expr__59036;
return (pred__59035.cljs$core$IFn$_invoke$arity$2 ? pred__59035.cljs$core$IFn$_invoke$arity$2(G__59064,G__59065) : pred__59035.call(null,G__59064,G__59065));
})())){
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,G__59024,self__.__meta,self__.__extmap,null));
} else {
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__59024),null));
}
}
}
}
...
(edamame.impl.parser.Options.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__59024){
var self__ = this;
var this__4438__auto____$1 = this;
return (new edamame.impl.parser.Options(self__.dispatch,self__.deref,self__.syntax_quote,self__.unquote,self__.unquote_splicing,self__.quote,self__.fn,self__.var$,self__.read_eval,self__.regex,self__.row_key,self__.col_key,self__.end_row_key,self__.end_col_key,G__59024,self__.__extmap,self__.__hash));
}));
 ...
 */
edamame.impl.parser.map__GT_Options = (function edamame$impl$parser$map__GT_Options(G__59028){
var extmap__4478__auto__ = (function (){var G__59066 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__59028,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"deref","deref",-145586795),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847),new cljs.core.Keyword(null,"unquote","unquote",1649741032),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556),new cljs.core.Keyword(null,"quote","quote",-262615245),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"var","var",-769682797),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932),new cljs.core.Keyword(null,"regex","regex",939488856),new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304)], 0));
if(cljs.core.record_QMARK_(G__59028)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__59066);
} else {
return G__59066;
}
})();
return (new edamame.impl.parser.Options(new cljs.core.Keyword(null,"dispatch","dispatch",1319337009).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"deref","deref",-145586795).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"syntax-quote","syntax-quote",-1233164847).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"unquote","unquote",1649741032).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"unquote-splicing","unquote-splicing",1295267556).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"quote","quote",-262615245).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"fn","fn",-1175266204).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"var","var",-769682797).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"read-eval","read-eval",1788733932).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"regex","regex",939488856).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(G__59028),new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(G__59028),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var opts__$3 = (function (){var G__59067 = opts__$2;
var G__59067__$1 = ((cljs.core.not(new cljs.core.Keyword(null,"row-key","row-key",-1189010712).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59067,new cljs.core.Keyword(null,"row-key","row-key",-1189010712),new cljs.core.Keyword(null,"row","row",-570139521)):G__59067);
var G__59067__$2 = ((cljs.core.not(new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59067__$1,new cljs.core.Keyword(null,"end-row-key","end-row-key",-1126662680),new cljs.core.Keyword(null,"end-row","end-row",-545103581)):G__59067__$1);
var G__59067__$3 = ((cljs.core.not(new cljs.core.Keyword(null,"col-key","col-key",-2009675766).cljs$core$IFn$_invoke$arity$1(opts__$2)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59067__$2,new cljs.core.Keyword(null,"col-key","col-key",-2009675766),new cljs.core.Keyword(null,"col","col",-1959363084)):G__59067__$2);
if(cljs.core.not(new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304).cljs$core$IFn$_invoke$arity$1(opts__$2))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__59067__$3,new cljs.core.Keyword(null,"end-col-key","end-col-key",81813304),new cljs.core.Keyword(null,"end-col","end-col",-724155879));
} else {
return G__59067__$3;
}
})();
...
var G__59111 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,next_val);
ret = G__59111;
continue;
}
break;
