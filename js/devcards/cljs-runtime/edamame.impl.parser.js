...
var G__59259 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(vals,next_val);
vals = G__59259;
continue;
...
if(("\\" === ch)){
var ch_59260__$1 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
if((ch_59260__$1 == null)){
edamame.impl.parser.throw_reader.cljs$core$IFn$_invoke$arity$2(reader,"Error while parsing regex");
} else {
}

sb.append(ch_59260__$1);
} else {
}

var G__59261 = reader.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__59261;
continue;
}
}
