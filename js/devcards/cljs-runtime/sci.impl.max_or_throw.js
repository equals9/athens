...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57758 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57758(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57736 = (n - (1));
var G__57737 = cljs.core.rest(s);
var G__57738 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57736,G__57737,G__57738) : sci.impl.max_or_throw.take_STAR_.call(null,G__57736,G__57737,G__57738));
})());
} else {
return null;
}
