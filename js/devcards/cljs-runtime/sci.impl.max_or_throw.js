...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57770 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57770(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57752 = (n - (1));
var G__57753 = cljs.core.rest(s);
var G__57754 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57752,G__57753,G__57754) : sci.impl.max_or_throw.take_STAR_.call(null,G__57752,G__57753,G__57754));
})());
} else {
return null;
}
