...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57739 = (n - (1));
var G__57740 = cljs.core.rest(s);
var G__57741 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57739,G__57740,G__57741) : sci.impl.max_or_throw.take_STAR_.call(null,G__57739,G__57740,G__57741));
})());
} else {
return null;
}
