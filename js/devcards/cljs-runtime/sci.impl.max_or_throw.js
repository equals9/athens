...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57791 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57791(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57778 = (n - (1));
var G__57779 = cljs.core.rest(s);
var G__57780 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57778,G__57779,G__57780) : sci.impl.max_or_throw.take_STAR_.call(null,G__57778,G__57779,G__57780));
})());
} else {
return null;
}
