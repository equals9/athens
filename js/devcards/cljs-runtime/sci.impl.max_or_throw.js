...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57765 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57765(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57747 = (n - (1));
var G__57748 = cljs.core.rest(s);
var G__57749 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57747,G__57748,G__57749) : sci.impl.max_or_throw.take_STAR_.call(null,G__57747,G__57748,G__57749));
})());
} else {
return null;
}
