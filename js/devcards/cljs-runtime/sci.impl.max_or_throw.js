...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57815 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57815(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57802 = (n - (1));
var G__57803 = cljs.core.rest(s);
var G__57804 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57802,G__57803,G__57804) : sci.impl.max_or_throw.take_STAR_.call(null,G__57802,G__57803,G__57804));
})());
} else {
return null;
}
