...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57776 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57776(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57762 = (n - (1));
var G__57763 = cljs.core.rest(s);
var G__57764 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57762,G__57763,G__57764) : sci.impl.max_or_throw.take_STAR_.call(null,G__57762,G__57763,G__57764));
})());
} else {
return null;
}
