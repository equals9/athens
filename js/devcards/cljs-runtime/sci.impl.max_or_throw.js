...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57793 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57793(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57783 = (n - (1));
var G__57784 = cljs.core.rest(s);
var G__57785 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57783,G__57784,G__57785) : sci.impl.max_or_throw.take_STAR_.call(null,G__57783,G__57784,G__57785));
})());
} else {
return null;
}
