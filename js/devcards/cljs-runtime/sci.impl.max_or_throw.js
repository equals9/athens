...
var sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57820 = (function (this$,ctx,n){
...
return sci$impl$max_or_throw$MaxOrThrow$max_or_throw$dyn_57820(this$,ctx,n);
}
});
...
return cljs.core.cons(cljs.core.first(s),(function (){var G__57805 = (n - (1));
var G__57806 = cljs.core.rest(s);
var G__57807 = err_val;
return (sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3 ? sci.impl.max_or_throw.take_STAR_.cljs$core$IFn$_invoke$arity$3(G__57805,G__57806,G__57807) : sci.impl.max_or_throw.take_STAR_.call(null,G__57805,G__57806,G__57807));
})());
} else {
return null;
}
