...
var vec__57407 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4582__auto__ = (function instaparse$abnf$iter__57410(s__57411){
...
var c__4580__auto__ = cljs.core.chunk_first(s__57411__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57413 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57412 = (0);
while(true){
if((i__57412 < size__4581__auto__)){
var n = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57412);
cljs.core.chunk_append(b__57413,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));

var G__57478 = (i__57412 + (1));
i__57412 = G__57478;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57413),instaparse$abnf$iter__57410(cljs.core.chunk_rest(s__57411__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57413),null);
}
} else {
var n = cljs.core.first(s__57411__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__57410(cljs.core.rest(s__57411__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq57406){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq57406));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$abnf$project_$_iter__57414(s__57415){
return (new cljs.core.LazySeq(null,(function (){
var s__57415__$1 = s__57415;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__57415__$1);
if(temp__5735__auto__){
var s__57415__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__57415__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__57415__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__57417 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__57416 = (0);
while(true){
if((i__57416 < size__4581__auto__)){
var k = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__57416);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__57417,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__57484 = (i__57416 + (1));
i__57416 = G__57484;
continue;
} else {
var G__57485 = (i__57416 + (1));
i__57416 = G__57485;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__57417),instaparse$abnf$project_$_iter__57414(cljs.core.chunk_rest(s__57415__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__57417),null);
}
} else {
var k = cljs.core.first(s__57415__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__57414(cljs.core.rest(s__57415__$2)));
} else {
var G__57487 = cljs.core.rest(s__57415__$2);
s__57415__$1 = G__57487;
continue;
}
}
} else {
...
var G__57497__delegate = function (rest__57429_SHARP_){
...
while (G__57500__i < G__57500__a.length) {G__57500__a[G__57500__i] = arguments[G__57500__i + 0]; ++G__57500__i;}
  rest__57429_SHARP_ = new cljs.core.IndexedSeq(G__57500__a,0,null);
} 
return G__57497__delegate.call(this,rest__57429_SHARP_);};
G__57497.cljs$lang$maxFixedArity = 0;
G__57497.cljs$lang$applyTo = (function (arglist__57501){
var rest__57429_SHARP_ = cljs.core.seq(arglist__57501);
return G__57497__delegate(rest__57429_SHARP_);
});
...
var G__57433 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__57430_SHARP_);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$1(G__57433) : instaparse.abnf.parse_int.call(null,G__57433));
};
...
var G__57434 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs);
var G__57435 = (16);
return (instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2 ? instaparse.abnf.parse_int.cljs$core$IFn$_invoke$arity$2(G__57434,G__57435) : instaparse.abnf.parse_int.call(null,G__57434,G__57435));
};
...
,(function() { 
var G__57516__delegate = function (rest__57428_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
...
while (G__57518__i < G__57518__a.length) {G__57518__a[G__57518__i] = arguments[G__57518__i + 0]; ++G__57518__i;}
  rest__57428_SHARP_ = new cljs.core.IndexedSeq(G__57518__a,0,null);
} 
return G__57516__delegate.call(this,rest__57428_SHARP_);};
G__57516.cljs$lang$maxFixedArity = 0;
G__57516.cljs$lang$applyTo = (function (arglist__57519){
var rest__57428_SHARP_ = cljs.core.seq(arglist__57519);
return G__57516__delegate(rest__57428_SHARP_);
});
G__57516.cljs$core$IFn$_invoke$arity$variadic = G__57516__delegate;
return G__57516;
})()
,(function() { 
var G__57520__delegate = function (items){
var G__57437 = cljs.core.count(items);
switch (G__57437) {
case (1):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57437)].join('')));
...
return G__57520__delegate.call(this,items);};
G__57520.cljs$lang$maxFixedArity = 0;
G__57520.cljs$lang$applyTo = (function (arglist__57526){
var items = cljs.core.seq(arglist__57526);
return G__57520__delegate(items);
});
G__57520.cljs$core$IFn$_invoke$arity$variadic = G__57520__delegate;
return G__57520;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__57527__delegate = function (cs){
var G__57438 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cs);
...
var G__57527 = function (var_args){
var cs = null;
if (arguments.length > 0) {
...
return G__57527__delegate.call(this,cs);};
G__57527.cljs$lang$maxFixedArity = 0;
G__57527.cljs$lang$applyTo = (function (arglist__57529){
var cs = cljs.core.seq(arglist__57529);
return G__57527__delegate(cs);
});
...
var opts = map__57451__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57453 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57454 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57454);
...
var _STAR_print_newline_STAR__orig_val__57456_57536 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57457_57537 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57458_57538 = true;
var _STAR_print_fn_STAR__temp_val__57459_57539 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57458_57538);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57459_57539);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57457_57537);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57456_57536);
}
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57453);
}}));
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57460_57541 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57461_57542 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57462_57543 = true;
var _STAR_print_fn_STAR__temp_val__57463_57544 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57462_57543);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57463_57544);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57461_57542);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57460_57541);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
