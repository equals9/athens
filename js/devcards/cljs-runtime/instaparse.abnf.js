...
var len__4736__auto___56618 = arguments.length;
var i__4737__auto___56619 = (0);
while(true){
if((i__4737__auto___56619 < len__4736__auto___56618)){
args__4742__auto__.push((arguments[i__4737__auto___56619]));

var G__56620 = (i__4737__auto___56619 + (1));
i__4737__auto___56619 = G__56620;
continue;
} else {
}
break;
...
var vec__56555 = nums;
var lo = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56555,(0),null);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56555,(1),null);
var hi = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56555,(2),null);
return instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$2(lo,hi);
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(instaparse.combinators_source.cat,(function (){var iter__4529__auto__ = (function instaparse$abnf$iter__56558(s__56559){
...
var n = cljs.core._nth(c__4527__auto__,i__56560);
cljs.core.chunk_append(b__56561,instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56561),instaparse$abnf$iter__56558(cljs.core.chunk_rest(s__56559__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56561),null);
}
} else {
var n = cljs.core.first(s__56559__$2);
return cljs.core.cons(instaparse.combinators_source.unicode_char.cljs$core$IFn$_invoke$arity$1(n),instaparse$abnf$iter__56558(cljs.core.rest(s__56559__$2)));
}
} else {
return null;
}
...
/** @this {Function} */
(instaparse.abnf.get_char_combinator.cljs$lang$applyTo = (function (seq56549){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56549));
}));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$abnf$project_$_iter__56562(s__56563){
return (new cljs.core.LazySeq(null,(function (){
var s__56563__$1 = s__56563;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56563__$1);
if(temp__5735__auto__){
var s__56563__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56563__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__56563__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__56565 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__56564 = (0);
while(true){
if((i__56564 < size__4528__auto__)){
var k = cljs.core._nth(c__4527__auto__,i__56564);
if(cljs.core.contains_QMARK_(m,k)){
cljs.core.chunk_append(b__56565,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null));

var G__56629 = (i__56564 + (1));
i__56564 = G__56629;
continue;
} else {
var G__56630 = (i__56564 + (1));
i__56564 = G__56630;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56565),instaparse$abnf$project_$_iter__56562(cljs.core.chunk_rest(s__56563__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56565),null);
}
} else {
var k = cljs.core.first(s__56563__$2);
if(cljs.core.contains_QMARK_(m,k)){
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(m.cljs$core$IFn$_invoke$arity$1 ? m.cljs$core$IFn$_invoke$arity$1(k) : m.call(null,k))], null),instaparse$abnf$project_$_iter__56562(cljs.core.rest(s__56563__$2)));
} else {
var G__56632 = cljs.core.rest(s__56563__$2);
s__56563__$1 = G__56632;
continue;
}
}
} else {
...
var G__56636__delegate = function (cs){
...
return G__56636__delegate.call(this,cs);};
G__56636.cljs$lang$maxFixedArity = 0;
G__56636.cljs$lang$applyTo = (function (arglist__56639){
var cs = cljs.core.seq(arglist__56639);
return G__56636__delegate(cs);
});
G__56636.cljs$core$IFn$_invoke$arity$variadic = G__56636__delegate;
return G__56636;
})()
,cljs.core.hash_map,(function() { 
var G__56642__delegate = function (rest__56570_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56570_SHARP_))));
} else {
return instaparse.combinators_source.nt(cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56570_SHARP_)));
}
};
...
while (G__56643__i < G__56643__a.length) {G__56643__a[G__56643__i] = arguments[G__56643__i + 0]; ++G__56643__i;}
  rest__56570_SHARP_ = new cljs.core.IndexedSeq(G__56643__a,0,null);
} 
return G__56642__delegate.call(this,rest__56570_SHARP_);};
G__56642.cljs$lang$maxFixedArity = 0;
G__56642.cljs$lang$applyTo = (function (arglist__56644){
var rest__56570_SHARP_ = cljs.core.seq(arglist__56644);
return G__56642__delegate(rest__56570_SHARP_);
});
G__56642.cljs$core$IFn$_invoke$arity$variadic = G__56642__delegate;
return G__56642;
})()
,(function() { 
var G__56645__delegate = function (rest__56571_SHARP_){
...
while (G__56646__i < G__56646__a.length) {G__56646__a[G__56646__i] = arguments[G__56646__i + 0]; ++G__56646__i;}
  rest__56571_SHARP_ = new cljs.core.IndexedSeq(G__56646__a,0,null);
} 
return G__56645__delegate.call(this,rest__56571_SHARP_);};
G__56645.cljs$lang$maxFixedArity = 0;
G__56645.cljs$lang$applyTo = (function (arglist__56647){
var rest__56571_SHARP_ = cljs.core.seq(arglist__56647);
return G__56645__delegate(rest__56571_SHARP_);
});
...
while (G__56650__i < G__56650__a.length) {G__56650__a[G__56650__i] = arguments[G__56650__i + 0]; ++G__56650__i;}
  cs = new cljs.core.IndexedSeq(G__56650__a,0,null);
} 
...
var cs = cljs.core.seq(arglist__56651);
...
var G__56652__delegate = function (cs){
...
while (G__56653__i < G__56653__a.length) {G__56653__a[G__56653__i] = arguments[G__56653__i + 0]; ++G__56653__i;}
  cs = new cljs.core.IndexedSeq(G__56653__a,0,null);
} 
return G__56652__delegate.call(this,cs);};
G__56652.cljs$lang$maxFixedArity = 0;
G__56652.cljs$lang$applyTo = (function (arglist__56654){
var cs = cljs.core.seq(arglist__56654);
return G__56652__delegate(cs);
});
...
var G__56655 = null;
var G__56655__1 = (function (element){
return element;
});
var G__56655__2 = (function (repeat,element){
...
G__56655 = function(repeat,element){
switch(arguments.length){
case 1:
return G__56655__1.call(this,repeat);
case 2:
return G__56655__2.call(this,repeat,element);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__56655.cljs$core$IFn$_invoke$arity$1 = G__56655__1;
G__56655.cljs$core$IFn$_invoke$arity$2 = G__56655__2;
return G__56655;
})()
,(function() { 
var G__56660__delegate = function (rest__56569_SHARP_){
if(cljs.core.truth_(instaparse.abnf._STAR_case_insensitive_STAR_)){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(clojure.string.upper_case(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56569_SHARP_)));
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.str,rest__56569_SHARP_));
}
};
var G__56660 = function (var_args){
var rest__56569_SHARP_ = null;
if (arguments.length > 0) {
...
while (G__56662__i < G__56662__a.length) {G__56662__a[G__56662__i] = arguments[G__56662__i + 0]; ++G__56662__i;}
  rest__56569_SHARP_ = new cljs.core.IndexedSeq(G__56662__a,0,null);
} 
return G__56660__delegate.call(this,rest__56569_SHARP_);};
G__56660.cljs$lang$maxFixedArity = 0;
G__56660.cljs$lang$applyTo = (function (arglist__56663){
var rest__56569_SHARP_ = cljs.core.seq(arglist__56663);
return G__56660__delegate(rest__56569_SHARP_);
});
G__56660.cljs$core$IFn$_invoke$arity$variadic = G__56660__delegate;
return G__56660;
})()
,(function() { 
var G__56664__delegate = function (items){
...
var G__56664 = function (var_args){
var items = null;
if (arguments.length > 0) {
...
while (G__56668__i < G__56668__a.length) {G__56668__a[G__56668__i] = arguments[G__56668__i + 0]; ++G__56668__i;}
  items = new cljs.core.IndexedSeq(G__56668__a,0,null);
} 
return G__56664__delegate.call(this,items);};
G__56664.cljs$lang$maxFixedArity = 0;
G__56664.cljs$lang$applyTo = (function (arglist__56669){
var items = cljs.core.seq(arglist__56669);
return G__56664__delegate(items);
});
G__56664.cljs$core$IFn$_invoke$arity$variadic = G__56664__delegate;
return G__56664;
})()
,instaparse.abnf.get_char_combinator,(function() { 
var G__56670__delegate = function (cs){
...
while (G__56672__i < G__56672__a.length) {G__56672__a[G__56672__i] = arguments[G__56672__i + 0]; ++G__56672__i;}
  cs = new cljs.core.IndexedSeq(G__56672__a,0,null);
} 
return G__56670__delegate.call(this,cs);};
G__56670.cljs$lang$maxFixedArity = 0;
G__56670.cljs$lang$applyTo = (function (arglist__56676){
var cs = cljs.core.seq(arglist__56676);
return G__56670__delegate(cs);
});
...
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4667__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56585_56684 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56586_56685 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56587_56686 = true;
var _STAR_print_fn_STAR__temp_val__56588_56687 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56587_56686);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56588_56687);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rule_tree], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56586_56685);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56585_56684);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})()], 0));
} else {
