...
var G__58469 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,var_STAR_,tbox_val);
var G__58470 = cljs.core.next(kvs);
ret = G__58469;
kvs = G__58470;
continue;
} else {
...
var x = cljs.core.first(arglist__58476);
arglist__58476 = cljs.core.next(arglist__58476);
var y = cljs.core.first(arglist__58476);
arglist__58476 = cljs.core.next(arglist__58476);
var z = cljs.core.first(arglist__58476);
var args = cljs.core.rest(arglist__58476);
...
var G__58477 = null;
if (arguments.length > 3) {
var G__58478__i = 0, G__58478__a = new Array(arguments.length -  3);
while (G__58478__i < G__58478__a.length) {G__58478__a[G__58478__i] = arguments[G__58478__i + 3]; ++G__58478__i;}
G__58477 = new cljs.core.IndexedSeq(G__58478__a,0,null);
}
return G__58473__4.cljs$core$IFn$_invoke$arity$variadic(x,y,z, G__58477);
}
...
var G__58511 = (i__4790__auto___58509 + (1));
i__4790__auto___58509 = G__58511;
continue;
} else {
}
break;
...
while(true){
if(vvs){
var G__58512 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(ret,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"var","var",870848730,null),null,(1),null)),(new cljs.core.List(null,cljs.core.first(vvs),null,(1),null)))))),cljs.core.second(vvs));
var G__58513 = cljs.core.next(cljs.core.next(vvs));
ret = G__58512;
vvs = G__58513;
continue;
} else {
