...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54978 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_54978(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54979 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54979(self);
}
});
...
while(true){
if((!((coll__$1 == null)))){
var G__55003 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55004 = cljs.core.next(coll__$1);
unmixed_hash = G__55003;
coll__$1 = G__55004;
continue;
} else {
return unmixed_hash;
...
var G__55015 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55016 = cljs.core.next(v);
acc = G__55015;
v = G__55016;
continue;
} else {
var G__55017 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55018 = cljs.core.next(v);
acc = G__55017;
v = G__55018;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55019 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55019(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54977 = (arguments.length - (1));
switch (G__54977) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54965){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54965)));
}));
