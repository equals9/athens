...
var G__56281 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56282 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56281;
index__$1 = G__56282;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56219 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56219) : instaparse.auto_flatten_seq.true_count.call(null,G__56219));
})() - (1)))){
...
var G__56283 = v;
var G__56284 = cljs.core.pop(index);
v = G__56283;
index = G__56284;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56298 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56299 = cljs.core.next(coll__$1);
unmixed_hash = G__56298;
coll__$1 = G__56299;
continue;
} else {
return unmixed_hash;
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56262){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56262)));
}));
