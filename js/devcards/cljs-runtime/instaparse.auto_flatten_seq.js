...
while(true){
if((!((coll__$1 == null)))){
var G__55904 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55905 = cljs.core.next(coll__$1);
unmixed_hash = G__55904;
coll__$1 = G__55905;
continue;
} else {
return unmixed_hash;
...
var G__55910 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55911 = cljs.core.next(v);
acc = G__55910;
v = G__55911;
continue;
} else {
var G__55916 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55917 = cljs.core.next(v);
acc = G__55916;
v = G__55917;
continue;
}
