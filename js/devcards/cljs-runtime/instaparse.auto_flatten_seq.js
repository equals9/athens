...
var G__55859 = v;
var G__55860 = cljs.core.pop(index);
v = G__55859;
index = G__55860;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55863 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55864 = cljs.core.next(coll__$1);
unmixed_hash = G__55863;
coll__$1 = G__55864;
continue;
} else {
return unmixed_hash;
...
var G__55865 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55866 = cljs.core.next(v);
acc = G__55865;
v = G__55866;
continue;
} else {
var G__55867 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55868 = cljs.core.next(v);
acc = G__55867;
v = G__55868;
continue;
}
