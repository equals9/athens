...
while(true){
if((!((coll__$1 == null)))){
var G__55011 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55012 = cljs.core.next(coll__$1);
unmixed_hash = G__55011;
coll__$1 = G__55012;
continue;
} else {
return unmixed_hash;
...
var G__55019 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55020 = cljs.core.next(v);
acc = G__55019;
v = G__55020;
continue;
} else {
var G__55021 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55022 = cljs.core.next(v);
acc = G__55021;
v = G__55022;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55025 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55025(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54984 = (arguments.length - (1));
switch (G__54984) {
case (1):
