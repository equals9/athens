...
var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54982 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_54982(self);
}
});
...
var G__54990 = n__$1;
var G__54991 = cljs.core.imul(z,y);
var G__54992 = cljs.core.imul(z,z);
n = G__54990;
y = G__54991;
z = G__54992;
continue;
...
var G__54993 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__54994 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__54993;
index__$1 = G__54994;
continue;
} else {
...
var G__54995 = v;
var G__54996 = cljs.core.pop(index);
v = G__54995;
index = G__54996;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55034 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55035 = cljs.core.next(coll__$1);
unmixed_hash = G__55034;
coll__$1 = G__55035;
continue;
} else {
return unmixed_hash;
...
var G__55048 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55049 = cljs.core.next(v);
acc = G__55048;
v = G__55049;
continue;
} else {
var G__55050 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55051 = cljs.core.next(v);
acc = G__55050;
v = G__55051;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55052 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55052(self);
}
});
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54973){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54973)));
}));
