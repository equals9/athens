...
var G__56253 = n__$1;
var G__56254 = y;
var G__56255 = cljs.core.imul(z,z);
n = G__56253;
y = G__56254;
z = G__56255;
continue;
...
var G__56256 = n__$1;
var G__56257 = cljs.core.imul(z,y);
...
var G__56259 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__56260 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__56259;
index__$1 = G__56260;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__56197 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__56197) : instaparse.auto_flatten_seq.true_count.call(null,G__56197));
})() - (1)))){
...
var G__56261 = v;
var G__56262 = cljs.core.pop(index);
v = G__56261;
index = G__56262;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__56286 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__56287 = cljs.core.next(coll__$1);
unmixed_hash = G__56286;
coll__$1 = G__56287;
continue;
} else {
return unmixed_hash;
...
var G__56288 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__56289 = cljs.core.next(v);
acc = G__56288;
v = G__56289;
continue;
} else {
var G__56290 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args56248){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56248)));
}));
