...
var instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_55043 = (function (self,obj){
...
return instaparse$auto_flatten_seq$ConjFlat$conj_flat$dyn_55043(self,obj);
}
});

var instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_55050 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$ConjFlat$cached_QMARK_$dyn_55050(self);
}
});
...
var G__55051 = n__$1;
var G__55052 = y;
var G__55053 = cljs.core.imul(z,z);
n = G__55051;
y = G__55052;
z = G__55053;
continue;
...
var G__55054 = n__$1;
var G__55055 = cljs.core.imul(z,y);
var G__55056 = cljs.core.imul(z,z);
n = G__55054;
y = G__55055;
z = G__55056;
continue;
...
var G__55057 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(v__$1,(0));
var G__55058 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(index__$1,(0));
v__$1 = G__55057;
index__$1 = G__55058;
continue;
} else {
...
if((cljs.core.peek(index) < ((function (){var G__54948 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(v,cljs.core.pop(index));
return (instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1 ? instaparse.auto_flatten_seq.true_count.cljs$core$IFn$_invoke$arity$1(G__54948) : instaparse.auto_flatten_seq.true_count.call(null,G__54948));
})() - (1)))){
...
var G__55059 = v;
var G__55060 = cljs.core.pop(index);
v = G__55059;
index = G__55060;
continue;
...
while(true){
if((!((coll__$1 == null)))){
var G__55079 = ((cljs.core.imul((31),unmixed_hash) + cljs.core.hash(cljs.core.first(coll__$1))) | (0));
var G__55080 = cljs.core.next(coll__$1);
unmixed_hash = G__55079;
coll__$1 = G__55080;
continue;
} else {
return unmixed_hash;
...
var G__55081 = (instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2 ? instaparse.auto_flatten_seq.flat_vec_helper.cljs$core$IFn$_invoke$arity$2(acc,fst) : instaparse.auto_flatten_seq.flat_vec_helper.call(null,acc,fst));
var G__55082 = cljs.core.next(v);
acc = G__55081;
v = G__55082;
continue;
} else {
var G__55083 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,fst);
var G__55084 = cljs.core.next(v);
acc = G__55083;
v = G__55084;
continue;
}
...
var instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55085 = (function (self){
var x__4428__auto__ = (((self == null))?null:self);
...
return instaparse$auto_flatten_seq$GetVec$get_vec$dyn_55085(self);
}
});
...
var self__ = this;
var self__ = this;
var G__54999 = (arguments.length - (1));
switch (G__54999) {
case (1):
...
(instaparse.auto_flatten_seq.FlattenOnDemandVector.prototype.apply = (function (self__,args54984){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args54984)));
}));
