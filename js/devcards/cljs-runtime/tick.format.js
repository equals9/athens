...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__51136 = goog.object.get(JSJodaLocale,"Locale");
if((G__51136 == null)){
return null;
} else {
return goog.object.get(G__51136,"US");
}
}catch (e51134){if((e51134 instanceof Error)){
var e = e51134;
return null;
} else {
throw e51134;
