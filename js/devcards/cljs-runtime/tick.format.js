...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50859 = goog.object.get(JSJodaLocale,"Locale");
if((G__50859 == null)){
return null;
} else {
return goog.object.get(G__50859,"US");
}
}catch (e50858){if((e50858 instanceof Error)){
var e = e50858;
return null;
} else {
throw e50858;
