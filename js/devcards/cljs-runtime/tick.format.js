...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__50850 = goog.object.get(JSJodaLocale,"Locale");
if((G__50850 == null)){
return null;
} else {
return goog.object.get(G__50850,"US");
}
}catch (e50849){if((e50849 instanceof Error)){
var e = e50849;
return null;
} else {
throw e50849;
