...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__33925 = goog.object.get(JSJodaLocale,"Locale");
if((G__33925 == null)){
return null;
} else {
return goog.object.get(G__33925,"US");
}
}catch (e33924){if((e33924 instanceof Error)){
var e = e33924;
return null;
} else {
throw e33924;
