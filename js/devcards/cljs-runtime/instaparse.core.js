...
if(cljs.core.truth_((function (){var fexpr__57544 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57555 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__57559 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57559)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57559)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57559)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57559)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57559)].join('')));
...
var len__4789__auto___57634 = arguments.length;
var i__4790__auto___57635 = (0);
while(true){
if((i__4790__auto___57635 < len__4789__auto___57634)){
args__4795__auto__.push((arguments[i__4790__auto___57635]));

var G__57636 = (i__4790__auto___57635 + (1));
i__4790__auto___57635 = G__57636;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57571){
var map__57572 = p__57571;
var map__57572__$1 = (((((!((map__57572 == null))))?(((((map__57572.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__57572.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__57572):map__57572);
var options = map__57572__$1;
...
while(true){
if((i__4790__auto___57714 < len__4789__auto___57712)){
args__4795__auto__.push((arguments[i__4790__auto___57714]));

var G__57716 = (i__4790__auto___57714 + (1));
i__4790__auto___57714 = G__57716;
continue;
} else {
}
break;
