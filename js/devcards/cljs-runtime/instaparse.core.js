...
var G__57582 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57582)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57582)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57582)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57582)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57582)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57594){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57597 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57597) : instaparse.reduction.node_builders.call(null,G__57597));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57587){
...
var args__4795__auto__ = [];
var len__4789__auto___57647 = arguments.length;
var i__4790__auto___57648 = (0);
while(true){
if((i__4790__auto___57648 < len__4789__auto___57647)){
args__4795__auto__.push((arguments[i__4790__auto___57648]));

var G__57649 = (i__4790__auto___57648 + (1));
i__4790__auto___57648 = G__57649;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57601){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57604 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57604) : instaparse.reduction.node_builders.call(null,G__57604));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57598){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57599,G__57600,seq57598__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k57606,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__57611 = k57606;
var G__57611__$1 = (((G__57611 instanceof cljs.core.Keyword))?G__57611.fqn:null);
switch (G__57611__$1) {
case "grammar":
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57612){
...
(instaparse.core.Parser.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__57605){
var self__ = this;
...
var h__4297__auto____$1 = (function (){var fexpr__57616 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57616(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this57607,other57608){
var self__ = this;
var this57607__$1 = this;
return (((!((other57608 == null)))) && ((this57607__$1.constructor === other57608.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57607__$1.grammar,other57608.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57607__$1.start_production,other57608.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57607__$1.output_format,other57608.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this57607__$1.__extmap,other57608.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__57605){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__57617 = cljs.core.keyword_identical_QMARK_;
var expr__57618 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57620 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57621 = expr__57618;
return (pred__57617.cljs$core$IFn$_invoke$arity$2 ? pred__57617.cljs$core$IFn$_invoke$arity$2(G__57620,G__57621) : pred__57617.call(null,G__57620,G__57621));
})())){
return (new instaparse.core.Parser(G__57605,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57622 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57623 = expr__57618;
return (pred__57617.cljs$core$IFn$_invoke$arity$2 ? pred__57617.cljs$core$IFn$_invoke$arity$2(G__57622,G__57623) : pred__57617.call(null,G__57622,G__57623));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57605,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57624 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57625 = expr__57618;
return (pred__57617.cljs$core$IFn$_invoke$arity$2 ? pred__57617.cljs$core$IFn$_invoke$arity$2(G__57624,G__57625) : pred__57617.call(null,G__57624,G__57625));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__57605,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__57605),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__57605){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__57605,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__57626 = (arguments.length - (1));
switch (G__57626) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57610){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57610)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57609){
var extmap__4478__auto__ = (function (){var G__57627 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57609,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57609),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57609),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57609),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__57720 = (i__4790__auto___57718 + (1));
i__4790__auto___57718 = G__57720;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57630){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57633 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57634 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57634);

try{var G__57635 = input_format;
var G__57635__$1 = (((G__57635 instanceof cljs.core.Keyword))?G__57635.fqn:null);
switch (G__57635__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57635__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57633);
}});
...
var map__57636 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57636__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57636__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57628){
var G__57629 = cljs.core.first(seq57628);
var seq57628__$1 = cljs.core.next(seq57628);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57629,seq57628__$1);
}));
