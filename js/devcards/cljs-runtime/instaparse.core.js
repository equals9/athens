...
var G__57570 = (i__4790__auto___57567 + (1));
i__4790__auto___57567 = G__57570;
continue;
} else {
}
break;
...
while(true){
if((i__4790__auto___57581 < len__4789__auto___57579)){
args__4795__auto__.push((arguments[i__4790__auto___57581]));

var G__57583 = (i__4790__auto___57581 + (1));
i__4790__auto___57581 = G__57583;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57501){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57502,G__57503,seq57501__$2);
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57524){
var extmap__4478__auto__ = (function (){var G__57555 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57524,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57524)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57555);
} else {
return G__57555;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57524),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57524),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57524),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
