...
if(cljs.core.truth_((function (){var fexpr__56652 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56652.cljs$core$IFn$_invoke$arity$1 ? fexpr__56652.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56652.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__56653 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__56653.cljs$core$IFn$_invoke$arity$1 ? fexpr__56653.cljs$core$IFn$_invoke$arity$1(type) : fexpr__56653.call(null,type));
})())){
} else {
...
var G__56654 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56654)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__56654)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__56654)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__56654)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56654)].join('')));
...
var len__4736__auto___56697 = arguments.length;
var i__4737__auto___56698 = (0);
while(true){
if((i__4737__auto___56698 < len__4736__auto___56697)){
args__4742__auto__.push((arguments[i__4737__auto___56698]));

var G__56700 = (i__4737__auto___56698 + (1));
i__4737__auto___56698 = G__56700;
continue;
} else {
}
break;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56661 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56661) : instaparse.reduction.node_builders.call(null,G__56661));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56655){
var G__56656 = cljs.core.first(seq56655);
var seq56655__$1 = cljs.core.next(seq56655);
var G__56657 = cljs.core.first(seq56655__$1);
var seq56655__$2 = cljs.core.next(seq56655__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56656,G__56657,seq56655__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56710 = arguments.length;
var i__4737__auto___56711 = (0);
while(true){
if((i__4737__auto___56711 < len__4736__auto___56710)){
args__4742__auto__.push((arguments[i__4737__auto___56711]));

var G__56714 = (i__4737__auto___56711 + (1));
i__4737__auto___56711 = G__56714;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56668 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56668) : instaparse.reduction.node_builders.call(null,G__56668));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56662){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56670,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__56675 = k56670;
var G__56675__$1 = (((G__56675 instanceof cljs.core.Keyword))?G__56675.fqn:null);
switch (G__56675__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56670,else__4383__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__56669){
var self__ = this;
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56671,other56672){
var self__ = this;
var this56671__$1 = this;
return (((!((other56672 == null)))) && ((this56671__$1.constructor === other56672.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56671__$1.grammar,other56672.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56671__$1.start_production,other56672.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56671__$1.output_format,other56672.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56671__$1.__extmap,other56672.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56669){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56680 = cljs.core.keyword_identical_QMARK_;
var expr__56681 = k__4388__auto__;
if(cljs.core.truth_((pred__56680.cljs$core$IFn$_invoke$arity$2 ? pred__56680.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56681) : pred__56680.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56681)))){
return (new instaparse.core.Parser(G__56669,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56680.cljs$core$IFn$_invoke$arity$2 ? pred__56680.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56681) : pred__56680.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56681)))){
return (new instaparse.core.Parser(self__.grammar,G__56669,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56680.cljs$core$IFn$_invoke$arity$2 ? pred__56680.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56681) : pred__56680.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56681)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56669,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56669),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56669){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56669,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__56683 = (arguments.length - (1));
switch (G__56683) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56674){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56674)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56673){
var extmap__4419__auto__ = (function (){var G__56684 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56673,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56673)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56684);
} else {
return G__56684;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56673),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56673),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56673),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__56687){
...
var _STAR_case_insensitive_literals_STAR__orig_val__56690 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56691 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56691);

try{var G__56692 = input_format;
var G__56692__$1 = (((G__56692 instanceof cljs.core.Keyword))?G__56692.fqn:null);
switch (G__56692__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56692__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56690);
}});
...
var map__56693 = temp__5733__auto__;
var map__56693__$1 = (((((!((map__56693 == null))))?(((((map__56693.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56693.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56693):map__56693);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56693__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56693__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq56685){
var G__56686 = cljs.core.first(seq56685);
var seq56685__$1 = cljs.core.next(seq56685);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56686,seq56685__$1);
}));
