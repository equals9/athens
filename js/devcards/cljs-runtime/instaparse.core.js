...
var G__56610 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__56610)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__56610)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__56610)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__56610)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56610)].join('')));
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq56611){
var G__56612 = cljs.core.first(seq56611);
var seq56611__$1 = cljs.core.next(seq56611);
var G__56613 = cljs.core.first(seq56611__$1);
var seq56611__$2 = cljs.core.next(seq56611__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56612,G__56613,seq56611__$2);
}));
...
var args__4742__auto__ = [];
var len__4736__auto___56707 = arguments.length;
var i__4737__auto___56709 = (0);
while(true){
if((i__4737__auto___56709 < len__4736__auto___56707)){
args__4742__auto__.push((arguments[i__4737__auto___56709]));

var G__56711 = (i__4737__auto___56709 + (1));
i__4737__auto___56709 = G__56711;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__56626 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__56626) : instaparse.reduction.node_builders.call(null,G__56626));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq56618){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k56630,else__4383__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k56630,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__56639){
var vec__56640 = p__56639;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56640,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56640,(1),null);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this56631,other56632){
var self__ = this;
var this56631__$1 = this;
return (((!((other56632 == null)))) && ((this56631__$1.constructor === other56632.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56631__$1.grammar,other56632.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56631__$1.start_production,other56632.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56631__$1.output_format,other56632.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this56631__$1.__extmap,other56632.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__56629){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__56659 = cljs.core.keyword_identical_QMARK_;
var expr__56660 = k__4388__auto__;
if(cljs.core.truth_((pred__56659.cljs$core$IFn$_invoke$arity$2 ? pred__56659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56660) : pred__56659.call(null,new cljs.core.Keyword(null,"grammar","grammar",1881328267),expr__56660)))){
return (new instaparse.core.Parser(G__56629,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56659.cljs$core$IFn$_invoke$arity$2 ? pred__56659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56660) : pred__56659.call(null,new cljs.core.Keyword(null,"start-production","start-production",687546537),expr__56660)))){
return (new instaparse.core.Parser(self__.grammar,G__56629,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__56659.cljs$core$IFn$_invoke$arity$2 ? pred__56659.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56660) : pred__56659.call(null,new cljs.core.Keyword(null,"output-format","output-format",-1826382676),expr__56660)))){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__56629,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__56629),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__56629){
var self__ = this;
var this__4379__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__56629,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args56634){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args56634)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__56633){
var extmap__4419__auto__ = (function (){var G__56684 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__56633,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__56633)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__56684);
} else {
return G__56684;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__56633),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__56633),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__56633),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
...
var args__4742__auto__ = [];
var len__4736__auto___56776 = arguments.length;
var i__4737__auto___56777 = (0);
while(true){
if((i__4737__auto___56777 < len__4736__auto___56776)){
args__4742__auto__.push((arguments[i__4737__auto___56777]));

var G__56778 = (i__4737__auto___56777 + (1));
i__4737__auto___56777 = G__56778;
continue;
} else {
}
break;
