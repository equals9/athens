...
if(cljs.core.truth_((function (){var fexpr__57539 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57552 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57552) : instaparse.reduction.node_builders.call(null,G__57552));
})());
} else {
...
var i__4790__auto___57641 = (0);
while(true){
if((i__4790__auto___57641 < len__4789__auto___57639)){
args__4795__auto__.push((arguments[i__4790__auto___57641]));

var G__57643 = (i__4790__auto___57641 + (1));
i__4790__auto___57641 = G__57643;
continue;
} else {
}
break;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57574 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq57564){
var G__57565 = cljs.core.first(seq57564);
var seq57564__$1 = cljs.core.next(seq57564);
var G__57566 = cljs.core.first(seq57564__$1);
var seq57564__$2 = cljs.core.next(seq57564__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57565,G__57566,seq57564__$2);
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57589){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args57589)));
}));
