...
if(cljs.core.truth_((function (){var fexpr__57553 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57553.cljs$core$IFn$_invoke$arity$1 ? fexpr__57553.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57553.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__57561 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57561.cljs$core$IFn$_invoke$arity$1 ? fexpr__57561.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57561.call(null,type));
})())){
} else {
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57584 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57584) : instaparse.reduction.node_builders.call(null,G__57584));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57570){
var G__57571 = cljs.core.first(seq57570);
var seq57570__$1 = cljs.core.next(seq57570);
var G__57572 = cljs.core.first(seq57570__$1);
var seq57570__$2 = cljs.core.next(seq57570__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57571,G__57572,seq57570__$2);
}));
...
while(true){
if((i__4790__auto___57702 < len__4789__auto___57700)){
args__4795__auto__.push((arguments[i__4790__auto___57702]));

var G__57708 = (i__4790__auto___57702 + (1));
i__4790__auto___57702 = G__57708;
continue;
} else {
}
break;
