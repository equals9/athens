...
if(cljs.core.truth_((function (){var fexpr__57488 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__57494 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__57494.cljs$core$IFn$_invoke$arity$1 ? fexpr__57494.cljs$core$IFn$_invoke$arity$1(type) : fexpr__57494.call(null,type));
})())){
} else {
...
var G__57495 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__57495)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__57495)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__57495)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__57495)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57495)].join('')));
...
var i__4790__auto___57553 = (0);
while(true){
if((i__4790__auto___57553 < len__4789__auto___57551)){
args__4795__auto__.push((arguments[i__4790__auto___57553]));

var G__57555 = (i__4790__auto___57553 + (1));
i__4790__auto___57553 = G__57555;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq57500){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57501,G__57502,seq57500__$2);
}));
