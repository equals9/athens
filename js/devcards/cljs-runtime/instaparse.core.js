...
if(cljs.core.truth_((function (){var fexpr__57576 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57595){
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__57618){
var map__57619 = p__57618;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__57621 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__57621) : instaparse.reduction.node_builders.call(null,G__57621));
})());
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__57629){
var vec__57630 = p__57629;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57630,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57630,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__57633 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__57633(this__4435__auto____$1);
})();
...
var pred__57634 = cljs.core.keyword_identical_QMARK_;
var expr__57635 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__57637 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__57638 = expr__57635;
return (pred__57634.cljs$core$IFn$_invoke$arity$2 ? pred__57634.cljs$core$IFn$_invoke$arity$2(G__57637,G__57638) : pred__57634.call(null,G__57637,G__57638));
})())){
...
if(cljs.core.truth_((function (){var G__57639 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__57640 = expr__57635;
return (pred__57634.cljs$core$IFn$_invoke$arity$2 ? pred__57634.cljs$core$IFn$_invoke$arity$2(G__57639,G__57640) : pred__57634.call(null,G__57639,G__57640));
})())){
return (new instaparse.core.Parser(self__.grammar,G__57622,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__57641 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__57642 = expr__57635;
return (pred__57634.cljs$core$IFn$_invoke$arity$2 ? pred__57634.cljs$core$IFn$_invoke$arity$2(G__57641,G__57642) : pred__57634.call(null,G__57641,G__57642));
})())){
...
var self__ = this;
var self__ = this;
var G__57643 = (arguments.length - (1));
switch (G__57643) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args57627){
var self__ = this;
var self____$1 = this;
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__57626){
var extmap__4478__auto__ = (function (){var G__57644 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__57626,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__57626)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__57644);
} else {
return G__57644;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__57626),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__57626),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__57626),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
while(true){
if((i__4790__auto___57735 < len__4789__auto___57734)){
args__4795__auto__.push((arguments[i__4790__auto___57735]));

var G__57737 = (i__4790__auto___57735 + (1));
i__4790__auto___57735 = G__57737;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__57647){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57650 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57651 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57651);

try{var G__57652 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57652__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57650);
}});
...
var map__57653 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57653__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57653__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq57645){
var G__57646 = cljs.core.first(seq57645);
var seq57645__$1 = cljs.core.next(seq57645);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57646,seq57645__$1);
}));
