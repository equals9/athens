...
sci.impl.for_macro.expand_for = (function sci$impl$for_macro$expand_for(_,p__58197){
var vec__58198 = p__58197;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58198,(0),null);
var seq_exprs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58198,(1),null);
var body_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58198,(2),null);
sci.impl.for_macro.assert_args(seq_exprs,body_expr);

var to_groups = (function (seq_exprs__$1){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (groups,p__58201){
var vec__58202 = p__58201;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58202,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58202,(1),null);
...
var err = (function() { 
var G__58232__delegate = function (msg){
...
while (G__58233__i < G__58233__a.length) {G__58233__a[G__58233__i] = arguments[G__58233__i + 0]; ++G__58233__i;}
  msg = new cljs.core.IndexedSeq(G__58233__a,0,null);
} 
return G__58232__delegate.call(this,msg);};
G__58232.cljs$lang$maxFixedArity = 0;
G__58232.cljs$lang$applyTo = (function (arglist__58234){
var msg = cljs.core.seq(arglist__58234);
return G__58232__delegate(msg);
});
G__58232.cljs$core$IFn$_invoke$arity$variadic = G__58232__delegate;
return G__58232;
})()
;
var emit_bind = (function sci$impl$for_macro$expand_for_$_emit_bind(p__58205){
...
var bind = first__58211;
var first__58211__$1 = cljs.core.first(seq__58210__$1);
var seq__58210__$2 = cljs.core.next(seq__58210__$1);
var expr = first__58211__$1;
var mod_pairs = seq__58210__$2;
var vec__58212 = seq__58207__$1;
var vec__58215 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58212,(0),null);
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58215,(0),null);
var next_expr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58215,(1),null);
var next_groups = vec__58212;
...
var do_mod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_mod(p__58218){
...
var vec__58222 = first__58221;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58222,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58222,(1),null);
var pair = vec__58222;
var etc = seq__58220__$1;
...
if(next_groups){
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","let","cljs.core/let",-308701135,null),null,(1),null)),(new cljs.core.List(null,cljs.core.vec(cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58192__auto__","iterys__58192__auto__",-1590149938,null),null,(1),null)),(new cljs.core.List(null,sci$impl$for_macro$expand_for_$_emit_bind(next_groups),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58193__auto__","fs__58193__auto__",345203547,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","seq","cljs.core/seq",-1649497689,null),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol(null,"iterys__58192__auto__","iterys__58192__auto__",-1590149938,null),null,(1),null)),(new cljs.core.List(null,next_expr,null,(1),null))))),null,(1),null))))),null,(1),null))], 0))))),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol(null,"if","if",1181717262,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58193__auto__","fs__58193__auto__",345203547,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","concat","cljs.core/concat",-1133584918,null),null,(1),null)),(new cljs.core.List(null,new cljs.core.Symbol(null,"fs__58193__auto__","fs__58193__auto__",345203547,null),null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,giter,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,sci.impl.utils.allowed_recur,null,(1),null)),(new cljs.core.List(null,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,new cljs.core.Symbol("cljs.core","rest","cljs.core/rest",-285075455,null),null,(1),null)),(new cljs.core.List(null,gxs,null,(1),null))))),null,(1),null))))),null,(1),null))], 0)))),null,(1),null))], 0))));
} else {
...
var do_cmod = (function sci$impl$for_macro$expand_for_$_emit_bind_$_do_cmod(p__58225){
