...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34625_SHARP_){
return handle_mode(p1__34625_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__34625_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34626_SHARP_){
return handle_mode(cljs.core.first(p1__34626_SHARP_),cljs.core.second(p1__34626_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__34628,options){
 ...
 */
stylefy.impl.conversion.convert_supports_rules = (function stylefy$impl$conversion$convert_supports_rules(p__34636,options){
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__34640,options){
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__34639_SHARP_){
if(cljs.core.map_QMARK_(p1__34639_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__34639_SHARP_);
} else {
