...
return handle_mode(p1__41080_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__41080_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__41081_SHARP_){
return handle_mode(cljs.core.first(p1__41081_SHARP_),cljs.core.second(p1__41081_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__41084,options){
 ...
 */
stylefy.impl.conversion.convert_media_queries = (function stylefy$impl$conversion$convert_media_queries(p__41087,options){
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__41096,options){
...
var manual_selector_and_css_props = clojure.walk.walk((function (p1__41095_SHARP_){
if(cljs.core.map_QMARK_(p1__41095_SHARP_)){
return stylefy.impl.utils.remove_special_keywords(p1__41095_SHARP_);
} else {
return p1__41095_SHARP_;
}
...
(stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$2 = (function (p__41101,options){
