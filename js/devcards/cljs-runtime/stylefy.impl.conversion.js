...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34606_SHARP_){
return handle_mode(p1__34606_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__34606_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__34607_SHARP_){
return handle_mode(cljs.core.first(p1__34607_SHARP_),cljs.core.second(p1__34607_SHARP_));
}),modes);
} else {
return null;
}
 ...
 */
stylefy.impl.conversion.convert_base_style_into_class = (function stylefy$impl$conversion$convert_base_style_into_class(p__34612,options){
 ...
 */
stylefy.impl.conversion.convert_manual_styles = (function stylefy$impl$conversion$convert_manual_styles(p__34623,options){
