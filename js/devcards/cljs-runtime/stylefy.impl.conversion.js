...
return handle_mode(p1__40011_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(modes,p1__40011_SHARP_));
}),cljs.core.keys(modes));
} else {
if(cljs.core.vector_QMARK_(modes)){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__40012_SHARP_){
return handle_mode(cljs.core.first(p1__40012_SHARP_),cljs.core.second(p1__40012_SHARP_));
}),modes);
} else {
return null;
}
