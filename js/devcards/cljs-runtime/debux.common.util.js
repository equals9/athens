...
var G__46072 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46071;
acc = G__46072;
continue;
} else {
...
var G__46076 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46075;
acc = G__46076;
continue;
} else {
...
var G__46083 = cljs.core.nnext(opts__$1);
var G__46084 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46083;
acc = G__46084;
continue;
} else {
...
var G__46088 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46087;
acc = G__46088;
continue;
} else {
...
G__46094.cljs$lang$applyTo = (function (arglist__46102){
...
var G__46105 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46105;
continue;
} else {
...
var G__46107 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46107;
continue;
} else {
