...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50353_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50353_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50352_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50352_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50358_SHARP_){
return (((p1__50358_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50358_SHARP_) == null)));
...
var G__50443 = cljs.core.next(opts__$1);
var G__50444 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__50443;
acc = G__50444;
continue;
} else {
...
var G__50445 = cljs.core.nnext(opts__$1);
var G__50446 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__50445;
acc = G__50446;
continue;
} else {
...
var G__50448 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__50447;
acc = G__50448;
continue;
} else {
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50412 = quoted_form;
var G__50413 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50412,G__50413) : debux.common.util.remove_d.call(null,G__50412,G__50413));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__50454 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__50454;
continue;
} else {
...
var G__50455 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__50455;
continue;
} else {
var G__50456 = clojure.zip.next(loc);
loc = G__50456;
continue;
