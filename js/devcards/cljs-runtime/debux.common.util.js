...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50390_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50390_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50389_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50389_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50391_SHARP_){
return (((p1__50391_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50391_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50394,mapping){
...
var state = map__50395__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50395__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50395__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50395__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50392_SHARP_){
if((p1__50392_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50392_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__50428 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50427 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50427.cljs$core$IFn$_invoke$arity$1 ? fexpr__50427.cljs$core$IFn$_invoke$arity$1(G__50428) : fexpr__50427.call(null,G__50428));
});
