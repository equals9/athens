...
var G__46354 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46354;
continue;
} else {
...
var G__46357 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46357;
continue;
} else {
var G__46358 = clojure.zip.next(loc);
loc = G__46358;
continue;
