...
var G__46050 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__46053 = clojure.zip.next(loc);
loc = G__46053;
continue;
}
}
...
return (function() { 
var G__46091__delegate = function (arg){
...
var G__46101 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46101;
continue;
} else {
