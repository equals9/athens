...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50331_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__50331_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50330_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__50330_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50332_SHARP_){
return (((p1__50332_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__50332_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__50337,mapping){
...
var state = map__50338__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50338__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50338__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50338__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__50335_SHARP_){
if((p1__50335_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__50335_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__50357){
var vec__50359 = p__50357;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50359,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq50355){
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50363_SHARP_){
...
var _STAR_print_newline_STAR__orig_val__50365_50418 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__50366_50419 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__50367_50420 = true;
var _STAR_print_fn_STAR__temp_val__50368_50421 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__50367_50420);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__50368_50421);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__50366_50419);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__50365_50418);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4667__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__50364_SHARP_){
return debux.common.util.prepend_bars(p1__50364_SHARP_,indent_level);
...
var G__50423 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__50422;
acc = G__50423;
continue;
} else {
if(typeof f === 'string'){
var G__50424 = cljs.core.next(opts__$1);
var G__50425 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__50424;
acc = G__50425;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__50426 = cljs.core.nnext(opts__$1);
var G__50427 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__50426;
acc = G__50427;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__50428 = cljs.core.next(opts__$1);
var G__50429 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__50428;
acc = G__50429;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__50371 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__50371.cljs$core$IFn$_invoke$arity$1 ? fexpr__50371.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50371.call(null,f));
})())){
...
if(cljs.core.truth_((function (){var fexpr__50372 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__50372.cljs$core$IFn$_invoke$arity$1 ? fexpr__50372.cljs$core$IFn$_invoke$arity$1(f) : fexpr__50372.call(null,f));
})())){
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__50375){
var vec__50377 = p__50375;
...
var G__50386 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__50385 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__50385.cljs$core$IFn$_invoke$arity$1 ? fexpr__50385.cljs$core$IFn$_invoke$arity$1(G__50386) : fexpr__50385.call(null,G__50386));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50396 = quoted_form;
var G__50397 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50396,G__50397) : debux.common.util.remove_d.call(null,G__50396,G__50397));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__50403 = quoted_form;
var G__50404 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__50403,G__50404) : debux.common.util.remove_d.call(null,G__50403,G__50404));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
