...
var G__46099 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46098;
acc = G__46099;
continue;
} else {
...
var G__46103 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46102;
acc = G__46103;
continue;
} else {
...
var G__46120 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46120;
continue;
} else {
var G__46121 = clojure.zip.next(loc);
loc = G__46121;
continue;
