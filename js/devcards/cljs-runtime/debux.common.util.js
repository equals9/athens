...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46033_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__46033_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__46032_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46032_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46034_SHARP_){
return (((p1__46034_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__46034_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__46037,mapping){
var map__46038 = p__46037;
var map__46038__$1 = (((((!((map__46038 == null))))?(((((map__46038.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__46038.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__46038):map__46038);
var state = map__46038__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46038__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46038__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46038__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__46035_SHARP_){
if((p1__46035_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__46035_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4789__auto___46085 = arguments.length;
var i__4790__auto___46086 = (0);
while(true){
if((i__4790__auto___46086 < len__4789__auto___46085)){
args__4795__auto__.push((arguments[i__4790__auto___46086]));

var G__46087 = (i__4790__auto___46086 + (1));
i__4790__auto___46086 = G__46087;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__46043){
var vec__46044 = p__46043;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46044,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq46041){
var G__46042 = cljs.core.first(seq46041);
var seq46041__$1 = cljs.core.next(seq46041);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46042,seq46041__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46047_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__46047_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__46049_46088 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46050_46089 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46051_46090 = true;
var _STAR_print_fn_STAR__temp_val__46052_46091 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46051_46090);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46052_46091);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46050_46089);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46049_46088);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__46048_SHARP_){
return debux.common.util.prepend_bars(p1__46048_SHARP_,indent_level);
...
var G__46095 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46094;
acc = G__46095;
continue;
} else {
...
var G__46097 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46096;
acc = G__46097;
continue;
} else {
...
var G__46099 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46098;
acc = G__46099;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46057 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
...
var G__46101 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46100;
acc = G__46101;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__46058 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__46058.cljs$core$IFn$_invoke$arity$1 ? fexpr__46058.cljs$core$IFn$_invoke$arity$1(f) : fexpr__46058.call(null,f));
})())){
var G__46102 = cljs.core.nnext(opts__$1);
var G__46103 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46102;
acc = G__46103;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__46059){
...
var G__46065 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__46064 = (function (){var fexpr__46066 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__46066.cljs$core$IFn$_invoke$arity$1 ? fexpr__46066.cljs$core$IFn$_invoke$arity$1(form) : fexpr__46066.call(null,form));
})();
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46068 = quoted_form;
var G__46069 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46068,G__46069) : debux.common.util.remove_d.call(null,G__46068,G__46069));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46070 = quoted_form;
var G__46071 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46070,G__46071) : debux.common.util.remove_d.call(null,G__46070,G__46071));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__46072 = quoted_form;
var G__46073 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__46072,G__46073) : debux.common.util.remove_d.call(null,G__46072,G__46073));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
