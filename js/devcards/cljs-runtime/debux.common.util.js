...
var G__46074 = clojure.zip.next(loc);
loc = G__46074;
continue;
}
}
...
return (function() { 
var G__46108__delegate = function (arg){
...
while (G__46110__i < G__46110__a.length) {G__46110__a[G__46110__i] = arguments[G__46110__i + 0]; ++G__46110__i;}
  arg = new cljs.core.IndexedSeq(G__46110__a,0,null);
} 
return G__46108__delegate.call(this,arg);};
G__46108.cljs$lang$maxFixedArity = 0;
G__46108.cljs$lang$applyTo = (function (arglist__46111){
var arg = cljs.core.seq(arglist__46111);
return G__46108__delegate(arg);
});
...
var G__46116 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46116;
continue;
} else {
...
var G__46117 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46117;
continue;
} else {
var G__46118 = clojure.zip.next(loc);
loc = G__46118;
continue;
