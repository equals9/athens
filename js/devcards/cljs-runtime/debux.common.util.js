...
var G__46091 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46090;
acc = G__46091;
continue;
} else {
...
var G__46104 = cljs.core.nnext(opts__$1);
var G__46105 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46104;
acc = G__46105;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46107 = cljs.core.next(opts__$1);
var G__46108 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46107;
acc = G__46108;
continue;
} else {
...
return (function() { 
var G__46116__delegate = function (arg){
...
while (G__46117__i < G__46117__a.length) {G__46117__a[G__46117__i] = arguments[G__46117__i + 0]; ++G__46117__i;}
  arg = new cljs.core.IndexedSeq(G__46117__a,0,null);
} 
return G__46116__delegate.call(this,arg);};
G__46116.cljs$lang$maxFixedArity = 0;
G__46116.cljs$lang$applyTo = (function (arglist__46118){
var arg = cljs.core.seq(arglist__46118);
return G__46116__delegate(arg);
});
...
var G__46126 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46126;
continue;
} else {
var G__46127 = clojure.zip.next(loc);
loc = G__46127;
continue;
