...
var G__46054 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__46053;
acc = G__46054;
continue;
} else {
...
var G__46058 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__46057;
acc = G__46058;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__46059 = cljs.core.nnext(opts__$1);
var G__46060 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__46059;
acc = G__46060;
continue;
} else {
...
var G__46064 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__46063;
acc = G__46064;
continue;
} else {
...
var G__46068 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__46067;
acc = G__46068;
continue;
} else {
...
var G__46069 = cljs.core.nnext(opts__$1);
var G__46070 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__46069;
acc = G__46070;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__46071 = cljs.core.next(opts__$1);
var G__46072 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__46071;
acc = G__46072;
continue;
} else {
...
return (function() { 
var G__46081__delegate = function (arg){
...
while (G__46085__i < G__46085__a.length) {G__46085__a[G__46085__i] = arguments[G__46085__i + 0]; ++G__46085__i;}
  arg = new cljs.core.IndexedSeq(G__46085__a,0,null);
} 
return G__46081__delegate.call(this,arg);};
G__46081.cljs$lang$maxFixedArity = 0;
G__46081.cljs$lang$applyTo = (function (arglist__46087){
var arg = cljs.core.seq(arglist__46087);
return G__46081__delegate(arg);
});
...
var G__46090 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46090;
continue;
} else {
...
var G__46091 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46091;
continue;
} else {
var G__46092 = clojure.zip.next(loc);
loc = G__46092;
continue;
