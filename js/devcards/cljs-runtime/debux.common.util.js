...
var G__46077 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
return (function() { 
var G__46115__delegate = function (arg){
...
while (G__46116__i < G__46116__a.length) {G__46116__a[G__46116__i] = arguments[G__46116__i + 0]; ++G__46116__i;}
  arg = new cljs.core.IndexedSeq(G__46116__a,0,null);
} 
return G__46115__delegate.call(this,arg);};
G__46115.cljs$lang$maxFixedArity = 0;
G__46115.cljs$lang$applyTo = (function (arglist__46117){
var arg = cljs.core.seq(arglist__46117);
return G__46115__delegate(arg);
});
...
var G__46122 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__46122;
continue;
} else {
...
var G__46124 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__46124;
continue;
} else {
var G__46125 = clojure.zip.next(loc);
loc = G__46125;
continue;
