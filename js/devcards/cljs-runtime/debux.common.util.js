...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51389_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__51389_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__51388_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__51388_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51390_SHARP_){
return (((p1__51390_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__51390_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__51408,mapping){
...
var state = map__51409__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51409__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51409__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51409__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__51405_SHARP_){
if((p1__51405_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__51405_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4789__auto___51462 = arguments.length;
var i__4790__auto___51463 = (0);
while(true){
if((i__4790__auto___51463 < len__4789__auto___51462)){
args__4795__auto__.push((arguments[i__4790__auto___51463]));

var G__51464 = (i__4790__auto___51463 + (1));
i__4790__auto___51463 = G__51464;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__51429_51465 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__51430_51466 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__51431_51467 = true;
var _STAR_print_fn_STAR__temp_val__51432_51468 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__51431_51467);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__51432_51468);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__51430_51466);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__51429_51465);
}
...
if(typeof f === 'number'){
var G__51469 = cljs.core.next(opts__$1);
var G__51470 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__51469;
acc = G__51470;
continue;
} else {
...
var G__51472 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__51471;
acc = G__51472;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__51473 = cljs.core.nnext(opts__$1);
var G__51474 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__51473;
acc = G__51474;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__51475 = cljs.core.next(opts__$1);
var G__51476 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__51475;
acc = G__51476;
continue;
} else {
...
var G__51478 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__51477;
acc = G__51478;
continue;
} else {
...
var G__51479 = cljs.core.nnext(opts__$1);
var G__51480 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__51479;
acc = G__51480;
continue;
} else {
...
var G__51482 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__51481;
acc = G__51482;
continue;
} else {
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51446 = quoted_form;
var G__51447 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51446,G__51447) : debux.common.util.remove_d.call(null,G__51446,G__51447));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__51448 = quoted_form;
var G__51449 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__51448,G__51449) : debux.common.util.remove_d.call(null,G__51448,G__51449));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__51483__delegate = function (arg){
...
while (G__51484__i < G__51484__a.length) {G__51484__a[G__51484__i] = arguments[G__51484__i + 0]; ++G__51484__i;}
  arg = new cljs.core.IndexedSeq(G__51484__a,0,null);
} 
return G__51483__delegate.call(this,arg);};
G__51483.cljs$lang$maxFixedArity = 0;
G__51483.cljs$lang$applyTo = (function (arglist__51485){
var arg = cljs.core.seq(arglist__51485);
return G__51483__delegate(arg);
});
...
var G__51486 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__51486;
continue;
} else {
...
var G__51495 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__51495;
continue;
} else {
var G__51496 = clojure.zip.next(loc);
loc = G__51496;
continue;
