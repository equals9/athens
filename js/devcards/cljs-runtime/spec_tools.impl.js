...
var vec__47582 = cljs.core.rest(expr);
...
var vec__47585 = first__47584;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47585,(0),null);
var form = seq__47583__$1;
...
var G__47588 = x;
var G__47588__$1 = (((G__47588 == null))?null:spec_tools.impl.polish(G__47588));
var G__47588__$2 = (((G__47588__$1 == null))?null:cljs.core.name(G__47588__$1));
if((G__47588__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47588__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__47589 = x;
var G__47589__$1 = (((G__47589 == null))?null:cljs.core.name(G__47589));
if((G__47589__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__47589__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__47590){
...
var data = map__47591__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47591__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47591__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47591__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47591__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__47593){
var map__47594 = p__47593;
var map__47594__$1 = (((((!((map__47594 == null))))?(((((map__47594.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47594.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47594):map__47594);
var data = map__47594__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47594__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47594__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__47596 = data;
var G__47596__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47596,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__47596);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47596__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__47596__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__47600 = form;
var G__47600__$1 = (((G__47600 == null))?null:cljs.core.rest(G__47600));
if((G__47600__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47600__$1);
}
})();
var G__47601 = m;
var G__47601__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47601,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__47597_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47597_SHARP_)));
})):G__47601);
var G__47601__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47601__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__47598_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__47598_SHARP_)));
})):G__47601__$1);
var G__47601__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__47601__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__47599_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__47599_SHARP_));
})):G__47601__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__47601__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__47602 = (function (){var G__47603 = form;
var G__47603__$1 = (((G__47603 == null))?null:cljs.core.rest(G__47603));
if((G__47603__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__47603__$1);
}
})();
var map__47602__$1 = (((((!((map__47602 == null))))?(((((map__47602.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47602.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47602):map__47602);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47602__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47602__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47602__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47602__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__47605 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__47605) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__47606 = form;
var G__47606__$1 = (((G__47606 == null))?null:cljs.core.seq(G__47606));
var G__47606__$2 = (((G__47606__$1 == null))?null:cljs.core.first(G__47606__$1));
if((G__47606__$2 == null)){
return null;
} else {
var fexpr__47607 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__47607.cljs$core$IFn$_invoke$arity$1 ? fexpr__47607.cljs$core$IFn$_invoke$arity$1(G__47606__$2) : fexpr__47607.call(null,G__47606__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq47608){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq47608));
}));
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__47615){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47616__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47616__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47616__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47616__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__47613_SHARP_){
return cljs.core.map_QMARK_(p1__47613_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__47614_SHARP_){
return cljs.core.contains_QMARK_(p1__47614_SHARP_,x);
});
}),req_keys));
