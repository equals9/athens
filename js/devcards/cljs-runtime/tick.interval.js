...
var iter__4582__auto__ = (function tick$interval$iter__51370(s__51371){
return (new cljs.core.LazySeq(null,(function (){
var s__51371__$1 = s__51371;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__51371__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var xi = cljs.core.first(xs__6292__auto__);
var iterys__4578__auto__ = ((function (s__51371__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1){
return (function tick$interval$iter__51370_$_iter__51372(s__51373){
return (new cljs.core.LazySeq(null,((function (s__51371__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1){
return (function (){
var s__51373__$1 = s__51373;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__51373__$1);
if(temp__5735__auto____$1){
var s__51373__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__51373__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__51373__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__51375 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__51374 = (0);
while(true){
if((i__51374 < size__4581__auto__)){
var yi = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__51374);
if((xi < yi)){
...
cljs.core.chunk_append(b__51375,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y,new cljs.core.Keyword(null,"relation","relation",-693437925),tick.interval.relation(x,y),new cljs.core.Keyword(null,"concur","concur",4812827),conc], null));

var G__51685 = (i__51374 + (1));
i__51374 = G__51685;
continue;
} else {
var G__51686 = (i__51374 + (1));
i__51374 = G__51686;
continue;
}
} else {
var G__51687 = (i__51374 + (1));
i__51374 = G__51687;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__51375),tick$interval$iter__51370_$_iter__51372(cljs.core.chunk_rest(s__51373__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__51375),null);
}
} else {
var yi = cljs.core.first(s__51373__$2);
if((xi < yi)){
var x = cljs.core.get.cljs$core$IFn$_invoke$arity$2(intervals__$1,xi);
var y = cljs.core.get.cljs$core$IFn$_invoke$arity$2(intervals__$1,yi);
var conc = tick.interval.concur(x,y);
if(cljs.core.truth_(conc)){
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),x,new cljs.core.Keyword(null,"y","y",-1757859776),y,new cljs.core.Keyword(null,"relation","relation",-693437925),tick.interval.relation(x,y),new cljs.core.Keyword(null,"concur","concur",4812827),conc], null),tick$interval$iter__51370_$_iter__51372(cljs.core.rest(s__51373__$2)));
} else {
var G__51691 = cljs.core.rest(s__51373__$2);
s__51373__$1 = G__51691;
continue;
}
} else {
var G__51692 = cljs.core.rest(s__51373__$2);
s__51373__$1 = G__51692;
continue;
}
}
} else {
...
});})(s__51371__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1))
,null,null));
});})(s__51371__$1,xi,xs__6292__auto__,temp__5735__auto__,intervals__$1))
;
...
if(fs__4579__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4579__auto__,tick$interval$iter__51370(cljs.core.rest(s__51371__$1)));
} else {
var G__51693 = cljs.core.rest(s__51371__$1);
s__51371__$1 = G__51693;
continue;
}
} else {
return null;
...
var fexpr__51421 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.meets_QMARK_,tick.interval.precedes_QMARK_]);
return (fexpr__51421.cljs$core$IFn$_invoke$arity$1 ? fexpr__51421.cljs$core$IFn$_invoke$arity$1(G__51422) : fexpr__51421.call(null,G__51422));
}));
...
var fexpr__51429 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.starts_QMARK_,tick.interval.overlaps_QMARK_,tick.interval.equals_QMARK_,tick.interval.meets_QMARK_,tick.interval.finished_by_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__51434 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_]);
...
var x__$1 = this;
var G__51443 = (tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2 ? tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2(x__$1,y) : tick.interval.basic_relation.call(null,x__$1,y));
var fexpr__51442 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.started_by_QMARK_,tick.interval.equals_QMARK_,tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_,tick.interval.overlapped_by_QMARK_,tick.interval.finishes_QMARK_]);
...
return (!(((function (){var G__51453 = s;
var vec__51457 = G__51453;
var seq__51458 = cljs.core.seq(vec__51457);
var first__51459 = cljs.core.first(seq__51458);
var seq__51458__$1 = cljs.core.next(seq__51458);
var x = first__51459;
var xs = seq__51458__$1;
var G__51453__$1 = G__51453;
while(true){
var vec__51460 = G__51453__$1;
...
var x__$1 = first__51462;
var xs__$1 = seq__51461__$1;
if((((x__$1 == null)) || ((cljs.core.first(xs__$1) == null)))){
return true;
} else {
if(cljs.core.truth_((function (){var G__51469 = x__$1;
var G__51470 = cljs.core.first(xs__$1);
return (rel.cljs$core$IFn$_invoke$arity$2 ? rel.cljs$core$IFn$_invoke$arity$2(G__51469,G__51470) : rel.call(null,G__51469,G__51470));
})())){
var G__51694 = xs__$1;
G__51453__$1 = G__51694;
continue;
} else {
return null;
}
...
var vec__51480 = s;
var initial = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51480,(0),null);
var subsequent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51480,(1),null);
...
var G__51618 = tick.interval.relation(ival,group);
var G__51618__$1 = (((G__51618 instanceof cljs.core.Keyword))?G__51618.fqn:null);
switch (G__51618__$1) {
case "precedes":
case "meets":
...
var G__51764 = (function (){var G__51619 = result;
if(cljs.core.truth_(cljs.core.not_empty(current_intervals))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51619,group,current_intervals);
} else {
return G__51619;
}
})();
...
break;
case "finished-by":
var vec__51620 = tick.interval.split_with_assert(ival,tick.core.beginning(group));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51618__$1)].join('')));
...
goog.object.set(G__51637_51798,G__51638_51799,G__51639_51800);
