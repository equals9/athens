...
var G__51682 = (i__51374 + (1));
i__51374 = G__51682;
continue;
} else {
var G__51683 = (i__51374 + (1));
i__51374 = G__51683;
continue;
}
} else {
var G__51684 = (i__51374 + (1));
i__51374 = G__51684;
continue;
}
} else {
...
var G__51685 = cljs.core.rest(s__51373__$2);
s__51373__$1 = G__51685;
continue;
}
} else {
var G__51686 = cljs.core.rest(s__51373__$2);
s__51373__$1 = G__51686;
continue;
}
}
} else {
...
var G__51687 = cljs.core.rest(s__51371__$1);
s__51371__$1 = G__51687;
continue;
}
} else {
return null;
...
var fexpr__51400 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.meets_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__51405 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.starts_QMARK_,tick.interval.overlaps_QMARK_,tick.interval.equals_QMARK_,tick.interval.meets_QMARK_,tick.interval.finished_by_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__51410 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_]);
...
var fexpr__51421 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.started_by_QMARK_,tick.interval.equals_QMARK_,tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_,tick.interval.overlapped_by_QMARK_,tick.interval.finishes_QMARK_]);
...
return (!(((function (){var G__51435 = s;
...
var x = first__51438;
var xs = seq__51437__$1;
var G__51435__$1 = G__51435;
while(true){
var vec__51442 = G__51435__$1;
var seq__51443 = cljs.core.seq(vec__51442);
var first__51444 = cljs.core.first(seq__51443);
var seq__51443__$1 = cljs.core.next(seq__51443);
var x__$1 = first__51444;
var xs__$1 = seq__51443__$1;
if((((x__$1 == null)) || ((cljs.core.first(xs__$1) == null)))){
return true;
} else {
if(cljs.core.truth_((function (){var G__51448 = x__$1;
var G__51449 = cljs.core.first(xs__$1);
return (rel.cljs$core$IFn$_invoke$arity$2 ? rel.cljs$core$IFn$_invoke$arity$2(G__51448,G__51449) : rel.call(null,G__51448,G__51449));
})())){
var G__51694 = xs__$1;
G__51435__$1 = G__51694;
continue;
} else {
return null;
}
...
var vec__51465 = s;
var initial = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51465,(0),null);
var subsequent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51465,(1),null);
...
var G__51711 = cljs.core.rest(s__51530__$2);
s__51530__$1 = G__51711;
continue;
}
}
} else {
...
args_arr__4810__auto__.push((arguments[i__4790__auto___51714]));
...
var G__51548 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51548__$1)].join('')));
...
var G__51764 = (function (){var G__51625 = result;
if(cljs.core.truth_(cljs.core.not_empty(current_intervals))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51625,group,current_intervals);
} else {
return G__51625;
}
})();
