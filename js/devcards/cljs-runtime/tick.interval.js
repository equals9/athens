...
cljs.spec.alpha.assert_STAR_(r,(function (p1__51340_SHARP_){
return (p1__51340_SHARP_ instanceof tick.interval.GeneralRelation);
}));
} else {
}
} else {
...
while(true){
if((i__4790__auto___51692 < len__4789__auto___51688)){
...
var G__51700 = (i__51386 + (1));
i__51386 = G__51700;
continue;
} else {
var G__51701 = (i__51386 + (1));
i__51386 = G__51701;
continue;
}
} else {
var G__51705 = (i__51386 + (1));
i__51386 = G__51705;
continue;
}
} else {
...
var G__51712 = cljs.core.rest(s__51385__$2);
s__51385__$1 = G__51712;
continue;
}
} else {
var G__51713 = cljs.core.rest(s__51385__$2);
s__51385__$1 = G__51713;
continue;
}
}
} else {
...
var G__51714 = cljs.core.rest(s__51383__$1);
s__51383__$1 = G__51714;
continue;
}
} else {
return null;
...
var fexpr__51457 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.meets_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__51462 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.starts_QMARK_,tick.interval.overlaps_QMARK_,tick.interval.equals_QMARK_,tick.interval.meets_QMARK_,tick.interval.finished_by_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__51470 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_]);
...
var fexpr__51475 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.started_by_QMARK_,tick.interval.equals_QMARK_,tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_,tick.interval.overlapped_by_QMARK_,tick.interval.finishes_QMARK_]);
...
if(cljs.core.truth_((function (){var G__51532 = cljs.core.first(c1);
var G__51533 = cljs.core.first(c2);
return (tick.interval.disjoint_QMARK_.cljs$core$IFn$_invoke$arity$2 ? tick.interval.disjoint_QMARK_.cljs$core$IFn$_invoke$arity$2(G__51532,G__51533) : tick.interval.disjoint_QMARK_.call(null,G__51532,G__51533));
})())){
