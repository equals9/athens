...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__55765){
var map__55766 = p__55765;
var map__55766__$1 = (((((!((map__55766 == null))))?(((((map__55766.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55766.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55766):map__55766);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55766__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput55768 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput55768 = (function (meta55769){
this.meta55769 = meta55769;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput55768.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55770,meta55769__$1){
var self__ = this;
var _55770__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput55768(meta55769__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput55768.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55770){
var self__ = this;
var _55770__$1 = this;
return self__.meta55769;
}));

(athens.devcards.textinput.t_athens$devcards$textinput55768.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput55768.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput55768.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55769","meta55769",-802592301,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput55768.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput55768.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput55768");

(athens.devcards.textinput.t_athens$devcards$textinput55768.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput55768");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput55768.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput55768 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput55768(meta55769){
return (new athens.devcards.textinput.t_athens$devcards$textinput55768(meta55769));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput55768(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput55771 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput55771 = (function (meta55772){
this.meta55772 = meta55772;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput55771.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55773,meta55772__$1){
var self__ = this;
var _55773__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput55771(meta55772__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput55771.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55773){
var self__ = this;
var _55773__$1 = this;
return self__.meta55772;
}));

(athens.devcards.textinput.t_athens$devcards$textinput55771.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput55771.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput55771.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput55771.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput55771.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput55771");

(athens.devcards.textinput.t_athens$devcards$textinput55771.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput55771");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput55771.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput55771 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput55771(meta55772){
return (new athens.devcards.textinput.t_athens$devcards$textinput55771(meta55772));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput55771(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
