...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60132){
var map__60133 = p__60132;
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60133__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60135 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60135 = (function (meta60136){
this.meta60136 = meta60136;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60135.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60137,meta60136__$1){
var self__ = this;
var _60137__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60135(meta60136__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60135.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60137){
var self__ = this;
var _60137__$1 = this;
return self__.meta60136;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60135.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60135.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60135.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60135.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60135.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60135");

(athens.devcards.textinput.t_athens$devcards$textinput60135.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60135");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60135.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60135 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60135(meta60136){
return (new athens.devcards.textinput.t_athens$devcards$textinput60135(meta60136));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60135(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60138 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60138 = (function (meta60139){
this.meta60139 = meta60139;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60138.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60140,meta60139__$1){
var self__ = this;
var _60140__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60138(meta60139__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60138.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60140){
var self__ = this;
var _60140__$1 = this;
return self__.meta60139;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60138.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60138.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60138.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60138.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60138.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60138");

(athens.devcards.textinput.t_athens$devcards$textinput60138.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60138");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60138.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60138 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60138(meta60139){
return (new athens.devcards.textinput.t_athens$devcards$textinput60138(meta60139));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60138(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
