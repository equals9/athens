...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60963){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60964__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60966 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60966 = (function (meta60967){
this.meta60967 = meta60967;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60966.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60968,meta60967__$1){
var self__ = this;
var _60968__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60966(meta60967__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60966.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60968){
var self__ = this;
var _60968__$1 = this;
return self__.meta60967;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60966.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60966.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60966.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60967","meta60967",583264861,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60966.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60966.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60966");

(athens.devcards.textinput.t_athens$devcards$textinput60966.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60966");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60966.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60966 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60966(meta60967){
return (new athens.devcards.textinput.t_athens$devcards$textinput60966(meta60967));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60966(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60969 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60969 = (function (meta60970){
this.meta60970 = meta60970;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60969.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60971,meta60970__$1){
var self__ = this;
var _60971__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60969(meta60970__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60969.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60971){
var self__ = this;
var _60971__$1 = this;
return self__.meta60970;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60969.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60969.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60969.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60970","meta60970",1559378338,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60969.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60969.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60969");

(athens.devcards.textinput.t_athens$devcards$textinput60969.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60969");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60969.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60969 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60969(meta60970){
return (new athens.devcards.textinput.t_athens$devcards$textinput60969(meta60970));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60969(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
