...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60667){
...
var autoFocus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"autoFocus","autoFocus",-552622425));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"value","value",305978217));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60668__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60670 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60670 = (function (meta60671){
this.meta60671 = meta60671;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60670.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60672,meta60671__$1){
var self__ = this;
var _60672__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60670(meta60671__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60670.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60672){
var self__ = this;
var _60672__$1 = this;
return self__.meta60671;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60670.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60670.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60670.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60671","meta60671",-503826664,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60670.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60670.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60670");

(athens.devcards.textinput.t_athens$devcards$textinput60670.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60670");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60670.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60670 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60670(meta60671){
return (new athens.devcards.textinput.t_athens$devcards$textinput60670(meta60671));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60670(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60678 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60678 = (function (meta60679){
this.meta60679 = meta60679;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60678.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60680,meta60679__$1){
var self__ = this;
var _60680__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60678(meta60679__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60678.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60680){
var self__ = this;
var _60680__$1 = this;
return self__.meta60679;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60678.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60678.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60678.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60678.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60678.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60678");

(athens.devcards.textinput.t_athens$devcards$textinput60678.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60678");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60678.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60678 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60678(meta60679){
return (new athens.devcards.textinput.t_athens$devcards$textinput60678(meta60679));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60678(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
