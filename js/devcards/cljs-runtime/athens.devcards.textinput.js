...
athens.devcards.textinput.textinput = (function athens$devcards$textinput$textinput(p__60919){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60920__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var defaultValue = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60920__$1,new cljs.core.Keyword(null,"defaultValue","defaultValue",-586131910));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60920__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60920__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var icon = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60920__$1,new cljs.core.Keyword(null,"icon","icon",1679606541));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60922 !== 'undefined')){
} else {
...
*/
athens.devcards.textinput.t_athens$devcards$textinput60922 = (function (meta60923){
this.meta60923 = meta60923;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60922.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60924,meta60923__$1){
var self__ = this;
var _60924__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60922(meta60923__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60922.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60924){
var self__ = this;
var _60924__$1 = this;
return self__.meta60923;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60922.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60922.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60922.getBasis = (function (){
...
(athens.devcards.textinput.t_athens$devcards$textinput60922.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60922.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60922");

(athens.devcards.textinput.t_athens$devcards$textinput60922.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60922");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60922.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60922 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60922(meta60923){
return (new athens.devcards.textinput.t_athens$devcards$textinput60922(meta60923));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60922(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.textinput !== 'undefined') && (typeof athens.devcards.textinput.t_athens$devcards$textinput60925 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.textinput.t_athens$devcards$textinput60925 = (function (meta60926){
this.meta60926 = meta60926;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.textinput.t_athens$devcards$textinput60925.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60927,meta60926__$1){
var self__ = this;
var _60927__$1 = this;
return (new athens.devcards.textinput.t_athens$devcards$textinput60925(meta60926__$1));
}));

(athens.devcards.textinput.t_athens$devcards$textinput60925.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60927){
var self__ = this;
var _60927__$1 = this;
return self__.meta60926;
}));

(athens.devcards.textinput.t_athens$devcards$textinput60925.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.textinput.t_athens$devcards$textinput60925.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.textinput.t_athens$devcards$textinput60925.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60926","meta60926",1899767015,null)], null);
}));

(athens.devcards.textinput.t_athens$devcards$textinput60925.cljs$lang$type = true);

(athens.devcards.textinput.t_athens$devcards$textinput60925.cljs$lang$ctorStr = "athens.devcards.textinput/t_athens$devcards$textinput60925");

(athens.devcards.textinput.t_athens$devcards$textinput60925.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.textinput/t_athens$devcards$textinput60925");
}));

/**
 * Positional factory function for athens.devcards.textinput/t_athens$devcards$textinput60925.
 */
athens.devcards.textinput.__GT_t_athens$devcards$textinput60925 = (function athens$devcards$textinput$__GT_t_athens$devcards$textinput60925(meta60926){
return (new athens.devcards.textinput.t_athens$devcards$textinput60925(meta60926));
});

}

return (new athens.devcards.textinput.t_athens$devcards$textinput60925(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
