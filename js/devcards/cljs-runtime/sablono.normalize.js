...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34450){
var vec__34455 = p__34450;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34470,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34470;
}
});
...
var len__4789__auto___34560 = arguments.length;
var i__4790__auto___34561 = (0);
while(true){
if((i__4790__auto___34561 < len__4789__auto___34560)){
...
var G__34487 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34487,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34487;
}
} else {
...
var vec__34496 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34501 = cljs.core.ffirst(matches);
var fexpr__34500 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34500.cljs$core$IFn$_invoke$arity$1 ? fexpr__34500.cljs$core$IFn$_invoke$arity$1(G__34501) : fexpr__34500.call(null,G__34501));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34496,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34496,(1),null);
...
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34494_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34494_SHARP_));
...
var tag = first__34529;
var content = seq__34528__$1;
...
var vec__34532 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34532,(2),null);
