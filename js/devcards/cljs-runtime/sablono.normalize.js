...
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34460,(1),null);
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34489,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34489;
}
});
...
var len__4789__auto___34620 = arguments.length;
var i__4790__auto___34621 = (0);
while(true){
if((i__4790__auto___34621 < len__4789__auto___34620)){
args__4795__auto__.push((arguments[i__4790__auto___34621]));

var G__34624 = (i__4790__auto___34621 + (1));
i__4790__auto___34621 = G__34624;
continue;
} else {
}
break;
...
var G__34509 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34509,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34509;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34493){
...
var vec__34517 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34522 = cljs.core.ffirst(matches);
var fexpr__34521 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34521.cljs$core$IFn$_invoke$arity$1 ? fexpr__34521.cljs$core$IFn$_invoke$arity$1(G__34522) : fexpr__34521.call(null,G__34522));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34517,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34513_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34513_SHARP_))){
return p1__34513_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34515_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34515_SHARP_));
