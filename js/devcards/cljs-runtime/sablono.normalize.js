...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__45146){
var vec__45147 = p__45146;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45147,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__45150_SHARP_){
return (((p1__45150_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__45150_SHARP_ === 'string'));
}),class$)))){
...
var vec__45181 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__45185 = cljs.core.ffirst(matches);
var fexpr__45184 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45181,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45181,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__45179_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__45179_SHARP_))){
return p1__45179_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__45180_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__45180_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__45190){
...
var tag = first__45193;
var content = seq__45192__$1;
...
var vec__45194 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45194,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45194,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45194,(2),null);
