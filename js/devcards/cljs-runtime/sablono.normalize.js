...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34432){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34443,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34443;
}
});
...
var len__4789__auto___34524 = arguments.length;
var i__4790__auto___34525 = (0);
while(true){
if((i__4790__auto___34525 < len__4789__auto___34524)){
args__4795__auto__.push((arguments[i__4790__auto___34525]));

var G__34527 = (i__4790__auto___34525 + (1));
i__4790__auto___34525 = G__34527;
continue;
} else {
}
break;
...
var G__34455 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34455,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34455;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34453){
...
var vec__34466 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34470 = cljs.core.ffirst(matches);
var fexpr__34469 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34466,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34466,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34460_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34460_SHARP_))){
return p1__34460_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34461_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34461_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34494){
var vec__34497 = p__34494;
var seq__34498 = cljs.core.seq(vec__34497);
var first__34499 = cljs.core.first(seq__34498);
var seq__34498__$1 = cljs.core.next(seq__34498);
var tag = first__34499;
var content = seq__34498__$1;
