...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34456){
...
var vec__34498 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34505 = cljs.core.ffirst(matches);
var fexpr__34504 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34504.cljs$core$IFn$_invoke$arity$1 ? fexpr__34504.cljs$core$IFn$_invoke$arity$1(G__34505) : fexpr__34504.call(null,G__34505));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34498,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34498,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34495_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34495_SHARP_))){
return p1__34495_SHARP_;
} else {
return null;
}
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34527){
...
var tag = first__34530;
var content = seq__34529__$1;
...
var vec__34535 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34535,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34535,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34535,(2),null);
