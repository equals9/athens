...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34451_SHARP_){
return (((p1__34451_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34451_SHARP_ === 'string'));
}),class$)))){
...
var len__4789__auto___34551 = arguments.length;
var i__4790__auto___34552 = (0);
while(true){
if((i__4790__auto___34552 < len__4789__auto___34551)){
args__4795__auto__.push((arguments[i__4790__auto___34552]));

var G__34553 = (i__4790__auto___34552 + (1));
i__4790__auto___34552 = G__34553;
continue;
} else {
}
break;
...
var G__34478 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34478,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34478;
}
} else {
...
var vec__34486 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34491 = cljs.core.ffirst(matches);
var fexpr__34490 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
...
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34486,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34483_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34483_SHARP_))){
return p1__34483_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34484_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34484_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34516){
...
var tag = first__34520;
var content = seq__34519__$1;
