...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34434_SHARP_){
return (((p1__34434_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34434_SHARP_ === 'string'));
}),class$)))){
...
var G__34520 = (i__4790__auto___34519 + (1));
i__4790__auto___34519 = G__34520;
continue;
} else {
}
break;
...
var G__34444 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34444,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34444;
}
} else {
...
var vec__34457 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34462 = cljs.core.ffirst(matches);
var fexpr__34461 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34461.cljs$core$IFn$_invoke$arity$1 ? fexpr__34461.cljs$core$IFn$_invoke$arity$1(G__34462) : fexpr__34461.call(null,G__34462));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34457,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34457,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34455_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34455_SHARP_))){
return p1__34455_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34456_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34456_SHARP_));
...
var tag = first__34490;
var content = seq__34489__$1;
