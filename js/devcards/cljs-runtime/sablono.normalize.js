...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34464){
var vec__34465 = p__34464;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34465,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34465,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34483_SHARP_){
return (((p1__34483_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34483_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34492,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34492;
}
});
...
var len__4789__auto___34586 = arguments.length;
var i__4790__auto___34587 = (0);
while(true){
if((i__4790__auto___34587 < len__4789__auto___34586)){
args__4795__auto__.push((arguments[i__4790__auto___34587]));

var G__34590 = (i__4790__auto___34587 + (1));
i__4790__auto___34587 = G__34590;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34497){
...
var vec__34518 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34524 = cljs.core.ffirst(matches);
var fexpr__34522 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34522.cljs$core$IFn$_invoke$arity$1 ? fexpr__34522.cljs$core$IFn$_invoke$arity$1(G__34524) : fexpr__34522.call(null,G__34524));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34518,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34518,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34515_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34515_SHARP_))){
return p1__34515_SHARP_;
} else {
return null;
}
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34557){
var vec__34558 = p__34557;
var seq__34559 = cljs.core.seq(vec__34558);
var first__34560 = cljs.core.first(seq__34559);
var seq__34559__$1 = cljs.core.next(seq__34559);
var tag = first__34560;
var content = seq__34559__$1;
...
var vec__34564 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34564,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34564,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34564,(2),null);
