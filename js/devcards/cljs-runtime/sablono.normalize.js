...
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39091,(0),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__39096_SHARP_){
return (((p1__39096_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__39096_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__39100,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__39100;
}
});
...
var G__39143 = (i__4790__auto___39141 + (1));
i__4790__auto___39141 = G__39143;
continue;
} else {
}
break;
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq39102){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq39102));
}));
...
var vec__39112 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__39117 = cljs.core.ffirst(matches);
var fexpr__39116 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__39116.cljs$core$IFn$_invoke$arity$1 ? fexpr__39116.cljs$core$IFn$_invoke$arity$1(G__39117) : fexpr__39116.call(null,G__39117));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39112,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39112,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__39110_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__39110_SHARP_))){
return p1__39110_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__39111_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__39111_SHARP_));
...
var vec__39130 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39130,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39130,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39130,(2),null);
