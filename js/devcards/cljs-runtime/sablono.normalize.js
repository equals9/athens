...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$1((function (p__34508){
var vec__34509 = p__34508;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34509,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34509,(1),null);
...
if(((((cljs.core.set_QMARK_(class$)) || (cljs.core.sequential_QMARK_(class$)))) && (cljs.core.every_QMARK_((function (p1__34516_SHARP_){
return (((p1__34516_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__34516_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__34540,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__34540;
}
});
...
var len__4789__auto___34636 = arguments.length;
var i__4790__auto___34638 = (0);
while(true){
if((i__4790__auto___34638 < len__4789__auto___34636)){
args__4795__auto__.push((arguments[i__4790__auto___34638]));

var G__34640 = (i__4790__auto___34638 + (1));
i__4790__auto___34638 = G__34640;
continue;
} else {
}
break;
...
var G__34548 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_(classes)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34548,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec(classes));
} else {
return G__34548;
}
} else {
...
/** @this {Function} */
(sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq34543){
...
var vec__34558 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2(["Can't match CSS tag: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"tag","tag",-1290361223),s], null))})():(cljs.core.truth_((function (){var G__34562 = cljs.core.ffirst(matches);
var fexpr__34561 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null);
return (fexpr__34561.cljs$core$IFn$_invoke$arity$1 ? fexpr__34561.cljs$core$IFn$_invoke$arity$1(G__34562) : fexpr__34561.call(null,G__34562));
...
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34558,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34558,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css(cljs.core.some((function (p1__34553_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__34553_SHARP_))){
return p1__34553_SHARP_;
} else {
return null;
}
}),names)),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p1__34555_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__34555_SHARP_));
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__34611){
var vec__34612 = p__34611;
var seq__34613 = cljs.core.seq(vec__34612);
var first__34614 = cljs.core.first(seq__34613);
var seq__34613__$1 = cljs.core.next(seq__34613);
var tag = first__34614;
var content = seq__34613__$1;
...
var vec__34617 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34617,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34617,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34617,(2),null);
