...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__61612,idx,id){
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61613__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__61615,id){
...
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61616__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__61618,id){
...
var map__61621 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61621__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61625__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__61627 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61627,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61627,(1),null);
...
var map__61632 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61632__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__61633 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61633__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__61630_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__61630_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__61631_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__61631_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__61636(s__61637){
return (new cljs.core.LazySeq(null,(function (){
var s__61637__$1 = s__61637;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__61637__$1);
if(temp__5735__auto__){
var s__61637__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__61637__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__61637__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__61639 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__61638 = (0);
while(true){
if((i__61638 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__61638);
cljs.core.chunk_append(b__61639,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__61654 = (i__61638 + (1));
i__61638 = G__61654;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__61639),athens$devcards$sci_boxes$box_component_$_iter__61636(cljs.core.chunk_rest(s__61637__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__61639),null);
}
} else {
var id__$1 = cljs.core.first(s__61637__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__61636(cljs.core.rest(s__61637__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640 = (function (meta61641){
this.meta61641 = meta61641;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61642,meta61641__$1){
var self__ = this;
var _61642__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640(meta61641__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61642){
var self__ = this;
var _61642__$1 = this;
return self__.meta61641;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42491__auto__,devcard_opts__42492__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61640");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61640");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes61640.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes61640 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes61640(meta61641){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640(meta61641));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes61640(null));
})()
