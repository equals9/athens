...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4529__auto__ = (function athens$devcards$sci_boxes$iter__60181(s__60182){
return (new cljs.core.LazySeq(null,(function (){
var s__60182__$1 = s__60182;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60182__$1);
if(temp__5735__auto__){
var s__60182__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60182__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__60182__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__60184 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__60183 = (0);
while(true){
if((i__60183 < size__4528__auto__)){
var vec__60185 = cljs.core._nth(c__4527__auto__,i__60183);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60185,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60185,(1),null);
cljs.core.chunk_append(b__60184,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__60235 = (i__60183 + (1));
i__60183 = G__60235;
continue;
} else {
return true;
...
return cljs.core.some((function (p__60191){
var vec__60192 = p__60191;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60192,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60192,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__60195){
...
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__60198,parent){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60199__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
}catch (e60201){if((e60201 instanceof Error)){
var e = e60201;
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60202_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60202_SHARP_) : visited.call(null,p1__60202_SHARP_)))){
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60203_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60203_SHARP_) : visited.call(null,p1__60203_SHARP_)))){
return p1__60203_SHARP_;
} else {
return null;
}
}),siblings);
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60204,idx,id){
...
var box = map__60205__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60205__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60207,id){
...
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60208__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60210,id){
...
var state = map__60211__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60211__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60213 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60213__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__60216_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__60216_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__60217 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60219 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60219,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60219,(1),null);
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232 = (function (meta60233){
this.meta60233 = meta60233;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60234,meta60233__$1){
var self__ = this;
var _60234__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232(meta60233__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60234){
var self__ = this;
var _60234__$1 = this;
return self__.meta60233;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__47717__auto__,devcard_opts__47718__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60232");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60232");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60232.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60232 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60232(meta60233){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232(meta60233));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60232(null));
})()
