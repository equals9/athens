...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__60291(s__60292){
...
var vec__60295 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60293);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60295,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60295,(1),null);
cljs.core.chunk_append(b__60294,cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)));

var G__60345 = (i__60293 + (1));
i__60293 = G__60345;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60294),athens$devcards$sci_boxes$iter__60291(cljs.core.chunk_rest(s__60292__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60294),null);
}
} else {
var vec__60298 = cljs.core.first(s__60292__$2);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60298,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60298,(1),null);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)),athens$devcards$sci_boxes$iter__60291(cljs.core.rest(s__60292__$2)));
}
} else {
return null;
}
...
return cljs.core.some((function (p__60301){
var vec__60302 = p__60301;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60302,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60302,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__60305){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60306__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
return clojure.string.starts_with_QMARK_(str_content,":sci");
});
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__60308,parent){
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60312_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60312_SHARP_) : visited.call(null,p1__60312_SHARP_)))){
return p1__60312_SHARP_;
} else {
return null;
}
}),children);
...
var temp__5733__auto____$1 = cljs.core.some((function (p1__60313_SHARP_){
if(cljs.core.not((visited.cljs$core$IFn$_invoke$arity$1 ? visited.cljs$core$IFn$_invoke$arity$1(p1__60313_SHARP_) : visited.call(null,p1__60313_SHARP_)))){
return p1__60313_SHARP_;
} else {
return null;
}
}),siblings);
...
var G__60346 = boxes_SINGLEQUOTE_;
var G__60347 = visited_SINGLEQUOTE_;
var G__60348 = id_SINGLEQUOTE_;
boxes__$1 = G__60346;
visited = G__60347;
id = G__60348;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60314,idx,id){
...
var box = map__60315__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60315__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60317,id){
...
var state = map__60318__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60318__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60318__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60320,id){
...
var state = map__60321__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60321__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60323 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60323__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__60326_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__60326_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60327__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60329 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60329,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60329,(1),null);
...
var map__60334 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60334__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var map__60335 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__60335__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60335__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60335__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60335__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__60332_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__60332_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__60333_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__60333_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__60338(s__60339){
return (new cljs.core.LazySeq(null,(function (){
...
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60340);
cljs.core.chunk_append(b__60341,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__60350 = (i__60340 + (1));
i__60340 = G__60350;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60341),athens$devcards$sci_boxes$box_component_$_iter__60338(cljs.core.chunk_rest(s__60339__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60341),null);
}
} else {
var id__$1 = cljs.core.first(s__60339__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__60338(cljs.core.rest(s__60339__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342 = (function (meta60343){
this.meta60343 = meta60343;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60344,meta60343__$1){
var self__ = this;
var _60344__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342(meta60343__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60344){
var self__ = this;
var _60344__$1 = this;
return self__.meta60343;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.getBasis = (function (){
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60342");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60342");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60342.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60342 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60342(meta60343){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342(meta60343));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60342(null));
})()
