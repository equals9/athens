...
return devcards.core.card_base(new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"name","name",1843675177),"sci-examples",new cljs.core.Keyword(null,"documentation","documentation",1889593999),null,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$iter__60173(s__60174){
return (new cljs.core.LazySeq(null,(function (){
var s__60174__$1 = s__60174;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60174__$1);
if(temp__5735__auto__){
var s__60174__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60174__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60174__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60176 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60175 = (0);
while(true){
if((i__60175 < size__4581__auto__)){
var vec__60177 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60175);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60177,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60177,(1),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60176),athens$devcards$sci_boxes$iter__60173(cljs.core.chunk_rest(s__60174__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60176),null);
}
} else {
var vec__60180 = cljs.core.first(s__60174__$2);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60180,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60180,(1),null);
return cljs.core.cons(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),s,new cljs.core.Keyword(null,"result","result",1415092211),sci.core.eval_string.cljs$core$IFn$_invoke$arity$2(s,opts)], null),(cljs.core.truth_(opts)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"opts","opts",155075701),opts], null):null)], 0)),athens$devcards$sci_boxes$iter__60173(cljs.core.rest(s__60174__$2)));
}
} else {
return null;
}
...
return cljs.core.some((function (p__60183){
var vec__60184 = p__60183;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60184,(0),null);
var box = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60184,(1),null);
...
athens.devcards.sci_boxes.sci_node_QMARK_ = (function athens$devcards$sci_boxes$sci_node_QMARK_(p__60187){
...
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60188__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
return clojure.string.starts_with_QMARK_(str_content,":sci");
});
athens.devcards.sci_boxes.eval_box = (function athens$devcards$sci_boxes$eval_box(p__60190,parent){
var map__60191 = p__60190;
...
var box = map__60191__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60191__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
...
}catch (e60193){if((e60193 instanceof Error)){
var e = e60193;
...
var G__60228 = boxes_SINGLEQUOTE_;
var G__60229 = visited_SINGLEQUOTE_;
var G__60230 = id_SINGLEQUOTE_;
boxes__$1 = G__60228;
visited = G__60229;
id = G__60230;
continue;
...
athens.devcards.sci_boxes.add_child = (function athens$devcards$sci_boxes$add_child(p__60196,idx,id){
...
var box = map__60197__$1;
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60197__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var new_idx = (idx + (1));
...
athens.devcards.sci_boxes.add_sibling = (function athens$devcards$sci_boxes$add_sibling(p__60199,id){
...
var state = map__60200__$1;
var next_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60200__$1,new cljs.core.Keyword(null,"next-id","next-id",-224240762));
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60200__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
...
athens.devcards.sci_boxes.delete_box = (function athens$devcards$sci_boxes$delete_box(p__60202,id){
...
var state = map__60203__$1;
var boxes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60203__$1,new cljs.core.Keyword(null,"boxes","boxes",-420813822));
var parent_id = athens.devcards.sci_boxes.get_parent_id(boxes,id);
...
var map__60205 = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"boxes","boxes",-420813822),id], null));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(athens.devcards.sci_boxes.box_state_STAR_,(function (p1__60208_SHARP_){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$5(p1__60208_SHARP_,new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.update_box_content,id,value),new cljs.core.Keyword(null,"boxes","boxes",-420813822),athens.devcards.sci_boxes.eval_all_boxes);
}));
});
athens.devcards.sci_boxes.sci_result_component = (function athens$devcards$sci_boxes$sci_result_component(result){
if(cljs.core.truth_(result)){
var map__60209 = result;
...
var hiccup = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60209__$1,new cljs.core.Keyword(null,"hiccup","hiccup",1218876238));
...
var vec__60211 = cljs.core.deref(err_STAR_);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60211,(0),null);
var info = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60211,(1),null);
...
var map__60216 = cljs.core.deref(athens.devcards.sci_boxes.box_state_STAR_);
...
var map__60217 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(boxes,id);
...
var box = map__60217__$1;
var str_content = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"str-content","str-content",297549190));
var children_ids = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"children-ids","children-ids",-293558198));
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"result","result",1415092211));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"display","display",242065432),"flex"], null)], null),id,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"textarea","textarea",-650375824),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"font-size","font-size",-1847940346),"1rem",new cljs.core.Keyword(null,"width","width",-384071477),"30rem"], null),new cljs.core.Keyword(null,"value","value",305978217),str_content,new cljs.core.Keyword(null,"on-change","on-change",-732046149),(function (p1__60214_SHARP_){
return athens.devcards.sci_boxes.handle_box_change_BANG_(p1__60214_SHARP_,id);
}),new cljs.core.Keyword(null,"on-key-down","on-key-down",-1374733765),(function (p1__60215_SHARP_){
return athens.devcards.sci_boxes.handle_box_key_down_BANG_(p1__60215_SHARP_,id);
})], null)], null),((athens.devcards.sci_boxes.sci_node_QMARK_(box))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.sci_result_wrapper,result], null):null)], null),((cljs.core.seq(children_ids))?cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"margin-left","margin-left",2015598377),"1rem"], null)], null)], null),(function (){var iter__4582__auto__ = (function athens$devcards$sci_boxes$box_component_$_iter__60220(s__60221){
return (new cljs.core.LazySeq(null,(function (){
var s__60221__$1 = s__60221;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__60221__$1);
if(temp__5735__auto__){
var s__60221__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__60221__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__60221__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__60223 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__60222 = (0);
while(true){
if((i__60222 < size__4581__auto__)){
var id__$1 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__60222);
cljs.core.chunk_append(b__60223,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null));

var G__60232 = (i__60222 + (1));
i__60222 = G__60232;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__60223),athens$devcards$sci_boxes$box_component_$_iter__60220(cljs.core.chunk_rest(s__60221__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__60223),null);
}
} else {
var id__$1 = cljs.core.first(s__60221__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.sci_boxes.box_component,id__$1], null),athens$devcards$sci_boxes$box_component_$_iter__60220(cljs.core.rest(s__60221__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.sci_boxes !== 'undefined') && (typeof athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224 !== 'undefined')){
} else {
...
*/
athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224 = (function (meta60225){
this.meta60225 = meta60225;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60226,meta60225__$1){
var self__ = this;
var _60226__$1 = this;
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224(meta60225__$1));
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60226){
var self__ = this;
var _60226__$1 = this;
return self__.meta60225;
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60225","meta60225",-1808185088,null)], null);
}));

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.cljs$lang$type = true);

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.cljs$lang$ctorStr = "athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60224");

(athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60224");
}));

/**
 * Positional factory function for athens.devcards.sci-boxes/t_athens$devcards$sci_boxes60224.
 */
athens.devcards.sci_boxes.__GT_t_athens$devcards$sci_boxes60224 = (function athens$devcards$sci_boxes$__GT_t_athens$devcards$sci_boxes60224(meta60225){
return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224(meta60225));
});

}

return (new athens.devcards.sci_boxes.t_athens$devcards$sci_boxes60224(null));
})()
