...
var G__20236 = cljs.core.first(matches);
...
while(true){
if((!((coll__$1 == null)))){
var G__20277 = sb.append(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(coll__$1)));
var G__20278 = cljs.core.next(coll__$1);
sb = G__20277;
coll__$1 = G__20278;
continue;
} else {
...
var G__20255 = goog.string.makeSafe(s);
return goog.string.isEmptyOrWhitespace(G__20255);
});
/**
