...
var vec__30850 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str__$1,/-/);
...
var start = first__30852;
var parts = seq__30851__$1;
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.str,start,cljs.core.map.cljs$core$IFn$_invoke$arity$2(reagent.impl.util.capitalize,parts));
}
});
...
var self__ = this;
var self__ = this;
var G__30879 = (arguments.length - (1));
switch (G__30879) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args30875){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args30875)));
}));
...
args_arr__4757__auto__.push((arguments[i__4737__auto___31022]));

var G__31025 = (i__4737__auto___31022 + (1));
i__4737__auto___31022 = G__31025;
continue;
} else {
}
break;
