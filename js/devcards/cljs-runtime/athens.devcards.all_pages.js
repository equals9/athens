...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55597 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55597 = (function (meta55598){
this.meta55598 = meta55598;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55597.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55599,meta55598__$1){
var self__ = this;
var _55599__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55597(meta55598__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55599){
var self__ = this;
var _55599__$1 = this;
return self__.meta55598;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55597.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55598","meta55598",-1462063553,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55597");

(athens.devcards.all_pages.t_athens$devcards$all_pages55597.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55597");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55597.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55597 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55597(meta55598){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55597(meta55598));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55597(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
