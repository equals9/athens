...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55664 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55664 = (function (meta55665){
this.meta55665 = meta55665;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55664.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55666,meta55665__$1){
var self__ = this;
var _55666__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55664(meta55665__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55666){
var self__ = this;
var _55666__$1 = this;
return self__.meta55665;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42236__auto__,devcard_opts__42237__auto__){
var self__ = this;
var this__42236__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55664.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55665","meta55665",-1622944045,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55664");

(athens.devcards.all_pages.t_athens$devcards$all_pages55664.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55664");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55664.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55664 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55664(meta55665){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55664(meta55665));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55664(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.all_pages !== 'undefined') && (typeof athens.devcards.all_pages.t_athens$devcards$all_pages55676 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.all_pages.t_athens$devcards$all_pages55676 = (function (meta55677){
this.meta55677 = meta55677;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.all_pages.t_athens$devcards$all_pages55676.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_55678,meta55677__$1){
var self__ = this;
var _55678__$1 = this;
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55676(meta55677__$1));
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_55678){
var self__ = this;
var _55678__$1 = this;
return self__.meta55677;
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42236__auto__,devcard_opts__42237__auto__){
var self__ = this;
var this__42236__auto____$1 = this;
...
(athens.devcards.all_pages.t_athens$devcards$all_pages55676.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta55677","meta55677",589368895,null)], null);
}));

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.cljs$lang$type = true);

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.cljs$lang$ctorStr = "athens.devcards.all-pages/t_athens$devcards$all_pages55676");

(athens.devcards.all_pages.t_athens$devcards$all_pages55676.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.all-pages/t_athens$devcards$all_pages55676");
}));

/**
 * Positional factory function for athens.devcards.all-pages/t_athens$devcards$all_pages55676.
 */
athens.devcards.all_pages.__GT_t_athens$devcards$all_pages55676 = (function athens$devcards$all_pages$__GT_t_athens$devcards$all_pages55676(meta55677){
return (new athens.devcards.all_pages.t_athens$devcards$all_pages55676(meta55677));
});

}

return (new athens.devcards.all_pages.t_athens$devcards$all_pages55676(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
