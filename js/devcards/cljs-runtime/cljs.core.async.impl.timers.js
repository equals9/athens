...
var i_40864 = (self__.level + (1));
while(true){
if((i_40864 <= (new_level + (1)))){
(update[i_40864] = self__.header);

var G__40869 = (i_40864 + (1));
i_40864 = G__40869;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_40877 = (update[i]).forward;
(x__$2.forward[i] = (links_40877[i]));
