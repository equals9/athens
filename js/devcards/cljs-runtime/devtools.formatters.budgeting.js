...
var G__24096 = data;
var target__20860__auto__ = G__24096;
if(cljs.core.truth_(target__20860__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24096)].join(''),"\n","target__20860__auto__"].join('')));
}

(target__20860__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
