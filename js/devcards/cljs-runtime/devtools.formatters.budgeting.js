...
var o__20569__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20569__auto__["add"]).call(o__20569__auto__,value);
}
});
...
var o__20569__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20569__auto__["delete"]).call(o__20569__auto__,value);
}
});
...
var o__20569__auto__ = devtools.formatters.budgeting.over_budget_values;
return (o__20569__auto__["has"]).call(o__20569__auto__,value);
}
});
...
var G__23799 = data;
var target__20574__auto__ = G__23799;
if(cljs.core.truth_(target__20574__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__23799)].join(''),"\n","target__20574__auto__"].join('')));
}

(target__20574__auto__["config"] = devtools.formatters.state.set_depth_budget(config,depth_budget));
