...
var temp__5733__auto___20681 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20681)){
var seen_errors_20682 = temp__5733__auto___20681;
if(cljs.core.truth_(seen_errors_20682.has(self))){
} else {
seen_errors_20682.add(self);

var temp__5735__auto___20683 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20683)){
var sense_20684 = temp__5735__auto___20683;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20684)].join(''));
} else {
}
}
} else {
