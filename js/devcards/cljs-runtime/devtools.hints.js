...
var G__20766 = cljs.core.PersistentArrayMap.EMPTY;
var G__20767 = native_stack_trace;
var G__20768 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20769 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20766,G__20767,G__20768,G__20769) : cljs.stacktrace.parse_stacktrace.call(null,G__20766,G__20767,G__20768,G__20769));
});
...
var map__20773 = top_item;
var map__20773__$1 = (((((!((map__20773 == null))))?(((((map__20773.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20773.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__20773):map__20773);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20773__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20773__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20773__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20772){var _e = e20772;
return false;
}});
...
var seen_errors_20817 = temp__5733__auto___20813;
if(cljs.core.truth_(seen_errors_20817.has(self))){
} else {
seen_errors_20817.add(self);

var temp__5735__auto___20818 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20818)){
var sense_20819 = temp__5735__auto___20818;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20819)].join(''));
} else {
}
}
} else {
