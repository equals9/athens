...
var seen_errors_20765 = temp__5733__auto___20764;
if(cljs.core.truth_(seen_errors_20765.has(self))){
} else {
seen_errors_20765.add(self);

var temp__5735__auto___20766 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20766)){
var sense_20767 = temp__5735__auto___20766;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20767)].join(''));
} else {
}
}
} else {
