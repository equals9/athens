...
var temp__5733__auto___20956 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20956)){
var seen_errors_20957 = temp__5733__auto___20956;
if(cljs.core.truth_(seen_errors_20957.has(self))){
} else {
seen_errors_20957.add(self);

var temp__5735__auto___20960 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20960)){
var sense_20962 = temp__5735__auto___20960;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20962)].join(''));
} else {
}
}
} else {
