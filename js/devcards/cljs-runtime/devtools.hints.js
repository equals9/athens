...
var G__20698 = cljs.core.PersistentArrayMap.EMPTY;
var G__20699 = native_stack_trace;
var G__20700 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20701 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20698,G__20699,G__20700,G__20701) : cljs.stacktrace.parse_stacktrace.call(null,G__20698,G__20699,G__20700,G__20701));
});
...
var temp__5733__auto___20728 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20728)){
var seen_errors_20729 = temp__5733__auto___20728;
if(cljs.core.truth_(seen_errors_20729.has(self))){
} else {
seen_errors_20729.add(self);

var temp__5735__auto___20730 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20730)){
var sense_20731 = temp__5735__auto___20730;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20731)].join(''));
} else {
}
}
} else {
