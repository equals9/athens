...
var temp__5733__auto___20643 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20643)){
var seen_errors_20644 = temp__5733__auto___20643;
if(cljs.core.truth_(seen_errors_20644.has(self))){
} else {
seen_errors_20644.add(self);

var temp__5735__auto___20647 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20647)){
var sense_20648 = temp__5735__auto___20647;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20648)].join(''));
} else {
}
}
} else {
