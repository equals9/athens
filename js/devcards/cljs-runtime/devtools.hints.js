...
var temp__5733__auto___20790 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20790)){
var seen_errors_20791 = temp__5733__auto___20790;
if(cljs.core.truth_(seen_errors_20791.has(self))){
} else {
seen_errors_20791.add(self);

var temp__5735__auto___20792 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20792)){
var sense_20793 = temp__5735__auto___20792;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20793)].join(''));
} else {
}
}
} else {
