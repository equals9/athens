...
var temp__5733__auto___20924 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20924)){
var seen_errors_20926 = temp__5733__auto___20924;
if(cljs.core.truth_(seen_errors_20926.has(self))){
} else {
seen_errors_20926.add(self);

var temp__5735__auto___20927 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20927)){
var sense_20928 = temp__5735__auto___20927;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20928)].join(''));
} else {
}
}
} else {
