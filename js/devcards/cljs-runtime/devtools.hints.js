...
var temp__5733__auto___20720 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20720)){
var seen_errors_20721 = temp__5733__auto___20720;
if(cljs.core.truth_(seen_errors_20721.has(self))){
} else {
seen_errors_20721.add(self);

var temp__5735__auto___20722 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20722)){
var sense_20723 = temp__5735__auto___20722;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20723)].join(''));
} else {
}
}
} else {
