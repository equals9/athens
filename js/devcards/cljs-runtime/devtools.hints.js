...
var seen_errors_20758 = temp__5733__auto___20756;
if(cljs.core.truth_(seen_errors_20758.has(self))){
} else {
seen_errors_20758.add(self);

var temp__5735__auto___20760 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20760)){
var sense_20762 = temp__5735__auto___20760;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20762)].join(''));
} else {
}
}
} else {
