...
var temp__5733__auto___20883 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20883)){
var seen_errors_20884 = temp__5733__auto___20883;
if(cljs.core.truth_(seen_errors_20884.has(self))){
} else {
seen_errors_20884.add(self);

var temp__5735__auto___20885 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20885)){
var sense_20886 = temp__5735__auto___20885;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20886)].join(''));
} else {
}
}
} else {
