...
}catch (e20771){var _e = e20771;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20815 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20815)){
var seen_errors_20816 = temp__5733__auto___20815;
if(cljs.core.truth_(seen_errors_20816.has(self))){
} else {
seen_errors_20816.add(self);

var temp__5735__auto___20821 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20821)){
var sense_20822 = temp__5735__auto___20821;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20822)].join(''));
} else {
}
}
} else {
