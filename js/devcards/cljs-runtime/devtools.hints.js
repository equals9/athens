...
}catch (e20835){var _e = e20835;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20847 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20847)){
var seen_errors_20848 = temp__5733__auto___20847;
if(cljs.core.truth_(seen_errors_20848.has(self))){
} else {
seen_errors_20848.add(self);

var temp__5735__auto___20849 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20849)){
var sense_20850 = temp__5735__auto___20849;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20850)].join(''));
} else {
}
}
} else {
