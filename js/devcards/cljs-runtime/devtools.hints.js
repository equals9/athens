...
var G__20656 = cljs.core.PersistentArrayMap.EMPTY;
var G__20657 = native_stack_trace;
var G__20658 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20659 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20656,G__20657,G__20658,G__20659) : cljs.stacktrace.parse_stacktrace.call(null,G__20656,G__20657,G__20658,G__20659));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20662__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20662__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20662__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e20661){var _e = e20661;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___20696 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20696)){
var seen_errors_20698 = temp__5733__auto___20696;
if(cljs.core.truth_(seen_errors_20698.has(self))){
} else {
seen_errors_20698.add(self);

var temp__5735__auto___20700 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20700)){
var sense_20701 = temp__5735__auto___20700;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20701)].join(''));
} else {
}
}
} else {
