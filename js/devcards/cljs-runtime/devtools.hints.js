...
var G__20739 = native_stack_trace;
var G__20740 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20741 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20738,G__20739,G__20740,G__20741) : cljs.stacktrace.parse_stacktrace.call(null,G__20738,G__20739,G__20740,G__20741));
});
...
var seen_errors_20777 = temp__5733__auto___20776;
if(cljs.core.truth_(seen_errors_20777.has(self))){
} else {
seen_errors_20777.add(self);

var temp__5735__auto___20778 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20778)){
var sense_20779 = temp__5735__auto___20778;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20779)].join(''));
} else {
}
}
} else {
