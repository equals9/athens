...
var temp__5733__auto___20827 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20827)){
var seen_errors_20828 = temp__5733__auto___20827;
if(cljs.core.truth_(seen_errors_20828.has(self))){
} else {
seen_errors_20828.add(self);

var temp__5735__auto___20829 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20829)){
var sense_20830 = temp__5735__auto___20829;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20830)].join(''));
} else {
}
}
} else {
