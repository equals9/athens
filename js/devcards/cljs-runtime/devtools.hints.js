...
var temp__5733__auto___20966 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20966)){
var seen_errors_20967 = temp__5733__auto___20966;
if(cljs.core.truth_(seen_errors_20967.has(self))){
} else {
seen_errors_20967.add(self);

var temp__5735__auto___20968 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20968)){
var sense_20969 = temp__5735__auto___20968;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20969)].join(''));
} else {
}
}
} else {
