...
var seen_errors_20800 = temp__5733__auto___20799;
if(cljs.core.truth_(seen_errors_20800.has(self))){
} else {
seen_errors_20800.add(self);

var temp__5735__auto___20801 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20801)){
var sense_20802 = temp__5735__auto___20801;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20802)].join(''));
} else {
}
}
} else {
