...
return React.createElement("div",({"key": "breadcrumbs-templ", "className": "com-rigsomelight-devcards-card-base com-rigsomelight-devcards-breadcrumbs com-rigsomelight-devcards-typog"}),sablono.interpreter.interpret(cljs.core.rest(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(cljs.core.iterate(sep_fn,sep_fn(null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41272){
...
var attrs41282 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41286){
var vec__41287 = p__41286;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(0),null);
var child_tree = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41287,(1),null);
...
}),cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__41293){
...
})()].join('')}),(function (){var attrs41300 = (function (){var temp__5735__auto__ = devcards.system.breadcrumbs(data);
if(cljs.core.truth_(temp__5735__auto__)){
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$4(React.createElement,"div",((cljs.core.map_QMARK_(attrs41300))?sablono.interpreter.attributes(sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["com-rigsomelight-devcards-container"], null)], null),attrs41300], 0))):({"className": "com-rigsomelight-devcards-container"})),((cljs.core.map_QMARK_(attrs41300))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(devcards.system.display_single_card_QMARK_(data))?null:(function (){var dir_paths = devcards.system.display_dir_paths(data);
...
})()], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret(attrs41300),(cljs.core.truth_(devcards.system.display_single_card_QMARK_(data))?null:(function (){var dir_paths = devcards.system.display_dir_paths(data);
return sablono.interpreter.interpret(devcards.system.dir_links(dir_paths,state_atom));
...
cljs.core.async.impl.dispatch.run((function (){
var f__36986__auto__ = (function (){var switch__36917__auto__ = (function (state_41421){
var state_val_41422 = (state_41421[(1)]);
if((state_val_41422 === (7))){
var state_41421__$1 = state_41421;
var statearr_41424_41560 = state_41421__$1;
...
var state_41421__$1 = state_41421;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_41421__$1,(2),inst_41396);
} else {
if((state_val_41422 === (4))){
var inst_41419 = (state_41421[(2)]);
var state_41421__$1 = state_41421;
return cljs.core.async.impl.ioc_helpers.return_chan(state_41421__$1,inst_41419);
} else {
if((state_val_41422 === (6))){
var inst_41405 = (state_41421[(7)]);
...
var state_41421__$1 = state_41421;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_41421__$1,(9),inst_41408);
} else {
if((state_val_41422 === (3))){
var state_41421__$1 = state_41421;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_41421__$1,(5),channel);
} else {
if((state_val_41422 === (2))){
var inst_41398 = (state_41421[(2)]);
...
var state_41421__$1 = (function (){var statearr_41429 = state_41421;
...
var statearr_41430_41562 = state_41421__$1;
...
var statearr_41432_41564 = state_41421__$1;
...
var inst_41405 = (state_41421[(7)]);
var inst_41405__$1 = (state_41421[(2)]);
var state_41421__$1 = (function (){var statearr_41433 = state_41421;
(statearr_41433[(7)] = inst_41405__$1);

return statearr_41433;
})();
if(cljs.core.truth_(inst_41405__$1)){
var statearr_41434_41565 = state_41421__$1;
(statearr_41434_41565[(1)] = (6));

} else {
var statearr_41435_41566 = state_41421__$1;
...
var inst_41416 = (state_41421[(2)]);
var state_41421__$1 = state_41421;
var statearr_41436_41568 = state_41421__$1;
...
var devcards$system$start_ui_with_renderer_$_state_machine__36918__auto____1 = (function (state_41421){
while(true){
var ret_value__36919__auto__ = (function (){try{while(true){
var result__36920__auto__ = switch__36917__auto__(state_41421);
if(cljs.core.keyword_identical_QMARK_(result__36920__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
continue;
} else {
return result__36920__auto__;
...
var statearr_41440_41569 = state_41421;
(statearr_41440_41569[(5)] = ex__36921__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_41421);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__36919__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__41570 = state_41421;
state_41421 = G__41570;
continue;
} else {
return ret_value__36919__auto__;
}
...
devcards$system$start_ui_with_renderer_$_state_machine__36918__auto__ = function(state_41421){
switch(arguments.length){
case 0:
return devcards$system$start_ui_with_renderer_$_state_machine__36918__auto____0.call(this);
case 1:
return devcards$system$start_ui_with_renderer_$_state_machine__36918__auto____1.call(this,state_41421);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var state__36987__auto__ = (function (){var statearr_41443 = (f__36986__auto__.cljs$core$IFn$_invoke$arity$0 ? f__36986__auto__.cljs$core$IFn$_invoke$arity$0() : f__36986__auto__.call(null));
(statearr_41443[(6)] = c__36985__auto___41559);
...
(statearr_41473[(8)] = inst_41450);

(statearr_41473[(9)] = inst_41448);

(statearr_41473[(10)] = inst_41446);

return statearr_41473;
})();
var statearr_41475_41573 = state_41468__$1;
...
var statearr_41479_41576 = state_41468__$1;
(statearr_41479_41576[(1)] = (6));

} else {
var statearr_41480_41577 = state_41468__$1;
(statearr_41480_41577[(1)] = (7));
...
var statearr_41484_41586 = state_41468;
...
if(cljs.core.keyword_identical_QMARK_(ret_value__36919__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__41587 = state_41468;
state_41468 = G__41587;
continue;
} else {
return ret_value__36919__auto__;
}
