...
var _STAR_print_newline_STAR__orig_val__60643_60702 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60644_60703 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60645_60704 = true;
var _STAR_print_fn_STAR__temp_val__60646_60705 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60645_60704);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60646_60705);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(obj);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60644_60703);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60643_60702);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
}));
shadow.cljs.devtools.client.env.repl_error = (function shadow$cljs$devtools$client$env$repl_error(e){
var G__60647 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","invoke-error","repl/invoke-error",839951858),new cljs.core.Keyword(null,"error","error",-978969032),e.message], null);
if(cljs.core.truth_(e.hasOwnProperty("stack"))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60647,new cljs.core.Keyword(null,"stack","stack",-793405930),e.stack);
} else {
return G__60647;
}
});
...
var G__60650_60706 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","out","repl/out",-905715102),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60650_60706) : msg_fn.call(null,G__60650_60706));
...
while (G__60707__i < G__60707__a.length) {G__60707__a[G__60707__i] = arguments[G__60707__i + 0]; ++G__60707__i;}
  args = new cljs.core.IndexedSeq(G__60707__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_fn.cljs$lang$applyTo = (function (arglist__60708){
var args = cljs.core.seq(arglist__60708);
...
var G__60651_60709 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","err","repl/err",-2086562244),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60651_60709) : msg_fn.call(null,G__60651_60709));
...
while (G__60710__i < G__60710__a.length) {G__60710__a[G__60710__i] = arguments[G__60710__i + 0]; ++G__60710__i;}
  args = new cljs.core.IndexedSeq(G__60710__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_err_fn.cljs$lang$applyTo = (function (arglist__60711){
var args = cljs.core.seq(arglist__60711);
...
var _STAR_default_data_reader_fn_STAR__orig_val__60652 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
var _STAR_default_data_reader_fn_STAR__temp_val__60653 = (function (tag,value){
...
(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__temp_val__60653);

try{try{var msg_60712 = cljs.tools.reader.read_string.cljs$core$IFn$_invoke$arity$1(text);
shadow.cljs.devtools.client.env.repl_queue_arr.push((function (){
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(msg_60712,shadow.cljs.devtools.client.env.done_BANG_) : handler.call(null,msg_60712,shadow.cljs.devtools.client.env.done_BANG_));
}));
...
throw e;
}}finally {(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__orig_val__60652);
}});
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__60655,p__60656){
...
var log_missing_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60657__$1,new cljs.core.Keyword(null,"log-missing-fn","log-missing-fn",732676765));
var log_call_async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60657__$1,new cljs.core.Keyword(null,"log-call-async","log-call-async",183826192));
var log_call = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60657__$1,new cljs.core.Keyword(null,"log-call","log-call",412404391));
...
var fn_sym = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60658__$1,new cljs.core.Keyword(null,"fn-sym","fn-sym",1423988510));
var fn_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60658__$1,new cljs.core.Keyword(null,"fn-str","fn-str",-1348506402));
var async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60658__$1,new cljs.core.Keyword(null,"async","async",1050769601));
...
}catch (e60661){var ex = e60661;
console.warn("error when calling lifecycle function",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_sym),ex);

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
}});
});
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(failure_fn,p__60662){
...
var task = first__60665;
var remaining_tasks = seq__60664__$1;
if(cljs.core.truth_(task)){
try{var G__60667 = (function (){
return (shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2 ? shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2(failure_fn,remaining_tasks) : shadow.cljs.devtools.client.env.do_js_reload_STAR_.call(null,failure_fn,remaining_tasks));
});
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__60667) : task.call(null,G__60667));
}catch (e60666){var e = e60666;
...
(shadow.cljs.devtools.client.env.do_js_reload.cljs$core$IFn$_invoke$arity$4 = (function (p__60672,load_code_fn,complete_fn,failure_fn){
...
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60673__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60668_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60668_SHARP_);
}),new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),(function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__60669_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60669_SHARP_);
...
shadow.cljs.devtools.client.env.before_load_src = (function shadow$cljs$devtools$client$env$before_load_src(p__60675){
...
var src = map__60676__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60676__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60676__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cljs","cljs",1492417629),type)){
var seq__60678 = cljs.core.seq(goog.global.SHADOW_NS_RESET);
var chunk__60679 = null;
var count__60680 = (0);
var i__60681 = (0);
while(true){
if((i__60681 < count__60680)){
var x = chunk__60679.cljs$core$IIndexed$_nth$arity$2(null,i__60681);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60714 = seq__60678;
var G__60715 = chunk__60679;
var G__60716 = count__60680;
var G__60717 = (i__60681 + (1));
seq__60678 = G__60714;
chunk__60679 = G__60715;
count__60680 = G__60716;
i__60681 = G__60717;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60678);
if(temp__5735__auto__){
var seq__60678__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60678__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60678__$1);
var G__60718 = cljs.core.chunk_rest(seq__60678__$1);
var G__60719 = c__4609__auto__;
var G__60720 = cljs.core.count(c__4609__auto__);
var G__60721 = (0);
seq__60678 = G__60718;
chunk__60679 = G__60719;
count__60680 = G__60720;
i__60681 = G__60721;
continue;
} else {
var x = cljs.core.first(seq__60678__$1);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60722 = cljs.core.next(seq__60678__$1);
var G__60723 = null;
var G__60724 = (0);
var G__60725 = (0);
seq__60678 = G__60722;
chunk__60679 = G__60723;
count__60680 = G__60724;
i__60681 = G__60725;
continue;
}
} else {
...
var seq__60682 = cljs.core.seq(cljs.core.deref(shadow.cljs.devtools.client.env.custom_msg_subscribers_ref));
var chunk__60683 = null;
var count__60684 = (0);
var i__60685 = (0);
while(true){
if((i__60685 < count__60684)){
var vec__60694 = chunk__60683.cljs$core$IIndexed$_nth$arity$2(null,i__60685);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60694,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60694,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60697){var e_60726 = e60697;
console.warn("failed to handle custom msg",id,msg);
}

var G__60727 = seq__60682;
var G__60728 = chunk__60683;
var G__60729 = count__60684;
var G__60730 = (i__60685 + (1));
seq__60682 = G__60727;
chunk__60683 = G__60728;
count__60684 = G__60729;
i__60685 = G__60730;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60682);
if(temp__5735__auto__){
var seq__60682__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60682__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60682__$1);
var G__60731 = cljs.core.chunk_rest(seq__60682__$1);
var G__60732 = c__4609__auto__;
var G__60733 = cljs.core.count(c__4609__auto__);
var G__60734 = (0);
seq__60682 = G__60731;
chunk__60683 = G__60732;
count__60684 = G__60733;
i__60685 = G__60734;
continue;
} else {
var vec__60698 = cljs.core.first(seq__60682__$1);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60698,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60698,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60701){var e_60735 = e60701;
console.warn("failed to handle custom msg",id,msg);
}

var G__60736 = cljs.core.next(seq__60682__$1);
var G__60737 = null;
var G__60738 = (0);
var G__60739 = (0);
seq__60682 = G__60736;
chunk__60683 = G__60737;
count__60684 = G__60738;
i__60685 = G__60739;
continue;
}
} else {
