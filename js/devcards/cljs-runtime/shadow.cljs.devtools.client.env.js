...
var _STAR_print_newline_STAR__orig_val__60610_60669 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60611_60670 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60612_60671 = true;
var _STAR_print_fn_STAR__temp_val__60613_60672 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60612_60671);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60613_60672);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(obj);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60611_60670);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60610_60669);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
}));
shadow.cljs.devtools.client.env.repl_error = (function shadow$cljs$devtools$client$env$repl_error(e){
var G__60614 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","invoke-error","repl/invoke-error",839951858),new cljs.core.Keyword(null,"error","error",-978969032),e.message], null);
if(cljs.core.truth_(e.hasOwnProperty("stack"))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60614,new cljs.core.Keyword(null,"stack","stack",-793405930),e.stack);
} else {
return G__60614;
}
});
...
var G__60617_60673 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","out","repl/out",-905715102),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60617_60673) : msg_fn.call(null,G__60617_60673));
...
var G__60674__i = 0, G__60674__a = new Array(arguments.length -  0);
while (G__60674__i < G__60674__a.length) {G__60674__a[G__60674__i] = arguments[G__60674__i + 0]; ++G__60674__i;}
  args = new cljs.core.IndexedSeq(G__60674__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_fn.cljs$lang$applyTo = (function (arglist__60675){
var args = cljs.core.seq(arglist__60675);
...
var G__60618_60676 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","err","repl/err",-2086562244),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60618_60676) : msg_fn.call(null,G__60618_60676));
...
var args = null;
if (arguments.length > 0) {
var G__60677__i = 0, G__60677__a = new Array(arguments.length -  0);
while (G__60677__i < G__60677__a.length) {G__60677__a[G__60677__i] = arguments[G__60677__i + 0]; ++G__60677__i;}
  args = new cljs.core.IndexedSeq(G__60677__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_err_fn.cljs$lang$applyTo = (function (arglist__60678){
var args = cljs.core.seq(arglist__60678);
...
var _STAR_default_data_reader_fn_STAR__orig_val__60619 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
var _STAR_default_data_reader_fn_STAR__temp_val__60620 = (function (tag,value){
...
(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__temp_val__60620);

try{try{var msg_60679 = cljs.tools.reader.read_string.cljs$core$IFn$_invoke$arity$1(text);
shadow.cljs.devtools.client.env.repl_queue_arr.push((function (){
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(msg_60679,shadow.cljs.devtools.client.env.done_BANG_) : handler.call(null,msg_60679,shadow.cljs.devtools.client.env.done_BANG_));
}));
...
throw e;
}}finally {(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__orig_val__60619);
}});
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__60622,p__60623){
...
var log_missing_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60624__$1,new cljs.core.Keyword(null,"log-missing-fn","log-missing-fn",732676765));
var log_call_async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60624__$1,new cljs.core.Keyword(null,"log-call-async","log-call-async",183826192));
var log_call = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60624__$1,new cljs.core.Keyword(null,"log-call","log-call",412404391));
...
var fn_sym = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60625__$1,new cljs.core.Keyword(null,"fn-sym","fn-sym",1423988510));
var fn_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60625__$1,new cljs.core.Keyword(null,"fn-str","fn-str",-1348506402));
var async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60625__$1,new cljs.core.Keyword(null,"async","async",1050769601));
...
}catch (e60628){var ex = e60628;
console.warn("error when calling lifecycle function",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_sym),ex);

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
}});
});
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(failure_fn,p__60629){
...
var task = first__60632;
var remaining_tasks = seq__60631__$1;
if(cljs.core.truth_(task)){
try{var G__60634 = (function (){
return (shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2 ? shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2(failure_fn,remaining_tasks) : shadow.cljs.devtools.client.env.do_js_reload_STAR_.call(null,failure_fn,remaining_tasks));
});
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__60634) : task.call(null,G__60634));
...
(shadow.cljs.devtools.client.env.do_js_reload.cljs$core$IFn$_invoke$arity$4 = (function (p__60639,load_code_fn,complete_fn,failure_fn){
...
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60640__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60635_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60635_SHARP_);
}),new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),(function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__60636_SHARP_){
...
shadow.cljs.devtools.client.env.before_load_src = (function shadow$cljs$devtools$client$env$before_load_src(p__60642){
...
var src = map__60643__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60643__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60643__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cljs","cljs",1492417629),type)){
var seq__60645 = cljs.core.seq(goog.global.SHADOW_NS_RESET);
var chunk__60646 = null;
var count__60647 = (0);
var i__60648 = (0);
while(true){
if((i__60648 < count__60647)){
var x = chunk__60646.cljs$core$IIndexed$_nth$arity$2(null,i__60648);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60681 = seq__60645;
var G__60682 = chunk__60646;
var G__60683 = count__60647;
var G__60684 = (i__60648 + (1));
seq__60645 = G__60681;
chunk__60646 = G__60682;
count__60647 = G__60683;
i__60648 = G__60684;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60645);
if(temp__5735__auto__){
var seq__60645__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60645__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60645__$1);
var G__60685 = cljs.core.chunk_rest(seq__60645__$1);
var G__60686 = c__4609__auto__;
var G__60687 = cljs.core.count(c__4609__auto__);
var G__60688 = (0);
seq__60645 = G__60685;
chunk__60646 = G__60686;
count__60647 = G__60687;
i__60648 = G__60688;
continue;
} else {
var x = cljs.core.first(seq__60645__$1);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60689 = cljs.core.next(seq__60645__$1);
var G__60690 = null;
var G__60691 = (0);
var G__60692 = (0);
seq__60645 = G__60689;
chunk__60646 = G__60690;
count__60647 = G__60691;
i__60648 = G__60692;
continue;
}
} else {
...
var seq__60649 = cljs.core.seq(cljs.core.deref(shadow.cljs.devtools.client.env.custom_msg_subscribers_ref));
var chunk__60650 = null;
var count__60651 = (0);
var i__60652 = (0);
while(true){
if((i__60652 < count__60651)){
var vec__60661 = chunk__60650.cljs$core$IIndexed$_nth$arity$2(null,i__60652);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60661,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60661,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60664){var e_60693 = e60664;
console.warn("failed to handle custom msg",id,msg);
}

var G__60694 = seq__60649;
var G__60695 = chunk__60650;
var G__60696 = count__60651;
var G__60697 = (i__60652 + (1));
seq__60649 = G__60694;
chunk__60650 = G__60695;
count__60651 = G__60696;
i__60652 = G__60697;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__60649);
if(temp__5735__auto__){
var seq__60649__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__60649__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__60649__$1);
var G__60698 = cljs.core.chunk_rest(seq__60649__$1);
var G__60699 = c__4609__auto__;
var G__60700 = cljs.core.count(c__4609__auto__);
var G__60701 = (0);
seq__60649 = G__60698;
chunk__60650 = G__60699;
count__60651 = G__60700;
i__60652 = G__60701;
continue;
} else {
var vec__60665 = cljs.core.first(seq__60649__$1);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60665,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60665,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60668){var e_60702 = e60668;
console.warn("failed to handle custom msg",id,msg);
}

var G__60703 = cljs.core.next(seq__60649__$1);
var G__60704 = null;
var G__60705 = (0);
var G__60706 = (0);
seq__60649 = G__60703;
chunk__60650 = G__60704;
count__60651 = G__60705;
i__60652 = G__60706;
continue;
}
} else {
