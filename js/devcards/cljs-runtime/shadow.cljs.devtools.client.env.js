...
var _STAR_print_newline_STAR__orig_val__60676_60735 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__60677_60736 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__60678_60737 = true;
var _STAR_print_fn_STAR__temp_val__60679_60738 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__60678_60737);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__60679_60738);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(obj);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__60677_60736);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__60676_60735);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
}));
shadow.cljs.devtools.client.env.repl_error = (function shadow$cljs$devtools$client$env$repl_error(e){
var G__60680 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","invoke-error","repl/invoke-error",839951858),new cljs.core.Keyword(null,"error","error",-978969032),e.message], null);
if(cljs.core.truth_(e.hasOwnProperty("stack"))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60680,new cljs.core.Keyword(null,"stack","stack",-793405930),e.stack);
} else {
return G__60680;
}
});
...
var G__60683_60739 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","out","repl/out",-905715102),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60683_60739) : msg_fn.call(null,G__60683_60739));
...
var G__60684_60742 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword("repl","err","repl/err",-2086562244),new cljs.core.Keyword(null,"text","text",-1790561697),clojure.string.join.cljs$core$IFn$_invoke$arity$2("",args)], null);
(msg_fn.cljs$core$IFn$_invoke$arity$1 ? msg_fn.cljs$core$IFn$_invoke$arity$1(G__60684_60742) : msg_fn.call(null,G__60684_60742));
...
var args = null;
if (arguments.length > 0) {
var G__60743__i = 0, G__60743__a = new Array(arguments.length -  0);
while (G__60743__i < G__60743__a.length) {G__60743__a[G__60743__i] = arguments[G__60743__i + 0]; ++G__60743__i;}
  args = new cljs.core.IndexedSeq(G__60743__a,0,null);
} 
...
shadow$cljs$devtools$client$env$set_print_fns_BANG__$_repl_print_err_fn.cljs$lang$applyTo = (function (arglist__60744){
var args = cljs.core.seq(arglist__60744);
...
var _STAR_default_data_reader_fn_STAR__orig_val__60685 = cljs.tools.reader._STAR_default_data_reader_fn_STAR_;
var _STAR_default_data_reader_fn_STAR__temp_val__60686 = (function (tag,value){
...
(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__temp_val__60686);

try{try{var msg_60745 = cljs.tools.reader.read_string.cljs$core$IFn$_invoke$arity$1(text);
shadow.cljs.devtools.client.env.repl_queue_arr.push((function (){
return (handler.cljs$core$IFn$_invoke$arity$2 ? handler.cljs$core$IFn$_invoke$arity$2(msg_60745,shadow.cljs.devtools.client.env.done_BANG_) : handler.call(null,msg_60745,shadow.cljs.devtools.client.env.done_BANG_));
}));

return shadow.cljs.devtools.client.env.process_next_BANG_();
}catch (e60687){var e = e60687;
console.warn("failed to parse websocket message",text,e);

throw e;
}}finally {(cljs.tools.reader._STAR_default_data_reader_fn_STAR_ = _STAR_default_data_reader_fn_STAR__orig_val__60685);
}});
shadow.cljs.devtools.client.env.make_task_fn = (function shadow$cljs$devtools$client$env$make_task_fn(p__60688,p__60689){
...
var log_missing_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60690__$1,new cljs.core.Keyword(null,"log-missing-fn","log-missing-fn",732676765));
var log_call_async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60690__$1,new cljs.core.Keyword(null,"log-call-async","log-call-async",183826192));
var log_call = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60690__$1,new cljs.core.Keyword(null,"log-call","log-call",412404391));
...
var fn_sym = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60691__$1,new cljs.core.Keyword(null,"fn-sym","fn-sym",1423988510));
var fn_str = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60691__$1,new cljs.core.Keyword(null,"fn-str","fn-str",-1348506402));
var async = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60691__$1,new cljs.core.Keyword(null,"async","async",1050769601));
...
}catch (e60694){var ex = e60694;
console.warn("error when calling lifecycle function",cljs.core.str.cljs$core$IFn$_invoke$arity$1(fn_sym),ex);

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
}});
});
shadow.cljs.devtools.client.env.do_js_reload_STAR_ = (function shadow$cljs$devtools$client$env$do_js_reload_STAR_(failure_fn,p__60695){
var vec__60696 = p__60695;
var seq__60697 = cljs.core.seq(vec__60696);
var first__60698 = cljs.core.first(seq__60697);
var seq__60697__$1 = cljs.core.next(seq__60697);
var task = first__60698;
var remaining_tasks = seq__60697__$1;
if(cljs.core.truth_(task)){
try{var G__60700 = (function (){
return (shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2 ? shadow.cljs.devtools.client.env.do_js_reload_STAR_.cljs$core$IFn$_invoke$arity$2(failure_fn,remaining_tasks) : shadow.cljs.devtools.client.env.do_js_reload_STAR_.call(null,failure_fn,remaining_tasks));
});
return (task.cljs$core$IFn$_invoke$arity$1 ? task.cljs$core$IFn$_invoke$arity$1(G__60700) : task.call(null,G__60700));
...
(shadow.cljs.devtools.client.env.do_js_reload.cljs$core$IFn$_invoke$arity$4 = (function (p__60705,load_code_fn,complete_fn,failure_fn){
...
var msg = map__60706__$1;
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60706__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var load_tasks = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__60701_SHARP_){
return shadow.cljs.devtools.client.env.make_task_fn(msg,p1__60701_SHARP_);
}),new cljs.core.Keyword(null,"before-load","before-load",-2060117064).cljs$core$IFn$_invoke$arity$1(reload_info)))),(function (next){
(load_code_fn.cljs$core$IFn$_invoke$arity$0 ? load_code_fn.cljs$core$IFn$_invoke$arity$0() : load_code_fn.call(null));

return (next.cljs$core$IFn$_invoke$arity$0 ? next.cljs$core$IFn$_invoke$arity$0() : next.call(null));
})),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__60702_SHARP_){
...
shadow.cljs.devtools.client.env.before_load_src = (function shadow$cljs$devtools$client$env$before_load_src(p__60708){
...
var src = map__60709__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60709__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60709__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"cljs","cljs",1492417629),type)){
var seq__60711 = cljs.core.seq(goog.global.SHADOW_NS_RESET);
var chunk__60712 = null;
var count__60713 = (0);
var i__60714 = (0);
while(true){
if((i__60714 < count__60713)){
var x = chunk__60712.cljs$core$IIndexed$_nth$arity$2(null,i__60714);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60747 = seq__60711;
var G__60748 = chunk__60712;
var G__60749 = count__60713;
var G__60750 = (i__60714 + (1));
seq__60711 = G__60747;
chunk__60712 = G__60748;
count__60713 = G__60749;
i__60714 = G__60750;
continue;
} else {
...
var G__60751 = cljs.core.chunk_rest(seq__60711__$1);
var G__60752 = c__4609__auto__;
var G__60753 = cljs.core.count(c__4609__auto__);
var G__60754 = (0);
seq__60711 = G__60751;
chunk__60712 = G__60752;
count__60713 = G__60753;
i__60714 = G__60754;
continue;
} else {
var x = cljs.core.first(seq__60711__$1);
(x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(ns) : x.call(null,ns));


var G__60755 = cljs.core.next(seq__60711__$1);
var G__60756 = null;
var G__60757 = (0);
var G__60758 = (0);
seq__60711 = G__60755;
chunk__60712 = G__60756;
count__60713 = G__60757;
i__60714 = G__60758;
continue;
}
} else {
...
var seq__60715 = cljs.core.seq(cljs.core.deref(shadow.cljs.devtools.client.env.custom_msg_subscribers_ref));
var chunk__60716 = null;
var count__60717 = (0);
var i__60718 = (0);
while(true){
if((i__60718 < count__60717)){
var vec__60727 = chunk__60716.cljs$core$IIndexed$_nth$arity$2(null,i__60718);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60727,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60727,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60730){var e_60759 = e60730;
console.warn("failed to handle custom msg",id,msg);
}

var G__60760 = seq__60715;
var G__60761 = chunk__60716;
var G__60762 = count__60717;
var G__60763 = (i__60718 + (1));
seq__60715 = G__60760;
chunk__60716 = G__60761;
count__60717 = G__60762;
i__60718 = G__60763;
continue;
} else {
...
var G__60764 = cljs.core.chunk_rest(seq__60715__$1);
var G__60765 = c__4609__auto__;
var G__60766 = cljs.core.count(c__4609__auto__);
var G__60767 = (0);
seq__60715 = G__60764;
chunk__60716 = G__60765;
count__60717 = G__60766;
i__60718 = G__60767;
continue;
} else {
var vec__60731 = cljs.core.first(seq__60715__$1);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60731,(0),null);
var callback = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60731,(1),null);
try{(callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(msg) : callback.call(null,msg));
}catch (e60734){var e_60768 = e60734;
console.warn("failed to handle custom msg",id,msg);
}

var G__60769 = cljs.core.next(seq__60715__$1);
var G__60770 = null;
var G__60771 = (0);
var G__60772 = (0);
seq__60715 = G__60769;
chunk__60716 = G__60770;
count__60717 = G__60771;
i__60718 = G__60772;
continue;
}
} else {
