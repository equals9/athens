...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.daily_notes !== 'undefined') && (typeof athens.devcards.daily_notes.t_athens$devcards$daily_notes58217 !== 'undefined')){
} else {
...
*/
athens.devcards.daily_notes.t_athens$devcards$daily_notes58217 = (function (meta58218){
this.meta58218 = meta58218;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58219,meta58218__$1){
var self__ = this;
var _58219__$1 = this;
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58217(meta58218__$1));
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58219){
var self__ = this;
var _58219__$1 = this;
return self__.meta58218;
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.getBasis = (function (){
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.cljs$lang$type = true);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.cljs$lang$ctorStr = "athens.devcards.daily-notes/t_athens$devcards$daily_notes58217");

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58217.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.daily-notes/t_athens$devcards$daily_notes58217");
}));

/**
 * Positional factory function for athens.devcards.daily-notes/t_athens$devcards$daily_notes58217.
 */
athens.devcards.daily_notes.__GT_t_athens$devcards$daily_notes58217 = (function athens$devcards$daily_notes$__GT_t_athens$devcards$daily_notes58217(meta58218){
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58217(meta58218));
});

}

return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58217(null));
})()
