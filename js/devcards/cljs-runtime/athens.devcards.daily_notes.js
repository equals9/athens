...
var daily_notes = cljs.core.deref((function (){var G__58239 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("daily-notes","items","daily-notes/items",227138573)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58239) : re_frame.core.subscribe.call(null,G__58239));
})());
...
if((delta < (1))){
var G__58240 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("daily-note","next","daily-note/next",-792628811),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$1(cljs.core.count(daily_notes))], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58240) : re_frame.core.dispatch.call(null,G__58240));
} else {
return null;
}
});
...
var note_refs = (function (){var G__58241 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("daily-notes","items","daily-notes/items",227138573)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58241) : re_frame.core.subscribe.call(null,G__58241));
})();
return (function (){
if(cljs.core.empty_QMARK_(cljs.core.deref(note_refs))){
var G__58242_58262 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("daily-note","next","daily-note/next",-792628811),athens.devcards.daily_notes.get_day.cljs$core$IFn$_invoke$arity$0()], null);
(re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58242_58262) : re_frame.core.dispatch.call(null,G__58242_58262));
} else {
}

var eids = (function (){var G__58243 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?e","?e",-1194391683,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__58244 = athens.db.dsdb;
var G__58245 = cljs.core.deref(note_refs);
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$3(G__58243,G__58244,G__58245) : posh.reagent.q.call(null,G__58243,G__58244,G__58245));
})();
if(cljs.core.truth_(cljs.core.not_empty(cljs.core.deref(eids)))){
var notes = (function (){var G__58246 = athens.db.dsdb;
var G__58247 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58248 = cljs.core.deref(eids);
return (posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull_many.cljs$core$IFn$_invoke$arity$3(G__58246,G__58247,G__58248) : posh.reagent.pull_many.call(null,G__58246,G__58247,G__58248));
})();
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div#daily-notes","div#daily-notes",-1983155722),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_scroll_area_style),cljs.core.doall.cljs$core$IFn$_invoke$arity$1((function (){var iter__4582__auto__ = (function athens$devcards$daily_notes$daily_notes_panel_$_iter__58249(s__58250){
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58252),athens$devcards$daily_notes$daily_notes_panel_$_iter__58249(cljs.core.chunk_rest(s__58250__$2)));
} else {
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.devcards.daily_notes.daily_notes_page_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.node_page.node_page_component,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),uid], null)),athens$devcards$daily_notes$daily_notes_panel_$_iter__58249(cljs.core.rest(s__58250__$2)));
}
} else {
return null;
}
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.daily_notes !== 'undefined') && (typeof athens.devcards.daily_notes.t_athens$devcards$daily_notes58257 !== 'undefined')){
} else {
...
*/
athens.devcards.daily_notes.t_athens$devcards$daily_notes58257 = (function (meta58258){
this.meta58258 = meta58258;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_58259,meta58258__$1){
var self__ = this;
var _58259__$1 = this;
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58257(meta58258__$1));
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_58259){
var self__ = this;
var _58259__$1 = this;
return self__.meta58258;
}));

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.getBasis = (function (){
...
(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.cljs$lang$type = true);

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.cljs$lang$ctorStr = "athens.devcards.daily-notes/t_athens$devcards$daily_notes58257");

(athens.devcards.daily_notes.t_athens$devcards$daily_notes58257.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.daily-notes/t_athens$devcards$daily_notes58257");
}));

/**
 * Positional factory function for athens.devcards.daily-notes/t_athens$devcards$daily_notes58257.
 */
athens.devcards.daily_notes.__GT_t_athens$devcards$daily_notes58257 = (function athens$devcards$daily_notes$__GT_t_athens$devcards$daily_notes58257(meta58258){
return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58257(meta58258));
});

}

return (new athens.devcards.daily_notes.t_athens$devcards$daily_notes58257(null));
})()
