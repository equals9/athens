...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__21053){
...
var clojure$data$EqualityPartition$equality_partition$dyn_21114 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_21114(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_21123 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_21123(a,b);
}
});
