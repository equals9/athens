...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__20909){
...
var clojure$data$EqualityPartition$equality_partition$dyn_20960 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_20960(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_20964 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_20964(a,b);
}
});
