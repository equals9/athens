...
var G__52714 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__52714;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__52751 = cljs.spec.alpha.get_spec(x);
x = G__52751;
continue;
} else {
