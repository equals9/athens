...
var G__48556 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__48556;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__48602 = cljs.spec.alpha.get_spec(x);
x = G__48602;
continue;
} else {
