...
var spec_tools$core$Coercion$_coerce$dyn_52639 = (function (this$,value,transformer,options){
...
return spec_tools$core$Coercion$_coerce$dyn_52639(this$,value,transformer,options);
}
});
...
var G__52717 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__52717;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__52755 = cljs.spec.alpha.get_spec(x);
x = G__52755;
continue;
} else {
