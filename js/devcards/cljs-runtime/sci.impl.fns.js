...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58359,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58360__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58360__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58360__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58360__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58360__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var vec__58376 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58376,(0),null);
var vec__58379 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58376,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58379,(0),null);
...
var map__58385 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58385__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58385__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58391){
...
var f = map__58392__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58392__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58392__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58412__delegate = function (args){
...
return G__58412__delegate.call(this,args);};
G__58412.cljs$lang$maxFixedArity = 0;
G__58412.cljs$lang$applyTo = (function (arglist__58415){
var args = cljs.core.seq(arglist__58415);
return G__58412__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58389_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58389_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58416__delegate = function (args){
...
var G__58416 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58417__i = 0, G__58417__a = new Array(arguments.length -  0);
while (G__58417__i < G__58417__a.length) {G__58417__a[G__58417__i] = arguments[G__58417__i + 0]; ++G__58417__i;}
  args = new cljs.core.IndexedSeq(G__58417__a,0,null);
} 
return G__58416__delegate.call(this,args);};
G__58416.cljs$lang$maxFixedArity = 0;
G__58416.cljs$lang$applyTo = (function (arglist__58418){
var args = cljs.core.seq(arglist__58418);
return G__58416__delegate(args);
});
G__58416.cljs$core$IFn$_invoke$arity$variadic = G__58416__delegate;
return G__58416;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58390_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58390_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
