...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57650,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var G__57694 = cljs.core.next(args__$1);
var G__57695 = cljs.core.next(params__$1);
var G__57696 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57694;
params__$1 = G__57695;
ret = G__57696;
continue;
...
var vec__57661 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57661,(0),null);
var vec__57664 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57661,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57664,(0),null);
var G__57699 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57699;
continue;
} else {
var G__57700 = recur_val;
args = G__57700;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57702){
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57676){
...
var f = map__57677__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57677__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57677__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57704__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__57704 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57705__i = 0, G__57705__a = new Array(arguments.length -  0);
while (G__57705__i < G__57705__a.length) {G__57705__a[G__57705__i] = arguments[G__57705__i + 0]; ++G__57705__i;}
  args = new cljs.core.IndexedSeq(G__57705__a,0,null);
} 
return G__57704__delegate.call(this,args);};
G__57704.cljs$lang$maxFixedArity = 0;
G__57704.cljs$lang$applyTo = (function (arglist__57706){
var args = cljs.core.seq(arglist__57706);
return G__57704__delegate(args);
});
G__57704.cljs$core$IFn$_invoke$arity$variadic = G__57704__delegate;
return G__57704;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57673_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57673_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57707__delegate = function (args){
...
var G__57707 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__57707__delegate.call(this,args);};
G__57707.cljs$lang$maxFixedArity = 0;
G__57707.cljs$lang$applyTo = (function (arglist__57709){
var args = cljs.core.seq(arglist__57709);
return G__57707__delegate(args);
});
G__57707.cljs$core$IFn$_invoke$arity$variadic = G__57707__delegate;
return G__57707;
})()
;
})());
