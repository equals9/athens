...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58317,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58318__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58318__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58318__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58362 = cljs.core.next(args__$1);
var G__58363 = cljs.core.next(params__$1);
var G__58364 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58362;
params__$1 = G__58363;
ret = G__58364;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58321 = ctx__$1;
var G__58322 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58321,G__58322) : interpret.call(null,G__58321,G__58322));
...
var G__58369 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58369;
continue;
} else {
var G__58373 = recur_val;
args = G__58373;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58375){
...
var map__58333 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58333__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58333__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58340){
...
var f = map__58341__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58341__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58341__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58382__delegate = function (args){
...
return G__58382__delegate.call(this,args);};
...
return G__58382__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58338_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58338_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58385__delegate = function (args){
...
var G__58385 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58386__i = 0, G__58386__a = new Array(arguments.length -  0);
while (G__58386__i < G__58386__a.length) {G__58386__a[G__58386__i] = arguments[G__58386__i + 0]; ++G__58386__i;}
  args = new cljs.core.IndexedSeq(G__58386__a,0,null);
} 
return G__58385__delegate.call(this,args);};
G__58385.cljs$lang$maxFixedArity = 0;
G__58385.cljs$lang$applyTo = (function (arglist__58387){
var args = cljs.core.seq(arglist__58387);
return G__58385__delegate(args);
});
G__58385.cljs$core$IFn$_invoke$arity$variadic = G__58385__delegate;
return G__58385;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58339_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58339_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
