...
var G__58336 = cljs.core.next(args__$1);
var G__58337 = cljs.core.next(params__$1);
var G__58338 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58336;
params__$1 = G__58337;
ret = G__58338;
continue;
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58322){
...
var f = map__58323__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58323__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58323__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58320_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58320_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58368__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__58373__i = 0, G__58373__a = new Array(arguments.length -  0);
while (G__58373__i < G__58373__a.length) {G__58373__a[G__58373__i] = arguments[G__58373__i + 0]; ++G__58373__i;}
  args = new cljs.core.IndexedSeq(G__58373__a,0,null);
} 
return G__58368__delegate.call(this,args);};
G__58368.cljs$lang$maxFixedArity = 0;
G__58368.cljs$lang$applyTo = (function (arglist__58374){
var args = cljs.core.seq(arglist__58374);
return G__58368__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58321_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58321_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
