...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58512,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58513__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58513__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58513__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58513__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58513__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var vec__58518 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58518,(0),null);
var vec__58521 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58518,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58521,(0),null);
var G__58552 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58552;
continue;
} else {
var G__58553 = recur_val;
args = G__58553;
continue;
}
} else {
...
var G__58554__i = 0, G__58554__a = new Array(arguments.length -  0);
while (G__58554__i < G__58554__a.length) {G__58554__a[G__58554__i] = arguments[G__58554__i + 0]; ++G__58554__i;}
  args = new cljs.core.IndexedSeq(G__58554__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58555){
var args = cljs.core.seq(arglist__58555);
...
var map__58526 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58526__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58537){
...
var f = map__58538__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58538__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58538__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58572__i < G__58572__a.length) {G__58572__a[G__58572__i] = arguments[G__58572__i + 0]; ++G__58572__i;}
  args = new cljs.core.IndexedSeq(G__58572__a,0,null);
} 
...
var args = cljs.core.seq(arglist__58573);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58528_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58528_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58578__delegate = function (args){
...
var G__58578 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58579__i = 0, G__58579__a = new Array(arguments.length -  0);
while (G__58579__i < G__58579__a.length) {G__58579__a[G__58579__i] = arguments[G__58579__i + 0]; ++G__58579__i;}
  args = new cljs.core.IndexedSeq(G__58579__a,0,null);
} 
return G__58578__delegate.call(this,args);};
G__58578.cljs$lang$maxFixedArity = 0;
G__58578.cljs$lang$applyTo = (function (arglist__58580){
var args = cljs.core.seq(arglist__58580);
return G__58578__delegate(args);
});
G__58578.cljs$core$IFn$_invoke$arity$variadic = G__58578__delegate;
return G__58578;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58531_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58531_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
