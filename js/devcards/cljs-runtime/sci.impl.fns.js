...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57699,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__57700__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57700__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57700__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57700__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57700__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57750 = cljs.core.next(args__$1);
var G__57751 = cljs.core.next(params__$1);
var G__57752 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57750;
params__$1 = G__57751;
ret = G__57752;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57706 = ctx__$1;
var G__57707 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57706,G__57707) : interpret.call(null,G__57706,G__57707));
...
var vec__57711 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57711,(0),null);
var vec__57714 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57711,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57714,(0),null);
var G__57753 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57753;
continue;
} else {
var G__57754 = recur_val;
args = G__57754;
continue;
}
} else {
...
var G__57756__i = 0, G__57756__a = new Array(arguments.length -  0);
while (G__57756__i < G__57756__a.length) {G__57756__a[G__57756__i] = arguments[G__57756__i + 0]; ++G__57756__i;}
  args = new cljs.core.IndexedSeq(G__57756__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57757){
var args = cljs.core.seq(arglist__57757);
...
var map__57717 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57717__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57717__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57732){
...
var f = map__57733__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57733__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57733__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__57769__delegate = function (args){
...
while (G__57770__i < G__57770__a.length) {G__57770__a[G__57770__i] = arguments[G__57770__i + 0]; ++G__57770__i;}
  args = new cljs.core.IndexedSeq(G__57770__a,0,null);
} 
return G__57769__delegate.call(this,args);};
G__57769.cljs$lang$maxFixedArity = 0;
G__57769.cljs$lang$applyTo = (function (arglist__57771){
var args = cljs.core.seq(arglist__57771);
return G__57769__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57722_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57722_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57777__delegate = function (args){
...
var G__57777 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__57778__i = 0, G__57778__a = new Array(arguments.length -  0);
while (G__57778__i < G__57778__a.length) {G__57778__a[G__57778__i] = arguments[G__57778__i + 0]; ++G__57778__i;}
  args = new cljs.core.IndexedSeq(G__57778__a,0,null);
} 
return G__57777__delegate.call(this,args);};
G__57777.cljs$lang$maxFixedArity = 0;
G__57777.cljs$lang$applyTo = (function (arglist__57779){
var args = cljs.core.seq(arglist__57779);
return G__57777__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57725_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57725_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
