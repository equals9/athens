...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__59013,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59014__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59014__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59014__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__59051 = cljs.core.next(args__$1);
var G__59052 = cljs.core.next(params__$1);
var G__59053 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__59051;
params__$1 = G__59052;
ret = G__59053;
continue;
...
while (G__59058__i < G__59058__a.length) {G__59058__a[G__59058__i] = arguments[G__59058__i + 0]; ++G__59058__i;}
  args = new cljs.core.IndexedSeq(G__59058__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__59059){
var args = cljs.core.seq(arglist__59059);
...
var map__59029 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59029__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__59042){
...
var f = map__59043__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59043__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__59043__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__59068__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__59068 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__59069__i = 0, G__59069__a = new Array(arguments.length -  0);
while (G__59069__i < G__59069__a.length) {G__59069__a[G__59069__i] = arguments[G__59069__i + 0]; ++G__59069__i;}
  args = new cljs.core.IndexedSeq(G__59069__a,0,null);
} 
return G__59068__delegate.call(this,args);};
G__59068.cljs$lang$maxFixedArity = 0;
G__59068.cljs$lang$applyTo = (function (arglist__59070){
var args = cljs.core.seq(arglist__59070);
return G__59068__delegate(args);
});
G__59068.cljs$core$IFn$_invoke$arity$variadic = G__59068__delegate;
return G__59068;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__59037_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__59037_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__59038_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__59038_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
