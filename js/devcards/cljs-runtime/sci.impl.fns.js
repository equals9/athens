...
var G__58619 = cljs.core.next(args__$1);
var G__58620 = cljs.core.next(params__$1);
var G__58621 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58619;
params__$1 = G__58620;
ret = G__58621;
continue;
...
var vec__58581 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58581,(0),null);
var vec__58584 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58581,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58584,(0),null);
var G__58629 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58629;
continue;
} else {
var G__58630 = recur_val;
args = G__58630;
continue;
}
} else {
...
while (G__58631__i < G__58631__a.length) {G__58631__a[G__58631__i] = arguments[G__58631__i + 0]; ++G__58631__i;}
  args = new cljs.core.IndexedSeq(G__58631__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58632){
var args = cljs.core.seq(arglist__58632);
...
var map__58590 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58590__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58590__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58596){
...
var f = map__58597__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58597__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58597__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58642__delegate = function (args){
...
while (G__58643__i < G__58643__a.length) {G__58643__a[G__58643__i] = arguments[G__58643__i + 0]; ++G__58643__i;}
  args = new cljs.core.IndexedSeq(G__58643__a,0,null);
} 
return G__58642__delegate.call(this,args);};
G__58642.cljs$lang$maxFixedArity = 0;
G__58642.cljs$lang$applyTo = (function (arglist__58644){
var args = cljs.core.seq(arglist__58644);
return G__58642__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58594_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58594_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58649__delegate = function (args){
...
var G__58649 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58652__i = 0, G__58652__a = new Array(arguments.length -  0);
while (G__58652__i < G__58652__a.length) {G__58652__a[G__58652__i] = arguments[G__58652__i + 0]; ++G__58652__i;}
  args = new cljs.core.IndexedSeq(G__58652__a,0,null);
} 
return G__58649__delegate.call(this,args);};
G__58649.cljs$lang$maxFixedArity = 0;
G__58649.cljs$lang$applyTo = (function (arglist__58654){
var args = cljs.core.seq(arglist__58654);
return G__58649__delegate(args);
});
G__58649.cljs$core$IFn$_invoke$arity$variadic = G__58649__delegate;
return G__58649;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58595_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58595_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
