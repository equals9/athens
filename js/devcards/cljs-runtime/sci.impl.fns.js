...
var G__58733 = cljs.core.next(args__$1);
var G__58734 = cljs.core.next(params__$1);
var G__58735 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58733;
params__$1 = G__58734;
ret = G__58735;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58698 = ctx__$1;
var G__58699 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58698,G__58699) : interpret.call(null,G__58698,G__58699));
...
var vec__58701 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58701,(0),null);
var vec__58704 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58701,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58704,(0),null);
var G__58736 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58736;
continue;
} else {
var G__58738 = recur_val;
args = G__58738;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58740){
...
var map__58709 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58709__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58713){
...
var f = map__58714__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58714__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__58744__i < G__58744__a.length) {G__58744__a[G__58744__i] = arguments[G__58744__i + 0]; ++G__58744__i;}
  args = new cljs.core.IndexedSeq(G__58744__a,0,null);
} 
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58711_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58711_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58746__delegate = function (args){
...
var G__58746 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58747__i = 0, G__58747__a = new Array(arguments.length -  0);
while (G__58747__i < G__58747__a.length) {G__58747__a[G__58747__i] = arguments[G__58747__i + 0]; ++G__58747__i;}
  args = new cljs.core.IndexedSeq(G__58747__a,0,null);
} 
return G__58746__delegate.call(this,args);};
G__58746.cljs$lang$maxFixedArity = 0;
G__58746.cljs$lang$applyTo = (function (arglist__58748){
var args = cljs.core.seq(arglist__58748);
return G__58746__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58712_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58712_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
