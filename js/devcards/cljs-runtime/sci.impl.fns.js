...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58489,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58491__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58491__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58491__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58491__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58491__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58532 = cljs.core.next(args__$1);
var G__58533 = cljs.core.next(params__$1);
var G__58534 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58532;
params__$1 = G__58533;
ret = G__58534;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58496 = ctx__$1;
var G__58497 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58496,G__58497) : interpret.call(null,G__58496,G__58497));
...
var vec__58498 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58498,(0),null);
var vec__58501 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58498,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58501,(0),null);
...
var map__58506 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58506__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58506__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
while (G__58543__i < G__58543__a.length) {G__58543__a[G__58543__i] = arguments[G__58543__i + 0]; ++G__58543__i;}
  args = new cljs.core.IndexedSeq(G__58543__a,0,null);
} 
return G__58540__delegate.call(this,args);};
G__58540.cljs$lang$maxFixedArity = 0;
G__58540.cljs$lang$applyTo = (function (arglist__58544){
var args = cljs.core.seq(arglist__58544);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58510_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58510_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58545__delegate = function (args){
...
var G__58545 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__58545__delegate.call(this,args);};
G__58545.cljs$lang$maxFixedArity = 0;
G__58545.cljs$lang$applyTo = (function (arglist__58547){
var args = cljs.core.seq(arglist__58547);
return G__58545__delegate(args);
});
G__58545.cljs$core$IFn$_invoke$arity$variadic = G__58545__delegate;
return G__58545;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58511_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58511_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
