...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58565,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58566__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58566__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58566__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58566__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58566__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58606 = cljs.core.next(args__$1);
var G__58607 = cljs.core.next(params__$1);
var G__58608 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58606;
params__$1 = G__58607;
ret = G__58608;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58570 = ctx__$1;
var G__58571 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58570,G__58571) : interpret.call(null,G__58570,G__58571));
...
var vec__58574 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58574,(0),null);
var vec__58577 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58574,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58577,(0),null);
var G__58619 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58619;
continue;
} else {
var G__58620 = recur_val;
args = G__58620;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58622){
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58591){
...
var f = map__58592__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58592__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58592__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58628__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58628 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58632__i = 0, G__58632__a = new Array(arguments.length -  0);
while (G__58632__i < G__58632__a.length) {G__58632__a[G__58632__i] = arguments[G__58632__i + 0]; ++G__58632__i;}
  args = new cljs.core.IndexedSeq(G__58632__a,0,null);
} 
return G__58628__delegate.call(this,args);};
G__58628.cljs$lang$maxFixedArity = 0;
G__58628.cljs$lang$applyTo = (function (arglist__58633){
var args = cljs.core.seq(arglist__58633);
return G__58628__delegate(args);
});
...
return (function() { 
var G__58637__delegate = function (args){
...
var G__58637 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58638__i = 0, G__58638__a = new Array(arguments.length -  0);
while (G__58638__i < G__58638__a.length) {G__58638__a[G__58638__i] = arguments[G__58638__i + 0]; ++G__58638__i;}
  args = new cljs.core.IndexedSeq(G__58638__a,0,null);
} 
return G__58637__delegate.call(this,args);};
G__58637.cljs$lang$maxFixedArity = 0;
G__58637.cljs$lang$applyTo = (function (arglist__58639){
var args = cljs.core.seq(arglist__58639);
return G__58637__delegate(args);
});
