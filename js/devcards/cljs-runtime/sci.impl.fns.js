...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58616 = ctx__$1;
var G__58617 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58616,G__58617) : interpret.call(null,G__58616,G__58617));
...
var vec__58620 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58620,(0),null);
var vec__58623 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58620,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58623,(0),null);
var G__58647 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58647;
continue;
} else {
var G__58648 = recur_val;
args = G__58648;
continue;
}
} else {
...
while (G__58649__i < G__58649__a.length) {G__58649__a[G__58649__i] = arguments[G__58649__i + 0]; ++G__58649__i;}
  args = new cljs.core.IndexedSeq(G__58649__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58650){
var args = cljs.core.seq(arglist__58650);
...
var map__58626 = cljs.core.meta(f);
...
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58626__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58631){
...
var f = map__58632__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58632__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58632__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58656__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58656 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58657__i = 0, G__58657__a = new Array(arguments.length -  0);
while (G__58657__i < G__58657__a.length) {G__58657__a[G__58657__i] = arguments[G__58657__i + 0]; ++G__58657__i;}
  args = new cljs.core.IndexedSeq(G__58657__a,0,null);
} 
return G__58656__delegate.call(this,args);};
G__58656.cljs$lang$maxFixedArity = 0;
G__58656.cljs$lang$applyTo = (function (arglist__58658){
var args = cljs.core.seq(arglist__58658);
return G__58656__delegate(args);
});
G__58656.cljs$core$IFn$_invoke$arity$variadic = G__58656__delegate;
return G__58656;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58628_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58628_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58629_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58629_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
