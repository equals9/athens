...
var G__58212 = cljs.core.next(args__$1);
var G__58213 = cljs.core.next(params__$1);
var G__58214 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58212;
params__$1 = G__58213;
ret = G__58214;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58179 = ctx__$1;
var G__58180 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58179,G__58180) : interpret.call(null,G__58179,G__58180));
...
var vec__58184 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58184,(0),null);
var vec__58187 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58184,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58187,(0),null);
var G__58217 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58217;
continue;
} else {
var G__58218 = recur_val;
args = G__58218;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58220){
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58206){
...
var f = map__58207__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58207__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58207__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
return G__58229__delegate.call(this,args);};
G__58229.cljs$lang$maxFixedArity = 0;
G__58229.cljs$lang$applyTo = (function (arglist__58231){
var args = cljs.core.seq(arglist__58231);
return G__58229__delegate(args);
});
G__58229.cljs$core$IFn$_invoke$arity$variadic = G__58229__delegate;
return G__58229;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58204_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58204_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
G__58232.cljs$lang$applyTo = (function (arglist__58235){
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58205_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58205_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
