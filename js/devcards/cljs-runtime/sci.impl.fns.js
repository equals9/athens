...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57661,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__57665 = p__57661;
...
var _m = map__57665__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57665__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57665__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57665__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57665__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57693 = cljs.core.next(args__$1);
var G__57694 = cljs.core.next(params__$1);
var G__57695 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57693;
params__$1 = G__57694;
ret = G__57695;
continue;
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57687){
...
var f = map__57688__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57688__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57688__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
return G__57709__delegate.call(this,args);};
G__57709.cljs$lang$maxFixedArity = 0;
G__57709.cljs$lang$applyTo = (function (arglist__57711){
var args = cljs.core.seq(arglist__57711);
return G__57709__delegate(args);
});
G__57709.cljs$core$IFn$_invoke$arity$variadic = G__57709__delegate;
return G__57709;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57685_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57685_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57712__delegate = function (args){
...
var G__57712 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__57712__delegate.call(this,args);};
G__57712.cljs$lang$maxFixedArity = 0;
G__57712.cljs$lang$applyTo = (function (arglist__57718){
var args = cljs.core.seq(arglist__57718);
return G__57712__delegate(args);
});
G__57712.cljs$core$IFn$_invoke$arity$variadic = G__57712__delegate;
return G__57712;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57686_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57686_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
