...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__57688,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57689__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57689__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57689__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__57735 = cljs.core.next(args__$1);
var G__57736 = cljs.core.next(params__$1);
var G__57737 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57735;
params__$1 = G__57736;
ret = G__57737;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57693 = ctx__$1;
var G__57694 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57693,G__57694) : interpret.call(null,G__57693,G__57694));
...
var vec__57697 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57697,(0),null);
var vec__57700 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57697,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57700,(0),null);
var G__57742 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57742;
continue;
} else {
var G__57743 = recur_val;
args = G__57743;
continue;
}
} else {
...
var G__57744__i = 0, G__57744__a = new Array(arguments.length -  0);
while (G__57744__i < G__57744__a.length) {G__57744__a[G__57744__i] = arguments[G__57744__i + 0]; ++G__57744__i;}
  args = new cljs.core.IndexedSeq(G__57744__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57745){
...
var map__57709 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57709__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57709__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__57714){
...
var f = map__57715__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57715__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57715__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var args = null;
if (arguments.length > 0) {
var G__57755__i = 0, G__57755__a = new Array(arguments.length -  0);
while (G__57755__i < G__57755__a.length) {G__57755__a[G__57755__i] = arguments[G__57755__i + 0]; ++G__57755__i;}
  args = new cljs.core.IndexedSeq(G__57755__a,0,null);
} 
return G__57751__delegate.call(this,args);};
G__57751.cljs$lang$maxFixedArity = 0;
G__57751.cljs$lang$applyTo = (function (arglist__57756){
var args = cljs.core.seq(arglist__57756);
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57711_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57711_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
var args = null;
if (arguments.length > 0) {
var G__57762__i = 0, G__57762__a = new Array(arguments.length -  0);
while (G__57762__i < G__57762__a.length) {G__57762__a[G__57762__i] = arguments[G__57762__i + 0]; ++G__57762__i;}
  args = new cljs.core.IndexedSeq(G__57762__a,0,null);
} 
return G__57760__delegate.call(this,args);};
G__57760.cljs$lang$maxFixedArity = 0;
G__57760.cljs$lang$applyTo = (function (arglist__57763){
var args = cljs.core.seq(arglist__57763);
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57712_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57712_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
