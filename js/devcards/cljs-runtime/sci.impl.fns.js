...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58547,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__58551 = p__58547;
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58551__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58590 = cljs.core.next(args__$1);
var G__58591 = cljs.core.next(params__$1);
var G__58592 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58590;
params__$1 = G__58591;
ret = G__58592;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58562 = ctx__$1;
var G__58563 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58562,G__58563) : interpret.call(null,G__58562,G__58563));
...
var vec__58564 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58564,(0),null);
var vec__58567 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58564,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58567,(0),null);
var G__58594 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58594;
continue;
} else {
var G__58595 = recur_val;
args = G__58595;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58597){
...
var map__58572 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58572__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58572__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
while (G__58606__i < G__58606__a.length) {G__58606__a[G__58606__i] = arguments[G__58606__i + 0]; ++G__58606__i;}
  args = new cljs.core.IndexedSeq(G__58606__a,0,null);
} 
return G__58605__delegate.call(this,args);};
G__58605.cljs$lang$maxFixedArity = 0;
G__58605.cljs$lang$applyTo = (function (arglist__58607){
var args = cljs.core.seq(arglist__58607);
return G__58605__delegate(args);
});
G__58605.cljs$core$IFn$_invoke$arity$variadic = G__58605__delegate;
return G__58605;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58574_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58574_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58611__delegate = function (args){
...
var G__58611 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58620__i = 0, G__58620__a = new Array(arguments.length -  0);
while (G__58620__i < G__58620__a.length) {G__58620__a[G__58620__i] = arguments[G__58620__i + 0]; ++G__58620__i;}
  args = new cljs.core.IndexedSeq(G__58620__a,0,null);
} 
return G__58611__delegate.call(this,args);};
G__58611.cljs$lang$maxFixedArity = 0;
G__58611.cljs$lang$applyTo = (function (arglist__58621){
var args = cljs.core.seq(arglist__58621);
return G__58611__delegate(args);
});
G__58611.cljs$core$IFn$_invoke$arity$variadic = G__58611__delegate;
return G__58611;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58575_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58575_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
