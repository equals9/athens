...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58607,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58608__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58608__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58644 = cljs.core.next(args__$1);
var G__58645 = cljs.core.next(params__$1);
var G__58646 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58644;
params__$1 = G__58645;
ret = G__58646;
continue;
...
var vec__58618 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58618,(0),null);
var vec__58621 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58618,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58621,(0),null);
var G__58648 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58648;
continue;
} else {
var G__58649 = recur_val;
args = G__58649;
continue;
}
} else {
...
var G__58650__i = 0, G__58650__a = new Array(arguments.length -  0);
while (G__58650__i < G__58650__a.length) {G__58650__a[G__58650__i] = arguments[G__58650__i + 0]; ++G__58650__i;}
  args = new cljs.core.IndexedSeq(G__58650__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58651){
var args = cljs.core.seq(arglist__58651);
