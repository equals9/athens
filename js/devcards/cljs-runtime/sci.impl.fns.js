...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58177 = ctx__$1;
var G__58178 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58177,G__58178) : interpret.call(null,G__58177,G__58178));
...
var map__58191 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58191__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58191__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
var G__58218__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58218 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58219__i = 0, G__58219__a = new Array(arguments.length -  0);
while (G__58219__i < G__58219__a.length) {G__58219__a[G__58219__i] = arguments[G__58219__i + 0]; ++G__58219__i;}
  args = new cljs.core.IndexedSeq(G__58219__a,0,null);
} 
return G__58218__delegate.call(this,args);};
G__58218.cljs$lang$maxFixedArity = 0;
G__58218.cljs$lang$applyTo = (function (arglist__58220){
var args = cljs.core.seq(arglist__58220);
return G__58218__delegate(args);
});
G__58218.cljs$core$IFn$_invoke$arity$variadic = G__58218__delegate;
return G__58218;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58193_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58193_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
...
while (G__58223__i < G__58223__a.length) {G__58223__a[G__58223__i] = arguments[G__58223__i + 0]; ++G__58223__i;}
  args = new cljs.core.IndexedSeq(G__58223__a,0,null);
} 
...
var args = cljs.core.seq(arglist__58224);
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58195_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58195_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
