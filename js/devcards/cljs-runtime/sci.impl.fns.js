...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__58250,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__58252__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58252__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58252__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58252__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58252__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__58292 = cljs.core.next(args__$1);
var G__58293 = cljs.core.next(params__$1);
var G__58294 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58292;
params__$1 = G__58293;
ret = G__58294;
continue;
...
var vec__58259 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58259,(0),null);
var vec__58262 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58259,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58262,(0),null);
var G__58297 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58297;
continue;
} else {
var G__58298 = recur_val;
args = G__58298;
continue;
}
} else {
...
var G__58299__i = 0, G__58299__a = new Array(arguments.length -  0);
while (G__58299__i < G__58299__a.length) {G__58299__a[G__58299__i] = arguments[G__58299__i + 0]; ++G__58299__i;}
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58300){
var args = cljs.core.seq(arglist__58300);
...
var map__58267 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58267__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58267__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58274){
...
var f = map__58275__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58275__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58275__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__58302__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__58302 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__58303__i = 0, G__58303__a = new Array(arguments.length -  0);
while (G__58303__i < G__58303__a.length) {G__58303__a[G__58303__i] = arguments[G__58303__i + 0]; ++G__58303__i;}
  args = new cljs.core.IndexedSeq(G__58303__a,0,null);
} 
return G__58302__delegate.call(this,args);};
G__58302.cljs$lang$maxFixedArity = 0;
G__58302.cljs$lang$applyTo = (function (arglist__58304){
var args = cljs.core.seq(arglist__58304);
return G__58302__delegate(args);
});
G__58302.cljs$core$IFn$_invoke$arity$variadic = G__58302__delegate;
return G__58302;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58271_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__58271_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__58306__delegate = function (args){
...
return G__58306__delegate.call(this,args);};
G__58306.cljs$lang$maxFixedArity = 0;
G__58306.cljs$lang$applyTo = (function (arglist__58309){
var args = cljs.core.seq(arglist__58309);
return G__58306__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58272_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58272_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
