...
var G__58679 = cljs.core.next(args__$1);
var G__58680 = cljs.core.next(params__$1);
var G__58681 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__58679;
params__$1 = G__58680;
ret = G__58681;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__58653 = ctx__$1;
var G__58654 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__58653,G__58654) : interpret.call(null,G__58653,G__58654));
...
var vec__58655 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58655,(0),null);
var vec__58658 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58655,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58658,(0),null);
var G__58683 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__58683;
continue;
} else {
var G__58684 = recur_val;
args = G__58684;
continue;
}
} else {
...
var G__58685__i = 0, G__58685__a = new Array(arguments.length -  0);
while (G__58685__i < G__58685__a.length) {G__58685__a[G__58685__i] = arguments[G__58685__i + 0]; ++G__58685__i;}
  args = new cljs.core.IndexedSeq(G__58685__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__58686){
var args = cljs.core.seq(arglist__58686);
...
var map__58662 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58662__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58662__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__58666){
...
var f = map__58667__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58667__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58667__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
return (function() { 
var G__58697__delegate = function (args){
...
var G__58697 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
while (G__58701__i < G__58701__a.length) {G__58701__a[G__58701__i] = arguments[G__58701__i + 0]; ++G__58701__i;}
  args = new cljs.core.IndexedSeq(G__58701__a,0,null);
} 
return G__58697__delegate.call(this,args);};
G__58697.cljs$lang$maxFixedArity = 0;
G__58697.cljs$lang$applyTo = (function (arglist__58704){
var args = cljs.core.seq(arglist__58704);
return G__58697__delegate(args);
});
G__58697.cljs$core$IFn$_invoke$arity$variadic = G__58697__delegate;
return G__58697;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__58665_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58665_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
