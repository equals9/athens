...
var G__57710 = cljs.core.next(args__$1);
var G__57711 = cljs.core.next(params__$1);
var G__57712 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__57710;
params__$1 = G__57711;
ret = G__57712;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__57683 = ctx__$1;
var G__57684 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__57683,G__57684) : interpret.call(null,G__57683,G__57684));
...
var vec__57685 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57685,(0),null);
var vec__57688 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57685,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57688,(0),null);
var G__57713 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__57713;
continue;
} else {
var G__57714 = recur_val;
args = G__57714;
continue;
}
} else {
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__57720){
...
var map__57692 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57692__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57692__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__57694_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__57694_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__57730__delegate = function (args){
...
var args = null;
if (arguments.length > 0) {
var G__57739__i = 0, G__57739__a = new Array(arguments.length -  0);
while (G__57739__i < G__57739__a.length) {G__57739__a[G__57739__i] = arguments[G__57739__i + 0]; ++G__57739__i;}
  args = new cljs.core.IndexedSeq(G__57739__a,0,null);
} 
return G__57730__delegate.call(this,args);};
G__57730.cljs$lang$maxFixedArity = 0;
G__57730.cljs$lang$applyTo = (function (arglist__57740){
var args = cljs.core.seq(arglist__57740);
return G__57730__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__57695_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__57695_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
