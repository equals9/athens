...
if((diff > (0))){
var G__25937 = only_a;
var G__25938 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(only_b,first_b);
var G__25939 = both;
var G__25940 = a__$1;
...
var comp_QMARK__26013 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
...
if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__26013;
...
var G__26015 = seq__25776;
var G__26016 = chunk__25777;
var G__26017 = count__25778;
var G__26018 = (i__25779 + (1));
seq__25776 = G__26015;
chunk__25777 = G__26016;
count__25778 = G__26017;
i__25779 = G__26018;
continue;
} else {
...
var G__26019 = cljs.core.chunk_rest(seq__25776__$1);
var G__26020 = c__4609__auto__;
var G__26021 = cljs.core.count(c__4609__auto__);
var G__26022 = (0);
seq__25776 = G__26019;
chunk__25777 = G__26020;
count__25778 = G__26021;
i__25779 = G__26022;
continue;
} else {
...
var comp_QMARK__26023 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
datascript.db.validate_schema_key(a,new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null));

if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__26023;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079));
} else {
return and__4174__auto__;
...
var G__26031 = cljs.core.next(seq__25776__$1);
var G__26032 = null;
var G__26033 = (0);
var G__26034 = (0);
seq__25776 = G__26031;
chunk__25777 = G__26032;
count__25778 = G__26033;
i__25779 = G__26034;
continue;
}
} else {
...
var G__26048 = cljs.core.next(xs);
var G__26049 = cljs.core.next(ys);
xs = G__26048;
ys = G__26049;
continue;
} else {
...
if(cljs.core.truth_(a)){
var G__25804_26054 = a;
var G__25805_26055 = (new cljs.core.List(null,new cljs.core.Symbol(null,"resolve-datom","resolve-datom",-294110827,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,e,(new cljs.core.List(null,a,(new cljs.core.List(null,v,(new cljs.core.List(null,t,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null)),(6),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__25804_26054,G__25805_26055) : datascript.db.validate_attr.call(null,G__25804_26054,G__25805_26055));
} else {
}
...
var G__26082 = db;
var G__26083 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__26082;
eid = G__26083;
continue;
} else {
...
var G__26118 = cljs.core.rest(s__25857__$1);
s__25857__$1 = G__26118;
continue;
}
} else {
var G__26119 = cljs.core.rest(s__25857__$1);
s__25857__$1 = G__26119;
continue;
}
} else {
return null;
...
var G__26133 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
var G__26134 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__26133;
es = G__26134;
continue;
} else {
...
,datoms))){
var G__26151 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__26153 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__26155 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__26156 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__26155;
es = G__26156;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__26160 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__26161 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__26160;
es = G__26161;
continue;
} else {
...
if((temp__5737__auto__ == null)){
var G__26162 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.next_eid(db));
var G__26163 = es;
report = G__26162;
es = G__26163;
continue;
...
var G__26164 = report;
var G__26165 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,vid], null),entities);
report = G__26164;
es = G__26165;
continue;
}
...
var G__26166 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,eid);
var G__26167 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,eid,a,v], null),entities);
report = G__26166;
es = G__26167;
continue;
}
...
var G__26168 = datascript.db.transact_add(report,entity);
...
var G__26177 = datascript.db.transact_retract_datom(report,old_datom);
...
var G__26184 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,datoms);
var G__26185 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,datoms),entities);
report = G__26184;
es = G__26185;
continue;
}
...
var G__26189 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(e_datoms,v_datoms));
var G__26190 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,e_datoms),entities);
report = G__26189;
es = G__26190;
continue;
}
