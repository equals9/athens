...
var listener_44975 = (function (direction,evt){
...
G__44924_44976.listen(goog.net.EventType.UPLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_44975,new cljs.core.Keyword(null,"upload","upload",-255769218)));

G__44924_44976.listen(goog.net.EventType.DOWNLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_44975,new cljs.core.Keyword(null,"download","download",-300081668)));
...
if(cljs.core.truth_(cancel)){
var c__42519__auto___44995 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
...
if(cljs.core.keyword_identical_QMARK_(ret_value__42485__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__45001 = state_44954;
state_44954 = G__45001;
continue;
} else {
return ret_value__42485__auto__;
}
...
(statearr_44961[(6)] = c__42519__auto___44995);
