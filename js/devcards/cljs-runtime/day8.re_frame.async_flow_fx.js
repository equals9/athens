 ...
 */
day8.re_frame.async_flow_fx.dissoc_in = (function day8$re_frame$async_flow_fx$dissoc_in(m,p__61724){
var vec__61725 = p__61724;
var seq__61726 = cljs.core.seq(vec__61725);
var first__61727 = cljs.core.first(seq__61726);
var seq__61726__$1 = cljs.core.next(seq__61726);
var k = first__61727;
var ks = seq__61726__$1;
var keys = vec__61725;
if(ks){
...
var G__61729 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__61730 = now_seen_events;
var fexpr__61728 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__61728.cljs$core$IFn$_invoke$arity$2 ? fexpr__61728.cljs$core$IFn$_invoke$arity$2(G__61729,G__61730) : fexpr__61728.call(null,G__61729,G__61730));
...
var G__61732 = "async-flow: got bad value for :when - ";
var G__61733 = when_kw;
...
return cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2((function (index,p__61734){
...
var rule = map__61735__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var when = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"when","when",-576417306));
...
var dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"dispatch","dispatch",1319337009));
...
var halt_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61735__$1,new cljs.core.Keyword(null,"halt?","halt?",-1110658247));
...
var G__61738 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__61739 = rule;
...
var G__61740 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__61740__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61740,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__61740);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__61740__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__61740__$1;
}
...
var dispatch_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614));
var dispatch_n = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61741__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236));
...
var G__61743 = new cljs.core.Keyword(null,"error","error",-978969032);
var G__61744 = "async-flow: dispatch-fn must return a seq of events ";
var G__61745 = rule;
return (re_frame.core.console.cljs$core$IFn$_invoke$arity$3 ? re_frame.core.console.cljs$core$IFn$_invoke$arity$3(G__61743,G__61744,G__61745) : re_frame.core.console.call(null,G__61743,G__61744,G__61745));
}
} else {
 ...
 */
day8.re_frame.async_flow_fx.make_flow_event_handler = (function day8$re_frame$async_flow_fx$make_flow_event_handler(p__61746){
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61747__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var db_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61747__$1,new cljs.core.Keyword(null,"db-path","db-path",-68094099));
var rules = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61747__$1,new cljs.core.Keyword(null,"rules","rules",1198912366));
var first_dispatch = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61747__$1,new cljs.core.Keyword(null,"first-dispatch","first-dispatch",128561923));
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__61749,p__61750){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61751__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__61752 = p__61750;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61752,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61752,(1),null);
var event_v = vec__61752;
var pred__61756 = cljs.core._EQ_;
var expr__61757 = event_type;
if(cljs.core.truth_((function (){var G__61759 = new cljs.core.Keyword(null,"setup","setup",1987730512);
var G__61760 = expr__61757;
return (pred__61756.cljs$core$IFn$_invoke$arity$2 ? pred__61756.cljs$core$IFn$_invoke$arity$2(G__61759,G__61760) : pred__61756.call(null,G__61759,G__61760));
})())){
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"db","db",993250759),(function (){var G__61761 = db;
var G__61762 = cljs.core.PersistentHashSet.EMPTY;
var G__61763 = cljs.core.PersistentHashSet.EMPTY;
return (set_state.cljs$core$IFn$_invoke$arity$3 ? set_state.cljs$core$IFn$_invoke$arity$3(G__61761,G__61762,G__61763) : set_state.call(null,G__61761,G__61762,G__61763));
...
var vec__61764 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61764,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61764,(1),null);
var map__61767 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
...
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61767__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61767__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
...
var vec__61769 = day8.re_frame.async_flow_fx.ensure_has_id(flow);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61769,(0),null);
var flow_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61769,(1),null);
...
var G__61772 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,new cljs.core.Keyword(null,"setup","setup",1987730512)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__61772) : re_frame.core.dispatch.call(null,G__61772));
});
var G__61773_61775 = new cljs.core.Keyword(null,"async-flow","async-flow",1464712702);
var G__61774_61776 = day8.re_frame.async_flow_fx.flow__GT_handler;
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__61773_61775,G__61774_61776) : re_frame.core.reg_fx.call(null,G__61773_61775,G__61774_61776));
