...
var G__57020 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57020)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57020)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57020)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57020)].join('')));
...
var G__57067 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57068 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57067;
v = G__57068;
continue;
} else {
var G__57069 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57070 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57069;
v = G__57070;
continue;
}
...
break;
case "\"":
var G__57072 = cljs.core.next(sq);
var G__57073 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57072;
v = G__57073;
continue;
...
break;
default:
var G__57074 = cljs.core.next(sq);
var G__57075 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57074;
v = G__57075;
continue;
...
while(true){
var G__57033 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__57033__$1 = (((G__57033 instanceof cljs.core.Keyword))?G__57033.fqn:null);
switch (G__57033__$1) {
case "rule":
var vec__57034 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57034,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57034,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57037 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57037) : instaparse.cfg.content.call(null,G__57037));
...
break;
case "paren":
var G__57078 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57078;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57038 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57038) : instaparse.cfg.build_rule.call(null,G__57038));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57040 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57040) : instaparse.cfg.build_rule.call(null,G__57040));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__57041 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57041) : instaparse.cfg.build_rule.call(null,G__57041));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57042 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57043 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57044 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57033__$1)].join('')));
...
while(true){
var G__57045 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57080 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57080;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57045__$1)].join('')));
...
var valid_nts_57081 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57046_57082 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57047_57083 = null;
var count__57048_57084 = (0);
var i__57049_57085 = (0);
while(true){
if((i__57049_57085 < count__57048_57084)){
var nt_57086 = chunk__57047_57083.cljs$core$IIndexed$_nth$arity$2(null,i__57049_57085);
if(cljs.core.truth_((valid_nts_57081.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57081.cljs$core$IFn$_invoke$arity$1(nt_57086) : valid_nts_57081.call(null,nt_57086)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57086),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57087 = seq__57046_57082;
var G__57088 = chunk__57047_57083;
var G__57089 = count__57048_57084;
var G__57090 = (i__57049_57085 + (1));
seq__57046_57082 = G__57087;
chunk__57047_57083 = G__57088;
count__57048_57084 = G__57089;
i__57049_57085 = G__57090;
continue;
} else {
var temp__5735__auto___57091 = cljs.core.seq(seq__57046_57082);
if(temp__5735__auto___57091){
var seq__57046_57092__$1 = temp__5735__auto___57091;
if(cljs.core.chunked_seq_QMARK_(seq__57046_57092__$1)){
var c__4609__auto___57093 = cljs.core.chunk_first(seq__57046_57092__$1);
var G__57094 = cljs.core.chunk_rest(seq__57046_57092__$1);
var G__57095 = c__4609__auto___57093;
var G__57096 = cljs.core.count(c__4609__auto___57093);
var G__57097 = (0);
seq__57046_57082 = G__57094;
chunk__57047_57083 = G__57095;
count__57048_57084 = G__57096;
i__57049_57085 = G__57097;
continue;
} else {
var nt_57098 = cljs.core.first(seq__57046_57092__$1);
if(cljs.core.truth_((valid_nts_57081.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57081.cljs$core$IFn$_invoke$arity$1(nt_57098) : valid_nts_57081.call(null,nt_57098)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57098),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57099 = cljs.core.next(seq__57046_57092__$1);
var G__57100 = null;
var G__57101 = (0);
var G__57102 = (0);
seq__57046_57082 = G__57099;
chunk__57047_57083 = G__57100;
count__57048_57084 = G__57101;
i__57049_57085 = G__57102;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57050_57103 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57051_57104 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57052_57105 = true;
var _STAR_print_fn_STAR__temp_val__57053_57106 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57052_57105);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57053_57106);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57051_57104);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57050_57103);
}
...
var len__4789__auto___57107 = arguments.length;
var i__4790__auto___57108 = (0);
while(true){
if((i__4790__auto___57108 < len__4789__auto___57107)){
args__4795__auto__.push((arguments[i__4790__auto___57108]));

var G__57109 = (i__4790__auto___57108 + (1));
i__4790__auto___57108 = G__57109;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57056){
...
var opts = map__57057__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57059 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57060 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57060);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57061_57110 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57062_57111 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57063_57112 = true;
var _STAR_print_fn_STAR__temp_val__57064_57113 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57063_57112);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57064_57113);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57062_57111);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57061_57110);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57059);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57054){
var G__57055 = cljs.core.first(seq57054);
var seq57054__$1 = cljs.core.next(seq57054);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57055,seq57054__$1);
}));
