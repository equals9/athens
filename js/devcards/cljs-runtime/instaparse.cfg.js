...
var G__56936 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56936)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56936)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56936)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56936)].join('')));
...
var G__56983 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56984 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__56983;
v = G__56984;
continue;
} else {
var G__56985 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__56986 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__56985;
v = G__56986;
continue;
}
...
break;
case "\"":
var G__56987 = cljs.core.next(sq);
var G__56988 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__56987;
v = G__56988;
continue;
...
break;
default:
var G__56989 = cljs.core.next(sq);
var G__56990 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__56989;
v = G__56990;
continue;
...
while(true){
var G__56945 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56945__$1 = (((G__56945 instanceof cljs.core.Keyword))?G__56945.fqn:null);
switch (G__56945__$1) {
case "rule":
var vec__56950 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56950,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56950,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56953 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56953) : instaparse.cfg.content.call(null,G__56953));
...
break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56954 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__56954) : instaparse.cfg.build_rule.call(null,G__56954));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56955 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__56956 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__56957 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56945__$1)].join('')));
...
case "neg":
case "rep":
var G__56996 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__56996;
continue;
...
var valid_nts_56997 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__56962_56998 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__56963_56999 = null;
var count__56964_57000 = (0);
var i__56965_57001 = (0);
while(true){
if((i__56965_57001 < count__56964_57000)){
var nt_57002 = chunk__56963_56999.cljs$core$IIndexed$_nth$arity$2(null,i__56965_57001);
if(cljs.core.truth_((valid_nts_56997.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56997.cljs$core$IFn$_invoke$arity$1(nt_57002) : valid_nts_56997.call(null,nt_57002)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57002),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57003 = seq__56962_56998;
var G__57004 = chunk__56963_56999;
var G__57005 = count__56964_57000;
var G__57006 = (i__56965_57001 + (1));
seq__56962_56998 = G__57003;
chunk__56963_56999 = G__57004;
count__56964_57000 = G__57005;
i__56965_57001 = G__57006;
continue;
} else {
var temp__5735__auto___57007 = cljs.core.seq(seq__56962_56998);
if(temp__5735__auto___57007){
var seq__56962_57008__$1 = temp__5735__auto___57007;
if(cljs.core.chunked_seq_QMARK_(seq__56962_57008__$1)){
var c__4609__auto___57009 = cljs.core.chunk_first(seq__56962_57008__$1);
var G__57010 = cljs.core.chunk_rest(seq__56962_57008__$1);
var G__57011 = c__4609__auto___57009;
var G__57012 = cljs.core.count(c__4609__auto___57009);
var G__57013 = (0);
seq__56962_56998 = G__57010;
chunk__56963_56999 = G__57011;
count__56964_57000 = G__57012;
i__56965_57001 = G__57013;
continue;
} else {
var nt_57014 = cljs.core.first(seq__56962_57008__$1);
if(cljs.core.truth_((valid_nts_56997.cljs$core$IFn$_invoke$arity$1 ? valid_nts_56997.cljs$core$IFn$_invoke$arity$1(nt_57014) : valid_nts_56997.call(null,nt_57014)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57014),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57015 = cljs.core.next(seq__56962_57008__$1);
var G__57016 = null;
var G__57017 = (0);
var G__57018 = (0);
seq__56962_56998 = G__57015;
chunk__56963_56999 = G__57016;
count__56964_57000 = G__57017;
i__56965_57001 = G__57018;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__56966_57019 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56967_57020 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56968_57021 = true;
var _STAR_print_fn_STAR__temp_val__56969_57022 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56968_57021);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56969_57022);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56967_57020);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56966_57019);
}
...
var len__4789__auto___57023 = arguments.length;
var i__4790__auto___57024 = (0);
while(true){
if((i__4790__auto___57024 < len__4789__auto___57023)){
args__4795__auto__.push((arguments[i__4790__auto___57024]));

var G__57025 = (i__4790__auto___57024 + (1));
i__4790__auto___57024 = G__57025;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__56972){
...
var opts = map__56973__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__56975 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__56976 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__56976);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__56977_57026 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__56978_57027 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__56979_57028 = true;
var _STAR_print_fn_STAR__temp_val__56980_57029 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__56979_57028);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__56980_57029);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__56978_57027);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__56977_57026);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__56975);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq56970){
var G__56971 = cljs.core.first(seq56970);
var seq56970__$1 = cljs.core.next(seq56970);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56971,seq56970__$1);
}));
