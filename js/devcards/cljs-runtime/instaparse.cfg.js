...
var G__56979 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__56979)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__56979)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__56979)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56979)].join('')));
...
var G__57028 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57027;
v = G__57028;
continue;
} else {
var G__57029 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57030 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57029;
v = G__57030;
continue;
}
...
var G__57032 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57031;
v = G__57032;
continue;
...
break;
default:
var G__57033 = cljs.core.next(sq);
var G__57034 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57033;
v = G__57034;
continue;
...
var G__56990 = null;
var G__56991 = null;
return (read_string_STAR__57035.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__57035.cljs$core$IFn$_invoke$arity$4(G__56988,G__56989,G__56990,G__56991) : read_string_STAR__57035.call(null,G__56988,G__56989,G__56990,G__56991));
});
/**
...
while(true){
var G__56993 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__56993__$1 = (((G__56993 instanceof cljs.core.Keyword))?G__56993.fqn:null);
switch (G__56993__$1) {
case "rule":
var vec__56994 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56994,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56994,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__56997 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__56997) : instaparse.cfg.content.call(null,G__56997));
...
break;
case "paren":
var G__57037 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57037;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__56998 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__56999 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57000 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57001 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57002 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57003 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
while(true){
var G__57004 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57039 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57039;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57004__$1)].join('')));
...
var valid_nts_57040 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57005_57041 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57006_57042 = null;
var count__57007_57043 = (0);
var i__57008_57044 = (0);
while(true){
if((i__57008_57044 < count__57007_57043)){
var nt_57045 = chunk__57006_57042.cljs$core$IIndexed$_nth$arity$2(null,i__57008_57044);
if(cljs.core.truth_((valid_nts_57040.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57040.cljs$core$IFn$_invoke$arity$1(nt_57045) : valid_nts_57040.call(null,nt_57045)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57045),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57046 = seq__57005_57041;
var G__57047 = chunk__57006_57042;
var G__57048 = count__57007_57043;
var G__57049 = (i__57008_57044 + (1));
seq__57005_57041 = G__57046;
chunk__57006_57042 = G__57047;
count__57007_57043 = G__57048;
i__57008_57044 = G__57049;
continue;
} else {
var temp__5735__auto___57050 = cljs.core.seq(seq__57005_57041);
if(temp__5735__auto___57050){
var seq__57005_57051__$1 = temp__5735__auto___57050;
if(cljs.core.chunked_seq_QMARK_(seq__57005_57051__$1)){
var c__4609__auto___57052 = cljs.core.chunk_first(seq__57005_57051__$1);
var G__57053 = cljs.core.chunk_rest(seq__57005_57051__$1);
var G__57054 = c__4609__auto___57052;
var G__57055 = cljs.core.count(c__4609__auto___57052);
var G__57056 = (0);
seq__57005_57041 = G__57053;
chunk__57006_57042 = G__57054;
count__57007_57043 = G__57055;
i__57008_57044 = G__57056;
continue;
} else {
var nt_57057 = cljs.core.first(seq__57005_57051__$1);
if(cljs.core.truth_((valid_nts_57040.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57040.cljs$core$IFn$_invoke$arity$1(nt_57057) : valid_nts_57040.call(null,nt_57057)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57057),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57058 = cljs.core.next(seq__57005_57051__$1);
var G__57059 = null;
var G__57060 = (0);
var G__57061 = (0);
seq__57005_57041 = G__57058;
chunk__57006_57042 = G__57059;
count__57007_57043 = G__57060;
i__57008_57044 = G__57061;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57009_57062 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57010_57063 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57011_57064 = true;
var _STAR_print_fn_STAR__temp_val__57012_57065 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57011_57064);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57012_57065);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57010_57063);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57009_57062);
}
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57015){
...
var opts = map__57016__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57018 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57019 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57019);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57020_57086 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57021_57087 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57022_57088 = true;
var _STAR_print_fn_STAR__temp_val__57023_57089 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57022_57088);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57023_57089);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57021_57087);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57020_57086);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57018);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57013){
var G__57014 = cljs.core.first(seq57013);
var seq57013__$1 = cljs.core.next(seq57013);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57014,seq57013__$1);
}));
