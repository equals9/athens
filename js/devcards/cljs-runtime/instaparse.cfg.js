...
var G__57372 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57372)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57372)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57372)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57372)].join('')));
...
var G__57420 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57419;
v = G__57420;
continue;
} else {
var G__57421 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57422 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57421;
v = G__57422;
continue;
}
...
var G__57424 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57423;
v = G__57424;
continue;
...
var G__57426 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57425;
v = G__57426;
continue;
...
var G__57379 = null;
var G__57380 = null;
return (read_string_STAR__57427.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__57427.cljs$core$IFn$_invoke$arity$4(G__57377,G__57378,G__57379,G__57380) : read_string_STAR__57427.call(null,G__57377,G__57378,G__57379,G__57380));
});
/**
...
switch (G__57381__$1) {
case "rule":
var vec__57386 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57386,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57386,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57389 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57389) : instaparse.cfg.content.call(null,G__57389));
...
break;
case "paren":
var G__57430 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57430;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57390 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57391 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57392 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57393 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57394 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
while(true){
var G__57397 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57432 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57432;
continue;
...
var valid_nts_57433 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57398_57434 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57399_57435 = null;
var count__57400_57436 = (0);
var i__57401_57437 = (0);
while(true){
if((i__57401_57437 < count__57400_57436)){
var nt_57438 = chunk__57399_57435.cljs$core$IIndexed$_nth$arity$2(null,i__57401_57437);
if(cljs.core.truth_((valid_nts_57433.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57433.cljs$core$IFn$_invoke$arity$1(nt_57438) : valid_nts_57433.call(null,nt_57438)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57438),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57439 = seq__57398_57434;
var G__57440 = chunk__57399_57435;
var G__57441 = count__57400_57436;
var G__57442 = (i__57401_57437 + (1));
seq__57398_57434 = G__57439;
chunk__57399_57435 = G__57440;
count__57400_57436 = G__57441;
i__57401_57437 = G__57442;
continue;
} else {
var temp__5735__auto___57443 = cljs.core.seq(seq__57398_57434);
if(temp__5735__auto___57443){
var seq__57398_57444__$1 = temp__5735__auto___57443;
if(cljs.core.chunked_seq_QMARK_(seq__57398_57444__$1)){
var c__4609__auto___57445 = cljs.core.chunk_first(seq__57398_57444__$1);
var G__57446 = cljs.core.chunk_rest(seq__57398_57444__$1);
var G__57447 = c__4609__auto___57445;
var G__57448 = cljs.core.count(c__4609__auto___57445);
var G__57449 = (0);
seq__57398_57434 = G__57446;
chunk__57399_57435 = G__57447;
count__57400_57436 = G__57448;
i__57401_57437 = G__57449;
continue;
} else {
var nt_57450 = cljs.core.first(seq__57398_57444__$1);
if(cljs.core.truth_((valid_nts_57433.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57433.cljs$core$IFn$_invoke$arity$1(nt_57450) : valid_nts_57433.call(null,nt_57450)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57450),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57451 = cljs.core.next(seq__57398_57444__$1);
var G__57452 = null;
var G__57453 = (0);
var G__57454 = (0);
seq__57398_57434 = G__57451;
chunk__57399_57435 = G__57452;
count__57400_57436 = G__57453;
i__57401_57437 = G__57454;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57402_57455 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57403_57456 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57404_57457 = true;
var _STAR_print_fn_STAR__temp_val__57405_57458 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57404_57457);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57405_57458);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57403_57456);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57402_57455);
}
...
args__4795__auto__.push((arguments[i__4790__auto___57460]));
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57408){
...
var _STAR_case_insensitive_literals_STAR__orig_val__57411 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57412 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57412);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57413_57462 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57414_57463 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57415_57464 = true;
var _STAR_print_fn_STAR__temp_val__57416_57465 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57415_57464);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57416_57465);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57414_57463);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57413_57462);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57411);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57406){
var G__57407 = cljs.core.first(seq57406);
var seq57406__$1 = cljs.core.next(seq57406);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57407,seq57406__$1);
}));
