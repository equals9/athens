...
var G__57034 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__57034)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__57034)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__57034)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57034)].join('')));
...
var G__57081 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57082 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__57081;
v = G__57082;
continue;
} else {
var G__57083 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__57084 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__57083;
v = G__57084;
continue;
}
...
break;
case "\"":
var G__57085 = cljs.core.next(sq);
var G__57086 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__57085;
v = G__57086;
continue;
...
break;
default:
var G__57087 = cljs.core.next(sq);
var G__57088 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__57087;
v = G__57088;
continue;
...
while(true){
var G__57043 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__57043__$1 = (((G__57043 instanceof cljs.core.Keyword))?G__57043.fqn:null);
switch (G__57043__$1) {
case "rule":
var vec__57044 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57044,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57044,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__57047 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__57047) : instaparse.cfg.content.call(null,G__57047));
...
break;
case "paren":
var G__57092 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__57092;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__57048 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__57049 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__57050 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__57051 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__57056 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57056) : instaparse.cfg.build_rule.call(null,G__57056));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__57057 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__57057) : instaparse.cfg.build_rule.call(null,G__57057));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__57043__$1)].join('')));
...
while(true){
var G__57058 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__57094 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__57094;
continue;
...
var valid_nts_57095 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__57060_57096 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__57061_57097 = null;
var count__57062_57098 = (0);
var i__57063_57099 = (0);
while(true){
if((i__57063_57099 < count__57062_57098)){
var nt_57100 = chunk__57061_57097.cljs$core$IIndexed$_nth$arity$2(null,i__57063_57099);
if(cljs.core.truth_((valid_nts_57095.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57095.cljs$core$IFn$_invoke$arity$1(nt_57100) : valid_nts_57095.call(null,nt_57100)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57100),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57101 = seq__57060_57096;
var G__57102 = chunk__57061_57097;
var G__57103 = count__57062_57098;
var G__57104 = (i__57063_57099 + (1));
seq__57060_57096 = G__57101;
chunk__57061_57097 = G__57102;
count__57062_57098 = G__57103;
i__57063_57099 = G__57104;
continue;
} else {
var temp__5735__auto___57105 = cljs.core.seq(seq__57060_57096);
if(temp__5735__auto___57105){
var seq__57060_57106__$1 = temp__5735__auto___57105;
if(cljs.core.chunked_seq_QMARK_(seq__57060_57106__$1)){
var c__4609__auto___57107 = cljs.core.chunk_first(seq__57060_57106__$1);
var G__57108 = cljs.core.chunk_rest(seq__57060_57106__$1);
var G__57109 = c__4609__auto___57107;
var G__57110 = cljs.core.count(c__4609__auto___57107);
var G__57111 = (0);
seq__57060_57096 = G__57108;
chunk__57061_57097 = G__57109;
count__57062_57098 = G__57110;
i__57063_57099 = G__57111;
continue;
} else {
var nt_57112 = cljs.core.first(seq__57060_57106__$1);
if(cljs.core.truth_((valid_nts_57095.cljs$core$IFn$_invoke$arity$1 ? valid_nts_57095.cljs$core$IFn$_invoke$arity$1(nt_57112) : valid_nts_57095.call(null,nt_57112)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_57112),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__57113 = cljs.core.next(seq__57060_57106__$1);
var G__57114 = null;
var G__57115 = (0);
var G__57116 = (0);
seq__57060_57096 = G__57113;
chunk__57061_57097 = G__57114;
count__57062_57098 = G__57115;
i__57063_57099 = G__57116;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__57064_57117 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57065_57118 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57066_57119 = true;
var _STAR_print_fn_STAR__temp_val__57067_57120 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57066_57119);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57067_57120);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57065_57118);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57064_57117);
}
...
var len__4789__auto___57121 = arguments.length;
var i__4790__auto___57122 = (0);
while(true){
if((i__4790__auto___57122 < len__4789__auto___57121)){
args__4795__auto__.push((arguments[i__4790__auto___57122]));

var G__57123 = (i__4790__auto___57122 + (1));
i__4790__auto___57122 = G__57123;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__57070){
...
var opts = map__57071__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__57073 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__57074 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__57074);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__57075_57124 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__57076_57125 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__57077_57126 = true;
var _STAR_print_fn_STAR__temp_val__57078_57127 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__57077_57126);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__57078_57127);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__57076_57125);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__57075_57124);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__57073);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq57068){
var G__57069 = cljs.core.first(seq57068);
var seq57068__$1 = cljs.core.next(seq57068);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__57069,seq57068__$1);
}));
