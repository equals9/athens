...
var G__57946 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57964__delegate = function (contents){
...
while (G__57965__i < G__57965__a.length) {G__57965__a[G__57965__i] = arguments[G__57965__i + 0]; ++G__57965__i;}
  contents = new cljs.core.IndexedSeq(G__57965__a,0,null);
} 
return G__57964__delegate.call(this,contents);};
G__57964.cljs$lang$maxFixedArity = 0;
G__57964.cljs$lang$applyTo = (function (arglist__57966){
var contents = cljs.core.seq(arglist__57966);
return G__57964__delegate(contents);
});
...
var node = (function (){var G__57948 = athens.db.dsdb;
var G__57949 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57950 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57948,G__57949,G__57950) : posh.reagent.pull.call(null,G__57948,G__57949,G__57950));
})();
...
var block = (function (){var G__57951 = athens.db.dsdb;
var G__57952 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
...
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57951,G__57952,G__57953) : posh.reagent.pull.call(null,G__57951,G__57952,G__57953));
})();
...
})], null),(function (){var G__57954 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57954) : athens.parse_renderer.parse_and_render.call(null,G__57954));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57955 = athens.db.dsdb;
var G__57956 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57957 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57955,G__57956,G__57957) : posh.reagent.pull.call(null,G__57955,G__57956,G__57957));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57958){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57959__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57959__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57961,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57962__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57947 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57946,G__57947) : instaparse.core.transform.call(null,G__57946,G__57947));
});
/**
