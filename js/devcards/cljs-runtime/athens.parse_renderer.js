...
var G__57984 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__58002__delegate = function (contents){
...
while (G__58003__i < G__58003__a.length) {G__58003__a[G__58003__i] = arguments[G__58003__i + 0]; ++G__58003__i;}
  contents = new cljs.core.IndexedSeq(G__58003__a,0,null);
} 
return G__58002__delegate.call(this,contents);};
G__58002.cljs$lang$maxFixedArity = 0;
G__58002.cljs$lang$applyTo = (function (arglist__58004){
var contents = cljs.core.seq(arglist__58004);
return G__58002__delegate(contents);
});
...
var node = (function (){var G__57986 = athens.db.dsdb;
var G__57987 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57988 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57986,G__57987,G__57988) : posh.reagent.pull.call(null,G__57986,G__57987,G__57988));
})();
...
var block = (function (){var G__57989 = athens.db.dsdb;
var G__57990 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57991 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57989,G__57990,G__57991) : posh.reagent.pull.call(null,G__57989,G__57990,G__57991));
})();
...
})], null),(function (){var G__57992 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57992) : athens.parse_renderer.parse_and_render.call(null,G__57992));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57993 = athens.db.dsdb;
var G__57994 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57995 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57993,G__57994,G__57995) : posh.reagent.pull.call(null,G__57993,G__57994,G__57995));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57996){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57997__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57997__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57999,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58000__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57985 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57984,G__57985) : instaparse.core.transform.call(null,G__57984,G__57985));
});
/**
