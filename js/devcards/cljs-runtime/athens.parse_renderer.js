...
var G__57970 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57988__delegate = function (contents){
...
while (G__57989__i < G__57989__a.length) {G__57989__a[G__57989__i] = arguments[G__57989__i + 0]; ++G__57989__i;}
  contents = new cljs.core.IndexedSeq(G__57989__a,0,null);
} 
return G__57988__delegate.call(this,contents);};
G__57988.cljs$lang$maxFixedArity = 0;
G__57988.cljs$lang$applyTo = (function (arglist__57990){
var contents = cljs.core.seq(arglist__57990);
return G__57988__delegate(contents);
});
...
var node = (function (){var G__57972 = athens.db.dsdb;
var G__57973 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57974 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57972,G__57973,G__57974) : posh.reagent.pull.call(null,G__57972,G__57973,G__57974));
})();
...
var block = (function (){var G__57975 = athens.db.dsdb;
var G__57976 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57977 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57975,G__57976,G__57977) : posh.reagent.pull.call(null,G__57975,G__57976,G__57977));
})();
...
})], null),(function (){var G__57978 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57978) : athens.parse_renderer.parse_and_render.call(null,G__57978));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57979 = athens.db.dsdb;
var G__57980 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57981 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57979,G__57980,G__57981) : posh.reagent.pull.call(null,G__57979,G__57980,G__57981));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57982){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57983__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57983__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57985,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57986__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57971 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57970,G__57971) : instaparse.core.transform.call(null,G__57970,G__57971));
});
/**
