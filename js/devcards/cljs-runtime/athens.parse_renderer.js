...
var G__57899 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__57917__delegate = function (contents){
...
return G__57917__delegate.call(this,contents);};
...
return G__57917__delegate(contents);
});
...
var node = (function (){var G__57901 = athens.db.dsdb;
...
var G__57903 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
...
var block = (function (){var G__57904 = athens.db.dsdb;
var G__57905 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57906 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57904,G__57905,G__57906) : posh.reagent.pull.call(null,G__57904,G__57905,G__57906));
})();
...
})], null),(function (){var G__57907 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__57907) : athens.parse_renderer.parse_and_render.call(null,G__57907));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__57908 = athens.db.dsdb;
var G__57909 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57910 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57908,G__57909,G__57910) : posh.reagent.pull.call(null,G__57908,G__57909,G__57910));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__57911){
...
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57912__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__57914,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57915__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__57900 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__57899,G__57900) : instaparse.core.transform.call(null,G__57899,G__57900));
});
/**
