...
var G__57016__delegate = function (tag_name){
...
var tag_name = null;
if (arguments.length > 0) {
var G__57024__i = 0, G__57024__a = new Array(arguments.length -  0);
while (G__57024__i < G__57024__a.length) {G__57024__a[G__57024__i] = arguments[G__57024__i + 0]; ++G__57024__i;}
  tag_name = new cljs.core.IndexedSeq(G__57024__a,0,null);
} 
return G__57016__delegate.call(this,tag_name);};
G__57016.cljs$lang$maxFixedArity = 0;
G__57016.cljs$lang$applyTo = (function (arglist__57026){
var tag_name = cljs.core.seq(arglist__57026);
return G__57016__delegate(tag_name);
});
