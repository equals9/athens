...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61114){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61115__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61115__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61117 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61117 = (function (meta61118){
this.meta61118 = meta61118;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61117.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61119,meta61118__$1){
var self__ = this;
var _61119__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61117(meta61118__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61117.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61119){
var self__ = this;
var _61119__$1 = this;
return self__.meta61118;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61117.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61117.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61117.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61117.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61117.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61117");

(athens.devcards.spinner.t_athens$devcards$spinner61117.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61117");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61117.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61117 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61117(meta61118){
return (new athens.devcards.spinner.t_athens$devcards$spinner61117(meta61118));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61117(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61120 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61120 = (function (meta61121){
this.meta61121 = meta61121;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61120.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61122,meta61121__$1){
var self__ = this;
var _61122__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61120(meta61121__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61120.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61122){
var self__ = this;
var _61122__$1 = this;
return self__.meta61121;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61120.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61120.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61120.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61120.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61120.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61120");

(athens.devcards.spinner.t_athens$devcards$spinner61120.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61120");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61120.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61120 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61120(meta61121){
return (new athens.devcards.spinner.t_athens$devcards$spinner61120(meta61121));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61120(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
