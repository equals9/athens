...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60928 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60928 = (function (meta60929){
this.meta60929 = meta60929;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60928.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60930,meta60929__$1){
var self__ = this;
var _60930__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60928(meta60929__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60928.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60930){
var self__ = this;
var _60930__$1 = this;
return self__.meta60929;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60928.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60928.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60928.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60929","meta60929",147665333,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60928.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60928.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60928");

(athens.devcards.spinner.t_athens$devcards$spinner60928.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60928");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60928.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60928 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60928(meta60929){
return (new athens.devcards.spinner.t_athens$devcards$spinner60928(meta60929));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60928(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60931 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60931 = (function (meta60932){
this.meta60932 = meta60932;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60931.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60933,meta60932__$1){
var self__ = this;
var _60933__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60931(meta60932__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60931.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60933){
var self__ = this;
var _60933__$1 = this;
return self__.meta60932;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60931.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60931.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60931.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60932","meta60932",-1301259379,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60931.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60931.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60931");

(athens.devcards.spinner.t_athens$devcards$spinner60931.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60931");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60931.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60931 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60931(meta60932){
return (new athens.devcards.spinner.t_athens$devcards$spinner60931(meta60932));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60931(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
