...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61188){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61189__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61189__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61194 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61194 = (function (meta61195){
this.meta61195 = meta61195;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61194.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61196,meta61195__$1){
var self__ = this;
var _61196__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61194(meta61195__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61194.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61196){
var self__ = this;
var _61196__$1 = this;
return self__.meta61195;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61194.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61194.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61194.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61194.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61194.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61194");

(athens.devcards.spinner.t_athens$devcards$spinner61194.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61194");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61194.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61194 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61194(meta61195){
return (new athens.devcards.spinner.t_athens$devcards$spinner61194(meta61195));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61194(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
