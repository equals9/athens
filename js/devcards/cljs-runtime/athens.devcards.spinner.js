...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61144){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61145__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61145__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61147 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61147 = (function (meta61148){
this.meta61148 = meta61148;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61147.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61149,meta61148__$1){
var self__ = this;
var _61149__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61147(meta61148__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61147.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61149){
var self__ = this;
var _61149__$1 = this;
return self__.meta61148;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61147.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61147.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61147.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61147.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61147.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61147");

(athens.devcards.spinner.t_athens$devcards$spinner61147.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61147");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61147.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61147 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61147(meta61148){
return (new athens.devcards.spinner.t_athens$devcards$spinner61147(meta61148));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61147(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61150 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61150 = (function (meta61151){
this.meta61151 = meta61151;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61150.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61152,meta61151__$1){
var self__ = this;
var _61152__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61150(meta61151__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61150.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61152){
var self__ = this;
var _61152__$1 = this;
return self__.meta61151;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61150.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61150.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61150.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61150.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61150.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61150");

(athens.devcards.spinner.t_athens$devcards$spinner61150.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61150");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61150.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61150 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61150(meta61151){
return (new athens.devcards.spinner.t_athens$devcards$spinner61150(meta61151));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61150(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
