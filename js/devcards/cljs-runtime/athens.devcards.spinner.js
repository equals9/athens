...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60846){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60847__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60847__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60853 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60853 = (function (meta60854){
this.meta60854 = meta60854;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60853.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60855,meta60854__$1){
var self__ = this;
var _60855__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60853(meta60854__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60853.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60855){
var self__ = this;
var _60855__$1 = this;
return self__.meta60854;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60853.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60853.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60853.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60853.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60853.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60853");

(athens.devcards.spinner.t_athens$devcards$spinner60853.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60853");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60853.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60853 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60853(meta60854){
return (new athens.devcards.spinner.t_athens$devcards$spinner60853(meta60854));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60853(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60869 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60869 = (function (meta60870){
this.meta60870 = meta60870;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60869.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60871,meta60870__$1){
var self__ = this;
var _60871__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60869(meta60870__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60869.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60871){
var self__ = this;
var _60871__$1 = this;
return self__.meta60870;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60869.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60869.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
var this__38815__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60869.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60870","meta60870",557460524,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60869.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60869.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60869");

(athens.devcards.spinner.t_athens$devcards$spinner60869.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60869");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60869.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60869 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60869(meta60870){
return (new athens.devcards.spinner.t_athens$devcards$spinner60869(meta60870));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60869(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
