...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60951){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60952__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60952__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60954 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60954 = (function (meta60955){
this.meta60955 = meta60955;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60954.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60956,meta60955__$1){
var self__ = this;
var _60956__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60954(meta60955__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60954.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60956){
var self__ = this;
var _60956__$1 = this;
return self__.meta60955;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60954.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60954.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60954.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60954.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60954.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60954");

(athens.devcards.spinner.t_athens$devcards$spinner60954.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60954");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60954.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60954 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60954(meta60955){
return (new athens.devcards.spinner.t_athens$devcards$spinner60954(meta60955));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60954(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60957 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60957 = (function (meta60958){
this.meta60958 = meta60958;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60957.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60959,meta60958__$1){
var self__ = this;
var _60959__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60957(meta60958__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60957.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60959){
var self__ = this;
var _60959__$1 = this;
return self__.meta60958;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60957.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60957.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60957.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta60958","meta60958",1184404677,null)], null);
}));

(athens.devcards.spinner.t_athens$devcards$spinner60957.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60957.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60957");

(athens.devcards.spinner.t_athens$devcards$spinner60957.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60957");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60957.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60957 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60957(meta60958){
return (new athens.devcards.spinner.t_athens$devcards$spinner60957(meta60958));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60957(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
