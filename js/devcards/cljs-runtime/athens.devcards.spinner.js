...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__60351){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60352__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60352__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60354 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner60354 = (function (meta60355){
this.meta60355 = meta60355;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60354.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60356,meta60355__$1){
var self__ = this;
var _60356__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60354(meta60355__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60354.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60356){
var self__ = this;
var _60356__$1 = this;
return self__.meta60355;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60354.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60354.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60354.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60354.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60354.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60354");

(athens.devcards.spinner.t_athens$devcards$spinner60354.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60354");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60354.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60354 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60354(meta60355){
return (new athens.devcards.spinner.t_athens$devcards$spinner60354(meta60355));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60354(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner60357 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner60357 = (function (meta60358){
this.meta60358 = meta60358;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner60357.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60359,meta60358__$1){
var self__ = this;
var _60359__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner60357(meta60358__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner60357.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60359){
var self__ = this;
var _60359__$1 = this;
return self__.meta60358;
}));

(athens.devcards.spinner.t_athens$devcards$spinner60357.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner60357.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38808__auto__,devcard_opts__38809__auto__){
var self__ = this;
var this__38808__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner60357.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner60357.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner60357.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner60357");

(athens.devcards.spinner.t_athens$devcards$spinner60357.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner60357");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner60357.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner60357 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner60357(meta60358){
return (new athens.devcards.spinner.t_athens$devcards$spinner60357(meta60358));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner60357(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
