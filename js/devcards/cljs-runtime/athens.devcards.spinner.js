...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61160){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61161__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61161__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61163 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61163 = (function (meta61164){
this.meta61164 = meta61164;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61163.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61165,meta61164__$1){
var self__ = this;
var _61165__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61163(meta61164__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61163.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61165){
var self__ = this;
var _61165__$1 = this;
return self__.meta61164;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61163.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61163.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61163.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61163.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61163.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61163");

(athens.devcards.spinner.t_athens$devcards$spinner61163.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61163");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61163.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61163 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61163(meta61164){
return (new athens.devcards.spinner.t_athens$devcards$spinner61163(meta61164));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61163(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61166 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61166 = (function (meta61167){
this.meta61167 = meta61167;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61166.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61168,meta61167__$1){
var self__ = this;
var _61168__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61166(meta61167__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61166.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61168){
var self__ = this;
var _61168__$1 = this;
return self__.meta61167;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61166.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61166.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61166.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61166.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61166.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61166");

(athens.devcards.spinner.t_athens$devcards$spinner61166.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61166");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61166.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61166 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61166(meta61167){
return (new athens.devcards.spinner.t_athens$devcards$spinner61166(meta61167));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61166(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
