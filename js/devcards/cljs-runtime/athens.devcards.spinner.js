...
athens.devcards.spinner.spinner_component = (function athens$devcards$spinner$spinner_component(p__61201){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61202__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61202__$1,new cljs.core.Keyword(null,"style","style",-496642736));
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61204 !== 'undefined')){
} else {
...
*/
athens.devcards.spinner.t_athens$devcards$spinner61204 = (function (meta61205){
this.meta61205 = meta61205;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61204.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61206,meta61205__$1){
var self__ = this;
var _61206__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61204(meta61205__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61204.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61206){
var self__ = this;
var _61206__$1 = this;
return self__.meta61205;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61204.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61204.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61204.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61204.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61204.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61204");

(athens.devcards.spinner.t_athens$devcards$spinner61204.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61204");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61204.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61204 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61204(meta61205){
return (new athens.devcards.spinner.t_athens$devcards$spinner61204(meta61205));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61204(null));
})()
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.spinner !== 'undefined') && (typeof athens.devcards.spinner.t_athens$devcards$spinner61207 !== 'undefined')){
} else {
 ...
 * @implements {devcards.core.IDevcardOptions}
*/
athens.devcards.spinner.t_athens$devcards$spinner61207 = (function (meta61208){
this.meta61208 = meta61208;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.spinner.t_athens$devcards$spinner61207.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61209,meta61208__$1){
var self__ = this;
var _61209__$1 = this;
return (new athens.devcards.spinner.t_athens$devcards$spinner61207(meta61208__$1));
}));

(athens.devcards.spinner.t_athens$devcards$spinner61207.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61209){
var self__ = this;
var _61209__$1 = this;
return self__.meta61208;
}));

(athens.devcards.spinner.t_athens$devcards$spinner61207.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.spinner.t_athens$devcards$spinner61207.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41690__auto__,devcard_opts__41691__auto__){
var self__ = this;
var this__41690__auto____$1 = this;
...
(athens.devcards.spinner.t_athens$devcards$spinner61207.getBasis = (function (){
...
(athens.devcards.spinner.t_athens$devcards$spinner61207.cljs$lang$type = true);

(athens.devcards.spinner.t_athens$devcards$spinner61207.cljs$lang$ctorStr = "athens.devcards.spinner/t_athens$devcards$spinner61207");

(athens.devcards.spinner.t_athens$devcards$spinner61207.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.spinner/t_athens$devcards$spinner61207");
}));

/**
 * Positional factory function for athens.devcards.spinner/t_athens$devcards$spinner61207.
 */
athens.devcards.spinner.__GT_t_athens$devcards$spinner61207 = (function athens$devcards$spinner$__GT_t_athens$devcards$spinner61207(meta61208){
return (new athens.devcards.spinner.t_athens$devcards$spinner61207(meta61208));
});

}

return (new athens.devcards.spinner.t_athens$devcards$spinner61207(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));
