...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__26295_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__26296_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__26301(s__26302){
return (new cljs.core.LazySeq(null,(function (){
var s__26302__$1 = s__26302;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__26302__$1);
if(temp__5735__auto__){
var s__26302__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26302__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__26302__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__26304 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__26303 = (0);
while(true){
if((i__26303 < size__4581__auto__)){
var vec__26309 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__26303);
...
cljs.core.chunk_append(b__26304,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__26521 = (i__26303 + (1));
i__26303 = G__26521;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26304),datascript$impl$entity$js_seq_$_iter__26301(cljs.core.chunk_rest(s__26302__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26304),null);
}
} else {
var vec__26321 = cljs.core.first(s__26302__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__26301(cljs.core.rest(s__26302__$2)));
}
} else {
return null;
}
...
var G__26525 = null;
var G__26525__1 = (function (f){
var self__ = this;
var this$ = this;
var seq__26359 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26360 = null;
var count__26361 = (0);
var i__26362 = (0);
while(true){
if((i__26362 < count__26361)){
var vec__26382 = chunk__26360.cljs$core$IIndexed$_nth$arity$2(null,i__26362);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26382,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26382,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__26529 = seq__26359;
var G__26530 = chunk__26360;
var G__26531 = count__26361;
var G__26532 = (i__26362 + (1));
seq__26359 = G__26529;
chunk__26360 = G__26530;
count__26361 = G__26531;
i__26362 = G__26532;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__26359);
if(temp__5735__auto__){
var seq__26359__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__26359__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__26359__$1);
var G__26554 = cljs.core.chunk_rest(seq__26359__$1);
var G__26555 = c__4609__auto__;
var G__26556 = cljs.core.count(c__4609__auto__);
var G__26557 = (0);
seq__26359 = G__26554;
chunk__26360 = G__26555;
count__26361 = G__26556;
i__26362 = G__26557;
continue;
} else {
var vec__26387 = cljs.core.first(seq__26359__$1);
...
var G__26558 = cljs.core.next(seq__26359__$1);
var G__26559 = null;
var G__26560 = (0);
var G__26561 = (0);
seq__26359 = G__26558;
chunk__26360 = G__26559;
count__26361 = G__26560;
i__26362 = G__26561;
continue;
}
} else {
...
var G__26525__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
var seq__26392 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__26393 = null;
var count__26394 = (0);
var i__26395 = (0);
while(true){
if((i__26395 < count__26394)){
var vec__26415 = chunk__26393.cljs$core$IIndexed$_nth$arity$2(null,i__26395);
...
var G__26562 = seq__26392;
var G__26563 = chunk__26393;
var G__26564 = count__26394;
var G__26565 = (i__26395 + (1));
seq__26392 = G__26562;
chunk__26393 = G__26563;
count__26394 = G__26564;
i__26395 = G__26565;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__26392);
if(temp__5735__auto__){
var seq__26392__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__26392__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__26392__$1);
var G__26568 = cljs.core.chunk_rest(seq__26392__$1);
var G__26569 = c__4609__auto__;
var G__26570 = cljs.core.count(c__4609__auto__);
var G__26571 = (0);
seq__26392 = G__26568;
chunk__26393 = G__26569;
count__26394 = G__26570;
i__26395 = G__26571;
continue;
} else {
var vec__26421 = cljs.core.first(seq__26392__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26421,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26421,(1),null);
f.call(use_as_this,v,a,this$);


var G__26572 = cljs.core.next(seq__26392__$1);
var G__26573 = null;
var G__26574 = (0);
var G__26575 = (0);
seq__26392 = G__26572;
chunk__26393 = G__26573;
count__26394 = G__26574;
i__26395 = G__26575;
continue;
}
} else {
...
G__26525 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__26525__1.call(this,f);
case 2:
return G__26525__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__26525.cljs$core$IFn$_invoke$arity$1 = G__26525__1;
...
var self__ = this;
var this$__$1 = this;
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353),(function (){var G__26455 = this$__$1;
var G__26456 = k;
var G__26457 = new cljs.core.Keyword("datascript.impl.entity","nf","datascript.impl.entity/nf",-953741353);
return (datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3 ? datascript.impl.entity.lookup_entity.cljs$core$IFn$_invoke$arity$3(G__26455,G__26456,G__26457) : datascript.impl.entity.lookup_entity.call(null,G__26455,G__26456,G__26457));
})());
}));
...
var self__ = this;
var self__ = this;
var G__26459 = (arguments.length - (1));
switch (G__26459) {
case (1):
...
(datascript.impl.entity.Entity.prototype.apply = (function (self__,args26349){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args26349)));
}));
...
var temp__5737__auto__ = (function (){var fexpr__26486 = cljs.core.deref(this$.cache);
return (fexpr__26486.cljs$core$IFn$_invoke$arity$1 ? fexpr__26486.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__26486.call(null,attr));
})();
