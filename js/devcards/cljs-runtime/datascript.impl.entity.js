...
var G__28218 = db;
var G__28219 = e;
var G__28220 = cljs.core.volatile_BANG_(false);
var G__28221 = cljs.core.volatile_BANG_(cljs.core.PersistentArrayMap.EMPTY);
return (datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4 ? datascript.impl.entity.__GT_Entity.cljs$core$IFn$_invoke$arity$4(G__28218,G__28219,G__28220,G__28221) : datascript.impl.entity.__GT_Entity.call(null,G__28218,G__28219,G__28220,G__28221));
} else {
return null;
}
});
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28222_SHARP_,p2__28223_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28222_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28223_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
} else {
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28224_SHARP_,p2__28225_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28224_SHARP_,new cljs.core.Keyword(null,"v","v",21465059).cljs$core$IFn$_invoke$arity$1(p2__28225_SHARP_));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
if(datascript.db.ref_QMARK_(db,a)){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28226_SHARP_,p2__28227_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__28226_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__28227_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4529__auto__ = (function datascript$impl$entity$js_seq_$_iter__28228(s__28229){
return (new cljs.core.LazySeq(null,(function (){
var s__28229__$1 = s__28229;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__28229__$1);
if(temp__5735__auto__){
var s__28229__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__28229__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__28229__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__28231 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__28230 = (0);
while(true){
if((i__28230 < size__4528__auto__)){
var vec__28232 = cljs.core._nth(c__4527__auto__,i__28230);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28232,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28232,(1),null);
cljs.core.chunk_append(b__28231,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__28392 = (i__28230 + (1));
i__28230 = G__28392;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28231),datascript$impl$entity$js_seq_$_iter__28228(cljs.core.chunk_rest(s__28229__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28231),null);
}
} else {
var vec__28235 = cljs.core.first(s__28229__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__28228(cljs.core.rest(s__28229__$2)));
}
} else {
return null;
}
...
var G__28402 = seq__28239;
var G__28403 = chunk__28240;
var G__28404 = count__28241;
var G__28405 = (i__28242 + (1));
seq__28239 = G__28402;
chunk__28240 = G__28403;
count__28241 = G__28404;
i__28242 = G__28405;
continue;
} else {
...
var G__28410 = cljs.core.chunk_rest(seq__28239__$1);
var G__28411 = c__4556__auto__;
var G__28412 = cljs.core.count(c__4556__auto__);
var G__28413 = (0);
seq__28239 = G__28410;
chunk__28240 = G__28411;
count__28241 = G__28412;
i__28242 = G__28413;
continue;
} else {
...
var G__28414 = cljs.core.next(seq__28239__$1);
var G__28415 = null;
var G__28416 = (0);
var G__28417 = (0);
seq__28239 = G__28414;
chunk__28240 = G__28415;
count__28241 = G__28416;
i__28242 = G__28417;
continue;
}
} else {
...
var G__28396__2 = (function (f,use_as_this){
var self__ = this;
var this$ = this;
...
var G__28420 = seq__28255;
var G__28421 = chunk__28256;
var G__28422 = count__28257;
var G__28423 = (i__28258 + (1));
seq__28255 = G__28420;
chunk__28256 = G__28421;
count__28257 = G__28422;
i__28258 = G__28423;
continue;
} else {
...
var G__28430 = cljs.core.chunk_rest(seq__28255__$1);
var G__28431 = c__4556__auto__;
var G__28432 = cljs.core.count(c__4556__auto__);
var G__28433 = (0);
seq__28255 = G__28430;
chunk__28256 = G__28431;
count__28257 = G__28432;
i__28258 = G__28433;
continue;
} else {
...
var G__28438 = cljs.core.next(seq__28255__$1);
var G__28439 = null;
var G__28440 = (0);
var G__28441 = (0);
seq__28255 = G__28438;
chunk__28256 = G__28439;
count__28257 = G__28440;
i__28258 = G__28441;
continue;
}
} else {
...
G__28396 = function(f,use_as_this){
switch(arguments.length){
case 1:
return G__28396__1.call(this,f);
case 2:
return G__28396__2.call(this,f,use_as_this);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__28396.cljs$core$IFn$_invoke$arity$1 = G__28396__1;
...
var self__ = this;
var self__ = this;
var G__28280 = (arguments.length - (1));
switch (G__28280) {
case (1):
...
var temp__5737__auto__ = (function (){var fexpr__28343 = cljs.core.deref(this$.cache);
return (fexpr__28343.cljs$core$IFn$_invoke$arity$1 ? fexpr__28343.cljs$core$IFn$_invoke$arity$1(attr) : fexpr__28343.call(null,attr));
})();
...
var temp__5735__auto___28483 = cljs.core.not_empty(datascript.db._search(e.db,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [e.eid], null)));
if(cljs.core.truth_(temp__5735__auto___28483)){
var datoms_28484 = temp__5735__auto___28483;
cljs.core.vreset_BANG_(e.cache,datascript.impl.entity.touch_components(e.db,datascript.impl.entity.datoms__GT_cache(e.db,datoms_28484)));
