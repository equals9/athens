...
var G__29305 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__29306 = rest_datom;
var G__29307 = cljs.core.rest(patterns);
var G__29308 = new_patterns;
var G__29309 = leftover_patterns;
entids = G__29305;
rest_datom = G__29306;
patterns = G__29307;
new_patterns = G__29308;
leftover_patterns = G__29309;
continue;
} else {
var G__29311 = entids;
