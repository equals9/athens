...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__29046 = cljs.core.first(datom);
return (p.cljs$core$IFn$_invoke$arity$1 ? p.cljs$core$IFn$_invoke$arity$1(G__29046) : p.call(null,G__29046));
})():false);
...
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__29048_SHARP_,datom);
}),patterns);
});
