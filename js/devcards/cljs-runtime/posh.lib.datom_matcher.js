...
var G__29080 = cljs.core.rest(pattern);
var G__29081 = cljs.core.rest(datom);
pattern = G__29080;
datom = G__29081;
continue;
} else {
...
var G__29101 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(entids,((cljs.core.set_QMARK_(cljs.core.ffirst(patterns)))?cljs.core.ffirst(patterns):cljs.core.set(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.ffirst(patterns)], null))));
var G__29102 = rest_datom;
var G__29103 = cljs.core.rest(patterns);
var G__29104 = new_patterns;
var G__29105 = leftover_patterns;
entids = G__29101;
rest_datom = G__29102;
patterns = G__29103;
new_patterns = G__29104;
leftover_patterns = G__29105;
continue;
} else {
var G__29106 = entids;
...
var G__29115 = new cljs.core.Keyword(null,"new-patterns","new-patterns",404552774).cljs$core$IFn$_invoke$arity$1(r);
var G__29116 = new cljs.core.Keyword(null,"leftover-patterns","leftover-patterns",377032963).cljs$core$IFn$_invoke$arity$1(r);
new_patterns = G__29115;
leftover_patterns = G__29116;
continue;
} else {
