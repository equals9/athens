...
var G__25505 = cljs.core.cons(pdb,path);
var G__25506 = posh.lib.db.get_parent_db(pdb);
path = G__25505;
pdb = G__25506;
continue;
} else {
...
var G__25507 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__25507;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25477__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25477__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25477__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25477__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__25487,poshdb){
...
var posh_tree = map__25488__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25488__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25488__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__25493 = (function (){var G__25495 = posh_tree;
var G__25496 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__25495,G__25496) : posh.lib.db.poshdb__GT_db.call(null,G__25495,G__25496));
})();
var G__25494 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__25492 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25492.cljs$core$IFn$_invoke$arity$2 ? fexpr__25492.cljs$core$IFn$_invoke$arity$2(G__25493,G__25494) : fexpr__25492.call(null,G__25493,G__25494));
}
});
