...
var G__25495 = cljs.core.cons(pdb,path);
var G__25496 = posh.lib.db.get_parent_db(pdb);
path = G__25495;
pdb = G__25496;
continue;
} else {
...
var G__25498 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__25498;
continue;
}
break;
...
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__25473 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25473.cljs$core$IFn$_invoke$arity$2 ? fexpr__25473.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__25473.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__25474 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25474.cljs$core$IFn$_invoke$arity$2 ? fexpr__25474.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__25474.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__25475 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25475.cljs$core$IFn$_invoke$arity$2 ? fexpr__25475.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__25475.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__25477 = db__$4;
var G__25478 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__25476 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25476.cljs$core$IFn$_invoke$arity$2 ? fexpr__25476.cljs$core$IFn$_invoke$arity$2(G__25477,G__25478) : fexpr__25476.call(null,G__25477,G__25478));
})():db__$4);
return db__$5;
}));
...
var G__25485 = (function (){var G__25487 = posh_tree;
var G__25488 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__25487,G__25488) : posh.lib.db.poshdb__GT_db.call(null,G__25487,G__25488));
})();
