...
var G__30655 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30655__$1)].join('')));
...
var G__30705 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__30705;
continue;
}
break;
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__30682,poshdb){
...
var posh_tree = map__30684__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30684__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30684__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
