...
var G__25452 = cljs.core.first(poshdb);
var G__25452__$1 = (((G__25452 instanceof cljs.core.Keyword))?G__25452.fqn:null);
switch (G__25452__$1) {
case "db":
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25452__$1)].join('')));
...
var G__25494 = cljs.core.cons(pdb,path);
var G__25495 = posh.lib.db.get_parent_db(pdb);
path = G__25494;
pdb = G__25495;
continue;
} else {
...
var G__25497 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__25497;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25462__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25462__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25462__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25462__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4126__auto__ = db;
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
} else {
var fexpr__25464 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25464.cljs$core$IFn$_invoke$arity$1 ? fexpr__25464.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__25464.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__25465 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25465.cljs$core$IFn$_invoke$arity$2 ? fexpr__25465.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__25465.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__25466 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25466.cljs$core$IFn$_invoke$arity$2 ? fexpr__25466.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__25466.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__25467 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25467.cljs$core$IFn$_invoke$arity$2 ? fexpr__25467.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__25467.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__25473 = db__$4;
var G__25474 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__25472 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25472.cljs$core$IFn$_invoke$arity$2 ? fexpr__25472.cljs$core$IFn$_invoke$arity$2(G__25473,G__25474) : fexpr__25472.call(null,G__25473,G__25474));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__25479,poshdb){
...
var posh_tree = map__25480__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25480__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25480__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__25483 = (function (){var G__25485 = posh_tree;
var G__25486 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__25485,G__25486) : posh.lib.db.poshdb__GT_db.call(null,G__25485,G__25486));
})();
var G__25484 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
