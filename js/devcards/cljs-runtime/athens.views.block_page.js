...
athens.views.block_page.block_page_el = (function athens$views$block_page$block_page_el(p__58061,parents,editing_uid){
...
var string = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58062__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58062__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
...
}),cljs.core.interpose.cljs$core$IFn$_invoke$arity$2(">",(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58064(s__58065){
...
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58068__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58068__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
cljs.core.chunk_append(b__58067,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__58066,map__58068,map__58068__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58067,s__58065__$2,temp__5735__auto__,map__58062,map__58062__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(i__58066,map__58068,map__58068__$1,title,uid__$1,string__$1,c__4580__auto__,size__4581__auto__,b__58067,s__58065__$2,temp__5735__auto__,map__58062,map__58062__$1,string,children,uid))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58067),athens$views$block_page$block_page_el_$_iter__58064(cljs.core.chunk_rest(s__58065__$2)));
} else {
...
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58070__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58070__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__58070,map__58070__$1,title,uid__$1,string__$1,s__58065__$2,temp__5735__auto__,map__58062,map__58062__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid.cljs$core$IFn$_invoke$arity$1(uid__$1);
});})(map__58070,map__58070__$1,title,uid__$1,string__$1,s__58065__$2,temp__5735__auto__,map__58062,map__58062__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
})()], null),athens$views$block_page$block_page_el_$_iter__58064(cljs.core.rest(s__58065__$2)));
}
} else {
return null;
}
...
var G__58072 = e.target.value;
var G__58073 = uid;
return (athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2 ? athens.views.blocks.db_on_change.cljs$core$IFn$_invoke$arity$2(G__58072,G__58073) : athens.views.blocks.db_on_change.call(null,G__58072,G__58073));
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),string], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$views$block_page$block_page_el_$_iter__58074(s__58075){
return (new cljs.core.LazySeq(null,(function (){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58076);
cljs.core.chunk_append(b__58077,(function (){var map__58078 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58078__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58077),athens$views$block_page$block_page_el_$_iter__58074(cljs.core.chunk_rest(s__58075__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58077),null);
}
} else {
var child = cljs.core.first(s__58075__$2);
return cljs.core.cons((function (){var map__58080 = child;
...
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58080__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$views$block_page$block_page_el_$_iter__58074(cljs.core.rest(s__58075__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__58082 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("editing","uid","editing/uid",974963040)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__58082) : re_frame.core.subscribe.call(null,G__58082));
})());
