...
var G__41369 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__41369,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__41369;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq41374){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41375,G__41376,seq41374__$2);
}));
...
var map__41389 = m;
var map__41389__$1 = (((((!((map__41389 == null))))?(((((map__41389.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__41389.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__41389):map__41389);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41389__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41389__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41389__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__41386_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__41386_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__41401 = cljs.core.get_global_hierarchy;
return (fexpr__41401.cljs$core$IFn$_invoke$arity$0 ? fexpr__41401.cljs$core$IFn$_invoke$arity$0() : fexpr__41401.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__41406 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41406) : formatter_fn.call(null,G__41406));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__41407 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__41407) : formatter_fn.call(null,G__41407));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__41442 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__41442,"/"].join('');
} else {
return G__41442;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__41460 = exception.stack;
var G__41460__$1 = (((G__41460 == null))?null:clojure.string.split_lines(G__41460));
var G__41460__$2 = (((G__41460__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__41460__$1,depth));
if((G__41460__$2 == null)){
return null;
} else {
return clojure.string.trim(G__41460__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__41476 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41476,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41476,(1),null);
var vec__41479 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41479,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41479,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41479,(2),null);
...
var m__$1 = (function (){var G__41483 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__41483__$1 = (((G__41483 instanceof cljs.core.Keyword))?G__41483.fqn:null);
switch (G__41483__$1) {
case "fail":
...
var G__41490 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__41493 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__41493) : cljs.test.run_block.call(null,G__41493));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__41490) : obj.call(null,G__41490));
} else {
var G__41540 = (function (){var G__41495 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__41495);
} else {
return G__41495;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__41499,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var G__41508 = type;
var G__41509 = new cljs.core.Keyword(null,"async","async",1050769601);
var fexpr__41507 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword(null,"async","async",1050769601),new cljs.core.Keyword(null,"fn","fn",-1175266204),new cljs.core.Keyword(null,"sync","sync",-624148946),new cljs.core.Keyword("cljs.analyzer","analyzed","cljs.analyzer/analyzed",-735094162),true], null);
return (fexpr__41507.cljs$core$IFn$_invoke$arity$2 ? fexpr__41507.cljs$core$IFn$_invoke$arity$2(G__41508,G__41509) : fexpr__41507.call(null,G__41508,G__41509));
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__41510){
var vec__41511 = p__41510;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41511,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41511,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__41514 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var seq__41517 = cljs.core.seq(vars__$1);
var chunk__41518 = null;
var count__41519 = (0);
var i__41520 = (0);
while(true){
if((i__41520 < count__41519)){
var v = chunk__41518.cljs$core$IIndexed$_nth$arity$2(null,i__41520);
var temp__5735__auto___41558 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___41558)){
var t_41560 = temp__5735__auto___41558;
var G__41526_41561 = ((function (seq__41517,chunk__41518,count__41519,i__41520,t_41560,temp__5735__auto___41558,v,each_fixture_fn,G__41514,G__41514__$1,env,once_fixtures,each_fixtures,vec__41511,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_41560)));
});})(seq__41517,chunk__41518,count__41519,i__41520,t_41560,temp__5735__auto___41558,v,each_fixture_fn,G__41514,G__41514__$1,env,once_fixtures,each_fixtures,vec__41511,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__41526_41561) : each_fixture_fn.call(null,G__41526_41561));
} else {
}


var G__41562 = seq__41517;
var G__41563 = chunk__41518;
var G__41564 = count__41519;
var G__41565 = (i__41520 + (1));
seq__41517 = G__41562;
chunk__41518 = G__41563;
count__41519 = G__41564;
i__41520 = G__41565;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__41517);
if(temp__5735__auto__){
var seq__41517__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__41517__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__41517__$1);
var G__41567 = cljs.core.chunk_rest(seq__41517__$1);
var G__41568 = c__4609__auto__;
var G__41569 = cljs.core.count(c__4609__auto__);
var G__41570 = (0);
seq__41517 = G__41567;
chunk__41518 = G__41568;
count__41519 = G__41569;
i__41520 = G__41570;
continue;
} else {
var v = cljs.core.first(seq__41517__$1);
var temp__5735__auto___41572__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___41572__$1)){
var t_41573 = temp__5735__auto___41572__$1;
var G__41527_41574 = ((function (seq__41517,chunk__41518,count__41519,i__41520,t_41573,temp__5735__auto___41572__$1,v,seq__41517__$1,temp__5735__auto__,each_fixture_fn,G__41514,G__41514__$1,env,once_fixtures,each_fixtures,vec__41511,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_41573)));
});})(seq__41517,chunk__41518,count__41519,i__41520,t_41573,temp__5735__auto___41572__$1,v,seq__41517__$1,temp__5735__auto__,each_fixture_fn,G__41514,G__41514__$1,env,once_fixtures,each_fixtures,vec__41511,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__41527_41574) : each_fixture_fn.call(null,G__41527_41574));
} else {
}


var G__41575 = cljs.core.next(seq__41517__$1);
var G__41576 = null;
var G__41577 = (0);
var G__41578 = (0);
seq__41517 = G__41575;
chunk__41518 = G__41576;
count__41519 = G__41577;
i__41520 = G__41578;
continue;
}
} else {
...
var fexpr__41515 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__41515.cljs$core$IFn$_invoke$arity$1 ? fexpr__41515.cljs$core$IFn$_invoke$arity$1(G__41516) : fexpr__41515.call(null,G__41516));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41514__$1)].join('')));
