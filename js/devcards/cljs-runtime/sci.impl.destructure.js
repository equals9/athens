...
var G__58402 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58403 = n;
var G__58404 = cljs.core.nnext(bs);
var G__58405 = true;
ret = G__58402;
n = G__58403;
bs = G__58404;
seen_rest_QMARK_ = G__58405;
continue;
} else {
...
var G__58407 = (n + (1));
var G__58408 = cljs.core.next(bs);
var G__58409 = seen_rest_QMARK_;
ret = G__58406;
n = G__58407;
bs = G__58408;
seen_rest_QMARK_ = G__58409;
continue;
}
...
});})(G__58398,gmap,defaults,pvec,bents))
;
return fexpr__58397(G__58398);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58378_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58378_SHARP_);
}
})(),cljs.core.name(p1__58378_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58379_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58379_SHARP_);
}
})(),cljs.core.name(p1__58379_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58380_SHARP_,p2__58381_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58380_SHARP_,p2__58381_SHARP_,(function (){var fexpr__58399 = cljs.core.val(entry);
return (fexpr__58399.cljs$core$IFn$_invoke$arity$1 ? fexpr__58399.cljs$core$IFn$_invoke$arity$1(p2__58381_SHARP_) : fexpr__58399.call(null,p2__58381_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58400 = cljs.core.key(entry);
return (fexpr__58400.cljs$core$IFn$_invoke$arity$1 ? fexpr__58400.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58400.call(null,bes));
})());
...
var G__58410 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58411 = cljs.core.next(bes);
ret = G__58410;
bes = G__58411;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58382_SHARP_){
return (cljs.core.first(p1__58382_SHARP_) instanceof cljs.core.Keyword);
}),bents));
