...
var G__58599 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58600 = n;
var G__58601 = cljs.core.nnext(bs);
var G__58602 = true;
ret = G__58599;
n = G__58600;
bs = G__58601;
seen_rest_QMARK_ = G__58602;
continue;
} else {
...
});})(G__58594,gmap,defaults,pvec,bents))
;
return fexpr__58593(G__58594);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58585_SHARP_,p2__58586_SHARP_,(function (){var fexpr__58595 = cljs.core.val(entry);
return (fexpr__58595.cljs$core$IFn$_invoke$arity$1 ? fexpr__58595.cljs$core$IFn$_invoke$arity$1(p2__58586_SHARP_) : fexpr__58595.call(null,p2__58586_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58596 = cljs.core.key(entry);
return (fexpr__58596.cljs$core$IFn$_invoke$arity$1 ? fexpr__58596.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58596.call(null,bes));
})());
...
var G__58611 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58612 = cljs.core.next(bes);
ret = G__58611;
bes = G__58612;
continue;
} else {
