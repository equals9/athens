...
var G__58266 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__58267 = n;
var G__58268 = cljs.core.nnext(bs);
var G__58269 = true;
ret = G__58266;
n = G__58267;
bs = G__58268;
seen_rest_QMARK_ = G__58269;
continue;
} else {
...
});})(G__58262,gmap,defaults,pvec,bents))
;
return fexpr__58261(G__58262);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58242_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58242_SHARP_);
}
})(),cljs.core.name(p1__58242_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__58243_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__58243_SHARP_);
}
})(),cljs.core.name(p1__58243_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__58244_SHARP_,p2__58245_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__58244_SHARP_,p2__58245_SHARP_,(function (){var fexpr__58263 = cljs.core.val(entry);
return (fexpr__58263.cljs$core$IFn$_invoke$arity$1 ? fexpr__58263.cljs$core$IFn$_invoke$arity$1(p2__58245_SHARP_) : fexpr__58263.call(null,p2__58245_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__58264 = cljs.core.key(entry);
return (fexpr__58264.cljs$core$IFn$_invoke$arity$1 ? fexpr__58264.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__58264.call(null,bes));
})());
...
var G__58274 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__58275 = cljs.core.next(bes);
ret = G__58274;
bes = G__58275;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58246_SHARP_){
return (cljs.core.first(p1__58246_SHARP_) instanceof cljs.core.Keyword);
}),bents));
