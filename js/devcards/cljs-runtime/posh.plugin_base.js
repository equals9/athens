...
return posh.core.add_pull(p1__31246_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.core.add_pull_many(p1__31260_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return (fexpr__31308.cljs$core$IFn$_invoke$arity$1 ? fexpr__31308.cljs$core$IFn$_invoke$arity$1(p1__31291_SHARP_) : fexpr__31308.call(null,p1__31291_SHARP_));
})())){
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31316_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31316_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
