...
return posh.core.add_pull(p1__31226_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.core.add_pull_many(p1__31241_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
var parsed_query = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31261,(0),null);
var last_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31261,(1),null);
...
return (fexpr__31306.cljs$core$IFn$_invoke$arity$1 ? fexpr__31306.cljs$core$IFn$_invoke$arity$1(p1__31294_SHARP_) : fexpr__31306.call(null,p1__31294_SHARP_));
})())){
...
var posh_atom = cljs.core.first(cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31295_SHARP_){
return posh.plugin_base.get_posh_atom(dcfg,p1__31295_SHARP_);
}),args)));
var storage_key = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"q","q",689001697),query,true_poshdb_args], null);
...
/** @this {Function} */
(posh.plugin_base.q_info.cljs$lang$applyTo = (function (seq31298){
