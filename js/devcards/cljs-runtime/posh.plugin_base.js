...
return posh.core.add_pull(p1__31231_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31278_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__31278_SHARP_,query),true_poshdb_args);
}),options);
}));
