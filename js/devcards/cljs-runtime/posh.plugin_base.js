...
var query_reaction = (function (){var G__31252 = (function (){
return cljs.core.deref(query_ratom);
});
var G__31253 = new cljs.core.Keyword(null,"on-dispose","on-dispose",2105306360);
var G__31254 = (function (_,___$1){
...
var fexpr__31251 = new cljs.core.Keyword(null,"make-reaction","make-reaction",295148585).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__31251.cljs$core$IFn$_invoke$arity$3 ? fexpr__31251.cljs$core$IFn$_invoke$arity$3(G__31252,G__31253,G__31254) : fexpr__31251.call(null,G__31252,G__31253,G__31254));
})();
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31264_SHARP_){
return posh.core.add_pull(p1__31264_SHARP_,true_poshdb,pull_pattern,eid);
}),options);
}));
...
return posh.core.add_pull_many(p1__31277_SHARP_,true_poshdb,pull_pattern,eids);
}),options);
}));
...
return posh.plugin_base.make_query_reaction.cljs$core$IFn$_invoke$arity$5(dcfg,posh_atom,storage_key,(function (p1__31304_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$3(posh.core.add_q,p1__31304_SHARP_,query),true_poshdb_args);
}),options);
}));
...
/** @this {Function} */
(posh.plugin_base.q.cljs$lang$applyTo = (function (seq31307){
