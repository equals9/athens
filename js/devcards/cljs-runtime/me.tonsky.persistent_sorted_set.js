...
while(true){
if((i__24796__auto___24898 < n__4666__auto___24895)){
...
var G__25062 = new_left;
var G__25063 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25064 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
...
var pos_25128 = (0);
while(true){
var rest_25129 = (len - pos_25128);
if((rest_25129 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25128));
} else {
if((rest_25129 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25128,(pos_25128 + chunk_len)));

var G__25131 = (pos_25128 + chunk_len);
pos_25128 = G__25131;
continue;
} else {
var piece_len_25132 = (rest_25129 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25128,(pos_25128 + piece_len_25132)));

var G__25134 = (pos_25128 + piece_len_25132);
pos_25128 = G__25134;
continue;
...
break;
default:
var G__25180 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__24874,leaves){
...
var G__25181 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__25180;
shift = G__25181;
continue;
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___25196 = arguments.length;
var i__4790__auto___25197 = (0);
while(true){
if((i__4790__auto___25197 < len__4789__auto___25196)){
args_arr__4810__auto__.push((arguments[i__4790__auto___25197]));

var G__25198 = (i__4790__auto___25197 + (1));
i__4790__auto___25197 = G__25198;
continue;
} else {
}
break;
