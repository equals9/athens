...
while(true){
if((level__$1 > (0))){
var G__26784 = (function (){var arr__26558__auto__ = node__$1.pointers;
return (arr__26558__auto__[(arr__26558__auto__.length - (1))]);
})();
var G__26785 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__26786 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__26784;
path = G__26785;
level__$1 = G__26786;
continue;
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26811 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26811(this$,left,right);
}
});
...
var G__26882 = (node.pointers[idx]);
var G__26883 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26884 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26882;
path = G__26883;
level = G__26884;
continue;
...
var G__26892 = (node.pointers[idx]);
var G__26893 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26894 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26892;
path = G__26893;
level = G__26894;
continue;
...
var G__26916 = (pos_26914 + chunk_len);
pos_26914 = G__26916;
continue;
} else {
var piece_len_26917 = (rest_26915 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26914,(pos_26914 + piece_len_26917)));

var G__26920 = (pos_26914 + piece_len_26917);
pos_26914 = G__26920;
continue;
...
var i__4737__auto___26951 = (0);
while(true){
if((i__4737__auto___26951 < len__4736__auto___26949)){
args_arr__4757__auto__.push((arguments[i__4737__auto___26951]));

var G__26952 = (i__4737__auto___26951 + (1));
i__4737__auto___26951 = G__26952;
continue;
} else {
}
break;
...
var G__26961 = (i__4737__auto___26959 + (1));
i__4737__auto___26959 = G__26961;
continue;
} else {
}
break;
