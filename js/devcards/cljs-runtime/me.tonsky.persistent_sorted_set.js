...
var me$tonsky$persistent_sorted_set$INode$node_merge$dyn_26748 = (function (_,next){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_merge$dyn_26748(_,next);
}
});
...
while(true){
if((level > (0))){
var G__26829 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__26830 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__26829;
node = G__26830;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__26837 = (function (){var arr__26563__auto__ = node__$1.pointers;
return (arr__26563__auto__[(arr__26563__auto__.length - (1))]);
})();
var G__26838 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26871 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26871(this$,left,right);
}
});
...
var G__26910 = new_left;
var G__26911 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__26912 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__26913 = new_acc;
left__$1 = G__26910;
keys__$1 = G__26911;
idx__$1 = G__26912;
acc = G__26913;
...
var G__26930 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__26931 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__26930;
res = G__26931;
continue;
}
...
var G__26934 = (node.pointers[idx]);
var G__26935 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26936 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26934;
path = G__26935;
level = G__26936;
continue;
...
var G__26938 = (node.pointers[idx]);
var G__26939 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26940 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26938;
path = G__26939;
level = G__26940;
continue;
...
var pos_26948 = (0);
while(true){
var rest_26949 = (len - pos_26948);
if((rest_26949 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26948));
} else {
if((rest_26949 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26948,(pos_26948 + chunk_len)));

var G__26951 = (pos_26948 + chunk_len);
pos_26948 = G__26951;
continue;
} else {
var piece_len_26952 = (rest_26949 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26948,(pos_26948 + piece_len_26952)));

var G__26954 = (pos_26948 + piece_len_26952);
pos_26948 = G__26954;
continue;
...
var G__26964 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__26965 = (i + (1));
var G__26966 = e;
acc = G__26964;
i = G__26965;
...
break;
default:
var G__26980 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__26681,leaves){
...
var G__26981 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__26980;
shift = G__26981;
continue;
...
var len__4736__auto___26987 = arguments.length;
var i__4737__auto___26988 = (0);
while(true){
if((i__4737__auto___26988 < len__4736__auto___26987)){
args_arr__4757__auto__.push((arguments[i__4737__auto___26988]));

var G__26990 = (i__4737__auto___26988 + (1));
i__4737__auto___26988 = G__26990;
continue;
} else {
}
break;
