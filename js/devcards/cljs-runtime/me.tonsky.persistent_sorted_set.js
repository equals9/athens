...
var me$tonsky$persistent_sorted_set$INode$node_merge$dyn_26749 = (function (_,next){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_merge$dyn_26749(_,next);
}
});
...
var me$tonsky$persistent_sorted_set$INode$node_conj$dyn_26759 = (function (_,cmp,key){
var x__4428__auto__ = (((_ == null))?null:_);
...
return me$tonsky$persistent_sorted_set$INode$node_conj$dyn_26759(_,cmp,key);
}
});
...
var self__ = this;
var ___$1 = this;
var arr__26566__auto__ = self__.keys;
return (arr__26566__auto__[(arr__26566__auto__.length - (1))]);
}));
...
while(true){
if((level > (0))){
var G__26820 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__26821 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__26820;
node = G__26821;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__26830 = (function (){var arr__26566__auto__ = node__$1.pointers;
return (arr__26566__auto__[(arr__26566__auto__.length - (1))]);
})();
var G__26831 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__26832 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__26830;
path = G__26831;
level__$1 = G__26832;
continue;
...
var me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26849 = (function (this$,left,right){
...
return me$tonsky$persistent_sorted_set$IIter$_copy$dyn_26849(this$,left,right);
}
});
...
var G__26872 = (left__$1 + (1));
var G__26873 = keys__$1;
var G__26874 = (idx__$1 + (1));
var G__26875 = new_acc;
left__$1 = G__26872;
keys__$1 = G__26873;
idx__$1 = G__26874;
acc = G__26875;
...
var G__26878 = new_left;
var G__26879 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__26880 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__26881 = new_acc;
left__$1 = G__26878;
keys__$1 = G__26879;
idx__$1 = G__26880;
acc = G__26881;
...
var G__26926 = (node.pointers[idx]);
var G__26927 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26928 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26926;
path = G__26927;
level = G__26928;
continue;
...
var pos_26936 = (0);
while(true){
var rest_26937 = (len - pos_26936);
if((rest_26937 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26936));
} else {
if((rest_26937 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26936,(pos_26936 + chunk_len)));

var G__26938 = (pos_26936 + chunk_len);
pos_26936 = G__26938;
continue;
} else {
var piece_len_26940 = (rest_26937 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26936,(pos_26936 + piece_len_26940)));

var G__26941 = (pos_26936 + piece_len_26940);
pos_26936 = G__26941;
continue;
...
var G__26949 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__26950 = (i + (1));
var G__26951 = e;
acc = G__26949;
i = G__26950;
...
break;
default:
var G__26966 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__26681,leaves){
...
var G__26967 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__26966;
shift = G__26967;
continue;
...
args_arr__4757__auto__.push((arguments[i__4737__auto___26974]));
