...
while(true){
if((level > (0))){
var G__24975 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__24976 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24975;
node = G__24976;
continue;
} else {
...
var G__25036 = new_left;
var G__25037 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25038 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__25039 = new_acc;
left__$1 = G__25036;
keys__$1 = G__25037;
idx__$1 = G__25038;
acc = G__25039;
...
var G__25077 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__25078 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__25077;
res = G__25078;
continue;
}
...
var G__25093 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__25094 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__25091;
path = G__25093;
level = G__25094;
continue;
...
var pos_25111 = (0);
while(true){
var rest_25112 = (len - pos_25111);
if((rest_25112 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25111));
} else {
if((rest_25112 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25111,(pos_25111 + chunk_len)));

var G__25113 = (pos_25111 + chunk_len);
pos_25111 = G__25113;
continue;
} else {
var piece_len_25114 = (rest_25112 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25111,(pos_25111 + piece_len_25114)));

var G__25116 = (pos_25111 + piece_len_25114);
pos_25111 = G__25116;
continue;
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___25150 = arguments.length;
var i__4790__auto___25151 = (0);
while(true){
if((i__4790__auto___25151 < len__4789__auto___25150)){
args_arr__4810__auto__.push((arguments[i__4790__auto___25151]));

var G__25152 = (i__4790__auto___25151 + (1));
i__4790__auto___25151 = G__25152;
continue;
} else {
}
break;
