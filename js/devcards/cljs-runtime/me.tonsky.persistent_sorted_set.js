...
var l__26528__auto___26703 = (splice_from - cut_from);
var n__4613__auto___26705 = l__26528__auto___26703;
var i__26529__auto___26706 = (0);
while(true){
if((i__26529__auto___26706 < n__4613__auto___26705)){
(new_arr[(i__26529__auto___26706 + (0))] = (arr[(i__26529__auto___26706 + cut_from)]));

var G__26708 = (i__26529__auto___26706 + (1));
i__26529__auto___26706 = G__26708;
continue;
} else {
}
break;
...
while(true){
if((level > (0))){
var G__26805 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__26806 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__26805;
node = G__26806;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__26809 = (function (){var arr__26561__auto__ = node__$1.pointers;
return (arr__26561__auto__[(arr__26561__auto__.length - (1))]);
})();
var G__26810 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__26811 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__26809;
path = G__26810;
level__$1 = G__26811;
continue;
...
var G__26880 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__26881 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__26880;
res = G__26881;
continue;
}
...
var G__26898 = (node.pointers[idx]);
var G__26899 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26900 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26898;
path = G__26899;
level = G__26900;
continue;
...
var pos_26918 = (0);
while(true){
var rest_26920 = (len - pos_26918);
if((rest_26920 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26918));
} else {
if((rest_26920 >= (chunk_len + min_len))){
...
var piece_len_26923 = (rest_26920 >>> (1));
...
var G__26934 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__26935 = (i + (1));
var G__26936 = e;
acc = G__26934;
i = G__26935;
