...
while(true){
if((level > (0))){
var G__24988 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__24989 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__24988;
node = G__24989;
continue;
} else {
...
var pos_25117 = (0);
while(true){
var rest_25118 = (len - pos_25117);
if((rest_25118 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25117));
} else {
if((rest_25118 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25117,(pos_25117 + chunk_len)));

var G__25121 = (pos_25117 + chunk_len);
pos_25117 = G__25121;
continue;
} else {
var piece_len_25122 = (rest_25118 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25117,(pos_25117 + piece_len_25122)));

var G__25123 = (pos_25117 + piece_len_25122);
pos_25117 = G__25123;
continue;
