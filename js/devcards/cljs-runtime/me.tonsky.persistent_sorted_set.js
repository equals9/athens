...
while(true){
if((i__24796__auto___24928 < n__4666__auto___24926)){
...
var G__25004 = (left__$1 + (1));
var G__25005 = keys__$1;
var G__25006 = (idx__$1 + (1));
...
var G__25009 = new_left;
var G__25010 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25011 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
...
var pos_25064 = (0);
while(true){
var rest_25066 = (len - pos_25064);
if((rest_25066 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25064));
} else {
if((rest_25066 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25064,(pos_25064 + chunk_len)));

var G__25070 = (pos_25064 + chunk_len);
pos_25064 = G__25070;
continue;
} else {
var piece_len_25071 = (rest_25066 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25064,(pos_25064 + piece_len_25071)));

var G__25072 = (pos_25064 + piece_len_25071);
pos_25064 = G__25072;
continue;
...
var G__25096 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__25097 = (i + (1));
var G__25098 = e;
acc = G__25096;
i = G__25097;
