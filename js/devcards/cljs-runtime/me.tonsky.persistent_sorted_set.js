...
while(true){
if((level__$1 > (0))){
var G__26794 = (function (){var arr__26566__auto__ = node__$1.pointers;
return (arr__26566__auto__[(arr__26566__auto__.length - (1))]);
})();
...
var G__26838 = keys__$1;
var G__26839 = (idx__$1 + (1));
var G__26840 = new_acc;
left__$1 = G__26836;
keys__$1 = G__26838;
idx__$1 = G__26839;
acc = G__26840;
...
var G__26869 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__26870 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__26869;
res = G__26870;
continue;
}
...
var G__26880 = (node.pointers[idx]);
var G__26881 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26882 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26880;
path = G__26881;
level = G__26882;
continue;
...
var G__26886 = (node.pointers[idx]);
var G__26887 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26888 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26886;
path = G__26887;
level = G__26888;
continue;
...
var pos_26911 = (0);
while(true){
var rest_26913 = (len - pos_26911);
if((rest_26913 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26911));
} else {
if((rest_26913 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26911,(pos_26911 + chunk_len)));

var G__26916 = (pos_26911 + chunk_len);
pos_26911 = G__26916;
continue;
} else {
var piece_len_26917 = (rest_26913 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26911,(pos_26911 + piece_len_26917)));

var G__26918 = (pos_26911 + piece_len_26917);
pos_26911 = G__26918;
continue;
...
break;
default:
var G__26945 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__26681,leaves){
...
var G__26946 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__26945;
shift = G__26946;
continue;
...
var len__4736__auto___26948 = arguments.length;
var i__4737__auto___26949 = (0);
while(true){
if((i__4737__auto___26949 < len__4736__auto___26948)){
args_arr__4757__auto__.push((arguments[i__4737__auto___26949]));

var G__26951 = (i__4737__auto___26949 + (1));
i__4737__auto___26949 = G__26951;
continue;
} else {
}
break;
