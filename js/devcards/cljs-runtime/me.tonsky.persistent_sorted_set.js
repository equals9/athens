...
while(true){
if((i__24796__auto___24899 < n__4666__auto___24898)){
...
var G__25012 = (left__$1 + (1));
var G__25013 = keys__$1;
var G__25014 = (idx__$1 + (1));
...
var G__25018 = new_left;
var G__25019 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__25020 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__25021 = new_acc;
left__$1 = G__25018;
keys__$1 = G__25019;
idx__$1 = G__25020;
acc = G__25021;
...
var G__25063 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__25064 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__25063;
res = G__25064;
continue;
}
...
var G__25084 = (node.pointers[idx]);
var G__25085 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__25086 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__25084;
path = G__25085;
level = G__25086;
continue;
...
var pos_25102 = (0);
while(true){
var rest_25103 = (len - pos_25102);
if((rest_25103 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25102));
} else {
if((rest_25103 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25102,(pos_25102 + chunk_len)));

var G__25106 = (pos_25102 + chunk_len);
pos_25102 = G__25106;
continue;
} else {
var piece_len_25107 = (rest_25103 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25102,(pos_25102 + piece_len_25107)));

var G__25108 = (pos_25102 + piece_len_25107);
pos_25102 = G__25108;
continue;
...
while(true){
if((i__4790__auto___25146 < len__4789__auto___25144)){
