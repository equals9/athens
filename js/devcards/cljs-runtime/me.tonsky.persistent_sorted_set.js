...
while(true){
if((level > (0))){
var G__26831 = (level - me.tonsky.persistent_sorted_set.level_shift);
var G__26832 = (node.pointers[me.tonsky.persistent_sorted_set.path_get(path,level)]);
level = G__26831;
node = G__26832;
continue;
} else {
...
while(true){
if((level__$1 > (0))){
var G__26842 = (function (){var arr__26561__auto__ = node__$1.pointers;
return (arr__26561__auto__[(arr__26561__auto__.length - (1))]);
})();
var G__26843 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
var G__26844 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
node__$1 = G__26842;
path = G__26843;
level__$1 = G__26844;
continue;
...
var G__26928 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__26929 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__26928;
res = G__26929;
continue;
}
...
var G__26937 = (node.pointers[idx]);
var G__26938 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__26939 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__26937;
path = G__26938;
level = G__26939;
continue;
...
var pos_26946 = (0);
while(true){
var rest_26947 = (len - pos_26946);
if((rest_26947 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26946));
} else {
if((rest_26947 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26946,(pos_26946 + chunk_len)));

var G__26950 = (pos_26946 + chunk_len);
pos_26946 = G__26950;
continue;
} else {
var piece_len_26951 = (rest_26947 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_26946,(pos_26946 + piece_len_26951)));

var G__26953 = (pos_26946 + piece_len_26951);
pos_26946 = G__26953;
continue;
...
break;
default:
var G__26989 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__26681,leaves){
...
var G__26990 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__26989;
shift = G__26990;
continue;
...
var G__27000 = (i__4737__auto___26998 + (1));
i__4737__auto___26998 = G__27000;
continue;
} else {
}
break;
