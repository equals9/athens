...
var pos_25043 = (0);
while(true){
var rest_25044 = (len - pos_25043);
if((rest_25044 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25043));
} else {
if((rest_25044 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25043,(pos_25043 + chunk_len)));

var G__25046 = (pos_25043 + chunk_len);
pos_25043 = G__25046;
continue;
} else {
var piece_len_25047 = (rest_25044 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_25043,(pos_25043 + piece_len_25047)));

var G__25048 = (pos_25043 + piece_len_25047);
pos_25043 = G__25048;
continue;
