...
var len__4736__auto___23562 = arguments.length;
var i__4737__auto___23563 = (0);
while(true){
if((i__4737__auto___23563 < len__4736__auto___23562)){
args__4742__auto__.push((arguments[i__4737__auto___23563]));

var G__23564 = (i__4737__auto___23563 + (1));
i__4737__auto___23563 = G__23564;
continue;
} else {
}
break;
...
var map__23537 = opts;
var map__23537__$1 = (((((!((map__23537 == null))))?(((((map__23537.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23537.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23537):map__23537);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23537__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23541){var _e__20655__auto__ = e23541;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23543){var _e__20655__auto__ = e23543;
return false;
}}
})())){
...
var temp__5733__auto___23607 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23607)){
var managed_print_level_23609 = temp__5733__auto___23607;
var _STAR_print_level_STAR__orig_val__23551_23611 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23552_23612 = managed_print_level_23609;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23552_23612);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23550_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23550_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23551_23611);
}} else {
job_fn();
}
