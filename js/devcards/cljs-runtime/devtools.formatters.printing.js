...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23503){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23504,G__23505,seq23503__$2);
}));
...
}catch (e23528){var _e__20655__auto__ = e23528;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e23530){var _e__20655__auto__ = e23530;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23534 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23535 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23535);

try{var map__23536 = opts;
var map__23536__$1 = (((((!((map__23536 == null))))?(((((map__23536.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23536.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__23536):map__23536);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23536__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23534);
}});
...
var temp__5733__auto___23559 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___23559)){
var managed_print_level_23560 = temp__5733__auto___23559;
var _STAR_print_level_STAR__orig_val__23541_23561 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23542_23562 = managed_print_level_23560;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23542_23562);
...
job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23541_23561);
}} else {
job_fn();
}
