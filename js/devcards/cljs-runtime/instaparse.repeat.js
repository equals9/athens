...
var vec__57394 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57394,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57394,(1),null);
...
var vec__57397 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57397,(0),null);
...
var G__57461 = cljs.core.next(parses__$1);
parses__$1 = G__57461;
continue;
}
...
var G__57408 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57409 = G__57408;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57409,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57409,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57409,(2),null);
var selection = vec__57409;
...
var vec__57415 = G__57408__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57415,(2),null);
var selection__$1 = vec__57415;
...
var G__57463 = cljs.core.long$(end__$1);
var G__57464 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57465 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57463;
parses__$1 = G__57464;
G__57408__$1 = G__57465;
continue;
...
var G__57423 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57424 = G__57423;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57424,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57424,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57424,(2),null);
var selection = vec__57424;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57423__$1 = G__57423;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57430 = G__57423__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57430,(2),null);
var selection__$1 = vec__57430;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57467 = cljs.core.long$(end__$1);
var G__57468 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57469 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57467;
parses__$1 = G__57468;
G__57423__$1 = G__57469;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57438 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57439 = G__57438;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57439,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57439,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57439,(2),null);
var selection = vec__57439;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57438__$1 = G__57438;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57445 = G__57438__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57445,(2),null);
var selection__$1 = vec__57445;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57471 = cljs.core.long$(end__$1);
var G__57472 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57473 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57471;
parses__$1 = G__57472;
G__57438__$1 = G__57473;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57450 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57450.cljs$core$IFn$_invoke$arity$1 ? fexpr__57450.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57450.call(null,output_format));
})())){
} else {
...
var G__57451 = output_format;
var G__57451__$1 = (((G__57451 instanceof cljs.core.Keyword))?G__57451.fqn:null);
switch (G__57451__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57459 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57458 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57458.cljs$core$IFn$_invoke$arity$1 ? fexpr__57458.cljs$core$IFn$_invoke$arity$1(G__57459) : fexpr__57458.call(null,G__57459));
})();
