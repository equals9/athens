...
var vec__57418 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57418,(0),null);
...
var vec__57421 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57421,(0),null);
...
var vec__57424 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57424,(0),null);
...
var G__57485 = cljs.core.next(parses__$1);
parses__$1 = G__57485;
continue;
}
...
var G__57487 = cljs.core.long$(end__$1);
var G__57488 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57489 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57487;
parses__$1 = G__57488;
G__57432__$1 = G__57489;
continue;
...
var G__57491 = cljs.core.long$(end__$1);
var G__57492 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57493 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57491;
parses__$1 = G__57492;
G__57447__$1 = G__57493;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57462 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57463 = G__57462;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57463,(2),null);
var selection = vec__57463;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57462__$1 = G__57462;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57469 = G__57462__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57469,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57469,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57469,(2),null);
var selection__$1 = vec__57469;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
if(cljs.core.truth_((function (){var fexpr__57474 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57474.cljs$core$IFn$_invoke$arity$1 ? fexpr__57474.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57474.call(null,output_format));
})())){
} else {
...
var G__57475 = output_format;
var G__57475__$1 = (((G__57475 instanceof cljs.core.Keyword))?G__57475.fqn:null);
switch (G__57475__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57483 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57482 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57482.cljs$core$IFn$_invoke$arity$1 ? fexpr__57482.cljs$core$IFn$_invoke$arity$1(G__57483) : fexpr__57482.call(null,G__57483));
})();
