...
var vec__57353 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57353,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57353,(1),null);
...
var G__57414 = cljs.core.next(parses__$1);
parses__$1 = G__57414;
continue;
}
...
var G__57361 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57362 = G__57361;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57362,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57362,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57362,(2),null);
var selection = vec__57362;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57361__$1 = G__57361;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57368 = G__57361__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57368,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57368,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57368,(2),null);
var selection__$1 = vec__57368;
...
var G__57376 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57377 = G__57376;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57377,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57377,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57377,(2),null);
var selection = vec__57377;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57376__$1 = G__57376;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57383 = G__57376__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(2),null);
var selection__$1 = vec__57383;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57420 = cljs.core.long$(end__$1);
var G__57421 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57422 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57420;
parses__$1 = G__57421;
G__57376__$1 = G__57422;
continue;
...
var G__57424 = cljs.core.long$(end__$1);
var G__57425 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57426 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57424;
parses__$1 = G__57425;
G__57391__$1 = G__57426;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57403 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57403.cljs$core$IFn$_invoke$arity$1 ? fexpr__57403.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57403.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57412 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57411 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57411.cljs$core$IFn$_invoke$arity$1 ? fexpr__57411.cljs$core$IFn$_invoke$arity$1(G__57412) : fexpr__57411.call(null,G__57412));
})();
