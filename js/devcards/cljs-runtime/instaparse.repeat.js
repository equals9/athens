...
var vec__57380 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57380,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57383 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57383,(1),null);
...
var G__57444 = cljs.core.next(parses__$1);
parses__$1 = G__57444;
continue;
}
...
var G__57391 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57392 = G__57391;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57392,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57392,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57392,(2),null);
var selection = vec__57392;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57391__$1 = G__57391;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57398 = G__57391__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57398,(2),null);
var selection__$1 = vec__57398;
...
var G__57406 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57407 = G__57406;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57407,(2),null);
var selection = vec__57407;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57406__$1 = G__57406;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57413 = G__57406__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57413,(2),null);
var selection__$1 = vec__57413;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57450 = cljs.core.long$(end__$1);
var G__57451 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57452 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57450;
parses__$1 = G__57451;
G__57406__$1 = G__57452;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57421 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57422 = G__57421;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57422,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57422,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57422,(2),null);
var selection = vec__57422;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57421__$1 = G__57421;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57428 = G__57421__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57428,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57428,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57428,(2),null);
var selection__$1 = vec__57428;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57454 = cljs.core.long$(end__$1);
var G__57455 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57456 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57454;
parses__$1 = G__57455;
G__57421__$1 = G__57456;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57433 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57433.cljs$core$IFn$_invoke$arity$1 ? fexpr__57433.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57433.call(null,output_format));
})())){
} else {
...
var G__57434 = output_format;
var G__57434__$1 = (((G__57434 instanceof cljs.core.Keyword))?G__57434.fqn:null);
switch (G__57434__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57442 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57441 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57441.cljs$core$IFn$_invoke$arity$1 ? fexpr__57441.cljs$core$IFn$_invoke$arity$1(G__57442) : fexpr__57441.call(null,G__57442));
})();
