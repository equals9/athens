...
var vec__57334 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57334,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57334,(1),null);
...
var vec__57337 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57337,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57337,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57340 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57340,(0),null);
...
var G__57401 = cljs.core.next(parses__$1);
parses__$1 = G__57401;
continue;
}
...
var G__57348 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57349 = G__57348;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57349,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57349,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57349,(2),null);
var selection = vec__57349;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57348__$1 = G__57348;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57355 = G__57348__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57355,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57355,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57355,(2),null);
var selection__$1 = vec__57355;
...
var G__57403 = cljs.core.long$(end__$1);
var G__57404 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57405 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57403;
parses__$1 = G__57404;
G__57348__$1 = G__57405;
continue;
...
var G__57363 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57364 = G__57363;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57364,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57364,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57364,(2),null);
var selection = vec__57364;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57363__$1 = G__57363;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57370 = G__57363__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57370,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57370,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57370,(2),null);
var selection__$1 = vec__57370;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57407 = cljs.core.long$(end__$1);
var G__57408 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57409 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57407;
parses__$1 = G__57408;
G__57363__$1 = G__57409;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__57378 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57379 = G__57378;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57379,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57379,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57379,(2),null);
var selection = vec__57379;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57378__$1 = G__57378;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57385 = G__57378__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57385,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57385,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57385,(2),null);
var selection__$1 = vec__57385;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__57411 = cljs.core.long$(end__$1);
var G__57412 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57413 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57411;
parses__$1 = G__57412;
G__57378__$1 = G__57413;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57390 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57390.cljs$core$IFn$_invoke$arity$1 ? fexpr__57390.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57390.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57399 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57398 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57398.cljs$core$IFn$_invoke$arity$1 ? fexpr__57398.cljs$core$IFn$_invoke$arity$1(G__57399) : fexpr__57398.call(null,G__57399));
})();
