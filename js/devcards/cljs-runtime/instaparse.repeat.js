...
var vec__57324 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57324,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57324,(1),null);
...
var vec__57327 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57327,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57327,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__57330 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57330,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57330,(1),null);
...
var G__57391 = cljs.core.next(parses__$1);
parses__$1 = G__57391;
continue;
}
...
var G__57338 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__57339 = G__57338;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57339,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57339,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57339,(2),null);
var selection = vec__57339;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__57338__$1 = G__57338;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__57345 = G__57338__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57345,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57345,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57345,(2),null);
var selection__$1 = vec__57345;
...
var G__57393 = cljs.core.long$(end__$1);
var G__57394 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57395 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57393;
parses__$1 = G__57394;
G__57338__$1 = G__57395;
continue;
...
var G__57397 = cljs.core.long$(end__$1);
var G__57398 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57399 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57397;
parses__$1 = G__57398;
G__57353__$1 = G__57399;
continue;
...
var G__57401 = cljs.core.long$(end__$1);
var G__57402 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__57403 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__57401;
parses__$1 = G__57402;
G__57368__$1 = G__57403;
continue;
...
if(cljs.core.truth_((function (){var fexpr__57380 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__57380.cljs$core$IFn$_invoke$arity$1 ? fexpr__57380.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__57380.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__57389 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__57388 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__57388.cljs$core$IFn$_invoke$arity$1 ? fexpr__57388.cljs$core$IFn$_invoke$arity$1(G__57389) : fexpr__57388.call(null,G__57389));
})();
