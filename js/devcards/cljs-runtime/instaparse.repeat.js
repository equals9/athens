...
var vec__56454 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56454,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56454,(1),null);
...
var vec__56457 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56457,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56457,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__56460 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56460,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56460,(1),null);
...
var G__56521 = cljs.core.next(parses__$1);
parses__$1 = G__56521;
continue;
}
...
var G__56468 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56469 = G__56468;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56469,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56469,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56469,(2),null);
var selection = vec__56469;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56468__$1 = G__56468;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56475 = G__56468__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56475,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56475,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56475,(2),null);
var selection__$1 = vec__56475;
...
var G__56483 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56484 = G__56483;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56484,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56484,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56484,(2),null);
var selection = vec__56484;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56483__$1 = G__56483;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56490 = G__56483__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56490,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56490,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56490,(2),null);
var selection__$1 = vec__56490;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__56498 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__56499 = G__56498;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56499,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56499,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56499,(2),null);
var selection = vec__56499;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__56498__$1 = G__56498;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__56505 = G__56498__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56505,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56505,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56505,(2),null);
var selection__$1 = vec__56505;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
if(cljs.core.truth_((function (){var fexpr__56510 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__56510.cljs$core$IFn$_invoke$arity$1 ? fexpr__56510.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__56510.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4115__auto__ = (function (){var G__56519 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__56518 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__56518.cljs$core$IFn$_invoke$arity$1 ? fexpr__56518.cljs$core$IFn$_invoke$arity$1(G__56519) : fexpr__56518.call(null,G__56519));
})();
