goog.provide('athens.devcards.slash_menu');
...
athens.devcards.slash_menu.slash_menu_component = (function athens$devcards$slash_menu$slash_menu_component(){
...
devcards.core.register_card(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"path","path",-188191168),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"athens.devcards.slash_menu","athens.devcards.slash_menu",-1455528324),new cljs.core.Keyword(null,"Slash-Menu","Slash-Menu",-1412883759)], null),new cljs.core.Keyword(null,"func","func",-238706040),(function (){
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.slash_menu !== 'undefined') && (typeof athens.devcards.slash_menu.t_athens$devcards$slash_menu61116 !== 'undefined')){
} else {
...
*/
athens.devcards.slash_menu.t_athens$devcards$slash_menu61116 = (function (meta61117){
this.meta61117 = meta61117;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61118,meta61117__$1){
var self__ = this;
var _61118__$1 = this;
return (new athens.devcards.slash_menu.t_athens$devcards$slash_menu61116(meta61117__$1));
}));

(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61118){
var self__ = this;
var _61118__$1 = this;
return self__.meta61117;
}));

(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__41676__auto__,devcard_opts__41677__auto__){
var self__ = this;
var this__41676__auto____$1 = this;
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(devcard_opts__41677__auto__,new cljs.core.Keyword(null,"main-obj","main-obj",-1544409742),(function (){var v__41695__auto__ = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.slash_menu.slash_menu_component], null);
...
(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.getBasis = (function (){
...
(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.cljs$lang$type = true);

(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.cljs$lang$ctorStr = "athens.devcards.slash-menu/t_athens$devcards$slash_menu61116");

(athens.devcards.slash_menu.t_athens$devcards$slash_menu61116.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.slash-menu/t_athens$devcards$slash_menu61116");
}));

/**
 * Positional factory function for athens.devcards.slash-menu/t_athens$devcards$slash_menu61116.
 */
athens.devcards.slash_menu.__GT_t_athens$devcards$slash_menu61116 = (function athens$devcards$slash_menu$__GT_t_athens$devcards$slash_menu61116(meta61117){
return (new athens.devcards.slash_menu.t_athens$devcards$slash_menu61116(meta61117));
});

}

return (new athens.devcards.slash_menu.t_athens$devcards$slash_menu61116(null));
})()
,new cljs.core.Keyword(null,"initial-data","initial-data",-1315709804),null,new cljs.core.Keyword(null,"options","options",99638489),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"watch-atom","watch-atom",-2134031308),false], null)], null));
})], null));

//# sourceMappingURL=athens.devcards.slash_menu.js.map
