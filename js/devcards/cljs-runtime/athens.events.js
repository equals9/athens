...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377),((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (db,p__60428){
var vec__60430 = p__60428;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60430,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60430,(1),null);
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
...
throw e;
}}):(function (db,p__60439){
var vec__60441 = p__60439;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60441,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60441,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"drag-bullet","drag-bullet",441161411),(function (db,p__60445){
var vec__60446 = p__60445;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60446,(0),null);
var map = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60446,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(db,new cljs.core.Keyword(null,"drag-bullet","drag-bullet",441161411),map);
}));
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tooltip-uid","tooltip-uid",-1719650452),(function (db,p__60451){
var vec__60452 = p__60451;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60452,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60452,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"parse-datoms","parse-datoms",-2086422577),(function (_,p__60463){
var vec__60464 = p__60463;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60464,(0),null);
var json_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60464,(1),null);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"get-local-storage-db","get-local-storage-db",381131920),(function (p__60469){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60470__$1,new cljs.core.Keyword(null,"db","db",993250759));
...
var temp__5735__auto__ = athens.db.find_prev(cljs.core.deref(athens.db.history),(function (p1__60478_SHARP_){
return (cljs.core.deref(athens.db.dsdb) === p1__60478_SHARP_);
}));
...
var temp__5735__auto__ = athens.db.find_next(cljs.core.deref(athens.db.history),(function (p1__60479_SHARP_){
return (cljs.core.deref(athens.db.dsdb) === p1__60479_SHARP_);
}));
if(cljs.core.truth_(temp__5735__auto__)){
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"transact-event","transact-event",1188240621),(function (_,p__60480){
var vec__60482 = p__60480;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60482,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60482,(1),null);
...
return cljs.core.deref((function (){var G__60490 = athens.db.dsdb;
var G__60491 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437)], null)], null)], null);
var G__60492 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__60490,G__60491,G__60492) : posh.reagent.pull.call(null,G__60490,G__60491,G__60492));
})());
});
athens.events.get_parent = (function athens$events$get_parent(id){
var eid = new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__60497 = cljs.core.deref(athens.db.dsdb);
var G__60498 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__60497,G__60498) : datascript.core.entity.call(null,G__60497,G__60498));
})())));
return athens.events.get_block(eid);
});
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"indent","indent",-148200125),(function (_,p__60502){
var vec__60504 = p__60502;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60504,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60504,(1),null);
...
var new_parent_uid = cljs.core.second(cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__60500_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(uid,cljs.core.second(p1__60500_SHARP_));
}),cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(cljs.core.first,cljs.core.vec((function (){var G__60507 = new cljs.core.PersistentVector(null, 10, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.Symbol(null,"?order","?order",2076500391,null),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?children","?children",2075030425,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?children","?children",2075030425,null),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Symbol(null,"?order","?order",2076500391,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?children","?children",2075030425,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?uid","?uid",-1894399761,null)], null)], null);
var G__60508 = cljs.core.deref(athens.db.dsdb);
var G__60509 = old_parent_eid;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$3 ? datascript.core.q.cljs$core$IFn$_invoke$arity$3(G__60507,G__60508,G__60509) : datascript.core.q.call(null,G__60507,G__60508,G__60509));
})())))));
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"unindent","unindent",-1291301718),(function (_,p__60513){
var vec__60514 = p__60513;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60514,(0),null);
var uid = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60514,(1),null);
...
return athens.events.reindex(cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__60525_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(p1__60525_SHARP_),source);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"drop-bullet","drop-bullet",1177869489),((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (_,p__60531){
var vec__60532 = p__60531;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60532,(0),null);
var map__60535 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60532,(1),null);
...
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60535__$1,new cljs.core.Keyword(null,"source","source",-433931539));
var target = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60535__$1,new cljs.core.Keyword(null,"target","target",253001721));
var kind = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60535__$1,new cljs.core.Keyword(null,"kind","kind",-717265803));
var _PLUS_debux_dbg_opts_PLUS_ = cljs.core.PersistentArrayMap.EMPTY;
