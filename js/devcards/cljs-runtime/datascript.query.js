...
var med = (size >> (1));
var G__28498 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(terms,med);
if(cljs.core.even_QMARK_(size)){
return ((G__28498 + cljs.core.nth.cljs$core$IFn$_invoke$arity$2(terms,(med - (1)))) / (2));
} else {
return G__28498;
}
});
...
var mean = avg(coll);
var sum__$1 = sum((function (){var iter__4582__auto__ = (function datascript$query$variance_$_iter__28499(s__28500){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__28500__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__28502 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__28501 = (0);
while(true){
if((i__28501 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__28501);
var delta = (x - mean);
cljs.core.chunk_append(b__28502,(delta * delta));

var G__28827 = (i__28501 + (1));
i__28501 = G__28827;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__28502),datascript$query$variance_$_iter__28499(cljs.core.chunk_rest(s__28500__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__28502),null);
}
} else {
var x = cljs.core.first(s__28500__$2);
var delta = (x - mean);
return cljs.core.cons((delta * delta),datascript$query$variance_$_iter__28499(cljs.core.rest(s__28500__$2)));
}
} else {
return null;
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(datascript.query.sum_rel,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28504_SHARP_){
return datascript.query.in__GT_rel(binding__$1.binding,p1__28504_SHARP_);
}),coll));
...
return (function (tuple){
return cljs.core.list_STAR_.cljs$core$IFn$_invoke$arity$1(getters__$1.map((function (p1__28512_SHARP_){
return (p1__28512_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__28512_SHARP_.cljs$core$IFn$_invoke$arity$1(tuple) : p1__28512_SHARP_.call(null,tuple));
})));
});
}
});
...
var G__28884 = cljs.core.rest(s__28562__$2);
s__28562__$1 = G__28884;
continue;
}
}
} else {
...
});})(vec__28580,seq__28581,first__28582,seq__28581__$1,vec__28583,seq__28584,first__28585,seq__28584__$1,_,rule_args,clauses,replacements,branch,s__28570__$2,temp__5735__auto__,vec__28566,seq__28567,first__28568,seq__28567__$1,rule,call_args,seqid,branches))
...
var G__28942 = cljs.core.rest(s__28728__$1);
s__28728__$1 = G__28942;
continue;
}
} else {
return null;
