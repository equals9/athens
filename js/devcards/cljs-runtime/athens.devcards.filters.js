...
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60698 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60698)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60698)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60698)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60698)].join('')));
...
var vec__60699 = cljs.core.first(s__60690__$2);
...
var count = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60702__$1,new cljs.core.Keyword(null,"count","count",2139924085));
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60702__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var added_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"added","added",2057651688));
var excluded_QMARK_ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(state,new cljs.core.Keyword(null,"excluded","excluded",-715952088));
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$2(cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([athens.devcards.filters.filter_style,((added_QMARK_)?athens.devcards.filters.added_style:((excluded_QMARK_)?athens.devcards.filters.excluded_style:null))], 0)),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (added_QMARK_,excluded_QMARK_,vec__60699,k,map__60702,map__60702__$1,count,state,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s){
return (function (_){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(s,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"items","items",1031954938),k,new cljs.core.Keyword(null,"state","state",-1988618099)], null),(function (){var G__60707 = state;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__60707)){
return new cljs.core.Keyword(null,"added","added",2057651688);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"added","added",2057651688),G__60707)){
return new cljs.core.Keyword(null,"excluded","excluded",-715952088);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"excluded","excluded",-715952088),G__60707)){
return null;
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__60707)].join('')));

}
}
}
})());
});})(added_QMARK_,excluded_QMARK_,vec__60699,k,map__60702,map__60702__$1,count,state,s__60690__$2,temp__5735__auto__,sort_,filtered_items,items__$2,num_filters,s))
...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters60711 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters60711 = (function (meta60712){
this.meta60712 = meta60712;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters60711.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_60713,meta60712__$1){
var self__ = this;
var _60713__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters60711(meta60712__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters60711.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_60713){
var self__ = this;
var _60713__$1 = this;
return self__.meta60712;
}));

(athens.devcards.filters.t_athens$devcards$filters60711.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters60711.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__38815__auto__,devcard_opts__38816__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters60711.getBasis = (function (){
...
(athens.devcards.filters.t_athens$devcards$filters60711.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters60711.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters60711");

(athens.devcards.filters.t_athens$devcards$filters60711.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters60711");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters60711.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters60711 = (function athens$devcards$filters$__GT_t_athens$devcards$filters60711(meta60712){
return (new athens.devcards.filters.t_athens$devcards$filters60711(meta60712));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters60711(null));
})()
