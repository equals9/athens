...
if((typeof athens !== 'undefined') && (typeof athens.devcards !== 'undefined') && (typeof athens.devcards.filters !== 'undefined') && (typeof athens.devcards.filters.t_athens$devcards$filters61171 !== 'undefined')){
} else {
...
*/
athens.devcards.filters.t_athens$devcards$filters61171 = (function (meta61172){
this.meta61172 = meta61172;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(athens.devcards.filters.t_athens$devcards$filters61171.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_61173,meta61172__$1){
var self__ = this;
var _61173__$1 = this;
return (new athens.devcards.filters.t_athens$devcards$filters61171(meta61172__$1));
}));

(athens.devcards.filters.t_athens$devcards$filters61171.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_61173){
var self__ = this;
var _61173__$1 = this;
return self__.meta61172;
}));

(athens.devcards.filters.t_athens$devcards$filters61171.prototype.devcards$core$IDevcardOptions$ = cljs.core.PROTOCOL_SENTINEL);

(athens.devcards.filters.t_athens$devcards$filters61171.prototype.devcards$core$IDevcardOptions$_devcard_options$arity$2 = (function (this__42236__auto__,devcard_opts__42237__auto__){
var self__ = this;
...
(athens.devcards.filters.t_athens$devcards$filters61171.getBasis = (function (){
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"meta61172","meta61172",392465611,null)], null);
}));

(athens.devcards.filters.t_athens$devcards$filters61171.cljs$lang$type = true);

(athens.devcards.filters.t_athens$devcards$filters61171.cljs$lang$ctorStr = "athens.devcards.filters/t_athens$devcards$filters61171");

(athens.devcards.filters.t_athens$devcards$filters61171.cljs$lang$ctorPrWriter = (function (this__4428__auto__,writer__4429__auto__,opt__4430__auto__){
return cljs.core._write(writer__4429__auto__,"athens.devcards.filters/t_athens$devcards$filters61171");
}));

/**
 * Positional factory function for athens.devcards.filters/t_athens$devcards$filters61171.
 */
athens.devcards.filters.__GT_t_athens$devcards$filters61171 = (function athens$devcards$filters$__GT_t_athens$devcards$filters61171(meta61172){
return (new athens.devcards.filters.t_athens$devcards$filters61171(meta61172));
});

}

return (new athens.devcards.filters.t_athens$devcards$filters61171(null));
})()
