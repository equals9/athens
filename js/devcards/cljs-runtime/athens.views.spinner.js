...
athens.views.spinner.spinner_progress_style = new cljs.core.PersistentArrayMap(null, 6, [new cljs.core.Keyword(null,"width","width",-384071477),"3em",new cljs.core.Keyword(null,"height","height",1025178622),"3em",new cljs.core.Keyword(null,"border-radius","border-radius",419594011),"1000px",new cljs.core.Keyword(null,"border","border",1444987323),["1.5px solid ",athens.style.cssv.cljs$core$IFn$_invoke$arity$1("background-minus-1")].join(''),new cljs.core.Keyword(null,"border-top-color","border-top-color",-804629899),athens.style.cssv.cljs$core$IFn$_invoke$arity$1("link-color"),new cljs.core.Keyword(null,"animation","animation",-1248293244),"spinning 3s linear infinite"], null);
...
athens.views.spinner.spinner_component = (function athens$views$spinner$spinner_component(p__61259){
...
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61260__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61260__$1,new cljs.core.Keyword(null,"style","style",-496642736));
