...
var pattern_28259 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28259,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__28185){
...
var frame = first__28188;
var frames = seq__28187__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__28191){
...
var frame = first__28194;
var frames = seq__28193__$1;
...
var vec__28195 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28195,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28195,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28202__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28202__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__28210 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28210,attr,eid);
} else {
return G__28210;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28211__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28211__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__28220){
while(true){
...
var frame = first__28224;
var frames = seq__28223__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__28273 = db;
var G__28274 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28273;
p__28220 = G__28274;
continue;
}
...
while(true){
var G__28234 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__28234__$1 = (((G__28234 instanceof cljs.core.Keyword))?G__28234.fqn:null);
switch (G__28234__$1) {
case "expand":
var G__28280 = db;
var G__28281 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28280;
frames = G__28281;
continue;
...
case "expand-rev":
var G__28282 = db;
var G__28283 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28282;
frames = G__28283;
continue;
...
case "pattern":
var G__28288 = db;
var G__28289 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28288;
frames = G__28289;
continue;
...
case "recursion":
var G__28290 = db;
var G__28291 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28290;
frames = G__28291;
continue;
...
var f = first__28244;
var remaining = seq__28243__$1;
var result = (function (){var G__28245 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__28245);
} else {
return G__28245;
}
})();
...
var G__28300 = db;
var G__28301 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28246 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28246,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__28246;
}
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__28234__$1)].join('')));
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__28250_SHARP_){
return datascript.db.entid_strict(db,p1__28250_SHARP_);
})),eids);
