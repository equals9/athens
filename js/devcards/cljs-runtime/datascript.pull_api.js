...
var G__26295 = db;
var G__26296 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26295;
p__26254 = G__26296;
continue;
}
...
case "expand":
var G__26301 = db;
var G__26302 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26301;
frames = G__26302;
continue;
...
case "expand-rev":
var G__26306 = db;
var G__26307 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26306;
frames = G__26307;
continue;
...
case "pattern":
var G__26308 = db;
var G__26309 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26308;
frames = G__26309;
continue;
...
case "recursion":
var G__26310 = db;
var G__26311 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26310;
frames = G__26311;
continue;
...
var result = (function (){var G__26263 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26263);
} else {
return G__26263;
}
})();
...
var G__26315 = db;
var G__26316 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26264 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26264,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__26264;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__26265_SHARP_){
return datascript.db.entid_strict(db,p1__26265_SHARP_);
})),eids);
