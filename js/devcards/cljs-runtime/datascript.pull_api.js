...
var results = (function (){var G__26405 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__26405,kvps);
} else {
return G__26405;
}
})();
...
break;
case "done":
var vec__26458 = frames;
var seq__26459 = cljs.core.seq(vec__26458);
var first__26460 = cljs.core.first(seq__26459);
var seq__26459__$1 = cljs.core.next(seq__26459);
var f = first__26460;
var remaining = seq__26459__$1;
var result = (function (){var G__26461 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26461);
} else {
return G__26461;
}
})();
...
var G__26527 = db;
var G__26528 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26462 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26462,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__26462;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__26463_SHARP_){
return datascript.db.entid_strict(db,p1__26463_SHARP_);
})),eids);
