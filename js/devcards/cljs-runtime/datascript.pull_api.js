...
var pattern_26323 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_26323,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__26224){
var vec__26225 = p__26224;
var seq__26226 = cljs.core.seq(vec__26225);
var first__26227 = cljs.core.first(seq__26226);
var seq__26226__$1 = cljs.core.next(seq__26226);
var parent = first__26227;
var frames = seq__26226__$1;
...
var found = cljs.core.not_empty((function (){var G__26231 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$1(limit),G__26231);
} else {
return G__26231;
}
})());
...
var as_value = (function (){var G__26232 = datom_val;
if(ref_QMARK_){
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,cljs.core.update.cljs$core$IFn$_invoke$arity$5(parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,(function (){var G__26233 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(as_value),found);
if(single_QMARK_){
return cljs.core.first(G__26233);
} else {
return G__26233;
}
})()));
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__26234 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26234,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__26234;
}
})());
...
var vec__26235 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26235,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26235,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__26238){
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__26242){
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__26246){
...
var frame = first__26249;
var frames = seq__26248__$1;
...
var vec__26250 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26250,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26250,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26253__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26253__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__26255 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__26255,attr,eid);
} else {
return G__26255;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26256__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26256__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var G__26331 = db;
var G__26332 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__26331;
p__26258 = G__26332;
continue;
}
...
while(true){
var G__26270 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__26270__$1 = (((G__26270 instanceof cljs.core.Keyword))?G__26270.fqn:null);
switch (G__26270__$1) {
case "expand":
var G__26334 = db;
var G__26335 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__26334;
frames = G__26335;
continue;
...
case "expand-rev":
var G__26336 = db;
var G__26337 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__26336;
frames = G__26337;
continue;
...
case "pattern":
var G__26338 = db;
var G__26339 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__26338;
frames = G__26339;
continue;
...
case "recursion":
var G__26340 = db;
var G__26341 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__26340;
frames = G__26341;
continue;
...
break;
case "done":
var vec__26273 = frames;
var seq__26274 = cljs.core.seq(vec__26273);
var first__26275 = cljs.core.first(seq__26274);
var seq__26274__$1 = cljs.core.next(seq__26274);
var f = first__26275;
var remaining = seq__26274__$1;
var result = (function (){var G__26276 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__26276);
} else {
return G__26276;
}
})();
...
var G__26342 = db;
var G__26343 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__26277 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__26277,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__26277;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__26278_SHARP_){
return datascript.db.entid_strict(db,p1__26278_SHARP_);
})),eids);
