...
var depth = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28148__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28148__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__28153 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__28153__$1 = (((G__28153 == null))?null:cljs.core.persistent_BANG_(G__28153));
if((G__28153__$1 == null)){
return null;
} else {
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__28153__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__28154){
...
var frame = first__28157;
var frames = seq__28156__$1;
...
var results = (function (){var G__28158 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq(kvps)){
return cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(G__28158,kvps);
} else {
return G__28158;
}
})();
...
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28159__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28159__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_28262 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(datascript.pull_api.subpattern_frame(pattern_28262,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__28162){
var vec__28163 = p__28162;
var seq__28164 = cljs.core.seq(vec__28163);
var first__28165 = cljs.core.first(seq__28164);
var seq__28164__$1 = cljs.core.next(seq__28164);
var parent = first__28165;
var frames = seq__28164__$1;
...
if(ref_QMARK_){
return cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__28161_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__28161_SHARP_]);
}),G__28167);
} else {
return G__28167;
}
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,(function (){var G__28173 = parent;
if(cljs.core.contains_QMARK_(opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28173,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key__$1,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__28173;
}
})());
...
var vec__28178 = spec;
var attr_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28178,(0),null);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28178,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.cljs$core$IFn$_invoke$arity$1((function (p__28183){
var vec__28184 = p__28183;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28184,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28184,(1),null);
...
datascript.pull_api.pull_expand_reverse_frame = (function datascript$pull_api$pull_expand_reverse_frame(db,p__28194){
...
var frame = first__28197;
var frames = seq__28196__$1;
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__28201){
...
var frame = first__28204;
var frames = seq__28203__$1;
...
var vec__28206 = cljs.core.first(datoms_by_attr);
var attr = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28206,(0),null);
var datoms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28206,(1),null);
...
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28222__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28222__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__28231 = recursion;
if((!((attr == null)))){
return datascript.pull_api.push_recursion(G__28231,attr,eid);
} else {
return G__28231;
}
})();
...
var eid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28238__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28238__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__28247){
while(true){
...
var frame = first__28250;
var frames = seq__28249__$1;
var temp__5733__auto__ = cljs.core.seq(new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__5733__auto__){
var eids = temp__5733__auto__;
...
var G__28289 = db;
var G__28290 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(frames,datascript.pull_api.reset_frame(frame,cljs.core.rest(eids),cljs.core.not_empty(cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__28289;
p__28247 = G__28290;
continue;
}
...
while(true){
var G__28251 = new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first(frames));
var G__28251__$1 = (((G__28251 instanceof cljs.core.Keyword))?G__28251.fqn:null);
switch (G__28251__$1) {
case "expand":
var G__28292 = db;
var G__28293 = datascript.pull_api.pull_expand_frame(db,frames);
db = G__28292;
frames = G__28293;
continue;
...
case "expand-rev":
var G__28294 = db;
var G__28295 = datascript.pull_api.pull_expand_reverse_frame(db,frames);
db = G__28294;
frames = G__28295;
continue;
...
case "pattern":
var G__28296 = db;
var G__28297 = datascript.pull_api.pull_pattern_frame(db,frames);
db = G__28296;
frames = G__28297;
continue;
...
case "recursion":
var G__28298 = db;
var G__28299 = datascript.pull_api.pull_recursion_frame(db,frames);
db = G__28298;
frames = G__28299;
continue;
...
break;
case "done":
var vec__28252 = frames;
var seq__28253 = cljs.core.seq(vec__28252);
var first__28254 = cljs.core.first(seq__28253);
var seq__28253__$1 = cljs.core.next(seq__28253);
var f = first__28254;
var remaining = seq__28253__$1;
var result = (function (){var G__28255 = cljs.core.persistent_BANG_(new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not(new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first(G__28255);
} else {
return G__28255;
}
})();
...
var G__28300 = db;
var G__28301 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.rest(remaining),(function (){var G__28256 = cljs.core.first(remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$5(G__28256,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__28256;
}
})());
...
var eids__$1 = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p1__28257_SHARP_){
return datascript.db.entid_strict(db,p1__28257_SHARP_);
})),eids);
