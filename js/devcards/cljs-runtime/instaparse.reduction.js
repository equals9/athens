...
var G__55063 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4529__auto__ = (function instaparse$reduction$iter__55066(s__55067){
...
var vec__55070 = cljs.core._nth(c__4527__auto__,i__55068);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55070,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55070,(1),null);
cljs.core.chunk_append(b__55069,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__55078 = (i__55068 + (1));
i__55068 = G__55078;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55069),instaparse$reduction$iter__55066(cljs.core.chunk_rest(s__55067__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55069),null);
}
} else {
var vec__55073 = cljs.core.first(s__55067__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__55066(cljs.core.rest(s__55067__$2)));
}
} else {
return null;
}
