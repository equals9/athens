...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function athens$devcards$data_browser$reverse_refs_$_iter__58041(s__58042){
...
var attr = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58043);
cljs.core.chunk_append(b__58044,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.devcards.data_browser.wrap_with_db_id,athens.devcards.data_browser.reverse_refs_for_attr(attr,eid))], null));

var G__58108 = (i__58043 + (1));
i__58043 = G__58108;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58044),athens$devcards$data_browser$reverse_refs_$_iter__58041(cljs.core.chunk_rest(s__58042__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58044),null);
}
} else {
var attr = cljs.core.first(s__58042__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.devcards.data_browser.wrap_with_db_id,athens.devcards.data_browser.reverse_refs_for_attr(attr,eid))], null),athens$devcards$data_browser$reverse_refs_$_iter__58041(cljs.core.rest(s__58042__$2)));
}
} else {
return null;
}
