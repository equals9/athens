...
var len__4789__auto___56407 = arguments.length;
var i__4790__auto___56408 = (0);
while(true){
if((i__4790__auto___56408 < len__4789__auto___56407)){
args__4795__auto__.push((arguments[i__4790__auto___56408]));

var G__56409 = (i__4790__auto___56408 + (1));
i__4790__auto___56408 = G__56409;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq56350){
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq56352){
var G__56353 = cljs.core.first(seq56352);
var seq56352__$1 = cljs.core.next(seq56352);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56353,seq56352__$1);
}));
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq56355){
var self__4777__auto__ = this;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__56358 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__56358) : instaparse.combinators_source.unhide_content.call(null,G__56358));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56359 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56360 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__56361(s__56362){
return (new cljs.core.LazySeq(null,(function (){
var s__56362__$1 = s__56362;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56362__$1);
if(temp__5735__auto__){
var s__56362__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56362__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56362__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56364 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56363 = (0);
while(true){
if((i__56363 < size__4581__auto__)){
var vec__56365 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56363);
...
cljs.core.chunk_append(b__56364,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56487 = (i__56363 + (1));
i__56363 = G__56487;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56364),instaparse$combinators_source$unhide_all_content_$_iter__56361(cljs.core.chunk_rest(s__56362__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56364),null);
}
} else {
var vec__56368 = cljs.core.first(s__56362__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__56361(cljs.core.rest(s__56362__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__56371(s__56372){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__56374,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56494 = (i__56373 + (1));
i__56373 = G__56494;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56374),instaparse$combinators_source$unhide_tags_$_iter__56371(cljs.core.chunk_rest(s__56372__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__56371(cljs.core.rest(s__56372__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__56381(s__56382){
return (new cljs.core.LazySeq(null,(function (){
var s__56382__$1 = s__56382;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56382__$1);
if(temp__5735__auto__){
var s__56382__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56382__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56382__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56384 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56383 = (0);
while(true){
if((i__56383 < size__4581__auto__)){
var vec__56385 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56383);
...
cljs.core.chunk_append(b__56384,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56501 = (i__56383 + (1));
i__56383 = G__56501;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56384),instaparse$combinators_source$unhide_all_$_iter__56381(cljs.core.chunk_rest(s__56382__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56384),null);
}
} else {
var vec__56388 = cljs.core.first(s__56382__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__56381(cljs.core.rest(s__56382__$2)));
}
} else {
return null;
}
...
var G__56392 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56391_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__56391_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__56391_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56393 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__56394 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__56393,G__56394) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__56393,G__56394));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56395 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56392__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__56397(s__56398){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__56400,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56523 = (i__56399 + (1));
i__56399 = G__56523;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56400),instaparse$combinators_source$auto_whitespace_$_iter__56397(cljs.core.chunk_rest(s__56398__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__56397(cljs.core.rest(s__56398__$2)));
}
} else {
return null;
}
