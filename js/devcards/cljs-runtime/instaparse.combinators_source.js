...
var len__4789__auto___55971 = arguments.length;
var i__4790__auto___55972 = (0);
while(true){
if((i__4790__auto___55972 < len__4789__auto___55971)){
args__4795__auto__.push((arguments[i__4790__auto___55972]));

var G__55973 = (i__4790__auto___55972 + (1));
i__4790__auto___55972 = G__55973;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq55914){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55914));
}));
...
var len__4789__auto___55975 = arguments.length;
var i__4790__auto___55976 = (0);
while(true){
if((i__4790__auto___55976 < len__4789__auto___55975)){
args_arr__4810__auto__.push((arguments[i__4790__auto___55976]));

var G__55977 = (i__4790__auto___55976 + (1));
i__4790__auto___55976 = G__55977;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq55916){
var G__55917 = cljs.core.first(seq55916);
var seq55916__$1 = cljs.core.next(seq55916);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__55917,seq55916__$1);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___55978 = arguments.length;
var i__4790__auto___55979 = (0);
while(true){
if((i__4790__auto___55979 < len__4789__auto___55978)){
args__4795__auto__.push((arguments[i__4790__auto___55979]));

var G__55980 = (i__4790__auto___55979 + (1));
i__4790__auto___55979 = G__55980;
continue;
} else {
}
break;
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq55919){
var self__4777__auto__ = this;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__55922 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55922) : instaparse.combinators_source.unhide_content.call(null,G__55922));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55923 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55923) : instaparse.combinators_source.unhide_content.call(null,G__55923));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55924 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__55924) : instaparse.combinators_source.unhide_content.call(null,G__55924));
})()], 0));
} else {
return parser__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__55925(s__55926){
...
cljs.core.chunk_append(b__55928,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56000 = (i__55927 + (1));
i__55927 = G__56000;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55928),instaparse$combinators_source$unhide_all_content_$_iter__55925(cljs.core.chunk_rest(s__55926__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__55925(cljs.core.rest(s__55926__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__55935(s__55936){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__55938,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56014 = (i__55937 + (1));
i__55937 = G__56014;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55938),instaparse$combinators_source$unhide_tags_$_iter__55935(cljs.core.chunk_rest(s__55936__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__55935(cljs.core.rest(s__55936__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__55945(s__55946){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__55948,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56039 = (i__55947 + (1));
i__55947 = G__56039;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55948),instaparse$combinators_source$unhide_all_$_iter__55945(cljs.core.chunk_rest(s__55946__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__55945(cljs.core.rest(s__55946__$2)));
}
} else {
return null;
}
...
var G__55956 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__55955_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__55955_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__55955_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__55957 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__55958 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55957,G__55958) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55957,G__55958));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__55959 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__55960 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__55959,G__55960) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__55959,G__55960));
})()], 0));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__55961(s__55962){
return (new cljs.core.LazySeq(null,(function (){
var s__55962__$1 = s__55962;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__55962__$1);
if(temp__5735__auto__){
var s__55962__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__55962__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__55962__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__55964 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__55963 = (0);
while(true){
if((i__55963 < size__4581__auto__)){
var vec__55965 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__55963);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55965,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55965,(1),null);
cljs.core.chunk_append(b__55964,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56056 = (i__55963 + (1));
i__55963 = G__56056;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__55964),instaparse$combinators_source$auto_whitespace_$_iter__55961(cljs.core.chunk_rest(s__55962__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__55964),null);
}
} else {
var vec__55968 = cljs.core.first(s__55962__$2);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55968,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55968,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__55961(cljs.core.rest(s__55962__$2)));
}
} else {
return null;
}
