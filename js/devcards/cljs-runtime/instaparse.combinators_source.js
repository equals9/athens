...
/** @this {Function} */
(instaparse.combinators_source.alt.cljs$lang$applyTo = (function (seq55998){
...
args_arr__4810__auto__.push((arguments[i__4790__auto___56062]));
...
/** @this {Function} */
(instaparse.combinators_source.ord.cljs$lang$applyTo = (function (seq56000){
var G__56001 = cljs.core.first(seq56000);
var seq56000__$1 = cljs.core.next(seq56000);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__56001,seq56000__$1);
}));
...
/** @this {Function} */
(instaparse.combinators_source.cat.cljs$lang$applyTo = (function (seq56003){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq56003));
}));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310),(function (){var G__56006 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__56006) : instaparse.combinators_source.unhide_content.call(null,G__56006));
})());
} else {
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56007 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__56007) : instaparse.combinators_source.unhide_content.call(null,G__56007));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56008 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1 ? instaparse.combinators_source.unhide_content.cljs$core$IFn$_invoke$arity$1(G__56008) : instaparse.combinators_source.unhide_content.call(null,G__56008));
})()], 0));
} else {
return parser__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_content_$_iter__56009(s__56010){
...
cljs.core.chunk_append(b__56012,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null));

var G__56100 = (i__56011 + (1));
i__56011 = G__56100;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56012),instaparse$combinators_source$unhide_all_content_$_iter__56009(cljs.core.chunk_rest(s__56010__$2)));
} else {
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,instaparse.combinators_source.unhide_content(v)], null),instaparse$combinators_source$unhide_all_content_$_iter__56009(cljs.core.rest(s__56010__$2)));
}
} else {
return null;
}
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_tags_$_iter__56019(s__56020){
return (new cljs.core.LazySeq(null,(function (){
var s__56020__$1 = s__56020;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56020__$1);
if(temp__5735__auto__){
var s__56020__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56020__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56020__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56022 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56021 = (0);
while(true){
if((i__56021 < size__4581__auto__)){
var vec__56023 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56021);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56023,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56023,(1),null);
cljs.core.chunk_append(b__56022,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56122 = (i__56021 + (1));
i__56021 = G__56122;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56022),instaparse$combinators_source$unhide_tags_$_iter__56019(cljs.core.chunk_rest(s__56020__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56022),null);
}
} else {
var vec__56026 = cljs.core.first(s__56020__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56026,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56026,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_tags_$_iter__56019(cljs.core.rest(s__56020__$2)));
}
} else {
return null;
}
...
if(cljs.core.truth_(temp__5733__auto__)){
var reduction = temp__5733__auto__;
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$unhide_all_$_iter__56029(s__56030){
return (new cljs.core.LazySeq(null,(function (){
var s__56030__$1 = s__56030;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56030__$1);
if(temp__5735__auto__){
var s__56030__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56030__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56030__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56032 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56031 = (0);
while(true){
if((i__56031 < size__4581__auto__)){
var vec__56033 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56031);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56033,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56033,(1),null);
cljs.core.chunk_append(b__56032,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null));

var G__56132 = (i__56031 + (1));
i__56031 = G__56132;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56032),instaparse$combinators_source$unhide_all_$_iter__56029(cljs.core.chunk_rest(s__56030__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56032),null);
}
} else {
var vec__56036 = cljs.core.first(s__56030__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56036,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56036,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(instaparse.combinators_source.unhide_content(v),new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null),instaparse$combinators_source$unhide_all_$_iter__56029(cljs.core.rest(s__56030__$2)));
}
} else {
return null;
}
...
var G__56040 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "alt":
case "cat":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(parser,new cljs.core.Keyword(null,"parsers","parsers",-804353827),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56039_SHARP_){
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(p1__56039_SHARP_,ws_parser) : instaparse.combinators_source.auto_whitespace_parser.call(null,p1__56039_SHARP_,ws_parser));
}),new cljs.core.Keyword(null,"parsers","parsers",-804353827).cljs$core$IFn$_invoke$arity$1(parser)));

break;
case "ord":
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(parser,new cljs.core.Keyword(null,"parser1","parser1",-439601422),(function (){var G__56041 = new cljs.core.Keyword(null,"parser1","parser1",-439601422).cljs$core$IFn$_invoke$arity$1(parser);
var G__56042 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__56041,G__56042) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__56041,G__56042));
})(),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"parser2","parser2",1013754688),(function (){var G__56043 = new cljs.core.Keyword(null,"parser2","parser2",1013754688).cljs$core$IFn$_invoke$arity$1(parser);
var G__56044 = ws_parser;
return (instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2 ? instaparse.combinators_source.auto_whitespace_parser.cljs$core$IFn$_invoke$arity$2(G__56043,G__56044) : instaparse.combinators_source.auto_whitespace_parser.call(null,G__56043,G__56044));
})()], 0));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__56040__$1)].join('')));
...
var modified_grammar = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$combinators_source$auto_whitespace_$_iter__56045(s__56046){
return (new cljs.core.LazySeq(null,(function (){
...
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56049,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56049,(1),null);
cljs.core.chunk_append(b__56048,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null));

var G__56146 = (i__56047 + (1));
i__56047 = G__56146;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56048),instaparse$combinators_source$auto_whitespace_$_iter__56045(cljs.core.chunk_rest(s__56046__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56048),null);
}
} else {
var vec__56052 = cljs.core.first(s__56046__$2);
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56052,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56052,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [nt,instaparse.combinators_source.auto_whitespace_parser(parser,ws_parser)], null),instaparse$combinators_source$auto_whitespace_$_iter__56045(cljs.core.rest(s__56046__$2)));
}
} else {
return null;
}
