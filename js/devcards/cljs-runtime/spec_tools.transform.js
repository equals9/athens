...
if((x instanceof cljs.core.Keyword)){
var G__47401 = spec;
var G__47402 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__47403 = spec;
var G__47404 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47403,G__47404) : f.call(null,G__47403,G__47404));
} else {
return x;
...
}catch (e47405){if((e47405 instanceof Error)){
var ___$1 = e47405;
return x;
} else {
throw e47405;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__47410,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47411__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__47413,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47414__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__47416,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47417__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
