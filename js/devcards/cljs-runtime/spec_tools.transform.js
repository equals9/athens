...
if((x instanceof cljs.core.Keyword)){
var G__47648 = spec;
var G__47649 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__47648,G__47649) : f.call(null,G__47648,G__47649));
} else {
if(typeof x === 'string'){
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__47657,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47658__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__47660,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47661__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__47663,x){
var map__47664 = p__47663;
var map__47664__$1 = (((((!((map__47664 == null))))?(((((map__47664.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__47664.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__47664):map__47664);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47664__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
