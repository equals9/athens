...
var navved_data = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (d,p__59513){
var vec__59514 = p__59513;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59514,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59514,(1),null);
...
});})(i__59527,nav,i,c__4527__auto__,size__4528__auto__,b__59528,s__59526__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
);
});})(i__59527,nav,i,c__4527__auto__,size__4528__auto__,b__59528,s__59526__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__59528),athens$views$devtool$data_browser_$_iter__59525(cljs.core.chunk_rest(s__59526__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__59528),null);
}
} else {
var i = cljs.core.first(s__59526__$2);
return cljs.core.cons((function (){var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(navs,i);
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"padding","padding",1660304693),"0.125rem 0.25rem"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (nav,i,s__59526__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,(function (s){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.update.cljs$core$IFn$_invoke$arity$5(s,new cljs.core.Keyword(null,"navs","navs",-1350609868),cljs.core.subvec,(0),i),new cljs.core.Keyword(null,"viewer","viewer",-783949853));
}));
});})(nav,i,s__59526__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"<>","<>",1280186386),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$material_ui$icons$index.ChevronLeft], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),cljs.core.first(nav)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),i], null));
})(),athens$views$devtool$data_browser_$_iter__59525(cljs.core.rest(s__59526__$2)));
}
} else {
return null;
}
...
});})(i__59531,v,c__4527__auto__,size__4528__auto__,b__59532,s__59530__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__59532),athens$views$devtool$data_browser_$_iter__59529(cljs.core.chunk_rest(s__59530__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__59532),null);
}
} else {
var v = cljs.core.first(s__59530__$2);
return cljs.core.cons((function (){var click_fn = ((function (v,s__59530__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state){
return (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(state,cljs.core.assoc,new cljs.core.Keyword(null,"viewer","viewer",-783949853),v);
});})(v,s__59530__$2,temp__5735__auto__,navs,add_nav_BANG_,navved_data,datafied_data,applicable_vs,viewer_name,viewer,state))
;
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.buttons.button,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"on-click","on-click",1632826543),click_fn,new cljs.core.Keyword(null,"active","active",1895962068),cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(v,viewer_name)], null),cljs.core.name(v)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),v], null));
})(),athens$views$devtool$data_browser_$_iter__59529(cljs.core.rest(s__59530__$2)));
}
} else {
return null;
}
