...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40167 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_40167(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40174 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_40174(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40180 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_40180(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40182 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_40182(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40185 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_40185(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40193 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_40193(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_40197 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_40197(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40201 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_40201(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40205 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_40205(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40211 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_40211(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40213 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_40213(b);
}
});
