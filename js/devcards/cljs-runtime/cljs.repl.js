...
var G__45336 = seq__45102_45325;
var G__45337 = chunk__45103_45326;
var G__45338 = count__45104_45327;
var G__45339 = (i__45105_45328 + (1));
seq__45102_45325 = G__45336;
chunk__45103_45326 = G__45337;
count__45104_45327 = G__45338;
i__45105_45328 = G__45339;
continue;
} else {
var temp__5735__auto___45340 = cljs.core.seq(seq__45102_45325);
if(temp__5735__auto___45340){
var seq__45102_45341__$1 = temp__5735__auto___45340;
...
var spec_45370 = temp__5735__auto___45368__$2;
...
var map__45142 = datafied_throwable;
var map__45142__$1 = (((((!((map__45142 == null))))?(((((map__45142.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45142.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__45142):map__45142);
var via = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"via","via",-1904457336));
var trace = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45142__$1,new cljs.core.Keyword(null,"trace","trace",-1082747415));
var phase = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__45142__$1,new cljs.core.Keyword(null,"phase","phase",575722892),new cljs.core.Keyword(null,"execution","execution",253283524));
var map__45143 = cljs.core.last(via);
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45143__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var message = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45143__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var data = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45143__$1,new cljs.core.Keyword(null,"data","data",-232669377));
var map__45144 = data;
...
var problems = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45144__$1,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45144__$1,new cljs.core.Keyword("cljs.spec.alpha","fn","cljs.spec.alpha/fn",408600443));
var caller = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45144__$1,new cljs.core.Keyword("cljs.spec.test.alpha","caller","cljs.spec.test.alpha/caller",-398302390));
var map__45149 = new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.first(via));
...
var top_data = map__45149__$1;
var source = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45149__$1,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397));
...
var G__45173 = cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(cljs.core.second(via)),top_data], 0));
var G__45173__$1 = (cljs.core.truth_(source)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45173,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397),source):G__45173);
var G__45173__$2 = (cljs.core.truth_((function (){var fexpr__45174 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["NO_SOURCE_PATH",null,"NO_SOURCE_FILE",null], null), null);
return (fexpr__45174.cljs$core$IFn$_invoke$arity$1 ? fexpr__45174.cljs$core$IFn$_invoke$arity$1(source) : fexpr__45174.call(null,source));
})())?cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__45173__$1,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397)):G__45173__$1);
if(cljs.core.truth_(message)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45173__$2,new cljs.core.Keyword("clojure.error","cause","clojure.error/cause",-1879175742),message);
} else {
return G__45173__$2;
}
...
var G__45194 = top_data;
var G__45194__$1 = (cljs.core.truth_(line)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45194,new cljs.core.Keyword("clojure.error","line","clojure.error/line",-1816287471),line):G__45194);
var G__45194__$2 = (cljs.core.truth_(file)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45194__$1,new cljs.core.Keyword("clojure.error","source","clojure.error/source",-2011936397),file):G__45194__$1);
var G__45194__$3 = (cljs.core.truth_((function (){var and__4174__auto__ = source__$1;
if(cljs.core.truth_(and__4174__auto__)){
return method;
} else {
return and__4174__auto__;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45194__$2,new cljs.core.Keyword("clojure.error","symbol","clojure.error/symbol",1544821994),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[source__$1,method],null))):G__45194__$2);
var G__45194__$4 = (cljs.core.truth_(type)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45194__$3,new cljs.core.Keyword("clojure.error","class","clojure.error/class",278435890),type):G__45194__$3);
if(cljs.core.truth_(message)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__45194__$4,new cljs.core.Keyword("clojure.error","cause","clojure.error/cause",-1879175742),message);
} else {
return G__45194__$4;
}
...
break;
case "execution":
var vec__45203 = cljs.core.first(trace);
var source__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45203,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45203,(1),null);
var file = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45203,(2),null);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45203,(3),null);
...
return (fexpr__45223.cljs$core$IFn$_invoke$arity$1 ? fexpr__45223.cljs$core$IFn$_invoke$arity$1(p1__45137_SHARP_) : fexpr__45223.call(null,p1__45137_SHARP_));
}
 ...
 */
cljs.repl.ex_str = (function cljs$repl$ex_str(p__45234){
...
var triage_data = map__45235__$1;
var phase = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","phase","clojure.error/phase",275140358));
...
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","line","clojure.error/line",-1816287471));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","column","clojure.error/column",304721553));
var symbol = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","symbol","clojure.error/symbol",1544821994));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","class","clojure.error/class",278435890));
var cause = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","cause","clojure.error/cause",-1879175742));
var spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45235__$1,new cljs.core.Keyword("clojure.error","spec","clojure.error/spec",2055032595));
...
var _STAR_print_newline_STAR__orig_val__45264_45387 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__45265_45388 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__45266_45389 = true;
var _STAR_print_fn_STAR__temp_val__45267_45390 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__45266_45389);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__45267_45390);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__45265_45388);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__45264_45387);
}
...
try{cljs.spec.alpha.explain_out(cljs.core.update.cljs$core$IFn$_invoke$arity$3(spec,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814),(function (probs){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__45233_SHARP_){
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__45233_SHARP_,new cljs.core.Keyword(null,"in","in",-1531184865));
}),probs);
}))
);
