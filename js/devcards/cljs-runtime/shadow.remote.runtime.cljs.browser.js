...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61097,action,ex){
var map__61098 = p__61097;
...
var state = map__61098__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61098__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__61100 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61100) : callback.call(null,G__61100));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61101,p__61102){
...
var state = map__61103__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61103__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__61104__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61104__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61107 = type;
var G__61107__$1 = (((G__61107 instanceof cljs.core.Keyword))?G__61107.fqn:null);
switch (G__61107__$1) {
case "repl/invoke":
var map__61108 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61108__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61111 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61111) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61111));
}catch (e61110){var ex = e61110;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61107__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61112){
...
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61113__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61115 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61115.cljs$core$IFn$_invoke$arity$1 ? fexpr__61115.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61115.call(null,state));
} else {
var map__61116 = cljs.core.first(actions);
...
var action = map__61116__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61116__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61123 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61124 = (function (res){
var req = this;
var map__61128 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__61128__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61128__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__61130 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61130) : callback.call(null,G__61130));
} else {
...
var G__61125 = "POST";
var G__61126 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61127 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61123,G__61124,G__61125,G__61126,G__61127);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61119,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61119,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61132){
var vec__61133 = p__61132;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61133,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61133,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61118){
var self__ = this;
var G__61118__$1 = this;
return (new cljs.core.RecordIter((0),G__61118__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61136 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61136(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61120,other61121){
var self__ = this;
var this61120__$1 = this;
return (((!((other61121 == null)))) && ((this61120__$1.constructor === other61121.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61120__$1.ws,other61121.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61120__$1.state_ref,other61121.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61120__$1.__extmap,other61121.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61118){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61137 = cljs.core.keyword_identical_QMARK_;
var expr__61138 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61140 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61141 = expr__61138;
return (pred__61137.cljs$core$IFn$_invoke$arity$2 ? pred__61137.cljs$core$IFn$_invoke$arity$2(G__61140,G__61141) : pred__61137.call(null,G__61140,G__61141));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61118,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61142 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61143 = expr__61138;
return (pred__61137.cljs$core$IFn$_invoke$arity$2 ? pred__61137.cljs$core$IFn$_invoke$arity$2(G__61142,G__61143) : pred__61137.call(null,G__61142,G__61143));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61118,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61118),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61118){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61118,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61122){
var extmap__4478__auto__ = (function (){var G__61144 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61122,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61122)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61144);
} else {
return G__61144;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61122),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61122),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61145 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61145);
...
var map__61146 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61146__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
