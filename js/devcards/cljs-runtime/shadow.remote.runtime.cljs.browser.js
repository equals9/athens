...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61437,action,ex){
...
var state = map__61438__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61438__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61440) : callback.call(null,G__61440));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61441,p__61442){
...
var state = map__61443__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61443__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61448__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61451 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61451) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61451));
}catch (e61450){var ex = e61450;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61447__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61452){
...
var state = map__61453__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61453__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61455 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61455.cljs$core$IFn$_invoke$arity$1 ? fexpr__61455.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61455.call(null,state));
} else {
var map__61456 = cljs.core.first(actions);
...
var action = map__61456__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61456__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__61463 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61464 = (function (res){
var req = this;
var map__61468 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var result = map__61468__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61468__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__61470 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61470) : callback.call(null,G__61470));
} else {
...
var G__61465 = "POST";
var G__61466 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61467 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61463,G__61464,G__61465,G__61466,G__61467);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61459,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__61471 = k61459;
var G__61471__$1 = (((G__61471 instanceof cljs.core.Keyword))?G__61471.fqn:null);
switch (G__61471__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61459,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61472){
var vec__61473 = p__61472;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61473,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61473,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61458){
var self__ = this;
var G__61458__$1 = this;
return (new cljs.core.RecordIter((0),G__61458__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61476 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61476(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61460,other61461){
var self__ = this;
var this61460__$1 = this;
return (((!((other61461 == null)))) && ((this61460__$1.constructor === other61461.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61460__$1.ws,other61461.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61460__$1.state_ref,other61461.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61460__$1.__extmap,other61461.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61458){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61477 = cljs.core.keyword_identical_QMARK_;
var expr__61478 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61480 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61481 = expr__61478;
return (pred__61477.cljs$core$IFn$_invoke$arity$2 ? pred__61477.cljs$core$IFn$_invoke$arity$2(G__61480,G__61481) : pred__61477.call(null,G__61480,G__61481));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61458,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61482 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61483 = expr__61478;
return (pred__61477.cljs$core$IFn$_invoke$arity$2 ? pred__61477.cljs$core$IFn$_invoke$arity$2(G__61482,G__61483) : pred__61477.call(null,G__61482,G__61483));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61458,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61458),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61458){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61458,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61462){
var extmap__4478__auto__ = (function (){var G__61484 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61462,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61462)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61484);
} else {
return G__61484;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61462),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61462),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61485 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61485);
...
var map__61486 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61486__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
