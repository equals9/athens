...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__61401,action,ex){
...
var state = map__61402__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61402__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
...
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__61404) : callback.call(null,G__61404));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__61405,p__61406){
...
var action = map__61408__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61408__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__61411 = type;
var G__61411__$1 = (((G__61411 instanceof cljs.core.Keyword))?G__61411.fqn:null);
switch (G__61411__$1) {
case "repl/invoke":
var map__61412 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61412__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__61415 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__61415) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__61415));
}catch (e61414){var ex = e61414;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__61411__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__61416){
...
var state = map__61417__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61417__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__61419 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__61419.cljs$core$IFn$_invoke$arity$1 ? fexpr__61419.cljs$core$IFn$_invoke$arity$1(state) : fexpr__61419.call(null,state));
} else {
var map__61420 = cljs.core.first(actions);
...
var self__ = this;
var this$ = this;
var G__61427 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__61428 = (function (res){
var req = this;
var map__61432 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__61434 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
...
var G__61429 = "POST";
var G__61430 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__61431 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__61427,G__61428,G__61429,G__61430,G__61431);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k61423,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k61423,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__61436){
var vec__61437 = p__61436;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61437,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__61437,(1),null);
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__61422){
var self__ = this;
var G__61422__$1 = this;
return (new cljs.core.RecordIter((0),G__61422__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ws","ws",86841443),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__61440 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__61440(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this61424,other61425){
var self__ = this;
var this61424__$1 = this;
return (((!((other61425 == null)))) && ((this61424__$1.constructor === other61425.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61424__$1.ws,other61425.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61424__$1.state_ref,other61425.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this61424__$1.__extmap,other61425.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__61422){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__61441 = cljs.core.keyword_identical_QMARK_;
var expr__61442 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__61444 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__61445 = expr__61442;
return (pred__61441.cljs$core$IFn$_invoke$arity$2 ? pred__61441.cljs$core$IFn$_invoke$arity$2(G__61444,G__61445) : pred__61441.call(null,G__61444,G__61445));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__61422,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__61446 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__61447 = expr__61442;
return (pred__61441.cljs$core$IFn$_invoke$arity$2 ? pred__61441.cljs$core$IFn$_invoke$arity$2(G__61446,G__61447) : pred__61441.call(null,G__61446,G__61447));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__61422,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__61422),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__61422){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__61422,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__61426){
var extmap__4478__auto__ = (function (){var G__61448 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__61426,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__61426)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__61448);
} else {
return G__61448;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__61426),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__61426),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__61449 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__61449);
...
var map__61450 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61450__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
