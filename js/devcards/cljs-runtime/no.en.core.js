...
var G__44814 = (i__4737__auto___44808 + (1));
i__4737__auto___44808 = G__44814;
continue;
} else {
}
break;
...
var encoding = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44719,(0),null);
if(cljs.core.truth_(s)){
...
var G__44731 = clojure.string.upper_case(unit);
switch (G__44731) {
default:
var G__44732 = unit;
switch (G__44732) {
...
break;
default:
throw (new Error(["No matching clause: ",G__44732].join('')));
...
var number = (function (){var G__44739 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(matches,(1));
return (parse_fn.cljs$core$IFn$_invoke$arity$1 ? parse_fn.cljs$core$IFn$_invoke$arity$1(G__44739) : parse_fn.call(null,G__44739));
})();
...
return no.en.core.parse_number(s,(function (p1__44743_SHARP_){
return parseInt(p1__44743_SHARP_);
}));
});
/**
...
return parseFloat(p1__44748_SHARP_);
}));
});
/**
...
/** @this {Function} */
(no.en.core.deep_merge.cljs$lang$applyTo = (function (seq44793){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq44793));
}));
