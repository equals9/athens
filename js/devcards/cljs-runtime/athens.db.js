...
var G__33146 = cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1(b));
var G__33147 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__33146;
res = G__33147;
continue;
}
...
var G__33154 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ch,(n - (1)));
block = G__33154;
continue;
}
break;
...
var G__33170 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__33171 = cljs.core.next(xs__$1);
acc = G__33170;
xs__$1 = G__33171;
continue;
...
return cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__33126_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__33126_SHARP_) : pred.call(null,p1__33126_SHARP_)));
}),xs));
});
athens.db.find_next = (function athens$db$find_next(xs,pred){
return cljs.core.fnext(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__33128_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__33128_SHARP_) : pred.call(null,p1__33128_SHARP_)));
}),xs));
});
...
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33131__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33131__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__33130_SHARP_){
return (p1__33130_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
