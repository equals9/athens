...
athens.db.attr_mappings = cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("vc","blocks","vc/blocks",-610466494),new cljs.core.Keyword("children","view-type","children/view-type",784761250),new cljs.core.Keyword("edit","seen-by","edit/seen-by",1538981059),new cljs.core.Keyword("window","id","window/id",-62222780),new cljs.core.Keyword("attrs","lookup","attrs/lookup",849089348),new cljs.core.Keyword("block","props","block/props",-542295228),new cljs.core.Keyword("create","email","create/email",-1530017530),new cljs.core.Keyword("create","time","create/time",-1563077754),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","heading","block/heading",-1941840630),new cljs.core.Keyword("entity","title","entity/title",1897048586),new cljs.core.Keyword("block","refs","block/refs",-1214495349),new cljs.core.Keyword("user","color","user/color",1016790124),new cljs.core.Keyword("ent","emojis","ent/emojis",-2098423410),new cljs.core.Keyword("user","display-name","user/display-name",692861614),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Keyword("log","id","log/id",-1388423408),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("user","uid","user/uid",-1462122573),new cljs.core.Keyword("edit","time","edit/time",1384867476),new cljs.core.Keyword("entity","attrs","entity/attrs",1455479094),new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("user","email","user/email",1419686391),new cljs.core.Keyword("window","filters","window/filters",1227680535),new cljs.core.Keyword("edit","email","edit/email",1419195448),new cljs.core.Keyword("entity","image-url","entity/image-url",1042719577),new cljs.core.Keyword("block","text-align","block/text-align",1776373178),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Keyword("user","photo-url","user/photo-url",-1811145957),new cljs.core.Keyword("user","settings","user/settings",1559882910),new cljs.core.Keyword("page","sidebar","page/sidebar",32416927)],["string","blocks","view-type","seen-by","id","lookup","props","email","time","title","heading","title","refs","color","emojis","display-name","children","id","uid","open","uid","time","attrs",new cljs.core.Keyword("db","id","db/id",-1388397098),"email","filters","email","image-url","text-align","order","photo-url","settings","sidebar"]);
athens.db.ATTRS = cljs.core.set(cljs.core.keys(athens.db.attr_mappings));
/**
 * If value is a string, starts with ":", and exists in
 *   ATTRS set, then convert that value.
 */
athens.db.walker = (function athens$db$walker(x){
var temp__5733__auto__ = ((typeof x === 'string')?((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(":",cljs.core.first(x)))?(function (){var G__33083 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.cljs$core$IFn$_invoke$arity$2(x,(1)));
return (athens.db.ATTRS.cljs$core$IFn$_invoke$arity$1 ? athens.db.ATTRS.cljs$core$IFn$_invoke$arity$1(G__33083) : athens.db.ATTRS.call(null,G__33083));
})():false):false);
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33085_SHARP_){
return cljs.core.cons(new cljs.core.Keyword("db","add","db/add",235286841),p1__33085_SHARP_);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33084_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.edn.read_string,p1__33084_SHARP_);
...
var edn_data = cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(JSON.parse(json_str));
if(cljs.core.map_QMARK_(cljs.core.first(edn_data))){
return clojure.walk.postwalk(athens.db.walker,edn_data);
} else {
...
return athens.db.sort_block_children(cljs.core.deref((function (){var G__33086 = athens.db.dsdb;
var G__33087 = new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword("edit","time","edit/time",1384867476)], null);
var G__33088 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__33086,G__33087,G__33088) : posh.reagent.pull.call(null,G__33086,G__33087,G__33088));
})()));
});
athens.db.get_node_document = (function athens$db$get_node_document(id){
return athens.db.sort_block_children(cljs.core.deref((function (){var G__33089 = athens.db.dsdb;
var G__33090 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.Keyword("block","open","block/open",-1875254829),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword("edit","time","edit/time",1384867476)], null);
var G__33091 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__33089,G__33090,G__33091) : posh.reagent.pull.call(null,G__33089,G__33090,G__33091));
})()));
});
/**
...
var G__33156 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(res,cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(b,new cljs.core.Keyword("block","_children","block/_children",1128070632)));
b = G__33155;
res = G__33156;
continue;
}
...
return athens.db.shape_parent_query(cljs.core.deref((function (){var G__33092 = athens.db.dsdb;
var G__33093 = new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","_children","block/_children",1128070632),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__33094 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__33092,G__33093,G__33094) : posh.reagent.pull.call(null,G__33092,G__33093,G__33094));
})()));
});
athens.db.get_block = (function athens$db$get_block(id){
return cljs.core.deref((function (){var G__33095 = athens.db.dsdb;
var G__33096 = new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","id","db/id",-1388397098),new cljs.core.Keyword("node","title","node/title",628940777),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Keyword("block","string","block/string",-2066596447),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword("block","order","block/order",-1429282437)], null)], null)], null);
var G__33097 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__33095,G__33096,G__33097) : posh.reagent.pull.call(null,G__33095,G__33096,G__33097));
})());
});
athens.db.get_parent = (function athens$db$get_parent(id){
return athens.db.get_block(new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(cljs.core.first(new cljs.core.Keyword("block","_children","block/_children",1128070632).cljs$core$IFn$_invoke$arity$1((function (){var G__33098 = cljs.core.deref(athens.db.dsdb);
var G__33099 = id;
return (datascript.core.entity.cljs$core$IFn$_invoke$arity$2 ? datascript.core.entity.cljs$core$IFn$_invoke$arity$2(G__33098,G__33099) : datascript.core.entity.call(null,G__33098,G__33099));
})()))));
});
athens.db.deepest_child_block = (function athens$db$deepest_child_block(id){
var document = cljs.core.deref((function (){var G__33100 = athens.db.dsdb;
var G__33101 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null)], null);
var G__33102 = id;
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__33100,G__33101,G__33102) : posh.reagent.pull.call(null,G__33100,G__33101,G__33102));
})());
var block = document;
while(true){
...
var G__33164 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(ch,(n - (1)));
block = G__33164;
continue;
}
break;
...
var G__33122 = new cljs.core.PersistentVector(null, 15, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),cljs.core.list(new cljs.core.Symbol(null,"pull","pull",779986722,null),new cljs.core.Symbol(null,"?sib","?sib",-855475017,null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null)),new cljs.core.Symbol(null,".",".",1975675962,null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?block-uid","?block-uid",1304565897,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?block","?block",1541466123,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?block-uid","?block-uid",1304565897,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?block","?block",1541466123,null),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Symbol(null,"?block-o","?block-o",-1447185258,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?block","?block",1541466123,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?sib","?sib",-855475017,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?sib","?sib",-855475017,null),new cljs.core.Keyword("block","order","block/order",-1429282437),new cljs.core.Symbol(null,"?sib-o","?sib-o",543429366,null)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?sib","?sib",-855475017,null),new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Symbol(null,"?sib-uid","?sib-uid",-1881170629,null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(new cljs.core.Symbol(null,"inc","inc",324505433,null),new cljs.core.Symbol(null,"?block-o","?block-o",-1447185258,null)),new cljs.core.Symbol(null,"?prev-sib-o","?prev-sib-o",-1869464663,null)], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.list(new cljs.core.Symbol(null,"=","=",-1501502141,null),new cljs.core.Symbol(null,"?sib-o","?sib-o",543429366,null),new cljs.core.Symbol(null,"?prev-sib-o","?prev-sib-o",-1869464663,null))], null)], null);
...
var G__33178 = new cljs.core.Keyword("block","uid","block/uid",-1623585167).cljs$core$IFn$_invoke$arity$1(parent);
uid__$1 = G__33178;
continue;
}
break;
...
var G__33179 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,x);
var G__33180 = cljs.core.next(xs__$1);
acc = G__33179;
xs__$1 = G__33180;
continue;
...
return cljs.core.last(cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__33130_SHARP_){
return cljs.core.not((pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(p1__33130_SHARP_) : pred.call(null,p1__33130_SHARP_)));
}),xs));
});
athens.db.find_next = (function athens$db$find_next(xs,pred){
return cljs.core.fnext(cljs.core.drop_while.cljs$core$IFn$_invoke$arity$2((function (p1__33132_SHARP_){
...
var db_before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33134__$1,new cljs.core.Keyword(null,"db-before","db-before",-553691536));
var db_after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33134__$1,new cljs.core.Keyword(null,"db-after","db-after",-571884666));
...
return athens.db.trim_head(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(athens.db.drop_tail(h,(function (p1__33133_SHARP_){
return (p1__33133_SHARP_ === db_before);
})),db_after),(10));
}));
} else {
return null;
