...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58759__$1)].join('')));
...
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58761,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58761,(1),null);
...
var G__58764 = new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"find","find",496279456),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Symbol(null,"...","...",-1926939749,null)], null),new cljs.core.Keyword(null,"in","in",-1531184865),new cljs.core.Symbol(null,"$","$",-1580747756,null),new cljs.core.Symbol(null,"?attr","?attr",-2066507837,null),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null),new cljs.core.Keyword(null,"where","where",-2044795965),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"?parent","?parent",-1403127243,null),new cljs.core.Keyword("block","children","block/children",-1040716209),new cljs.core.Symbol(null,"?eid","?eid",1087837141,null)], null)], null);
var G__58765 = cljs.core.deref(athens.db.dsdb);
var G__58766 = attr;
var G__58767 = eid;
return (datascript.core.q.cljs$core$IFn$_invoke$arity$4 ? datascript.core.q.cljs$core$IFn$_invoke$arity$4(G__58764,G__58765,G__58766,G__58767) : datascript.core.q.call(null,G__58764,G__58765,G__58766,G__58767));
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function athens$views$data_browser$reverse_refs_$_iter__58768(s__58769){
...
var attr = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58770);
cljs.core.chunk_append(b__58771,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.views.data_browser.wrap_with_db_id,athens.views.data_browser.reverse_refs_for_attr(attr,eid))], null));

var G__58833 = (i__58770 + (1));
i__58770 = G__58833;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58771),athens$views$data_browser$reverse_refs_$_iter__58768(cljs.core.chunk_rest(s__58769__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58771),null);
}
} else {
var attr = cljs.core.first(s__58769__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.views.data_browser.reverse_attr(attr),cljs.core.map.cljs$core$IFn$_invoke$arity$2(athens.views.data_browser.wrap_with_db_id,athens.views.data_browser.reverse_refs_for_attr(attr,eid))], null),athens$views$data_browser$reverse_refs_$_iter__58768(cljs.core.rest(s__58769__$2)));
}
} else {
return null;
}
...
athens.views.data_browser.reverse_rows = (function athens$views$data_browser$reverse_rows(p__58772){
var map__58773 = p__58772;
var map__58773__$1 = (((((!((map__58773 == null))))?(((((map__58773.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58773.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58773):map__58773);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58773__$1,new cljs.core.Keyword("db","id","db/id",-1388397098));
...
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58780,(0),null);
var values = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58780,(1),null);
...
var iter__4582__auto__ = (function athens$views$data_browser$maps_rows_$_iter__58783(s__58784){
return (new cljs.core.LazySeq(null,(function (){
var s__58784__$1 = s__58784;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__58784__$1);
if(temp__5735__auto__){
var s__58784__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__58784__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__58784__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__58786 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__58785 = (0);
while(true){
if((i__58785 < size__4581__auto__)){
var idx = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58785);
cljs.core.chunk_append(b__58786,cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (i__58785,idx,c__4580__auto__,size__4581__auto__,b__58786,s__58784__$2,temp__5735__auto__,hs){
return (function athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58787(s__58788){
return (new cljs.core.LazySeq(null,((function (i__58785,idx,c__4580__auto__,size__4581__auto__,b__58786,s__58784__$2,temp__5735__auto__,hs){
return (function (){
var s__58788__$1 = s__58788;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58788__$1);
if(temp__5735__auto____$1){
var s__58788__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__58788__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__58788__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__58790 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__58789 = (0);
while(true){
if((i__58789 < size__4581__auto____$1)){
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__58789);
cljs.core.chunk_append(b__58790,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null));

var G__58834 = (i__58789 + (1));
i__58789 = G__58834;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58790),athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58787(cljs.core.chunk_rest(s__58788__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58790),null);
}
} else {
var h = cljs.core.first(s__58788__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null),athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58787(cljs.core.rest(s__58788__$2)));
}
} else {
return null;
}
...
});})(i__58785,idx,c__4580__auto__,size__4581__auto__,b__58786,s__58784__$2,temp__5735__auto__,hs))
,null,null));
});})(i__58785,idx,c__4580__auto__,size__4581__auto__,b__58786,s__58784__$2,temp__5735__auto__,hs))
;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58786),athens$views$data_browser$maps_rows_$_iter__58783(cljs.core.chunk_rest(s__58784__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58786),null);
}
} else {
var idx = cljs.core.first(s__58784__$2);
return cljs.core.cons(cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"value","value",305978217),idx,new cljs.core.Keyword(null,"heading","heading",-1312171873),"idx",new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null)], null),(function (){var iter__4582__auto__ = ((function (idx,s__58784__$2,temp__5735__auto__,hs){
return (function athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58791(s__58792){
return (new cljs.core.LazySeq(null,(function (){
...
var h = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58793);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58794),athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58791(cljs.core.chunk_rest(s__58792__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58794),null);
}
} else {
var h = cljs.core.first(s__58792__$2);
return cljs.core.cons(new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"value","value",305978217),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(ms,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,h], null)),new cljs.core.Keyword(null,"attr","attr",-604132353),h,new cljs.core.Keyword(null,"heading","heading",-1312171873),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h),new cljs.core.Keyword(null,"idx","idx",1053688473),idx], null),athens$views$data_browser$maps_rows_$_iter__58783_$_iter__58791(cljs.core.rest(s__58792__$2)));
}
} else {
return null;
}
...
});})(idx,s__58784__$2,temp__5735__auto__,hs))
;
return iter__4582__auto__(cljs.core.rest(hs));
})()),athens$views$data_browser$maps_rows_$_iter__58783(cljs.core.rest(s__58784__$2)));
}
} else {
return null;
}
...
var G__58795 = mode;
var G__58795__$1 = (((G__58795 instanceof cljs.core.Keyword))?G__58795.fqn:null);
switch (G__58795__$1) {
case "coll":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__58795__$1)].join('')));

}
});
athens.views.data_browser.cell = (function athens$views$data_browser$cell(p__58796){
...
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58797__$1,new cljs.core.Keyword(null,"value","value",305978217));
...
athens.views.data_browser.table_view = (function athens$views$data_browser$table_view(data,mode,limit,p__58799){
...
var cell_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__58800__$1,new cljs.core.Keyword(null,"cell-fn","cell-fn",706974519),athens.views.data_browser.cell);
var hs = athens.views.data_browser.headings(data,mode);
var rows = athens.views.data_browser.get_rows(data,mode);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"overflow-x","overflow-x",-26547754),"auto"], null)], null),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"table","table",-564943036),stylefy.core.use_style.cljs$core$IFn$_invoke$arity$1(athens.views.data_browser.table_style),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"thead","thead",-291875296),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = (function athens$views$data_browser$table_view_$_iter__58802(s__58803){
return (new cljs.core.LazySeq(null,(function (){
...
cljs.core.chunk_append(b__58805,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["heading-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)].join('')], null)));

var G__58838 = (i__58804 + (1));
i__58804 = G__58838;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58805),athens$views$data_browser$table_view_$_iter__58802(cljs.core.chunk_rest(s__58803__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58805),null);
}
} else {
var h = cljs.core.first(s__58803__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"th","th",-545608566),cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["heading-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(h)].join('')], null)),athens$views$data_browser$table_view_$_iter__58802(cljs.core.rest(s__58803__$2)));
}
} else {
return null;
}
...
})()], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tbody","tbody",-80678300),(function (){var iter__4582__auto__ = (function athens$views$data_browser$table_view_$_iter__58806(s__58807){
return (new cljs.core.LazySeq(null,(function (){
...
var row = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58808);
cljs.core.chunk_append(b__58809,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = ((function (i__58808,row,c__4580__auto__,size__4581__auto__,b__58809,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn){
return (function athens$views$data_browser$table_view_$_iter__58806_$_iter__58810(s__58811){
return (new cljs.core.LazySeq(null,((function (i__58808,row,c__4580__auto__,size__4581__auto__,b__58809,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn){
return (function (){
var s__58811__$1 = s__58811;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58811__$1);
if(temp__5735__auto____$1){
var s__58811__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__58811__$2)){
var c__4580__auto____$1 = cljs.core.chunk_first(s__58811__$2);
var size__4581__auto____$1 = cljs.core.count(c__4580__auto____$1);
var b__58813 = cljs.core.chunk_buffer(size__4581__auto____$1);
if((function (){var i__58812 = (0);
while(true){
if((i__58812 < size__4581__auto____$1)){
var map__58814 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto____$1,i__58812);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58813),athens$views$data_browser$table_view_$_iter__58806_$_iter__58810(cljs.core.chunk_rest(s__58811__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58813),null);
}
} else {
var map__58816 = cljs.core.first(s__58811__$2);
...
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"none"], null)], null),(cell_fn.cljs$core$IFn$_invoke$arity$1 ? cell_fn.cljs$core$IFn$_invoke$arity$1(c) : cell_fn.call(null,c))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading)].join('')], null)),athens$views$data_browser$table_view_$_iter__58806_$_iter__58810(cljs.core.rest(s__58811__$2)));
}
} else {
return null;
}
...
});})(i__58808,row,c__4580__auto__,size__4581__auto__,b__58809,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn))
,null,null));
});})(i__58808,row,c__4580__auto__,size__4581__auto__,b__58809,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn))
;
...
var row = cljs.core.first(s__58807__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tr","tr",-1424774646),(function (){var iter__4582__auto__ = ((function (row,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn){
return (function athens$views$data_browser$table_view_$_iter__58806_$_iter__58818(s__58819){
return (new cljs.core.LazySeq(null,(function (){
var s__58819__$1 = s__58819;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__58819__$1);
if(temp__5735__auto____$1){
var s__58819__$2 = temp__5735__auto____$1;
...
var map__58822 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__58820);
...
var c = map__58822__$1;
var idx = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58822__$1,new cljs.core.Keyword(null,"idx","idx",1053688473));
var heading = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58822__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
cljs.core.chunk_append(b__58821,cljs.core.with_meta(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"td","td",1479933353),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"background-color","background-color",570434026),"none"], null)], null),(cell_fn.cljs$core$IFn$_invoke$arity$1 ? cell_fn.cljs$core$IFn$_invoke$arity$1(c) : cell_fn.call(null,c))], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(idx),cljs.core.str.cljs$core$IFn$_invoke$arity$1(heading)].join('')], null)));

var G__58841 = (i__58820 + (1));
i__58820 = G__58841;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__58821),athens$views$data_browser$table_view_$_iter__58806_$_iter__58818(cljs.core.chunk_rest(s__58819__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__58821),null);
}
} else {
var map__58824 = cljs.core.first(s__58819__$2);
...
});})(row,s__58807__$2,temp__5735__auto__,hs,rows,map__58800,map__58800__$1,cell_fn))
;
return iter__4582__auto__(row);
})()], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),["row-",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(cljs.core.first(row)))].join('')], null)),athens$views$data_browser$table_view_$_iter__58806(cljs.core.rest(s__58807__$2)));
}
} else {
return null;
}
...
(athens.views.data_browser.browser.cljs$core$IFn$_invoke$arity$variadic = (function (_,p__58828){
var vec__58829 = p__58828;
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58829,(0),null);
var limit = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((10));
var increase_limit = (function (){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$3(limit,cljs.core._PLUS_,(10));
});
return (function() { 
var G__58845__delegate = function (result,___$1){
...
var G__58845 = function (result,var_args){
var ___$1 = null;
if (arguments.length > 1) {
var G__58846__i = 0, G__58846__a = new Array(arguments.length -  1);
while (G__58846__i < G__58846__a.length) {G__58846__a[G__58846__i] = arguments[G__58846__i + 1]; ++G__58846__i;}
  ___$1 = new cljs.core.IndexedSeq(G__58846__a,0,null);
} 
return G__58845__delegate.call(this,result,___$1);};
G__58845.cljs$lang$maxFixedArity = 1;
G__58845.cljs$lang$applyTo = (function (arglist__58847){
var result = cljs.core.first(arglist__58847);
var ___$1 = cljs.core.rest(arglist__58847);
return G__58845__delegate(result,___$1);
});
G__58845.cljs$core$IFn$_invoke$arity$variadic = G__58845__delegate;
return G__58845;
})()
;
}));
...
/** @this {Function} */
(athens.views.data_browser.browser.cljs$lang$applyTo = (function (seq58826){
