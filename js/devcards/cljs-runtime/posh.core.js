...
var new_dbs = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,(function (){var iter__4529__auto__ = (function posh$core$after_transact_$_iter__25933(s__25934){
return (new cljs.core.LazySeq(null,(function (){
var s__25934__$1 = s__25934;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__25934__$1);
if(temp__5735__auto__){
var s__25934__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__25934__$2)){
var c__4527__auto__ = cljs.core.chunk_first(s__25934__$2);
var size__4528__auto__ = cljs.core.count(c__4527__auto__);
var b__25936 = cljs.core.chunk_buffer(size__4528__auto__);
if((function (){var i__25935 = (0);
while(true){
if((i__25935 < size__4528__auto__)){
var vec__25939 = cljs.core._nth(c__4527__auto__,i__25935);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25936),posh$core$after_transact_$_iter__25933(cljs.core.chunk_rest(s__25934__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25936),null);
}
} else {
var vec__25942 = cljs.core.first(s__25934__$2);
...
return cljs.core.cons((cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn))?cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.db.generate_initial_db.cljs$core$IFn$_invoke$arity$4(dcfg,conn,cljs.core.get.cljs$core$IFn$_invoke$arity$2(filters,db_id),new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(conns_results,conn)))]):cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,cljs.core.get.cljs$core$IFn$_invoke$arity$2(dbs,db_id)])),posh$core$after_transact_$_iter__25933(cljs.core.rest(s__25934__$2)));
}
} else {
return null;
}
...
posh.core.process_tx_BANG_ = (function posh$core$process_tx_BANG_(p__25953){
...
var posh_tree = map__25954__$1;
var dcfg = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25954__$1,new cljs.core.Keyword(null,"dcfg","dcfg",-880371016));
var txs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25954__$1,new cljs.core.Keyword(null,"txs","txs",2056038378));
var conns_results = cljs.core.reduce_kv((function (m,conn,tx){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,conn,(function (){var fexpr__25956 = new cljs.core.Keyword(null,"transact!","transact!",-822725810).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__25956.cljs$core$IFn$_invoke$arity$2 ? fexpr__25956.cljs$core$IFn$_invoke$arity$2(conn,tx) : fexpr__25956.call(null,conn,tx));
})());
