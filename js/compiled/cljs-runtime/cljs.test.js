...
var G__50754 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__50754,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__50754;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq50760){
var G__50761 = cljs.core.first(seq50760);
var seq50760__$1 = cljs.core.next(seq50760);
var G__50762 = cljs.core.first(seq50760__$1);
var seq50760__$2 = cljs.core.next(seq50760__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50761,G__50762,seq50760__$2);
}));
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50770_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__50770_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__50782 = cljs.core.get_global_hierarchy;
return (fexpr__50782.cljs$core$IFn$_invoke$arity$0 ? fexpr__50782.cljs$core$IFn$_invoke$arity$0() : fexpr__50782.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__50787 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50787) : formatter_fn.call(null,G__50787));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__50789 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50789) : formatter_fn.call(null,G__50789));
})()], 0));
});
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__50827 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__50827,"/"].join('');
} else {
return G__50827;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__50832 = exception.stack;
var G__50832__$1 = (((G__50832 == null))?null:clojure.string.split_lines(G__50832));
var G__50832__$2 = (((G__50832__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__50832__$1,depth));
if((G__50832__$2 == null)){
return null;
} else {
return clojure.string.trim(G__50832__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__50835 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50835,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50835,(1),null);
var vec__50838 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50838,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50838,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50838,(2),null);
...
var m__$1 = (function (){var G__50845 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__50853 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__50854 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__50854) : cljs.test.run_block.call(null,G__50854));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__50853) : obj.call(null,G__50853));
} else {
var G__50933 = (function (){var G__50855 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__50855);
} else {
return G__50855;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__50871,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__50895 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__50895) : f1.call(null,G__50895));
});
});
/**
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50905){
var vec__50906 = p__50905;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50906,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50906,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__50909 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var seq__50912 = cljs.core.seq(vars__$1);
var chunk__50913 = null;
var count__50914 = (0);
var i__50915 = (0);
while(true){
if((i__50915 < count__50914)){
var v = chunk__50913.cljs$core$IIndexed$_nth$arity$2(null,i__50915);
var temp__5735__auto___50941 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50941)){
var t_50942 = temp__5735__auto___50941;
var G__50918_50944 = ((function (seq__50912,chunk__50913,count__50914,i__50915,t_50942,temp__5735__auto___50941,v,each_fixture_fn,G__50909,G__50909__$1,env,once_fixtures,each_fixtures,vec__50906,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50942)));
});})(seq__50912,chunk__50913,count__50914,i__50915,t_50942,temp__5735__auto___50941,v,each_fixture_fn,G__50909,G__50909__$1,env,once_fixtures,each_fixtures,vec__50906,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50918_50944) : each_fixture_fn.call(null,G__50918_50944));
} else {
}


var G__50946 = seq__50912;
var G__50947 = chunk__50913;
var G__50948 = count__50914;
var G__50949 = (i__50915 + (1));
seq__50912 = G__50946;
chunk__50913 = G__50947;
count__50914 = G__50948;
i__50915 = G__50949;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50912);
if(temp__5735__auto__){
var seq__50912__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50912__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__50912__$1);
var G__50951 = cljs.core.chunk_rest(seq__50912__$1);
var G__50952 = c__4609__auto__;
var G__50953 = cljs.core.count(c__4609__auto__);
var G__50954 = (0);
seq__50912 = G__50951;
chunk__50913 = G__50952;
count__50914 = G__50953;
i__50915 = G__50954;
continue;
} else {
var v = cljs.core.first(seq__50912__$1);
var temp__5735__auto___50956__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50956__$1)){
var t_50957 = temp__5735__auto___50956__$1;
var G__50919_50958 = ((function (seq__50912,chunk__50913,count__50914,i__50915,t_50957,temp__5735__auto___50956__$1,v,seq__50912__$1,temp__5735__auto__,each_fixture_fn,G__50909,G__50909__$1,env,once_fixtures,each_fixtures,vec__50906,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50957)));
});})(seq__50912,chunk__50913,count__50914,i__50915,t_50957,temp__5735__auto___50956__$1,v,seq__50912__$1,temp__5735__auto__,each_fixture_fn,G__50909,G__50909__$1,env,once_fixtures,each_fixtures,vec__50906,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50919_50958) : each_fixture_fn.call(null,G__50919_50958));
} else {
}


var G__50959 = cljs.core.next(seq__50912__$1);
var G__50960 = null;
var G__50961 = (0);
var G__50962 = (0);
seq__50912 = G__50959;
chunk__50913 = G__50960;
count__50914 = G__50961;
i__50915 = G__50962;
continue;
}
} else {
...
var fexpr__50910 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__50910.cljs$core$IFn$_invoke$arity$1 ? fexpr__50910.cljs$core$IFn$_invoke$arity$1(G__50911) : fexpr__50910.call(null,G__50911));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50909__$1)].join('')));
...
var G__50920 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"end-test-vars","end-test-vars",-1394419713),new cljs.core.Keyword(null,"vars","vars",-2046957217),vars], null);
return (cljs.test.report.cljs$core$IFn$_invoke$arity$1 ? cljs.test.report.cljs$core$IFn$_invoke$arity$1(G__50920) : cljs.test.report.call(null,G__50920));
})], null)));
});
/**
