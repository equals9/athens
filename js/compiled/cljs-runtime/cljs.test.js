...
var G__50794 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__50794,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint], 0));
} else {
return G__50794;
}
}));
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq50804){
var G__50805 = cljs.core.first(seq50804);
var seq50804__$1 = cljs.core.next(seq50804);
var G__50806 = cljs.core.first(seq50804__$1);
var seq50804__$2 = cljs.core.next(seq50804__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50805,G__50806,seq50804__$2);
}));
...
var map__50812 = m;
var map__50812__$1 = (((((!((map__50812 == null))))?(((((map__50812.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50812.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__50812):map__50812);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50812__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50812__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50812__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50811_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(p1__50811_SHARP_));
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__50841 = cljs.core.get_global_hierarchy;
return (fexpr__50841.cljs$core$IFn$_invoke$arity$0 ? fexpr__50841.cljs$core$IFn$_invoke$arity$0() : fexpr__50841.call(null));
})());
...
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["expected:",(function (){var G__50843 = new cljs.core.Keyword(null,"expected","expected",1583670997).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50843) : formatter_fn.call(null,G__50843));
})()], 0));

return cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["  actual:",(function (){var G__50845 = new cljs.core.Keyword(null,"actual","actual",107306363).cljs$core$IFn$_invoke$arity$1(m);
return (formatter_fn.cljs$core$IFn$_invoke$arity$1 ? formatter_fn.cljs$core$IFn$_invoke$arity$1(G__50845) : formatter_fn.call(null,G__50845));
})()], 0));
});
...
var temp__5735__auto___50944 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___50944)){
var message_50945 = temp__5735__auto___50944;
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__50873 = output_dir;
if((!(clojure.string.ends_with_QMARK_(output_dir,"/")))){
return [G__50873,"/"].join('');
} else {
return G__50873;
}
})();
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__50887 = exception.stack;
var G__50887__$1 = (((G__50887 == null))?null:clojure.string.split_lines(G__50887));
var G__50887__$2 = (((G__50887__$1 == null))?null:cljs.core.get.cljs$core$IFn$_invoke$arity$2(G__50887__$1,depth));
if((G__50887__$2 == null)){
return null;
} else {
return clojure.string.trim(G__50887__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename(stack_element);
var vec__50890 = cljs.test.js_line_and_column(stack_element);
var line = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50890,(0),null);
var column = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50890,(1),null);
var vec__50893 = cljs.test.mapped_line_and_column(fname,line,column);
var fname__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50893,(0),null);
var line__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50893,(1),null);
var column__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50893,(2),null);
...
var m__$1 = (function (){var G__50900 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__50903 = (function (){var d = (new cljs.core.Delay(((function (fns,obj,f,xs__6292__auto__,temp__5735__auto__){
return (function (){
var G__50904 = cljs.core.rest(fns);
return (cljs.test.run_block.cljs$core$IFn$_invoke$arity$1 ? cljs.test.run_block.cljs$core$IFn$_invoke$arity$1(G__50904) : cljs.test.run_block.call(null,G__50904));
...
return (obj.cljs$core$IFn$_invoke$arity$1 ? obj.cljs$core$IFn$_invoke$arity$1(G__50903) : obj.call(null,G__50903));
} else {
var G__50948 = (function (){var G__50905 = cljs.core.rest(fns);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(obj,G__50905);
} else {
return G__50905;
}
})();
...
return cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$4(G__50906,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
return (function (g){
var G__50912 = (function (){
return (f2.cljs$core$IFn$_invoke$arity$1 ? f2.cljs$core$IFn$_invoke$arity$1(g) : f2.call(null,g));
});
return (f1.cljs$core$IFn$_invoke$arity$1 ? f1.cljs$core$IFn$_invoke$arity$1(G__50912) : f1.call(null,G__50912));
});
});
/**
...
var vec__50913 = fixtures_types();
var type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50913,(0),null);
var types = vec__50913;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50919){
var vec__50920 = p__50919;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50920,(0),null);
var vars__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50920,(1),null);
return (function (){
return cljs.test.block((function (){var env = cljs.test.get_current_env();
var once_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"once-fixtures","once-fixtures",1253947167),ns], null));
var each_fixtures = cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(env,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"each-fixtures","each-fixtures",802243977),ns], null));
var G__50923 = cljs.test.execution_strategy(once_fixtures,each_fixtures);
...
var seq__50926 = cljs.core.seq(vars__$1);
var chunk__50927 = null;
var count__50928 = (0);
var i__50929 = (0);
while(true){
if((i__50929 < count__50928)){
var v = chunk__50927.cljs$core$IIndexed$_nth$arity$2(null,i__50929);
var temp__5735__auto___50967 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50967)){
var t_50969 = temp__5735__auto___50967;
var G__50935_50970 = ((function (seq__50926,chunk__50927,count__50928,i__50929,t_50969,temp__5735__auto___50967,v,each_fixture_fn,G__50923,G__50923__$1,env,once_fixtures,each_fixtures,vec__50920,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50969)));
});})(seq__50926,chunk__50927,count__50928,i__50929,t_50969,temp__5735__auto___50967,v,each_fixture_fn,G__50923,G__50923__$1,env,once_fixtures,each_fixtures,vec__50920,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50935_50970) : each_fixture_fn.call(null,G__50935_50970));
} else {
}


var G__50971 = seq__50926;
var G__50972 = chunk__50927;
var G__50973 = count__50928;
var G__50974 = (i__50929 + (1));
seq__50926 = G__50971;
chunk__50927 = G__50972;
count__50928 = G__50973;
i__50929 = G__50974;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__50926);
if(temp__5735__auto__){
var seq__50926__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50926__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__50926__$1);
var G__50976 = cljs.core.chunk_rest(seq__50926__$1);
var G__50977 = c__4609__auto__;
var G__50978 = cljs.core.count(c__4609__auto__);
var G__50979 = (0);
seq__50926 = G__50976;
chunk__50927 = G__50977;
count__50928 = G__50978;
i__50929 = G__50979;
continue;
} else {
var v = cljs.core.first(seq__50926__$1);
var temp__5735__auto___50981__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(v));
if(cljs.core.truth_(temp__5735__auto___50981__$1)){
var t_50982 = temp__5735__auto___50981__$1;
var G__50936_50983 = ((function (seq__50926,chunk__50927,count__50928,i__50929,t_50982,temp__5735__auto___50981__$1,v,seq__50926__$1,temp__5735__auto__,each_fixture_fn,G__50923,G__50923__$1,env,once_fixtures,each_fixtures,vec__50920,ns,vars__$1){
return (function (){
return cljs.test.run_block(cljs.test.test_var_block_STAR_(v,cljs.test.disable_async(t_50982)));
});})(seq__50926,chunk__50927,count__50928,i__50929,t_50982,temp__5735__auto___50981__$1,v,seq__50926__$1,temp__5735__auto__,each_fixture_fn,G__50923,G__50923__$1,env,once_fixtures,each_fixtures,vec__50920,ns,vars__$1))
;
(each_fixture_fn.cljs$core$IFn$_invoke$arity$1 ? each_fixture_fn.cljs$core$IFn$_invoke$arity$1(G__50936_50983) : each_fixture_fn.call(null,G__50936_50983));
} else {
}


var G__50984 = cljs.core.next(seq__50926__$1);
var G__50985 = null;
var G__50986 = (0);
var G__50987 = (0);
seq__50926 = G__50984;
chunk__50927 = G__50985;
count__50928 = G__50986;
i__50929 = G__50987;
continue;
}
} else {
...
var fexpr__50924 = cljs.test.join_fixtures(once_fixtures);
return (fexpr__50924.cljs$core$IFn$_invoke$arity$1 ? fexpr__50924.cljs$core$IFn$_invoke$arity$1(G__50925) : fexpr__50924.call(null,G__50925));
})], null);

break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50923__$1)].join('')));
