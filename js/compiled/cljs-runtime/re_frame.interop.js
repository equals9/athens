...
return [(function (){var pred__32574 = cljs.core.instance_QMARK_;
var expr__32575 = reactive_val;
if(cljs.core.truth_((pred__32574.cljs$core$IFn$_invoke$arity$2 ? pred__32574.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__32575) : pred__32574.call(null,reagent.ratom.RAtom,expr__32575)))){
return "ra";
} else {
if(cljs.core.truth_((pred__32574.cljs$core$IFn$_invoke$arity$2 ? pred__32574.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__32575) : pred__32574.call(null,reagent.ratom.RCursor,expr__32575)))){
return "rc";
} else {
if(cljs.core.truth_((pred__32574.cljs$core$IFn$_invoke$arity$2 ? pred__32574.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__32575) : pred__32574.call(null,reagent.ratom.Reaction,expr__32575)))){
return "rx";
} else {
if(cljs.core.truth_((pred__32574.cljs$core$IFn$_invoke$arity$2 ? pred__32574.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__32575) : pred__32574.call(null,reagent.ratom.Track,expr__32575)))){
return "tr";
} else {
return "other";
}
