...
var vec__25795 = temp__5735__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25795,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25795,(1),null);
 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.rgb__GT_hex = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$rgb__GT_hex(p__25802){
...
var vec__25813 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25806_SHARP_){
...
var G__25841 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(o,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([a__$1,b__$1], 0));
...
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.update_hsla_field(color,new cljs.core.Keyword(null,"hue","hue",-508078848),cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__25851_SHARP_){
return cljs.core.mod(p1__25851_SHARP_,(360));
...
var G__25894 = cljs.core.merge_with.cljs$core$IFn$_invoke$arity$variadic(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.average,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c1,c2], 0));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.mix.cljs$lang$applyTo = (function (seq25887){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25888,G__25889,seq25887__$2);
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.hue_rotations.cljs$lang$applyTo = (function (seq25897){
var G__25898 = cljs.core.first(seq25897);
var seq25897__$1 = cljs.core.next(seq25897);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25898,seq25897__$1);
}));
...
var a = day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.util.clip((1),(90),(function (){var G__25917 = new cljs.core.Keyword(null,"magnitude","magnitude",1924274222).cljs$core$IFn$_invoke$arity$2(angle,angle);
return Math.abs(G__25917);
})());
...
var iter__4582__auto__ = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25921(s__25922){
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__25923);
cljs.core.chunk_append(b__25924,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)));

var G__26123 = (i__25923 + (1));
i__25923 = G__26123;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25924),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25921(cljs.core.chunk_rest(s__25922__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25924),null);
}
} else {
var i = cljs.core.first(s__25922__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25921(cljs.core.rest(s__25922__$2)));
}
} else {
return null;
}
...
return iter__4582__auto__(cljs.core.range.cljs$core$IFn$_invoke$arity$2((1),(function (){var G__25927 = (100.0 / step);
return Math.floor(G__25927);
})()));
}));
...
return day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.update_hsla_field(color,new cljs.core.Keyword(null,"alpha","alpha",-1574982441),(function (p1__25948_SHARP_,p2__25949_SHARP_){
var G__25954 = (p1__25948_SHARP_ * ((1) + (p2__25949_SHARP_ / (100))));
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.zero_to_one_clip.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.zero_to_one_clip.cljs$core$IFn$_invoke$arity$1(G__25954) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.zero_to_one_clip.call(null,G__25954));
}),amount);
});
...
var vec__25971 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25970_SHARP_){
return (p1__25970_SHARP_ / (100));
