...
var vec__25778 = p__25776;
var h = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25778,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25778,(1),null);
var l = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25778,(2),null);
...
var iter__4582__auto__ = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25944(s__25945){
...
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__25946);
cljs.core.chunk_append(b__25947,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)));

var G__26124 = (i__25946 + (1));
i__25946 = G__26124;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__25947),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25944(cljs.core.chunk_rest(s__25945__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__25947),null);
}
} else {
var i = cljs.core.first(s__25945__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(c,new cljs.core.Keyword(null,"lightness","lightness",-2040901930),(i * step)),day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$color$iter__25944(cljs.core.rest(s__25945__$2)));
}
} else {
return null;
}
...
var temp__5733__auto__ = (function (){var G__25973 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(n);
return (day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.color_name__GT_color.cljs$core$IFn$_invoke$arity$1 ? day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.color_name__GT_color.cljs$core$IFn$_invoke$arity$1(G__25973) : day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.color.color_name__GT_color.call(null,G__25973));
})();
