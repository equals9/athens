...
var c__41324__auto__ = (d1.e - d2.e);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41324__auto____$2)){
var c__41324__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41324__auto____$3)){
return (0);
} else {
return c__41324__auto____$3;
}
} else {
return c__41324__auto____$2;
}
} else {
return c__41324__auto____$1;
}
} else {
return c__41324__auto__;
}
});
datascript.db.cmp_datoms_aevt = (function datascript$db$cmp_datoms_aevt(d1,d2){
var c__41324__auto__ = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = (d1.e - d2.e);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41324__auto____$2)){
var c__41324__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
...
var c__41324__auto__ = datascript.db.cmp(d1.a,d2.a);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = datascript.db.cmp(d1.v,d2.v);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = (d1.e - d2.e);
if(((0) === c__41324__auto____$2)){
var c__41324__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41324__auto____$3)){
return (0);
...
var c__41324__auto__ = (d1.e - d2.e);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = cljs.core.compare(d1.v,d2.v);
if(((0) === c__41324__auto____$2)){
var c__41324__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
if(((0) === c__41324__auto____$3)){
return (0);
...
var c__41324__auto__ = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = (d1.e - d2.e);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = cljs.core.compare(d1.v,d2.v);
...
var c__41324__auto__ = datascript.db.cmp_attr_quick(d1.a,d2.a);
if(((0) === c__41324__auto__)){
var c__41324__auto____$1 = cljs.core.compare(d1.v,d2.v);
if(((0) === c__41324__auto____$1)){
var c__41324__auto____$2 = (d1.e - d2.e);
if(((0) === c__41324__auto____$2)){
var c__41324__auto____$3 = (d1.datascript$db$IDatom$datom_tx$arity$1(null) - d2.datascript$db$IDatom$datom_tx$arity$1(null));
...
var comp_QMARK__42262 = new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$2(kv,false);
datascript.db.validate_schema_key(a,new cljs.core.Keyword("db","isComponent","db/isComponent",423352398),new cljs.core.Keyword("db","isComponent","db/isComponent",423352398).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [true,null,false,null], null), null));

if(cljs.core.truth_((function (){var and__4174__auto__ = comp_QMARK__42262;
if(cljs.core.truth_(and__4174__auto__)){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("db","valueType","db/valueType",1827971944).cljs$core$IFn$_invoke$arity$1(kv),new cljs.core.Keyword("db.type","ref","db.type/ref",-1728373079));
} else {
return and__4174__auto__;
...
var G__42268 = cljs.core.next(seq__41975__$1);
var G__42269 = null;
var G__42270 = (0);
var G__42271 = (0);
seq__41975 = G__42268;
...
var G__42283 = cljs.core.next(xs);
var G__42284 = cljs.core.next(ys);
xs = G__42283;
ys = G__42284;
continue;
} else {
...
if(cljs.core.truth_(a)){
var G__42003_42295 = a;
var G__42004_42296 = (new cljs.core.List(null,new cljs.core.Symbol(null,"resolve-datom","resolve-datom",-294110827,null),(new cljs.core.List(null,new cljs.core.Symbol(null,"db","db",-1661185010,null),(new cljs.core.List(null,e,(new cljs.core.List(null,a,(new cljs.core.List(null,v,(new cljs.core.List(null,t,null,(1),null)),(2),null)),(3),null)),(4),null)),(5),null)),(6),null));
(datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2 ? datascript.db.validate_attr.cljs$core$IFn$_invoke$arity$2(G__42003_42295,G__42004_42296) : datascript.db.validate_attr.call(null,G__42003_42295,G__42004_42296));
} else {
}
