...
var G__42287 = cljs.core.next(seq__41975__$1);
var G__42288 = null;
var G__42289 = (0);
var G__42290 = (0);
seq__41975 = G__42287;
chunk__41976 = G__42288;
count__41977 = G__42289;
i__41978 = G__42290;
continue;
}
} else {
...
var G__42304 = cljs.core.next(xs);
var G__42305 = cljs.core.next(ys);
xs = G__42304;
ys = G__42305;
continue;
} else {
...
var G__42366 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,new_eid);
var G__42367 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.explode(db,new_entity),entities);
report = G__42366;
es = G__42367;
continue;
} else {
...
var G__42368 = report;
var G__42369 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,db,args),entities);
report = G__42368;
es = G__42369;
continue;
} else {
...
var G__42370 = report;
var G__42371 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__42370;
es = G__42371;
continue;
} else {
...
,datoms))){
var G__42373 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__42374 = entities;
report = G__42373;
es = G__42374;
continue;
} else {
...
var G__42375 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__42376 = entities;
report = G__42375;
es = G__42376;
continue;
} else {
...
var G__42377 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,datascript.db.current_tx(report));
var G__42378 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,datascript.db.current_tx(report),a,v], null),entities);
report = G__42377;
es = G__42378;
continue;
} else {
if(((datascript.db.ref_QMARK_(db,a)) && (datascript.db.tx_id_QMARK_(v)))){
var G__42379 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__42380 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__42379;
es = G__42380;
continue;
} else {
...
if((temp__5737__auto__ == null)){
var G__42381 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.next_eid(db));
var G__42382 = es;
report = G__42381;
es = G__42382;
continue;
...
var G__42383 = report;
var G__42384 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,vid], null),entities);
report = G__42383;
es = G__42384;
continue;
}
...
var G__42386 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,e,eid);
var G__42387 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,eid,a,v], null),entities);
report = G__42386;
es = G__42387;
continue;
}
...
var G__42388 = datascript.db.transact_add(report,entity);
...
var G__42394 = datascript.db.transact_retract_datom(report,old_datom);
...
var G__42398 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,datoms);
var G__42399 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,datoms),entities);
report = G__42398;
es = G__42399;
continue;
}
...
var G__42402 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(datascript.db.transact_retract_datom,report,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(e_datoms,v_datoms));
var G__42403 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(datascript.db.retract_components(db,e_datoms),entities);
report = G__42402;
es = G__42403;
continue;
}
...
var G__42404 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
var G__42405 = entities;
report = G__42404;
es = G__42405;
continue;
} else {
var G__42406 = report;
var G__42407 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","retract","db/retract",-1549825231),e,a,v], null),entities);
report = G__42406;
es = G__42407;
continue;
}
