...
if((diff > (0))){
var G__42142 = only_a;
var G__42143 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(only_b,first_b);
var G__42144 = both;
var G__42145 = a__$1;
...
var G__42293 = db;
var G__42294 = cljs.core.array_seq.cljs$core$IFn$_invoke$arity$1(eid);
db = G__42293;
eid = G__42294;
continue;
} else {
...
var G__42327 = cljs.core.rest(s__42056__$1);
s__42056__$1 = G__42327;
continue;
}
} else {
...
var G__42337 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,old_eid,id);
var G__42338 = cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(entity,new cljs.core.Keyword("db","id","db/id",-1388397098),id),entities);
report = G__42337;
es = G__42338;
continue;
} else {
...
var G__42348 = report;
var G__42349 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.apply.cljs$core$IFn$_invoke$arity$3(fun,db,args),entities);
report = G__42348;
es = G__42349;
continue;
} else {
...
,datoms))){
var G__42353 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
...
var G__42358 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e__$2,a__$1,nv__$1], null));
var G__42359 = entities;
report = G__42358;
es = G__42359;
continue;
} else {
...
var G__42365 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.current_tx(report));
var G__42366 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,datascript.db.current_tx(report)], null),entities);
report = G__42365;
es = G__42366;
continue;
} else {
...
if((temp__5737__auto__ == null)){
var G__42367 = datascript.db.allocate_eid.cljs$core$IFn$_invoke$arity$3(report,v,datascript.db.next_eid(db));
var G__42368 = es;
report = G__42367;
es = G__42368;
continue;
...
var G__42369 = report;
var G__42370 = cljs.core.cons(new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [op,e,a,vid], null),entities);
report = G__42369;
es = G__42370;
continue;
}
...
var G__42393 = datascript.db.transact_add(report,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),e,a,v,tx], null));
