...
var G__45254 = cljs.core.rest(pattern);
var G__45255 = cljs.core.rest(datom);
pattern = G__45254;
datom = G__45255;
continue;
} else {
...
var G__45239 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__45239)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__45239)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__45239)){
return true;
} else {
return cljs.core.some((function (p1__45235_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__45235_SHARP_);
}),datoms);
...
var G__45244 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__45244)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__45244)){
return datoms;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__45244)){
return null;
} else {
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45240_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__45240_SHARP_);
}),datoms);
