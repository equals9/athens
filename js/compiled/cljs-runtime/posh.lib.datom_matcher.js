...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__45242 = cljs.core.first(datom);
return (p.cljs$core$IFn$_invoke$arity$1 ? p.cljs$core$IFn$_invoke$arity$1(G__45242) : p.call(null,G__45242));
})():false);
...
return cljs.core.some((function (p1__45246_SHARP_){
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__45246_SHARP_,datom);
}),patterns);
});
...
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__45248_SHARP_);
}),datoms);
