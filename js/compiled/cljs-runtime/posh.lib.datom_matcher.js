...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__45227 = cljs.core.first(datom);
return (p.cljs$core$IFn$_invoke$arity$1 ? p.cljs$core$IFn$_invoke$arity$1(G__45227) : p.call(null,G__45227));
})():false);
...
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__45229_SHARP_,datom);
}),patterns);
});
...
var G__45267 = new cljs.core.Keyword(null,"new-patterns","new-patterns",404552774).cljs$core$IFn$_invoke$arity$1(r);
var G__45268 = new cljs.core.Keyword(null,"leftover-patterns","leftover-patterns",377032963).cljs$core$IFn$_invoke$arity$1(r);
new_patterns = G__45267;
leftover_patterns = G__45268;
continue;
} else {
var G__45269 = cljs.core.cons(cljs.core.first(leftover_patterns),new_patterns);
var G__45270 = cljs.core.rest(leftover_patterns);
new_patterns = G__45269;
leftover_patterns = G__45270;
continue;
}
}
break;
