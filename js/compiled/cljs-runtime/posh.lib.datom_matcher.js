...
var or__4185__auto____$1 = ((cljs.core.set_QMARK_(p))?(function (){var G__45239 = cljs.core.first(datom);
return (p.cljs$core$IFn$_invoke$arity$1 ? p.cljs$core$IFn$_invoke$arity$1(G__45239) : p.call(null,G__45239));
})():false);
...
return cljs.core.some((function (p1__45243_SHARP_){
return posh.lib.datom_matcher.datom_match_pattern_QMARK_(p1__45243_SHARP_,datom);
}),patterns);
});
posh.lib.datom_matcher.any_datoms_match_QMARK_ = (function posh$lib$datom_matcher$any_datoms_match_QMARK_(patterns,datoms){
var G__45248 = patterns;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__45248)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,G__45248)){
return null;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.PersistentVector.EMPTY], null),G__45248)){
return true;
} else {
return cljs.core.some((function (p1__45244_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__45244_SHARP_);
}),datoms);
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__45250_SHARP_){
return posh.lib.datom_matcher.datom_match_QMARK_(patterns,p1__45250_SHARP_);
}),datoms);
