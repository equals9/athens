...
athens.devcards.node_page.node_page_el = (function athens$devcards$node_page$node_page_el(p__68227,editing_uid,linked_refs,unlinked_refs){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68228__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68228__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68228__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),title], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68230(s__68231){
return (new cljs.core.LazySeq(null,(function (){
var s__68231__$1 = s__68231;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__68231__$1);
if(temp__5735__auto__){
var s__68231__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__68231__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__68231__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__68233 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__68232 = (0);
while(true){
if((i__68232 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68232);
cljs.core.chunk_append(b__68233,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null)));

var G__68249 = (i__68232 + (1));
i__68232 = G__68249;
continue;
} else {
return true;
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),"Linked References"], null),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68234(s__68235){
return (new cljs.core.LazySeq(null,(function (){
...
var ref = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68236);
cljs.core.chunk_append(b__68237,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),ref], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),ref], null)));

var G__68250 = (i__68236 + (1));
i__68236 = G__68250;
continue;
} else {
return true;
...
var ref = cljs.core.first(s__68235__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),ref], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),ref], null)),athens$devcards$node_page$node_page_el_$_iter__68234(cljs.core.rest(s__68235__$2)));
}
} else {
return null;
}
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),"Unlinked References"], null),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68238(s__68239){
return (new cljs.core.LazySeq(null,(function (){
...
var editing_uid = cljs.core.deref((function (){var G__68242 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__68242) : re_frame.core.subscribe.call(null,G__68242));
})());
if(clojure.string.blank_QMARK_(title)){
return null;
} else {
var linked_ref_entids = cljs.core.deref((function (){var G__68243 = athens.db.q_refs;
var G__68244 = athens.db.dsdb;
var G__68245 = athens.patterns.linked(title);
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$3(G__68243,G__68244,G__68245) : posh.reagent.q.call(null,G__68243,G__68244,G__68245));
})());
var unlinked_ref_entids = cljs.core.deref((function (){var G__68246 = athens.db.q_refs;
var G__68247 = athens.db.dsdb;
var G__68248 = athens.patterns.unlinked(title);
