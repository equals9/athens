...
athens.devcards.node_page.node_page_el = (function athens$devcards$node_page$node_page_el(p__68211,editing_uid,linked_refs,unlinked_refs){
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68212__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68212__$1,new cljs.core.Keyword("block","children","block/children",-1040716209));
var uid = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68212__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
...
})], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),title], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68214(s__68215){
...
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68216);
cljs.core.chunk_append(b__68217,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(child)], null)));

var G__68233 = (i__68216 + (1));
i__68216 = G__68233;
continue;
} else {
return true;
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),"Linked References"], null),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68218(s__68219){
return (new cljs.core.LazySeq(null,(function (){
...
})()], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h4","h4",2004862993),"Unlinked References"], null),(function (){var iter__4582__auto__ = (function athens$devcards$node_page$node_page_el_$_iter__68222(s__68223){
return (new cljs.core.LazySeq(null,(function (){
...
var ref = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__68224);
cljs.core.chunk_append(b__68225,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),ref], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),ref], null)));

var G__68255 = (i__68224 + (1));
i__68224 = G__68255;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__68225),athens$devcards$node_page$node_page_el_$_iter__68222(cljs.core.chunk_rest(s__68223__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__68225),null);
}
} else {
var ref = cljs.core.first(s__68223__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),ref], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),ref], null)),athens$devcards$node_page$node_page_el_$_iter__68222(cljs.core.rest(s__68223__$2)));
}
} else {
return null;
}
...
var editing_uid = cljs.core.deref((function (){var G__68226 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"editing-uid","editing-uid",1372614377)], null);
return (re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(G__68226) : re_frame.core.subscribe.call(null,G__68226));
})());
if(clojure.string.blank_QMARK_(title)){
return null;
} else {
var linked_ref_entids = cljs.core.deref((function (){var G__68227 = athens.db.q_refs;
var G__68228 = athens.db.dsdb;
var G__68229 = athens.patterns.linked(title);
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$3(G__68227,G__68228,G__68229) : posh.reagent.q.call(null,G__68227,G__68228,G__68229));
})());
var unlinked_ref_entids = cljs.core.deref((function (){var G__68230 = athens.db.q_refs;
var G__68231 = athens.db.dsdb;
var G__68232 = athens.patterns.unlinked(title);
return (posh.reagent.q.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.q.cljs$core$IFn$_invoke$arity$3(G__68230,G__68231,G__68232) : posh.reagent.q.call(null,G__68230,G__68231,G__68232));
})());
