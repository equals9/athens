...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68357,action,ex){
var map__68358 = p__68357;
...
var state = map__68358__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68358__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68360 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68360) : callback.call(null,G__68360));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68361,p__68362){
...
var state = map__68363__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68363__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
var action = map__68364__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68364__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68367 = type;
var G__68367__$1 = (((G__68367 instanceof cljs.core.Keyword))?G__68367.fqn:null);
switch (G__68367__$1) {
case "repl/invoke":
var map__68368 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68368__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68371 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68371) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68371));
}catch (e68370){var ex = e68370;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68367__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68372){
var map__68373 = p__68372;
...
var state = map__68373__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68373__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68375 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68375.cljs$core$IFn$_invoke$arity$1 ? fexpr__68375.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68375.call(null,state));
} else {
var map__68376 = cljs.core.first(actions);
...
var action = map__68376__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68376__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__68383 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68384 = (function (res){
var req = this;
var map__68388 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
var map__68388__$1 = (((((!((map__68388 == null))))?(((((map__68388.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68388.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68388):map__68388);
var result = map__68388__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68388__$1,new cljs.core.Keyword(null,"type","type",1174270348));
if((!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("repl","actions","repl/actions",-809718877),type)))){
var G__68390 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68390) : callback.call(null,G__68390));
} else {
...
var G__68385 = "POST";
var G__68386 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68387 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68383,G__68384,G__68385,G__68386,G__68387);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68379,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__68391 = k68379;
var G__68391__$1 = (((G__68391 instanceof cljs.core.Keyword))?G__68391.fqn:null);
switch (G__68391__$1) {
case "ws":
return self__.ws;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68379,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68392){
var vec__68393 = p__68392;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68393,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68393,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__68396 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68396(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68380,other68381){
var self__ = this;
var this68380__$1 = this;
return (((!((other68381 == null)))) && ((this68380__$1.constructor === other68381.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68380__$1.ws,other68381.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68380__$1.state_ref,other68381.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68380__$1.__extmap,other68381.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68378){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68397 = cljs.core.keyword_identical_QMARK_;
var expr__68398 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68400 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68401 = expr__68398;
return (pred__68397.cljs$core$IFn$_invoke$arity$2 ? pred__68397.cljs$core$IFn$_invoke$arity$2(G__68400,G__68401) : pred__68397.call(null,G__68400,G__68401));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68378,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68402 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68403 = expr__68398;
return (pred__68397.cljs$core$IFn$_invoke$arity$2 ? pred__68397.cljs$core$IFn$_invoke$arity$2(G__68402,G__68403) : pred__68397.call(null,G__68402,G__68403));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68378,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68378),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68378){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68378,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68382){
var extmap__4478__auto__ = (function (){var G__68404 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68382,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68382)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68404);
} else {
return G__68404;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68382),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68382),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68405 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68405);
...
var map__68406 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68406__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
