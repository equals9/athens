...
shadow.remote.runtime.cljs.browser.abort_BANG_ = (function shadow$remote$runtime$cljs$browser$abort_BANG_(p__68092,action,ex){
var map__68093 = p__68092;
var map__68093__$1 = (((((!((map__68093 == null))))?(((((map__68093.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__68093.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__68093):map__68093);
var state = map__68093__$1;
var callback = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68093__$1,new cljs.core.Keyword(null,"callback","callback",-705136228));
var G__68095 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(state,new cljs.core.Keyword(null,"failed","failed",-1397425762),true,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"completed","completed",-486056503),false,new cljs.core.Keyword(null,"ex","ex",-1413771341),ex,new cljs.core.Keyword(null,"ex-action","ex-action",672251553),action], 0));
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68095) : callback.call(null,G__68095));
});
shadow.remote.runtime.cljs.browser.interpret_action = (function shadow$remote$runtime$cljs$browser$interpret_action(p__68096,p__68097){
var map__68098 = p__68096;
...
var state = map__68098__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68098__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
var map__68099 = p__68097;
...
var action = map__68099__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68099__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var G__68102 = type;
var G__68102__$1 = (((G__68102 instanceof cljs.core.Keyword))?G__68102.fqn:null);
switch (G__68102__$1) {
case "repl/invoke":
var map__68103 = action;
...
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68103__$1,new cljs.core.Keyword(null,"js","js",1768080579));
try{var res = runtime.eval_js(js);
var G__68106 = cljs.core.update.cljs$core$IFn$_invoke$arity$4(state,new cljs.core.Keyword(null,"eval-results","eval-results",553789722),cljs.core.conj,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"value","value",305978217),res,new cljs.core.Keyword(null,"action","action",-811238024),action], null));
return (shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1 ? shadow.remote.runtime.cljs.browser.interpret_actions.cljs$core$IFn$_invoke$arity$1(G__68106) : shadow.remote.runtime.cljs.browser.interpret_actions.call(null,G__68106));
}catch (e68105){var ex = e68105;
return shadow.remote.runtime.cljs.browser.abort_BANG_(state,action,ex);
}
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__68102__$1)].join('')));

}
});
shadow.remote.runtime.cljs.browser.interpret_actions = (function shadow$remote$runtime$cljs$browser$interpret_actions(p__68107){
var map__68108 = p__68107;
...
var state = map__68108__$1;
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68108__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
if(cljs.core.empty_QMARK_(actions)){
var fexpr__68110 = new cljs.core.Keyword(null,"callback","callback",-705136228).cljs$core$IFn$_invoke$arity$1(state);
return (fexpr__68110.cljs$core$IFn$_invoke$arity$1 ? fexpr__68110.cljs$core$IFn$_invoke$arity$1(state) : fexpr__68110.call(null,state));
} else {
var map__68111 = cljs.core.first(actions);
...
var action = map__68111__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68111__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var self__ = this;
var this$ = this;
var G__68118 = [shadow.cljs.devtools.client.env.get_url_base(),"/worker/compile/",shadow.cljs.devtools.client.env.build_id,"/",shadow.cljs.devtools.client.env.proc_id,"/browser"].join('');
var G__68119 = (function (res){
var req = this;
var map__68123 = shadow.remote.runtime.cljs.browser.transit_read(req.getResponseText());
...
var G__68125 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"failed","failed",-1397425762),true,new cljs.core.Keyword(null,"result","result",1415092211),result], null);
return (callback.cljs$core$IFn$_invoke$arity$1 ? callback.cljs$core$IFn$_invoke$arity$1(G__68125) : callback.call(null,G__68125));
} else {
...
var G__68120 = "POST";
var G__68121 = shadow.remote.runtime.cljs.browser.transit_str(msg);
var G__68122 = ({"content-type": "application/transit+json; charset=utf-8"});
return goog.net.XhrIo.send(G__68118,G__68119,G__68120,G__68121,G__68122);
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k68114,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k68114,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__68127){
var vec__68128 = p__68127;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68128,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__68128,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__68131 = (function (coll__4436__auto__){
return (725844968 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__68131(this__4435__auto____$1);
})();
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this68115,other68116){
var self__ = this;
var this68115__$1 = this;
return (((!((other68116 == null)))) && ((this68115__$1.constructor === other68116.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68115__$1.ws,other68116.ws)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68115__$1.state_ref,other68116.state_ref)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this68115__$1.__extmap,other68116.__extmap)));
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__68113){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__68132 = cljs.core.keyword_identical_QMARK_;
var expr__68133 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__68135 = new cljs.core.Keyword(null,"ws","ws",86841443);
var G__68136 = expr__68133;
return (pred__68132.cljs$core$IFn$_invoke$arity$2 ? pred__68132.cljs$core$IFn$_invoke$arity$2(G__68135,G__68136) : pred__68132.call(null,G__68135,G__68136));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(G__68113,self__.state_ref,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__68137 = new cljs.core.Keyword(null,"state-ref","state-ref",2127874952);
var G__68138 = expr__68133;
return (pred__68132.cljs$core$IFn$_invoke$arity$2 ? pred__68132.cljs$core$IFn$_invoke$arity$2(G__68137,G__68138) : pred__68132.call(null,G__68137,G__68138));
})())){
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,G__68113,self__.__meta,self__.__extmap,null));
} else {
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__68113),null));
}
}
}));
...
(shadow.remote.runtime.cljs.browser.BrowserRuntime.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__68113){
var self__ = this;
var this__4438__auto____$1 = this;
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(self__.ws,self__.state_ref,G__68113,self__.__extmap,self__.__hash));
}));
 ...
 */
shadow.remote.runtime.cljs.browser.map__GT_BrowserRuntime = (function shadow$remote$runtime$cljs$browser$map__GT_BrowserRuntime(G__68117){
var extmap__4478__auto__ = (function (){var G__68139 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__68117,new cljs.core.Keyword(null,"ws","ws",86841443),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"state-ref","state-ref",2127874952)], 0));
if(cljs.core.record_QMARK_(G__68117)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__68139);
} else {
return G__68139;
}
})();
return (new shadow.remote.runtime.cljs.browser.BrowserRuntime(new cljs.core.Keyword(null,"ws","ws",86841443).cljs$core$IFn$_invoke$arity$1(G__68117),new cljs.core.Keyword(null,"state-ref","state-ref",2127874952).cljs$core$IFn$_invoke$arity$1(G__68117),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var runtime = (function (){var G__68140 = (new shadow.remote.runtime.cljs.browser.BrowserRuntime(socket,state_ref,null,null,null));
shadow.remote.runtime.shared.add_defaults(G__68140);
...
var map__68141 = temp__5737__auto__;
...
var stop = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__68141__$1,new cljs.core.Keyword(null,"stop","stop",-2140911342));
