...
var G__30443 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30443;
continue;
}
break;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30417){
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30422__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__30419;
if(cljs.core.seq(l)){
