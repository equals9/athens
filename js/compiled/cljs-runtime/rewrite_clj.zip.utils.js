...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__30428,k,f){
var vec__30429 = p__30428;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30429,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30429,(1),null);
var loc = vec__30429;
...
var G__30456 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30456;
continue;
}
break;
...
var G__30457 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__30457;
continue;
} else {
return zloc__$1;
...
var G__30458 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__30458;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30435){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__30443){
var vec__30444 = p__30443;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30444,(0),null);
var map__30447 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30444,(1),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30447__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__30444;
if(cljs.core.seq(r)){
...
var vec__30450 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30450,(0),null);
var map__30453 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30450,(1),null);
...
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30453__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30453__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30453__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30453__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
