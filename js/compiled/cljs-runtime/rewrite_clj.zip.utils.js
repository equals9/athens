...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__30406,k,f){
...
var G__30450 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__30450;
continue;
}
break;
...
var G__30451 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__30451;
continue;
} else {
return zloc__$1;
...
var G__30452 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__30452;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__30427){
var vec__30428 = p__30427;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30428,(0),null);
var map__30431 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30428,(1),null);
...
var path = map__30431__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30431__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__30428;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__30436){
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30440__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__30437;
if(cljs.core.seq(r)){
...
var vec__30442 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30442,(0),null);
var map__30445 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30442,(1),null);
...
var path = map__30445__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30445__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30445__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30445__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30445__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
