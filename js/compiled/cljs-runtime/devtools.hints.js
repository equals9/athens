...
var seen_errors_20949 = temp__5733__auto___20947;
if(cljs.core.truth_(seen_errors_20949.has(self))){
} else {
seen_errors_20949.add(self);

var temp__5735__auto___20950 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20950)){
var sense_20952 = temp__5735__auto___20950;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20952)].join(''));
} else {
}
}
} else {
