...
var temp__5733__auto___20729 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20729)){
var seen_errors_20730 = temp__5733__auto___20729;
if(cljs.core.truth_(seen_errors_20730.has(self))){
} else {
seen_errors_20730.add(self);

var temp__5735__auto___20733 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20733)){
var sense_20734 = temp__5735__auto___20733;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20734)].join(''));
} else {
}
}
} else {
