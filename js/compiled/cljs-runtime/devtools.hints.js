...
var G__20644 = cljs.core.PersistentArrayMap.EMPTY;
var G__20645 = native_stack_trace;
var G__20646 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__20647 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__20644,G__20645,G__20646,G__20647) : cljs.stacktrace.parse_stacktrace.call(null,G__20644,G__20645,G__20646,G__20647));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20651__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20651__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__20651__$1,new cljs.core.Keyword(null,"column","column",2078222095));
...
var temp__5733__auto___20665 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___20665)){
var seen_errors_20666 = temp__5733__auto___20665;
if(cljs.core.truth_(seen_errors_20666.has(self))){
} else {
seen_errors_20666.add(self);

var temp__5735__auto___20667 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___20667)){
var sense_20670 = temp__5735__auto___20667;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_20670)].join(''));
} else {
}
}
} else {
