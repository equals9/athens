...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__51809 = (new goog.Uri());
G__51809.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__51809.setDomain(server_name);

G__51809.setPort(server_port);

G__51809.setPath(uri);

G__51809.setQuery(query_string,true);
