...
return cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__51813 = (new goog.Uri());
G__51813.setScheme(cljs.core.name((function (){var or__4185__auto__ = scheme;
...
G__51813.setDomain(server_name);

G__51813.setPort(server_port);

G__51813.setPath(uri);

G__51813.setQuery(query_string,true);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__51823_SHARP_,p2__51822_SHARP_){
var vec__51824 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(p2__51822_SHARP_,/:\s+/);
...
return p1__51823_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__51823_SHARP_,clojure.string.lower_case(k),v);
}
