...
var G__24088 = data;
var target__20600__auto__ = G__24088;
if(cljs.core.truth_(target__20600__auto__)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24088)].join(''),"\n","target__20600__auto__"].join('')));
}
