...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__45328,pull_pattern,ent_id){
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__45342 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__45342.cljs$core$IFn$_invoke$arity$2 ? fexpr__45342.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__45342.call(null,db,ent_id));
})());
