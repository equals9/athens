...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__45332,pull_pattern,ent_id){
var map__45334 = p__45332;
...
var affected_datoms = posh.lib.pull_analyze.pull_affected_datoms(new cljs.core.Keyword(null,"pull","pull",-860544805).cljs$core$IFn$_invoke$arity$1(dcfg),db,pull_pattern,(function (){var fexpr__45349 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__45349.cljs$core$IFn$_invoke$arity$2 ? fexpr__45349.cljs$core$IFn$_invoke$arity$2(db,ent_id) : fexpr__45349.call(null,db,ent_id));
})());
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__45361,pull_pattern,ent_ids){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45362__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45362__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45362__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
...
var fexpr__45371 = new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__45371.cljs$core$IFn$_invoke$arity$2 ? fexpr__45371.cljs$core$IFn$_invoke$arity$2(db,p1__45358_SHARP_) : fexpr__45371.call(null,db,p1__45358_SHARP_));
}),ent_ids);
