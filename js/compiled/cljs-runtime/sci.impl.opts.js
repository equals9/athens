...
var len__4789__auto___66770 = arguments.length;
var i__4790__auto___66771 = (0);
while(true){
if((i__4790__auto___66771 < len__4789__auto___66770)){
args__4795__auto__.push((arguments[i__4790__auto___66771]));

var G__66772 = (i__4790__auto___66771 + (1));
i__4790__auto___66771 = G__66772;
continue;
} else {
}
break;
...
var G__66776 = null;
var G__66776__1 = (function (msg){
return (new Error(msg));
});
var G__66776__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__66776__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__66776 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__66776__1.call(this,msg);
case 2:
return G__66776__2.call(this,msg,filename);
case 3:
return G__66776__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__66776.cljs$core$IFn$_invoke$arity$1 = G__66776__1;
G__66776.cljs$core$IFn$_invoke$arity$2 = G__66776__2;
G__66776.cljs$core$IFn$_invoke$arity$3 = G__66776__3;
return G__66776;
})()
], null),new cljs.core.Symbol(null,"cljs.core.Delay","cljs.core.Delay",-1917476777,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.Delay,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__66753_SHARP_){
return (new cljs.core.Delay(p1__66753_SHARP_,null));
})], null),new cljs.core.Symbol(null,"goog.string.StringBuffer","goog.string.StringBuffer",-1220229842,null),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),goog.string.StringBuffer,new cljs.core.Keyword(null,"constructor","constructor",-1953928811),(function (p1__66754_SHARP_){
return (new goog.string.StringBuffer(p1__66754_SHARP_));
})], null)], null);
...
var vec__66758 = temp__5733__auto__;
var sym = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66758,(0),null);
var class_opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66758,(1),null);
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__66763){
var map__66764 = p__66763;
var map__66764__$1 = (((((!((map__66764 == null))))?(((((map__66764.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66764.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66764):map__66764);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var dry_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66764__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
