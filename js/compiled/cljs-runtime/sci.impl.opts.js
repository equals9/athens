...
var len__4789__auto___66679 = arguments.length;
var i__4790__auto___66680 = (0);
while(true){
...
var G__66685 = null;
var G__66685__1 = (function (msg){
return (new Error(msg));
});
var G__66685__2 = (function (msg,filename){
return (new Error(msg,filename));
});
var G__66685__3 = (function (msg,filename,line){
return (new Error(msg,filename,line));
});
G__66685 = function(msg,filename,line){
switch(arguments.length){
case 1:
return G__66685__1.call(this,msg);
case 2:
return G__66685__2.call(this,msg,filename);
case 3:
return G__66685__3.call(this,msg,filename,line);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
G__66685.cljs$core$IFn$_invoke$arity$1 = G__66685__1;
G__66685.cljs$core$IFn$_invoke$arity$2 = G__66685__2;
G__66685.cljs$core$IFn$_invoke$arity$3 = G__66685__3;
return G__66685;
})()
 ...
 * Initializes options
 */
sci.impl.opts.init = (function sci$impl$opts$init(p__66672){
var map__66673 = p__66672;
var map__66673__$1 = (((((!((map__66673 == null))))?(((((map__66673.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__66673.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__66673):map__66673);
var features = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"features","features",-1146962336));
var namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"namespaces","namespaces",-1444157469));
var bindings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"bindings","bindings",1271397192));
var readers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"readers","readers",-2118263030));
var env = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"env","env",-1815813235));
var imports = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"imports","imports",-1249933394));
var allow = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"allow","allow",-1857325745));
var preset = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"preset","preset",777387345));
var realize_max = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"realize-max","realize-max",-1846442543));
var load_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"load-fn","load-fn",-2121144334));
var dry_run = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"dry-run","dry-run",-1102788647));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
var deny = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"deny","deny",1589338523));
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66673__$1,new cljs.core.Keyword(null,"classes","classes",2037804510));
