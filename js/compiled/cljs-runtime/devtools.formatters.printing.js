...
var G__23912 = (i__4790__auto___23911 + (1));
i__4790__auto___23911 = G__23912;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq23827){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23828,G__23829,seq23827__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__23865_SHARP_){
return (!((cljs.core.meta(p1__23865_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23867__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e23878){var _e__20777__auto__ = e23878;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e23880){var _e__20777__auto__ = e23880;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__23900 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__23901 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__23901);

try{var map__23903 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23903__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__23900);
}});
...
var _STAR_print_level_STAR__orig_val__23908_23926 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__23909_23927 = managed_print_level_23925;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__23909_23927);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__23907_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__23907_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__23908_23926);
}} else {
job_fn();
}
