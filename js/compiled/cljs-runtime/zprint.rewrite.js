...
var G__30695 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__30695;
continue;
}
} else {
var G__30696 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__30696;
continue;
}
}
...
var G__30704 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__30705 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__30704;
out = G__30705;
continue;
} else {
...
var G__30708 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__30709 = cljs.core.next(new_loc);
var G__30710 = replaced_loc;
nloc = G__30708;
new_loc = G__30709;
last_loc = G__30710;
continue;
