...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53712_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53712_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53711_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53711_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53713_SHARP_){
return (((p1__53713_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53713_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53716,mapping){
...
var state = map__53717__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53717__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53717__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53717__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53714_SHARP_){
if((p1__53714_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53714_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var len__4789__auto___53768 = arguments.length;
var i__4790__auto___53769 = (0);
while(true){
if((i__4790__auto___53769 < len__4789__auto___53768)){
args__4795__auto__.push((arguments[i__4790__auto___53769]));

var G__53770 = (i__4790__auto___53769 + (1));
i__4790__auto___53769 = G__53770;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53722){
var vec__53723 = p__53722;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53723,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53720){
var G__53721 = cljs.core.first(seq53720);
var seq53720__$1 = cljs.core.next(seq53720);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53721,seq53720__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53729_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53729_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53731_53772 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53732_53773 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53733_53774 = true;
var _STAR_print_fn_STAR__temp_val__53734_53775 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53733_53774);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53734_53775);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53732_53773);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53731_53772);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53730_SHARP_){
return debux.common.util.prepend_bars(p1__53730_SHARP_,indent_level);
...
var G__53784 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53783;
acc = G__53784;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53737 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53737.cljs$core$IFn$_invoke$arity$1 ? fexpr__53737.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53737.call(null,f));
})())){
var G__53785 = cljs.core.next(opts__$1);
var G__53786 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53785;
acc = G__53786;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53738 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53738.cljs$core$IFn$_invoke$arity$1 ? fexpr__53738.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53738.call(null,f));
})())){
...
var G__53797 = cljs.core.next(opts__$1);
var G__53798 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53797;
acc = G__53798;
continue;
} else {
...
return (function() { 
var G__53804__delegate = function (arg){
...
var G__53804 = function (var_args){
var arg = null;
if (arguments.length > 0) {
var G__53805__i = 0, G__53805__a = new Array(arguments.length -  0);
while (G__53805__i < G__53805__a.length) {G__53805__a[G__53805__i] = arguments[G__53805__i + 0]; ++G__53805__i;}
  arg = new cljs.core.IndexedSeq(G__53805__a,0,null);
} 
return G__53804__delegate.call(this,arg);};
G__53804.cljs$lang$maxFixedArity = 0;
G__53804.cljs$lang$applyTo = (function (arglist__53806){
var arg = cljs.core.seq(arglist__53806);
return G__53804__delegate(arg);
});
G__53804.cljs$core$IFn$_invoke$arity$variadic = G__53804__delegate;
return G__53804;
})()
;
});
...
var G__53807 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53807;
continue;
} else {
...
var G__53808 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53808;
continue;
} else {
var G__53809 = clojure.zip.next(loc);
loc = G__53809;
continue;
