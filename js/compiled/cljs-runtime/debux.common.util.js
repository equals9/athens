...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53684_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53684_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53683_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53683_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53685_SHARP_){
return (((p1__53685_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53685_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53688,mapping){
...
var state = map__53689__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53689__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53689__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53689__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53686_SHARP_){
if((p1__53686_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53686_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53710){
var vec__53713 = p__53710;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53713,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53700){
var G__53701 = cljs.core.first(seq53700);
var seq53700__$1 = cljs.core.next(seq53700);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53701,seq53700__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53720_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53720_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53722_53758 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53723_53759 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53724_53760 = true;
var _STAR_print_fn_STAR__temp_val__53725_53761 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53724_53760);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53725_53761);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53723_53759);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53722_53758);
}
...
var G__53763 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53762;
acc = G__53763;
continue;
} else {
...
var G__53765 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53764;
acc = G__53765;
continue;
} else {
...
var G__53767 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53766;
acc = G__53767;
continue;
} else {
...
var G__53769 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53768;
acc = G__53769;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53728 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53728.cljs$core$IFn$_invoke$arity$1 ? fexpr__53728.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53728.call(null,f));
})())){
var G__53770 = cljs.core.next(opts__$1);
var G__53771 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53770;
acc = G__53771;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53729 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53729.cljs$core$IFn$_invoke$arity$1 ? fexpr__53729.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53729.call(null,f));
})())){
var G__53772 = cljs.core.nnext(opts__$1);
var G__53773 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53772;
acc = G__53773;
continue;
} else {
...
var G__53775 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53774;
acc = G__53775;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__53730){
var vec__53731 = p__53730;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53731,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53731,(1),null);
...
var G__53736 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__53735 = (function (){var fexpr__53737 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__53737.cljs$core$IFn$_invoke$arity$1 ? fexpr__53737.cljs$core$IFn$_invoke$arity$1(form) : fexpr__53737.call(null,form));
})();
return (fexpr__53735.cljs$core$IFn$_invoke$arity$1 ? fexpr__53735.cljs$core$IFn$_invoke$arity$1(G__53736) : fexpr__53735.call(null,G__53736));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53741 = quoted_form;
var G__53742 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53741,G__53742) : debux.common.util.remove_d.call(null,G__53741,G__53742));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__53776__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53743 = quoted_form;
var G__53744 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53743,G__53744) : debux.common.util.remove_d.call(null,G__53743,G__53744));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__53777__i < G__53777__a.length) {G__53777__a[G__53777__i] = arguments[G__53777__i + 0]; ++G__53777__i;}
  arg = new cljs.core.IndexedSeq(G__53777__a,0,null);
} 
return G__53776__delegate.call(this,arg);};
G__53776.cljs$lang$maxFixedArity = 0;
G__53776.cljs$lang$applyTo = (function (arglist__53778){
var arg = cljs.core.seq(arglist__53778);
return G__53776__delegate(arg);
});
...
var G__53779 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53779;
continue;
} else {
...
var G__53780 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53780;
continue;
} else {
var G__53781 = clojure.zip.next(loc);
loc = G__53781;
continue;
