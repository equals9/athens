...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58857_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__58857_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__58856_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__58856_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58858_SHARP_){
return (((p1__58858_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__58858_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__58861,mapping){
var map__58862 = p__58861;
var map__58862__$1 = (((((!((map__58862 == null))))?(((((map__58862.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__58862.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__58862):map__58862);
var state = map__58862__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58862__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58862__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58862__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__58859_SHARP_){
if((p1__58859_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__58859_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__58902 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__58903 = clojure.zip.next(loc);
loc = G__58903;
continue;
}
}
...
var G__58913 = (i__4790__auto___58911 + (1));
i__4790__auto___58911 = G__58913;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__58872){
var vec__58873 = p__58872;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58873,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq58870){
var G__58871 = cljs.core.first(seq58870);
var seq58870__$1 = cljs.core.next(seq58870);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__58871,seq58870__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58876_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__58876_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__58878_58917 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__58879_58918 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__58880_58919 = true;
var _STAR_print_fn_STAR__temp_val__58881_58920 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__58880_58919);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__58881_58920);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__58879_58918);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__58878_58917);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__58877_SHARP_){
return debux.common.util.prepend_bars(p1__58877_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__58921 = cljs.core.next(opts__$1);
var G__58922 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__58921;
acc = G__58922;
continue;
} else {
if(typeof f === 'string'){
var G__58923 = cljs.core.next(opts__$1);
var G__58924 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__58923;
acc = G__58924;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__58925 = cljs.core.nnext(opts__$1);
var G__58926 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__58925;
acc = G__58926;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__58927 = cljs.core.next(opts__$1);
var G__58928 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__58927;
acc = G__58928;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__58884 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__58884.cljs$core$IFn$_invoke$arity$1 ? fexpr__58884.cljs$core$IFn$_invoke$arity$1(f) : fexpr__58884.call(null,f));
})())){
var G__58929 = cljs.core.next(opts__$1);
var G__58930 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__58929;
acc = G__58930;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__58885 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__58885.cljs$core$IFn$_invoke$arity$1 ? fexpr__58885.cljs$core$IFn$_invoke$arity$1(f) : fexpr__58885.call(null,f));
})())){
var G__58931 = cljs.core.nnext(opts__$1);
var G__58932 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__58931;
acc = G__58932;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__58933 = cljs.core.next(opts__$1);
var G__58934 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__58933;
acc = G__58934;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__58886){
var vec__58887 = p__58886;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58887,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58887,(1),null);
...
var G__58892 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__58891 = (function (){var fexpr__58893 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__58893.cljs$core$IFn$_invoke$arity$1 ? fexpr__58893.cljs$core$IFn$_invoke$arity$1(form) : fexpr__58893.call(null,form));
})();
return (fexpr__58891.cljs$core$IFn$_invoke$arity$1 ? fexpr__58891.cljs$core$IFn$_invoke$arity$1(G__58892) : fexpr__58891.call(null,G__58892));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__58895 = quoted_form;
var G__58896 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__58895,G__58896) : debux.common.util.remove_d.call(null,G__58895,G__58896));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__58897 = quoted_form;
var G__58898 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__58897,G__58898) : debux.common.util.remove_d.call(null,G__58897,G__58898));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__58935__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__58899 = quoted_form;
var G__58900 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__58899,G__58900) : debux.common.util.remove_d.call(null,G__58899,G__58900));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__58936__i < G__58936__a.length) {G__58936__a[G__58936__i] = arguments[G__58936__i + 0]; ++G__58936__i;}
  arg = new cljs.core.IndexedSeq(G__58936__a,0,null);
} 
return G__58935__delegate.call(this,arg);};
G__58935.cljs$lang$maxFixedArity = 0;
G__58935.cljs$lang$applyTo = (function (arglist__58937){
var arg = cljs.core.seq(arglist__58937);
return G__58935__delegate(arg);
});
...
var G__58938 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__58938;
continue;
} else {
...
var G__58939 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__58939;
continue;
} else {
var G__58940 = clojure.zip.next(loc);
loc = G__58940;
continue;
