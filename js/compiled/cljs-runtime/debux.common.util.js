 ...
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53723,mapping){
...
var state = map__53724__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53724__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53724__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53724__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53718_SHARP_){
if((p1__53718_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53718_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__53767 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53768 = clojure.zip.next(loc);
loc = G__53768;
continue;
}
}
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53730){
var vec__53731 = p__53730;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53731,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53727){
var G__53728 = cljs.core.first(seq53727);
var seq53727__$1 = cljs.core.next(seq53727);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53728,seq53727__$1);
}));

debux.common.util.prepend_blanks = (function debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53734_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53734_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53737_53774 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53738_53775 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53739_53776 = true;
var _STAR_print_fn_STAR__temp_val__53740_53777 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53739_53776);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53740_53777);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53738_53775);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53737_53774);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53736_SHARP_){
return debux.common.util.prepend_bars(p1__53736_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__53781 = cljs.core.next(opts__$1);
var G__53782 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53781;
acc = G__53782;
continue;
} else {
if(typeof f === 'string'){
var G__53783 = cljs.core.next(opts__$1);
var G__53784 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53783;
acc = G__53784;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53785 = cljs.core.nnext(opts__$1);
var G__53786 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53785;
acc = G__53786;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__53787 = cljs.core.next(opts__$1);
var G__53788 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__53787;
acc = G__53788;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53747 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__53747.cljs$core$IFn$_invoke$arity$1 ? fexpr__53747.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53747.call(null,f));
})())){
var G__53789 = cljs.core.next(opts__$1);
var G__53790 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__53789;
acc = G__53790;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__53748 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__53748.cljs$core$IFn$_invoke$arity$1 ? fexpr__53748.cljs$core$IFn$_invoke$arity$1(f) : fexpr__53748.call(null,f));
})())){
var G__53791 = cljs.core.nnext(opts__$1);
var G__53792 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53791;
acc = G__53792;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"clog","clog",954273629))){
var G__53793 = cljs.core.next(opts__$1);
var G__53794 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53793;
acc = G__53794;
continue;
} else {
...
debux.common.util.quote_val = (function debux$common$util$quote_val(p__53749){
var vec__53750 = p__53749;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53750,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53750,(1),null);
...
var G__53755 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__53754 = (function (){var fexpr__53756 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten);
return (fexpr__53756.cljs$core$IFn$_invoke$arity$1 ? fexpr__53756.cljs$core$IFn$_invoke$arity$1(form) : fexpr__53756.call(null,form));
})();
return (fexpr__53754.cljs$core$IFn$_invoke$arity$1 ? fexpr__53754.cljs$core$IFn$_invoke$arity$1(G__53755) : fexpr__53754.call(null,G__53755));
});
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53758 = quoted_form;
var G__53759 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53758,G__53759) : debux.common.util.remove_d.call(null,G__53758,G__53759));
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53762 = quoted_form;
var G__53763 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53762,G__53763) : debux.common.util.remove_d.call(null,G__53762,G__53763));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__53795__delegate = function (arg){
...
debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__53764 = quoted_form;
var G__53765 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__53764,G__53765) : debux.common.util.remove_d.call(null,G__53764,G__53765));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
while (G__53796__i < G__53796__a.length) {G__53796__a[G__53796__i] = arguments[G__53796__i + 0]; ++G__53796__i;}
  arg = new cljs.core.IndexedSeq(G__53796__a,0,null);
} 
return G__53795__delegate.call(this,arg);};
G__53795.cljs$lang$maxFixedArity = 0;
G__53795.cljs$lang$applyTo = (function (arglist__53797){
var arg = cljs.core.seq(arglist__53797);
return G__53795__delegate(arg);
});
...
var G__53798 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53798;
continue;
} else {
...
var G__53799 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53799;
continue;
} else {
var G__53800 = clojure.zip.next(loc);
loc = G__53800;
continue;
