...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53681_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__53681_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__53680_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53680_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53682_SHARP_){
return (((p1__53682_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__53682_SHARP_) == null)));
}),debux.common.util.form_tree_seq(form))));
});
/**
 * Tidy up fully qualified names that have aliases in the existing namespace.
 */
debux.common.util.with_symbols_names = (function debux$common$util$with_symbols_names(form,p__53685,mapping){
...
var state = map__53686__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53686__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53686__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53686__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__53683_SHARP_){
if((p1__53683_SHARP_ instanceof cljs.core.Symbol)){
return cljs.core.namespace(p1__53683_SHARP_);
} else {
return false;
}
}),debux.common.util.form_tree_seq(form)));
...
var G__53726 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__53727 = clojure.zip.next(loc);
loc = G__53727;
continue;
}
}
...
var len__4789__auto___53730 = arguments.length;
var i__4790__auto___53731 = (0);
while(true){
if((i__4790__auto___53731 < len__4789__auto___53730)){
args__4795__auto__.push((arguments[i__4790__auto___53731]));

var G__53732 = (i__4790__auto___53731 + (1));
i__4790__auto___53731 = G__53732;
continue;
} else {
}
break;
...
(debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__53692){
var vec__53693 = p__53692;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53693,(0),null);
...
/** @this {Function} */
(debux.common.util.form_header.cljs$lang$applyTo = (function (seq53689){
var G__53690 = cljs.core.first(seq53689);
var seq53689__$1 = cljs.core.next(seq53689);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53690,seq53689__$1);
}));
...
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__53696_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__53698_53733 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__53699_53734 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__53700_53735 = true;
var _STAR_print_fn_STAR__temp_val__53701_53736 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__53700_53735);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__53701_53736);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__53699_53734);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__53698_53733);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__53697_SHARP_){
return debux.common.util.prepend_bars(p1__53697_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__53741 = cljs.core.next(opts__$1);
var G__53742 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__53741;
acc = G__53742;
continue;
} else {
...
var G__53745 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__53744;
acc = G__53745;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__53747 = cljs.core.nnext(opts__$1);
var G__53748 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__53747;
acc = G__53748;
continue;
} else {
...
var G__53756 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__53755;
acc = G__53756;
continue;
} else {
...
var G__53758 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__53757;
acc = G__53758;
continue;
} else {
...
return (function() { 
var G__53759__delegate = function (arg){
...
while (G__53760__i < G__53760__a.length) {G__53760__a[G__53760__i] = arguments[G__53760__i + 0]; ++G__53760__i;}
  arg = new cljs.core.IndexedSeq(G__53760__a,0,null);
} 
return G__53759__delegate.call(this,arg);};
G__53759.cljs$lang$maxFixedArity = 0;
G__53759.cljs$lang$applyTo = (function (arglist__53761){
var arg = cljs.core.seq(arglist__53761);
return G__53759__delegate(arg);
});
...
var G__53762 = clojure.zip.replace(loc,debux.common.util.third(node));
loc = G__53762;
continue;
} else {
...
var G__53763 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__53763;
continue;
} else {
var G__53764 = clojure.zip.next(loc);
loc = G__53764;
continue;
