...
var vec__55024 = cljs.core.rest(expr);
...
var vec__55027 = first__55026;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55027,(0),null);
var form = seq__55025__$1;
...
var G__55030 = x;
var G__55030__$1 = (((G__55030 == null))?null:spec_tools.impl.polish(G__55030));
var G__55030__$2 = (((G__55030__$1 == null))?null:cljs.core.name(G__55030__$1));
if((G__55030__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55030__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55031 = x;
var G__55031__$1 = (((G__55031 == null))?null:cljs.core.name(G__55031));
if((G__55031__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55031__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55032){
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55035){
var map__55036 = p__55035;
var map__55036__$1 = (((((!((map__55036 == null))))?(((((map__55036.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55036.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55036):map__55036);
var data = map__55036__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55036__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55036__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55038 = data;
var G__55038__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55038,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55038);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55038__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55038__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55042 = form;
var G__55042__$1 = (((G__55042 == null))?null:cljs.core.rest(G__55042));
if((G__55042__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55042__$1);
}
})();
var G__55043 = m;
var G__55043__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55043,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55039_SHARP_){
...
var G__55043__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55043__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55040_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55040_SHARP_)));
})):G__55043__$1);
var G__55043__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55043__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55041_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55041_SHARP_));
})):G__55043__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55043__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55044 = (function (){var G__55045 = form;
var G__55045__$1 = (((G__55045 == null))?null:cljs.core.rest(G__55045));
if((G__55045__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55045__$1);
}
})();
...
var G__55047 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55047) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55048 = form;
var G__55048__$1 = (((G__55048 == null))?null:cljs.core.seq(G__55048));
var G__55048__$2 = (((G__55048__$1 == null))?null:cljs.core.first(G__55048__$1));
if((G__55048__$2 == null)){
return null;
} else {
var fexpr__55049 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55049.cljs$core$IFn$_invoke$arity$1 ? fexpr__55049.cljs$core$IFn$_invoke$arity$1(G__55048__$2) : fexpr__55049.call(null,G__55048__$2));
}
})():null));
});
/**
...
var len__4789__auto___55070 = arguments.length;
var i__4790__auto___55071 = (0);
while(true){
if((i__4790__auto___55071 < len__4789__auto___55070)){
args__4795__auto__.push((arguments[i__4790__auto___55071]));

var G__55072 = (i__4790__auto___55071 + (1));
i__4790__auto___55071 = G__55072;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55050){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55050));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55051){
var vec__55052 = p__55051;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55052,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55052,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55057){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55055_SHARP_){
return cljs.core.map_QMARK_(p1__55055_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55056_SHARP_){
return cljs.core.contains_QMARK_(p1__55056_SHARP_,x);
});
}),req_keys));
