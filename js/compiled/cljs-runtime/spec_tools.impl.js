...
var vec__54921 = cljs.core.rest(expr);
var seq__54922 = cljs.core.seq(vec__54921);
var first__54923 = cljs.core.first(seq__54922);
var seq__54922__$1 = cljs.core.next(seq__54922);
var vec__54924 = first__54923;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54924,(0),null);
var form = seq__54922__$1;
...
var G__54927 = x;
var G__54927__$1 = (((G__54927 == null))?null:spec_tools.impl.polish(G__54927));
var G__54927__$2 = (((G__54927__$1 == null))?null:cljs.core.name(G__54927__$1));
if((G__54927__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54927__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54928 = x;
var G__54928__$1 = (((G__54928 == null))?null:cljs.core.name(G__54928));
if((G__54928__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54928__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54929){
var map__54930 = p__54929;
var map__54930__$1 = (((((!((map__54930 == null))))?(((((map__54930.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54930.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54930):map__54930);
var data = map__54930__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54930__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54930__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54930__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54930__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54932){
var map__54933 = p__54932;
...
var G__54935 = data;
var G__54935__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54935,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54935);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54935__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54935__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54939 = form;
var G__54939__$1 = (((G__54939 == null))?null:cljs.core.rest(G__54939));
if((G__54939__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54939__$1);
}
})();
var G__54940 = m;
var G__54940__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54940,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54936_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54936_SHARP_)));
})):G__54940);
var G__54940__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54940__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54937_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54937_SHARP_)));
})):G__54940__$1);
var G__54940__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54940__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54938_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54938_SHARP_));
})):G__54940__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54940__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54941 = (function (){var G__54942 = form;
var G__54942__$1 = (((G__54942 == null))?null:cljs.core.rest(G__54942));
if((G__54942__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54942__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54941__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54941__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54941__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54941__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54944 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__54944) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54945 = form;
var G__54945__$1 = (((G__54945 == null))?null:cljs.core.seq(G__54945));
var G__54945__$2 = (((G__54945__$1 == null))?null:cljs.core.first(G__54945__$1));
if((G__54945__$2 == null)){
return null;
} else {
var fexpr__54946 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54946.cljs$core$IFn$_invoke$arity$1 ? fexpr__54946.cljs$core$IFn$_invoke$arity$1(G__54945__$2) : fexpr__54946.call(null,G__54945__$2));
}
})():null));
});
/**
...
var len__4789__auto___54967 = arguments.length;
var i__4790__auto___54968 = (0);
while(true){
if((i__4790__auto___54968 < len__4789__auto___54967)){
args__4795__auto__.push((arguments[i__4790__auto___54968]));

var G__54969 = (i__4790__auto___54968 + (1));
i__4790__auto___54968 = G__54969;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54947){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54947));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54948){
var vec__54949 = p__54948;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54949,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54949,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54954){
var map__54955 = p__54954;
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54955__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54955__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54955__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54955__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54952_SHARP_){
return cljs.core.map_QMARK_(p1__54952_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54953_SHARP_){
return cljs.core.contains_QMARK_(p1__54953_SHARP_,x);
});
}),req_keys));
