...
var vec__54947 = cljs.core.rest(expr);
var seq__54948 = cljs.core.seq(vec__54947);
var first__54949 = cljs.core.first(seq__54948);
var seq__54948__$1 = cljs.core.next(seq__54948);
var vec__54950 = first__54949;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54950,(0),null);
var form = seq__54948__$1;
...
var G__54953 = x;
var G__54953__$1 = (((G__54953 == null))?null:spec_tools.impl.polish(G__54953));
var G__54953__$2 = (((G__54953__$1 == null))?null:cljs.core.name(G__54953__$1));
if((G__54953__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54953__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54954 = x;
var G__54954__$1 = (((G__54954 == null))?null:cljs.core.name(G__54954));
if((G__54954__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54954__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54955){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54956__$1,new cljs.core.Keyword(null,"req","req",-326448303));
...
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54956__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54958){
...
var data = map__54959__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54959__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54959__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54961 = data;
var G__54961__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54961,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54961);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54961__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54961__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54965 = form;
var G__54965__$1 = (((G__54965 == null))?null:cljs.core.rest(G__54965));
if((G__54965__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54965__$1);
}
})();
var G__54966 = m;
var G__54966__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54966,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54962_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54962_SHARP_)));
})):G__54966);
var G__54966__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54966__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54963_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54963_SHARP_)));
})):G__54966__$1);
var G__54966__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54966__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54964_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54964_SHARP_));
})):G__54966__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54966__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54967 = (function (){var G__54968 = form;
var G__54968__$1 = (((G__54968 == null))?null:cljs.core.rest(G__54968));
if((G__54968__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54968__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54967__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54967__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54967__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54967__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54970 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__54970) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54971 = form;
var G__54971__$1 = (((G__54971 == null))?null:cljs.core.seq(G__54971));
var G__54971__$2 = (((G__54971__$1 == null))?null:cljs.core.first(G__54971__$1));
if((G__54971__$2 == null)){
return null;
} else {
var fexpr__54972 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54972.cljs$core$IFn$_invoke$arity$1 ? fexpr__54972.cljs$core$IFn$_invoke$arity$1(G__54971__$2) : fexpr__54972.call(null,G__54971__$2));
}
})():null));
});
/**
...
var len__4789__auto___54993 = arguments.length;
var i__4790__auto___54994 = (0);
while(true){
if((i__4790__auto___54994 < len__4789__auto___54993)){
args__4795__auto__.push((arguments[i__4790__auto___54994]));

var G__54995 = (i__4790__auto___54994 + (1));
i__4790__auto___54994 = G__54995;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54973){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54973));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54974){
var vec__54975 = p__54974;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54975,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54975,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54980){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54978_SHARP_){
return cljs.core.map_QMARK_(p1__54978_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54979_SHARP_){
return cljs.core.contains_QMARK_(p1__54979_SHARP_,x);
});
}),req_keys));
