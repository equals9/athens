...
var vec__54970 = cljs.core.rest(expr);
var seq__54971 = cljs.core.seq(vec__54970);
var first__54972 = cljs.core.first(seq__54971);
var seq__54971__$1 = cljs.core.next(seq__54971);
var vec__54973 = first__54972;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54973,(0),null);
var form = seq__54971__$1;
...
var G__54976 = x;
var G__54976__$1 = (((G__54976 == null))?null:spec_tools.impl.polish(G__54976));
var G__54976__$2 = (((G__54976__$1 == null))?null:cljs.core.name(G__54976__$1));
if((G__54976__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54976__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54977 = x;
var G__54977__$1 = (((G__54977 == null))?null:cljs.core.name(G__54977));
if((G__54977__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54977__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54978){
var map__54979 = p__54978;
var map__54979__$1 = (((((!((map__54979 == null))))?(((((map__54979.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54979.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54979):map__54979);
var data = map__54979__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54979__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54979__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54979__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54979__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54981){
...
var data = map__54982__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54982__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54982__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54984 = data;
var G__54984__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54984,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54984);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54984__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54984__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54988 = form;
var G__54988__$1 = (((G__54988 == null))?null:cljs.core.rest(G__54988));
if((G__54988__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54988__$1);
}
})();
var G__54989 = m;
var G__54989__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54989,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54985_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54985_SHARP_)));
})):G__54989);
var G__54989__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54989__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54986_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54986_SHARP_)));
})):G__54989__$1);
var G__54989__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54989__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54987_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54987_SHARP_));
})):G__54989__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54989__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54990 = (function (){var G__54991 = form;
var G__54991__$1 = (((G__54991 == null))?null:cljs.core.rest(G__54991));
if((G__54991__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54991__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54990__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54990__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54990__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54990__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54993 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__54993) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54994 = form;
var G__54994__$1 = (((G__54994 == null))?null:cljs.core.seq(G__54994));
var G__54994__$2 = (((G__54994__$1 == null))?null:cljs.core.first(G__54994__$1));
if((G__54994__$2 == null)){
return null;
} else {
var fexpr__54995 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54995.cljs$core$IFn$_invoke$arity$1 ? fexpr__54995.cljs$core$IFn$_invoke$arity$1(G__54994__$2) : fexpr__54995.call(null,G__54994__$2));
}
})():null));
});
/**
...
var len__4789__auto___55016 = arguments.length;
var i__4790__auto___55017 = (0);
while(true){
if((i__4790__auto___55017 < len__4789__auto___55016)){
args__4795__auto__.push((arguments[i__4790__auto___55017]));

var G__55018 = (i__4790__auto___55017 + (1));
i__4790__auto___55017 = G__55018;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54996){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54996));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54997){
var vec__54998 = p__54997;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54998,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54998,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55003){
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55001_SHARP_){
return cljs.core.map_QMARK_(p1__55001_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55002_SHARP_){
return cljs.core.contains_QMARK_(p1__55002_SHARP_,x);
});
}),req_keys));
