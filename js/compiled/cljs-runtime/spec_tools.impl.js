...
var vec__60208 = cljs.core.rest(expr);
var seq__60209 = cljs.core.seq(vec__60208);
var first__60210 = cljs.core.first(seq__60209);
var seq__60209__$1 = cljs.core.next(seq__60209);
var vec__60211 = first__60210;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60211,(0),null);
var form = seq__60209__$1;
...
var G__60214 = x;
var G__60214__$1 = (((G__60214 == null))?null:spec_tools.impl.polish(G__60214));
var G__60214__$2 = (((G__60214__$1 == null))?null:cljs.core.name(G__60214__$1));
if((G__60214__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__60214__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__60215 = x;
var G__60215__$1 = (((G__60215 == null))?null:cljs.core.name(G__60215));
if((G__60215__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__60215__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__60216){
...
var data = map__60217__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60217__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__60219){
...
var data = map__60220__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60220__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60220__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__60222 = data;
var G__60222__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60222,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__60222);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60222__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__60222__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__60226 = form;
var G__60226__$1 = (((G__60226 == null))?null:cljs.core.rest(G__60226));
if((G__60226__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__60226__$1);
}
})();
var G__60227 = m;
var G__60227__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60227,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__60223_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__60223_SHARP_)));
})):G__60227);
var G__60227__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60227__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__60224_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__60224_SHARP_)));
})):G__60227__$1);
var G__60227__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__60227__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__60225_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__60225_SHARP_));
})):G__60227__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__60227__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__60228 = (function (){var G__60229 = form;
var G__60229__$1 = (((G__60229 == null))?null:cljs.core.rest(G__60229));
if((G__60229__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__60229__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60228__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60228__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60228__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60228__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__60231 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__60231) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__60232 = form;
var G__60232__$1 = (((G__60232 == null))?null:cljs.core.seq(G__60232));
var G__60232__$2 = (((G__60232__$1 == null))?null:cljs.core.first(G__60232__$1));
if((G__60232__$2 == null)){
return null;
} else {
var fexpr__60233 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__60233.cljs$core$IFn$_invoke$arity$1 ? fexpr__60233.cljs$core$IFn$_invoke$arity$1(G__60232__$2) : fexpr__60233.call(null,G__60232__$2));
}
})():null));
});
/**
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq60234){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq60234));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__60235){
var vec__60236 = p__60235;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60236,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__60236,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__60241){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60242__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60242__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60242__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60242__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__60239_SHARP_){
return cljs.core.map_QMARK_(p1__60239_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__60240_SHARP_){
return cljs.core.contains_QMARK_(p1__60240_SHARP_,x);
});
}),req_keys));
