...
var vec__54965 = cljs.core.rest(expr);
...
var vec__54968 = first__54967;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54968,(0),null);
var form = seq__54966__$1;
...
var G__54971 = x;
var G__54971__$1 = (((G__54971 == null))?null:spec_tools.impl.polish(G__54971));
var G__54971__$2 = (((G__54971__$1 == null))?null:cljs.core.name(G__54971__$1));
if((G__54971__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54971__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__54972 = x;
var G__54972__$1 = (((G__54972 == null))?null:cljs.core.name(G__54972));
if((G__54972__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__54972__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__54973){
...
var data = map__54974__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54974__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54974__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54974__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54974__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__54976){
...
var data = map__54977__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54977__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54977__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__54979 = data;
var G__54979__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54979,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__54979);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54979__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__54979__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__54983 = form;
var G__54983__$1 = (((G__54983 == null))?null:cljs.core.rest(G__54983));
if((G__54983__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54983__$1);
}
})();
var G__54984 = m;
var G__54984__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54984,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__54980_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__54980_SHARP_)));
})):G__54984);
var G__54984__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54984__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__54981_SHARP_){
...
var G__54984__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__54984__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__54982_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__54982_SHARP_));
})):G__54984__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__54984__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__54985 = (function (){var G__54986 = form;
var G__54986__$1 = (((G__54986 == null))?null:cljs.core.rest(G__54986));
if((G__54986__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__54986__$1);
}
})();
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54985__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54985__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54985__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54985__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__54988 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__54988) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__54989 = form;
var G__54989__$1 = (((G__54989 == null))?null:cljs.core.seq(G__54989));
var G__54989__$2 = (((G__54989__$1 == null))?null:cljs.core.first(G__54989__$1));
if((G__54989__$2 == null)){
return null;
} else {
var fexpr__54990 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__54990.cljs$core$IFn$_invoke$arity$1 ? fexpr__54990.cljs$core$IFn$_invoke$arity$1(G__54989__$2) : fexpr__54990.call(null,G__54989__$2));
}
})():null));
});
/**
...
var len__4789__auto___55011 = arguments.length;
var i__4790__auto___55012 = (0);
while(true){
if((i__4790__auto___55012 < len__4789__auto___55011)){
args__4795__auto__.push((arguments[i__4790__auto___55012]));

var G__55013 = (i__4790__auto___55012 + (1));
i__4790__auto___55012 = G__55013;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq54991){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq54991));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__54992){
var vec__54993 = p__54992;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54993,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54993,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__54998){
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54999__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54999__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54999__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54999__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__54996_SHARP_){
return cljs.core.map_QMARK_(p1__54996_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__54997_SHARP_){
return cljs.core.contains_QMARK_(p1__54997_SHARP_,x);
});
}),req_keys));
