...
var vec__54999 = cljs.core.rest(expr);
var seq__55000 = cljs.core.seq(vec__54999);
var first__55001 = cljs.core.first(seq__55000);
var seq__55000__$1 = cljs.core.next(seq__55000);
var vec__55002 = first__55001;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55002,(0),null);
var form = seq__55000__$1;
...
var G__55005 = x;
var G__55005__$1 = (((G__55005 == null))?null:spec_tools.impl.polish(G__55005));
var G__55005__$2 = (((G__55005__$1 == null))?null:cljs.core.name(G__55005__$1));
if((G__55005__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55005__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__55006 = x;
var G__55006__$1 = (((G__55006 == null))?null:cljs.core.name(G__55006));
if((G__55006__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__55006__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__55007){
...
var data = map__55008__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55008__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55008__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55008__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55008__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__55010){
...
var data = map__55011__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55011__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55011__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__55013 = data;
var G__55013__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55013,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__55013);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55013__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__55013__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__55017 = form;
var G__55017__$1 = (((G__55017 == null))?null:cljs.core.rest(G__55017));
if((G__55017__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55017__$1);
}
})();
var G__55018 = m;
var G__55018__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55018,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__55014_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55014_SHARP_)));
})):G__55018);
var G__55018__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55018__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__55015_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__55015_SHARP_)));
})):G__55018__$1);
var G__55018__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__55018__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__55016_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__55016_SHARP_));
})):G__55018__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__55018__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__55019 = (function (){var G__55020 = form;
var G__55020__$1 = (((G__55020 == null))?null:cljs.core.rest(G__55020));
if((G__55020__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__55020__$1);
}
})();
...
var G__55022 = (((kw instanceof cljs.core.Symbol))?cljs.core.namespace(kw):false);
switch (G__55022) {
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__55023 = form;
var G__55023__$1 = (((G__55023 == null))?null:cljs.core.seq(G__55023));
var G__55023__$2 = (((G__55023__$1 == null))?null:cljs.core.first(G__55023__$1));
if((G__55023__$2 == null)){
return null;
} else {
var fexpr__55024 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__55024.cljs$core$IFn$_invoke$arity$1 ? fexpr__55024.cljs$core$IFn$_invoke$arity$1(G__55023__$2) : fexpr__55024.call(null,G__55023__$2));
}
})():null));
});
/**
...
var len__4789__auto___55045 = arguments.length;
var i__4790__auto___55046 = (0);
while(true){
if((i__4790__auto___55046 < len__4789__auto___55045)){
args__4795__auto__.push((arguments[i__4790__auto___55046]));

var G__55047 = (i__4790__auto___55046 + (1));
i__4790__auto___55046 = G__55047;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq55025){
var self__4777__auto__ = this;
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq55025));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__55026){
var vec__55027 = p__55026;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55027,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55027,(1),null);
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__55032){
var map__55033 = p__55032;
var map__55033__$1 = (((((!((map__55033 == null))))?(((((map__55033.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55033.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55033):map__55033);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55033__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55033__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55033__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55033__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__55030_SHARP_){
return cljs.core.map_QMARK_(p1__55030_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__55031_SHARP_){
return cljs.core.contains_QMARK_(p1__55031_SHARP_,x);
});
}),req_keys));
