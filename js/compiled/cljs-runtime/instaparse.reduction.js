...
var G__63608 = new cljs.core.Keyword(null,"reduction-type","reduction-type",-488293450).cljs$core$IFn$_invoke$arity$1(f);
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4582__auto__ = (function instaparse$reduction$iter__63611(s__63612){
...
var c__4580__auto__ = cljs.core.chunk_first(s__63612__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__63614 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__63613 = (0);
while(true){
if((i__63613 < size__4581__auto__)){
var vec__63615 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__63613);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63615,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63615,(1),null);
cljs.core.chunk_append(b__63614,(cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)));

var G__63623 = (i__63613 + (1));
i__63613 = G__63623;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63614),instaparse$reduction$iter__63611(cljs.core.chunk_rest(s__63612__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63614),null);
}
} else {
var vec__63618 = cljs.core.first(s__63612__$2);
...
return cljs.core.cons((cljs.core.truth_(new cljs.core.Keyword(null,"red","red",-969428204).cljs$core$IFn$_invoke$arity$1(v))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,v], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,new cljs.core.Keyword(null,"red","red",-969428204),(reduction.cljs$core$IFn$_invoke$arity$1 ? reduction.cljs$core$IFn$_invoke$arity$1(k) : reduction.call(null,k)))], null)),instaparse$reduction$iter__63611(cljs.core.rest(s__63612__$2)));
}
} else {
return null;
}
