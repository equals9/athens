...
var G__28690 = cljs.core.next(ssv);
var G__28691 = (this_ssv == null);
var G__28692 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
var G__28693 = ((((doing_nil_QMARK_) && ((this_ssv == null))))?out:((((doing_nil_QMARK_) && ((!((this_ssv == null))))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),this_elide)),zprint.finish.gc_vec_to_style_vec(ctx,(0),elide__$1)),this_ssv):(((this_ssv == null))?out:cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,this_ssv)
)));
ssv = G__28690;
doing_nil_QMARK_ = G__28691;
last_elide = G__28692;
out = G__28693;
continue;
}
...
var G__28695 = cljs.core.next(remaining_cvec);
var G__28696 = new_idx;
var G__28697 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__28695;
idx = G__28696;
out = G__28697;
continue;
}
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__28650,existing_count){
var vec__28651 = p__28650;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28651,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28651,(1),null);
...
var vec__28662 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28662,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28662,(1),null);
var cvec_element = vec__28662;
...
var G__28716 = (idx + (1));
var G__28717 = idx;
var G__28718 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__28715;
idx = G__28716;
start = G__28717;
out = G__28718;
...
var G__28720 = (idx + (1));
var G__28721 = (idx + (1));
var G__28722 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__28719;
idx = G__28720;
start = G__28721;
out = G__28722;
...
var G__28728 = cljs.core.next(cvec_nl);
var G__28729 = (idx + (1));
var G__28730 = start;
var G__28731 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__28728;
idx = G__28729;
start = G__28730;
out = G__28731;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28667_SHARP_,p2__28666_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__28666_SHARP_)){
return cljs.core.reduced(p1__28667_SHARP_);
} else {
return (p1__28667_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__28669,p__28670){
var vec__28671 = p__28669;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28671,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28671,(1),null);
var vec__28674 = p__28670;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28674,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28674,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__28680,cvec,focus_vec){
...
var map__28682 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28681__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
...
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28682__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28682__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28682__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28679_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__28679_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
