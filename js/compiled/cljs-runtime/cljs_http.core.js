...
if(cljs.core.truth_(cancel)){
var c__38856__auto___51912 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
...
if(inst_51863){
var statearr_51873_51914 = state_51870__$1;
(statearr_51873_51914[(1)] = (3));

} else {
var statearr_51874_51915 = state_51870__$1;
(statearr_51874_51915[(1)] = (4));
...
var state_51870__$1 = state_51870;
var statearr_51875_51917 = state_51870__$1;
(statearr_51875_51917[(2)] = inst_51865);

(statearr_51875_51917[(1)] = (5));
...
var state_51870__$1 = state_51870;
var statearr_51876_51919 = state_51870__$1;
(statearr_51876_51919[(2)] = null);

(statearr_51876_51919[(1)] = (5));
...
var statearr_51879_51920 = state_51870;
(statearr_51879_51920[(5)] = ex__38792__auto__);
...
(statearr_51880[(6)] = c__38856__auto___51912);
...
var req_51927 = jsonp.send(null,(function cljs_http$core$jsonp_$_success_callback(data){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_http.core.pending_requests,cljs.core.assoc,channel,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"jsonp","jsonp",226119588),jsonp,new cljs.core.Keyword(null,"request","request",1772954723),req_51927], null));

if(cljs.core.truth_(cancel)){
var c__38856__auto___51930 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
...
var inst_51886 = jsonp.cancel(req_51927);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__38790__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__51937 = state_51888;
state_51888 = G__51937;
continue;
} else {
return ret_value__38790__auto__;
}
...
(statearr_51894[(6)] = c__38856__auto___51930);
