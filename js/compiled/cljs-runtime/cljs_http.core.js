...
var G__51834_51879 = xhr;
G__51834_51879.setProgressEventsEnabled(true);

G__51834_51879.listen(goog.net.EventType.UPLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_51878,new cljs.core.Keyword(null,"upload","upload",-255769218)));

G__51834_51879.listen(goog.net.EventType.DOWNLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_51878,new cljs.core.Keyword(null,"download","download",-300081668)));
...
if(cljs.core.truth_(cancel)){
var c__38856__auto___51880 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
...
if(inst_51838){
var statearr_51848_51881 = state_51845__$1;
(statearr_51848_51881[(1)] = (3));

} else {
var statearr_51849_51882 = state_51845__$1;
(statearr_51849_51882[(1)] = (4));
...
var state_51845__$1 = state_51845;
var statearr_51850_51883 = state_51845__$1;
(statearr_51850_51883[(2)] = inst_51840);

(statearr_51850_51883[(1)] = (5));
...
var state_51845__$1 = state_51845;
var statearr_51851_51884 = state_51845__$1;
(statearr_51851_51884[(2)] = null);

(statearr_51851_51884[(1)] = (5));
...
var statearr_51854_51886 = state_51845;
(statearr_51854_51886[(5)] = ex__38792__auto__);
...
var G__51887 = state_51845;
state_51845 = G__51887;
continue;
} else {
...
(statearr_51855[(6)] = c__38856__auto___51880);
...
var req_51888 = jsonp.send(null,(function cljs_http$core$jsonp_$_success_callback(data){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(cljs_http.core.pending_requests,cljs.core.assoc,channel,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"jsonp","jsonp",226119588),jsonp,new cljs.core.Keyword(null,"request","request",1772954723),req_51888], null));
...
var inst_51861 = jsonp.cancel(req_51888);
...
var statearr_51868_51895 = state_51863;
(statearr_51868_51895[(5)] = ex__38792__auto__);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__38790__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__51896 = state_51863;
state_51863 = G__51896;
continue;
} else {
return ret_value__38790__auto__;
}
...
(statearr_51869[(6)] = c__38856__auto___51893);
