...
var G__51859_51904 = xhr;
G__51859_51904.setProgressEventsEnabled(true);

G__51859_51904.listen(goog.net.EventType.UPLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_51903,new cljs.core.Keyword(null,"upload","upload",-255769218)));

G__51859_51904.listen(goog.net.EventType.DOWNLOAD_PROGRESS,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(listener_51903,new cljs.core.Keyword(null,"download","download",-300081668)));
...
if(inst_51863){
var statearr_51873_51907 = state_51870__$1;
(statearr_51873_51907[(1)] = (3));

} else {
var statearr_51874_51908 = state_51870__$1;
(statearr_51874_51908[(1)] = (4));
...
var state_51870__$1 = state_51870;
var statearr_51875_51909 = state_51870__$1;
(statearr_51875_51909[(2)] = inst_51865);

(statearr_51875_51909[(1)] = (5));
...
var state_51870__$1 = state_51870;
var statearr_51876_51911 = state_51870__$1;
(statearr_51876_51911[(2)] = null);

(statearr_51876_51911[(1)] = (5));
...
if(cljs.core.truth_(cancel)){
var c__38856__auto___51919 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
...
var statearr_51893_51922 = state_51888;
(statearr_51893_51922[(5)] = ex__38792__auto__);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__38790__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__51923 = state_51888;
state_51888 = G__51923;
continue;
} else {
return ret_value__38790__auto__;
}
...
(statearr_51894[(6)] = c__38856__auto___51919);
