...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58721 = goog.object.get(JSJodaLocale,"Locale");
if((G__58721 == null)){
return null;
} else {
return goog.object.get(G__58721,"US");
}
}catch (e58720){if((e58720 instanceof Error)){
var e = e58720;
return null;
} else {
throw e58720;
