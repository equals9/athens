...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58709 = goog.object.get(JSJodaLocale,"Locale");
if((G__58709 == null)){
return null;
} else {
return goog.object.get(G__58709,"US");
}
}catch (e58705){if((e58705 instanceof Error)){
var e = e58705;
return null;
} else {
throw e58705;
