...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58643 = goog.object.get(JSJodaLocale,"Locale");
if((G__58643 == null)){
return null;
} else {
return goog.object.get(G__58643,"US");
}
}catch (e58640){if((e58640 instanceof Error)){
var e = e58640;
return null;
} else {
throw e58640;
