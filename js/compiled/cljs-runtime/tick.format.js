...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58657 = goog.object.get(JSJodaLocale,"Locale");
if((G__58657 == null)){
return null;
} else {
return goog.object.get(G__58657,"US");
}
}catch (e58654){if((e58654 instanceof Error)){
var e = e58654;
return null;
} else {
throw e58654;
