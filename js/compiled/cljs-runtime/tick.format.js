...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58544 = goog.object.get(JSJodaLocale,"Locale");
if((G__58544 == null)){
return null;
} else {
return goog.object.get(G__58544,"US");
}
}catch (e58543){if((e58543 instanceof Error)){
var e = e58543;
return null;
} else {
throw e58543;
