...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58607 = goog.object.get(JSJodaLocale,"Locale");
if((G__58607 == null)){
return null;
} else {
return goog.object.get(G__58607,"US");
}
}catch (e58605){if((e58605 instanceof Error)){
var e = e58605;
return null;
} else {
throw e58605;
