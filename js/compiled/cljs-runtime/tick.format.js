...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58641 = goog.object.get(JSJodaLocale,"Locale");
if((G__58641 == null)){
return null;
} else {
return goog.object.get(G__58641,"US");
}
}catch (e58637){if((e58637 instanceof Error)){
var e = e58637;
return null;
} else {
throw e58637;
