...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58553 = goog.object.get(JSJodaLocale,"Locale");
if((G__58553 == null)){
return null;
} else {
return goog.object.get(G__58553,"US");
}
}catch (e58550){if((e58550 instanceof Error)){
var e = e58550;
return null;
} else {
throw e58550;
