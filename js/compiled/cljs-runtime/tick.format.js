...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58566 = goog.object.get(JSJodaLocale,"Locale");
if((G__58566 == null)){
return null;
} else {
return goog.object.get(G__58566,"US");
}
}catch (e58562){if((e58562 instanceof Error)){
var e = e58562;
return null;
} else {
throw e58562;
