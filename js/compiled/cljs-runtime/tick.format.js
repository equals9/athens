...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58552 = goog.object.get(JSJodaLocale,"Locale");
if((G__58552 == null)){
return null;
} else {
return goog.object.get(G__58552,"US");
}
}catch (e58551){if((e58551 instanceof Error)){
var e = e58551;
return null;
} else {
throw e58551;
