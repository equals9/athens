...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58781 = goog.object.get(JSJodaLocale,"Locale");
if((G__58781 == null)){
return null;
} else {
return goog.object.get(G__58781,"US");
}
}catch (e58778){if((e58778 instanceof Error)){
var e = e58778;
return null;
} else {
throw e58778;
