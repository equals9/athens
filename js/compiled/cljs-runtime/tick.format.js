...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58738 = goog.object.get(JSJodaLocale,"Locale");
if((G__58738 == null)){
return null;
} else {
return goog.object.get(G__58738,"US");
}
}catch (e58737){if((e58737 instanceof Error)){
var e = e58737;
return null;
} else {
throw e58737;
