...
return tick.format.formatter.cljs$core$IFn$_invoke$arity$2(fmt,(function (){try{var G__58707 = goog.object.get(JSJodaLocale,"Locale");
if((G__58707 == null)){
return null;
} else {
return goog.object.get(G__58707,"US");
}
}catch (e58702){if((e58702 instanceof Error)){
var e = e58702;
return null;
} else {
throw e58702;
