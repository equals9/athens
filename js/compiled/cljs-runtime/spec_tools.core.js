...
args__4795__auto__.push((arguments[i__4790__auto___55877]));
...
var G__55949 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55949;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__55957 = cljs.spec.alpha.get_spec(x);
x = G__55957;
continue;
} else {
