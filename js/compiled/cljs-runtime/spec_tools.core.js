...
var G__55994 = cljs.spec.alpha.get_spec(x);
x = G__55994;
continue;
} else {
...
var G__55995 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55995;
continue;
} else {
