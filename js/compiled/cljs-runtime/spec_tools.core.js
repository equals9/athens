...
var G__55925 = (i__4790__auto___55921 + (1));
i__4790__auto___55921 = G__55925;
continue;
} else {
}
break;
...
var G__56021 = cljs.spec.alpha.get_spec(x);
x = G__56021;
continue;
} else {
...
var G__56023 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56023;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56060 = cljs.spec.alpha.get_spec(x);
x = G__56060;
continue;
} else {
