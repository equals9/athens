...
var G__55861 = cljs.spec.alpha.get_spec(x);
x = G__55861;
continue;
} else {
...
var G__55865 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55865;
continue;
} else {
