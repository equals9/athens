...
while(true){
if((i__4790__auto___55935 < len__4789__auto___55932)){
...
var G__56030 = cljs.spec.alpha.get_spec(x);
x = G__56030;
continue;
} else {
...
var G__56032 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__56032;
continue;
} else {
