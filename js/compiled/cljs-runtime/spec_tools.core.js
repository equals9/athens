...
var G__55964 = cljs.spec.alpha.get_spec(x);
x = G__55964;
continue;
} else {
...
var G__55969 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55969;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__56005 = cljs.spec.alpha.get_spec(x);
x = G__56005;
continue;
} else {
