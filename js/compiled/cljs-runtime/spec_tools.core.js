...
while(true){
if((i__4790__auto___55916 < len__4789__auto___55914)){
...
var G__55982 = cljs.spec.alpha.get_spec(x);
x = G__55982;
continue;
} else {
...
var G__55983 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55983;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__55999 = cljs.spec.alpha.get_spec(x);
x = G__55999;
continue;
} else {
