...
var G__55917 = (i__4790__auto___55915 + (1));
i__4790__auto___55915 = G__55917;
continue;
} else {
}
break;
...
var G__55986 = cljs.spec.alpha.get_spec(x);
x = G__55986;
continue;
} else {
...
var G__55987 = cljs.spec.alpha.get_spec(new cljs.core.Keyword(null,"spec","spec",347520401).cljs$core$IFn$_invoke$arity$1(x));
x = G__55987;
continue;
} else {
...
if((x instanceof cljs.core.Keyword)){
var G__55990 = cljs.spec.alpha.get_spec(x);
x = G__55990;
continue;
} else {
