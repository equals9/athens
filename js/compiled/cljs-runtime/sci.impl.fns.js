...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65865,fn_name,macro_QMARK_,with_meta_QMARK_){
...
var _m = map__65866__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65866__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65866__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65866__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65866__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__65909 = cljs.core.next(args__$1);
var G__65910 = cljs.core.next(params__$1);
var G__65911 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65909;
params__$1 = G__65910;
ret = G__65911;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__65873 = ctx__$1;
var G__65874 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__65873,G__65874) : interpret.call(null,G__65873,G__65874));
...
var vec__65875 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65875,(0),null);
var vec__65878 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65875,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65878,(0),null);
var G__65914 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65914;
continue;
} else {
var G__65915 = recur_val;
args = G__65915;
continue;
}
} else {
...
while (G__65916__i < G__65916__a.length) {G__65916__a[G__65916__i] = arguments[G__65916__i + 0]; ++G__65916__i;}
  args = new cljs.core.IndexedSeq(G__65916__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__65917){
var args = cljs.core.seq(arglist__65917);
...
var map__65883 = cljs.core.meta(f);
var map__65883__$1 = (((((!((map__65883 == null))))?(((((map__65883.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65883.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65883):map__65883);
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65883__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65883__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65891){
...
var f = map__65892__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65892__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65892__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__65919__delegate = function (args){
...
while (G__65920__i < G__65920__a.length) {G__65920__a[G__65920__i] = arguments[G__65920__i + 0]; ++G__65920__i;}
  args = new cljs.core.IndexedSeq(G__65920__a,0,null);
} 
return G__65919__delegate.call(this,args);};
G__65919.cljs$lang$maxFixedArity = 0;
G__65919.cljs$lang$applyTo = (function (arglist__65921){
var args = cljs.core.seq(arglist__65921);
return G__65919__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65887_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65887_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65924__delegate = function (args){
...
while (G__65925__i < G__65925__a.length) {G__65925__a[G__65925__i] = arguments[G__65925__i + 0]; ++G__65925__i;}
  args = new cljs.core.IndexedSeq(G__65925__a,0,null);
} 
return G__65924__delegate.call(this,args);};
G__65924.cljs$lang$maxFixedArity = 0;
G__65924.cljs$lang$applyTo = (function (arglist__65926){
var args = cljs.core.seq(arglist__65926);
return G__65924__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65889_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65889_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
