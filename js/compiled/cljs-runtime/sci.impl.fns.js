...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__66394,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__66395 = p__66394;
...
var _m = map__66395__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66395__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66395__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66395__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66395__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__66420 = cljs.core.next(args__$1);
var G__66421 = cljs.core.next(params__$1);
var G__66422 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__66420;
params__$1 = G__66421;
ret = G__66422;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__66405 = ctx__$1;
var G__66406 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__66405,G__66406) : interpret.call(null,G__66405,G__66406));
...
var vec__66407 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66407,(0),null);
var vec__66410 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66407,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__66410,(0),null);
...
var G__66433__i = 0, G__66433__a = new Array(arguments.length -  0);
while (G__66433__i < G__66433__a.length) {G__66433__a[G__66433__i] = arguments[G__66433__i + 0]; ++G__66433__i;}
  args = new cljs.core.IndexedSeq(G__66433__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__66434){
var args = cljs.core.seq(arglist__66434);
...
var map__66413 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66413__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66413__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__66417){
...
var f = map__66418__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66418__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__66418__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__66448__i < G__66448__a.length) {G__66448__a[G__66448__i] = arguments[G__66448__i + 0]; ++G__66448__i;}
  args = new cljs.core.IndexedSeq(G__66448__a,0,null);
} 
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__66415_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__66415_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__66450__delegate = function (args){
...
var G__66450 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__66451__i = 0, G__66451__a = new Array(arguments.length -  0);
while (G__66451__i < G__66451__a.length) {G__66451__a[G__66451__i] = arguments[G__66451__i + 0]; ++G__66451__i;}
  args = new cljs.core.IndexedSeq(G__66451__a,0,null);
} 
return G__66450__delegate.call(this,args);};
G__66450.cljs$lang$maxFixedArity = 0;
G__66450.cljs$lang$applyTo = (function (arglist__66452){
var args = cljs.core.seq(arglist__66452);
return G__66450__delegate(args);
});
G__66450.cljs$core$IFn$_invoke$arity$variadic = G__66450__delegate;
return G__66450;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__66416_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__66416_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
