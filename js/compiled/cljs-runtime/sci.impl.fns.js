...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65873,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__65874 = p__65873;
...
var _m = map__65874__$1;
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65874__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65874__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65874__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65874__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65900){
...
var f = map__65901__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65901__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65901__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
while (G__65930__i < G__65930__a.length) {G__65930__a[G__65930__i] = arguments[G__65930__i + 0]; ++G__65930__i;}
  args = new cljs.core.IndexedSeq(G__65930__a,0,null);
} 
return G__65929__delegate.call(this,args);};
G__65929.cljs$lang$maxFixedArity = 0;
G__65929.cljs$lang$applyTo = (function (arglist__65931){
var args = cljs.core.seq(arglist__65931);
return G__65929__delegate(args);
});
G__65929.cljs$core$IFn$_invoke$arity$variadic = G__65929__delegate;
return G__65929;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65895_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65895_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65933__delegate = function (args){
...
var G__65933 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65934__i = 0, G__65934__a = new Array(arguments.length -  0);
while (G__65934__i < G__65934__a.length) {G__65934__a[G__65934__i] = arguments[G__65934__i + 0]; ++G__65934__i;}
  args = new cljs.core.IndexedSeq(G__65934__a,0,null);
} 
return G__65933__delegate.call(this,args);};
G__65933.cljs$lang$maxFixedArity = 0;
G__65933.cljs$lang$applyTo = (function (arglist__65935){
var args = cljs.core.seq(arglist__65935);
return G__65933__delegate(args);
});
G__65933.cljs$core$IFn$_invoke$arity$variadic = G__65933__delegate;
return G__65933;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65896_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65896_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
