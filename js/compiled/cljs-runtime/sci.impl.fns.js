...
var G__65934 = cljs.core.next(args__$1);
var G__65935 = cljs.core.next(params__$1);
var G__65936 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65934;
params__$1 = G__65935;
ret = G__65936;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__65914 = ctx__$1;
var G__65915 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__65914,G__65915) : interpret.call(null,G__65914,G__65915));
...
var vec__65916 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65916,(0),null);
var vec__65919 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65916,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65919,(0),null);
var G__65944 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65944;
continue;
} else {
...
var map__65924 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65924__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65924__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65928){
...
var f = map__65929__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65929__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65929__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__65950__delegate = function (args){
...
while (G__65951__i < G__65951__a.length) {G__65951__a[G__65951__i] = arguments[G__65951__i + 0]; ++G__65951__i;}
  args = new cljs.core.IndexedSeq(G__65951__a,0,null);
} 
return G__65950__delegate.call(this,args);};
G__65950.cljs$lang$maxFixedArity = 0;
G__65950.cljs$lang$applyTo = (function (arglist__65952){
var args = cljs.core.seq(arglist__65952);
return G__65950__delegate(args);
});
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65926_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65926_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65957__delegate = function (args){
...
while (G__65958__i < G__65958__a.length) {G__65958__a[G__65958__i] = arguments[G__65958__i + 0]; ++G__65958__i;}
  args = new cljs.core.IndexedSeq(G__65958__a,0,null);
} 
return G__65957__delegate.call(this,args);};
G__65957.cljs$lang$maxFixedArity = 0;
G__65957.cljs$lang$applyTo = (function (arglist__65959){
var args = cljs.core.seq(arglist__65959);
return G__65957__delegate(args);
});
...
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65927_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65927_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
