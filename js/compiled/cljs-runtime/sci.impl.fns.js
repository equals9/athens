...
sci.impl.fns.parse_fn_args_PLUS_body = (function sci$impl$fns$parse_fn_args_PLUS_body(ctx,interpret,eval_do_STAR_,p__65905,fn_name,macro_QMARK_,with_meta_QMARK_){
var map__65907 = p__65905;
...
var var_arg_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65907__$1,new cljs.core.Keyword("sci.impl","var-arg-name","sci.impl/var-arg-name",1800498100));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65907__$1,new cljs.core.Keyword("sci.impl","params","sci.impl/params",-175360738));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65907__$1,new cljs.core.Keyword("sci.impl","body","sci.impl/body",-1493886648));
...
var G__65943 = cljs.core.next(args__$1);
var G__65944 = cljs.core.next(params__$1);
var G__65945 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(ret,fp,cljs.core.first(args__$1));
args__$1 = G__65943;
params__$1 = G__65944;
ret = G__65945;
continue;
...
var ret = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((1),cljs.core.count(body)))?(function (){var G__65909 = ctx__$1;
var G__65910 = cljs.core.first(body);
return (interpret.cljs$core$IFn$_invoke$arity$2 ? interpret.cljs$core$IFn$_invoke$arity$2(G__65909,G__65910) : interpret.call(null,G__65909,G__65910));
...
var vec__65911 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(recur_val,(0),min_var_args_arity),cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(recur_val,min_var_args_arity)], null);
var fixed_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65911,(0),null);
var vec__65914 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65911,(1),null);
var rest_args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65914,(0),null);
var G__65946 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(fixed_args,rest_args);
args = G__65946;
continue;
} else {
var G__65947 = recur_val;
args = G__65947;
continue;
}
} else {
...
while (G__65948__i < G__65948__a.length) {G__65948__a[G__65948__i] = arguments[G__65948__i + 0]; ++G__65948__i;}
  args = new cljs.core.IndexedSeq(G__65948__a,0,null);
} 
...
sci$impl$fns$parse_fn_args_PLUS_body_$_run_fn.cljs$lang$applyTo = (function (arglist__65949){
var args = cljs.core.seq(arglist__65949);
...
var map__65918 = cljs.core.meta(f);
...
var fixed_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65918__$1,new cljs.core.Keyword("sci.impl","fixed-arity","sci.impl/fixed-arity",-1251617052));
var min_var_args_arity = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65918__$1,new cljs.core.Keyword("sci.impl","min-var-args-arity","sci.impl/min-var-args-arity",-1081358721));
...
sci.impl.fns.eval_fn = (function sci$impl$fns$eval_fn(ctx,interpret,eval_do_STAR_,p__65931){
...
var f = map__65932__$1;
var fn_bodies = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65932__$1,new cljs.core.Keyword("sci.impl","fn-bodies","sci.impl/fn-bodies",134751661));
var fn_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65932__$1,new cljs.core.Keyword("sci.impl","fn-name","sci.impl/fn-name",-1172300569));
...
var G__65965__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.deref(self_ref),args);
};
var G__65965 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65966__i = 0, G__65966__a = new Array(arguments.length -  0);
while (G__65966__i < G__65966__a.length) {G__65966__a[G__65966__i] = arguments[G__65966__i + 0]; ++G__65966__i;}
  args = new cljs.core.IndexedSeq(G__65966__a,0,null);
} 
return G__65965__delegate.call(this,args);};
G__65965.cljs$lang$maxFixedArity = 0;
G__65965.cljs$lang$applyTo = (function (arglist__65967){
var args = cljs.core.seq(arglist__65967);
return G__65965__delegate(args);
});
G__65965.cljs$core$IFn$_invoke$arity$variadic = G__65965__delegate;
return G__65965;
})()
;
...
var f__$1 = ((single_arity_QMARK_)?sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,cljs.core.first(fn_bodies),fn_name,macro_QMARK_,false):(function (){var arities = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__65922_SHARP_){
return sci.impl.fns.parse_fn_args_PLUS_body(ctx__$1,interpret,eval_do_STAR_,p1__65922_SHARP_,fn_name,macro_QMARK_,true);
}),fn_bodies);
return (function() { 
var G__65972__delegate = function (args){
...
var G__65972 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__65973__i = 0, G__65973__a = new Array(arguments.length -  0);
while (G__65973__i < G__65973__a.length) {G__65973__a[G__65973__i] = arguments[G__65973__i + 0]; ++G__65973__i;}
  args = new cljs.core.IndexedSeq(G__65973__a,0,null);
} 
return G__65972__delegate.call(this,args);};
G__65972.cljs$lang$maxFixedArity = 0;
G__65972.cljs$lang$applyTo = (function (arglist__65974){
var args = cljs.core.seq(arglist__65974);
return G__65972__delegate(args);
});
G__65972.cljs$core$IFn$_invoke$arity$variadic = G__65972__delegate;
return G__65972;
})()
;
})());
var f__$2 = (cljs.core.truth_(macro_QMARK_)?cljs.core.vary_meta.cljs$core$IFn$_invoke$arity$2(f__$1,(function (p1__65923_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65923_SHARP_,new cljs.core.Keyword("sci","macro","sci/macro",-868536151),macro_QMARK_);
})):f__$1);
