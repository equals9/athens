...
var G__28441 = p1__28437_SHARP_.which;
switch (G__28441) {
case (13):
save();
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__28446){
var vec__28447 = p__28446;
var property = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28447,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28447,(1),null);
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(property),value);
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28445_SHARP_){
return clojure.string.split.cljs$core$IFn$_invoke$arity$2(p1__28445_SHARP_,/:/);
...
var previous_config__28428__auto__ = devtools.prefs.get_prefs();
var prefs__28429__auto__ = day8.re_frame_10x.view.components.effective_cljs_devtools_prefs;
try{devtools.prefs.set_prefs_BANG_(prefs__28429__auto__);

return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(api_fn,args);
}finally {if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.prefs.get_prefs(),prefs__28429__auto__)){
} else {
throw (new Error(["Assert failed: ","someone modified devtools.prefs behind our back!","\n","(clojure.core/= (devtools.prefs/get-prefs) prefs__28429__auto__)"].join('')));
}

devtools.prefs.set_prefs_BANG_(previous_config__28428__auto__);
}}));
