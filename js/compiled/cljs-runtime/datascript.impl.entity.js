...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__42495_SHARP_,p2__42496_SHARP_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(p1__42495_SHARP_,datascript.impl.entity.entity(db,new cljs.core.Keyword(null,"e","e",1381269198).cljs$core$IFn$_invoke$arity$1(p2__42496_SHARP_)));
}),cljs.core.PersistentHashSet.EMPTY,datoms);
}
} else {
return not_found;
...
var iter__4582__auto__ = (function datascript$impl$entity$js_seq_$_iter__42503(s__42504){
return (new cljs.core.LazySeq(null,(function (){
var s__42504__$1 = s__42504;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__42504__$1);
if(temp__5735__auto__){
var s__42504__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__42504__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__42504__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__42506 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__42505 = (0);
while(true){
if((i__42505 < size__4581__auto__)){
var vec__42515 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__42505);
...
cljs.core.chunk_append(b__42506,((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)));

var G__42720 = (i__42505 + (1));
i__42505 = G__42720;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__42506),datascript$impl$entity$js_seq_$_iter__42503(cljs.core.chunk_rest(s__42504__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__42506),null);
}
} else {
var vec__42521 = cljs.core.first(s__42504__$2);
...
return cljs.core.cons(((datascript.db.multival_QMARK_(e.db,a))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,datascript.impl.entity.multival__GT_js(v)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [a,v], null)),datascript$impl$entity$js_seq_$_iter__42503(cljs.core.rest(s__42504__$2)));
}
} else {
return null;
}
...
var self__ = this;
var this$ = this;
var seq__42562 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42563 = null;
var count__42564 = (0);
var i__42565 = (0);
while(true){
if((i__42565 < count__42564)){
var vec__42581 = chunk__42563.cljs$core$IIndexed$_nth$arity$2(null,i__42565);
...
var G__42727 = seq__42562;
var G__42728 = chunk__42563;
var G__42729 = count__42564;
var G__42730 = (i__42565 + (1));
seq__42562 = G__42727;
chunk__42563 = G__42728;
count__42564 = G__42729;
i__42565 = G__42730;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42562);
if(temp__5735__auto__){
var seq__42562__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42562__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42562__$1);
var G__42732 = cljs.core.chunk_rest(seq__42562__$1);
var G__42733 = c__4609__auto__;
var G__42734 = cljs.core.count(c__4609__auto__);
var G__42735 = (0);
seq__42562 = G__42732;
chunk__42563 = G__42733;
count__42564 = G__42734;
i__42565 = G__42735;
continue;
} else {
var vec__42586 = cljs.core.first(seq__42562__$1);
var a = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42586,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42586,(1),null);
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(v,a,this$) : f.call(null,v,a,this$));


var G__42736 = cljs.core.next(seq__42562__$1);
var G__42737 = null;
var G__42738 = (0);
var G__42739 = (0);
seq__42562 = G__42736;
chunk__42563 = G__42737;
count__42564 = G__42738;
i__42565 = G__42739;
continue;
}
} else {
...
var self__ = this;
var this$ = this;
var seq__42591 = cljs.core.seq(datascript.impl.entity.js_seq(this$));
var chunk__42592 = null;
var count__42593 = (0);
var i__42594 = (0);
while(true){
if((i__42594 < count__42593)){
var vec__42614 = chunk__42592.cljs$core$IIndexed$_nth$arity$2(null,i__42594);
...
var G__42751 = seq__42591;
var G__42752 = chunk__42592;
var G__42753 = count__42593;
var G__42754 = (i__42594 + (1));
seq__42591 = G__42751;
chunk__42592 = G__42752;
count__42593 = G__42753;
i__42594 = G__42754;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__42591);
if(temp__5735__auto__){
var seq__42591__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__42591__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__42591__$1);
var G__42755 = cljs.core.chunk_rest(seq__42591__$1);
var G__42756 = c__4609__auto__;
var G__42757 = cljs.core.count(c__4609__auto__);
var G__42758 = (0);
seq__42591 = G__42755;
chunk__42592 = G__42756;
count__42593 = G__42757;
i__42594 = G__42758;
continue;
} else {
var vec__42620 = cljs.core.first(seq__42591__$1);
...
var G__42761 = cljs.core.next(seq__42591__$1);
var G__42762 = null;
var G__42763 = (0);
var G__42764 = (0);
seq__42591 = G__42761;
chunk__42592 = G__42762;
count__42593 = G__42763;
i__42594 = G__42764;
continue;
}
} else {
...
var self__ = this;
var self__ = this;
var G__42658 = (arguments.length - (1));
switch (G__42658) {
case (1):
...
var datoms_42812 = temp__5735__auto___42803;
