...
var iter__4582__auto__ = (function sablono$core$update_arglists_$_iter__50382(s__50383){
...
var args = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50384);
cljs.core.chunk_append(b__50385,cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)));

var G__50562 = (i__50384 + (1));
i__50384 = G__50562;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50385),sablono$core$update_arglists_$_iter__50382(cljs.core.chunk_rest(s__50383__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50385),null);
}
} else {
var args = cljs.core.first(s__50383__$2);
return cljs.core.cons(cljs.core.vec(cljs.core.cons(new cljs.core.Symbol(null,"attr-map?","attr-map?",116307443,null),args)),sablono$core$update_arglists_$_iter__50382(cljs.core.rest(s__50383__$2)));
}
} else {
return null;
}
...
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50438,(0),null);
...
var G__50626 = (i__4790__auto___50623 + (1));
i__4790__auto___50623 = G__50626;
continue;
} else {
}
break;
