 ...
 */
sablono.core.mail_to50422 = (function sablono$core$mail_to50422(var_args){
var args__4795__auto__ = [];
...
var argseq__4796__auto__ = ((((1) < args__4795__auto__.length))?(new cljs.core.IndexedSeq(args__4795__auto__.slice((1)),(0),null)):null);
return sablono.core.mail_to50422.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});

(sablono.core.mail_to50422.cljs$core$IFn$_invoke$arity$variadic = (function (e_mail,p__50429){
...
(sablono.core.mail_to50422.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(sablono.core.mail_to50422.cljs$lang$applyTo = (function (seq50423){
...
sablono.core.mail_to = sablono.core.wrap_attrs(sablono.core.mail_to50422);
/**
 * Wrap a collection in an unordered list.
 */
sablono.core.unordered_list50433 = (function sablono$core$unordered_list50433(coll){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"ul","ul",-1349521403),(function (){var iter__4582__auto__ = (function sablono$core$unordered_list50433_$_iter__50435(s__50436){
return (new cljs.core.LazySeq(null,(function (){
...
var c__4580__auto__ = cljs.core.chunk_first(s__50436__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__50438 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__50437 = (0);
while(true){
if((i__50437 < size__4581__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__50437);
cljs.core.chunk_append(b__50438,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null));

var G__50566 = (i__50437 + (1));
i__50437 = G__50566;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50438),sablono$core$unordered_list50433_$_iter__50435(cljs.core.chunk_rest(s__50436__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50438),null);
}
} else {
var x = cljs.core.first(s__50436__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li","li",723558921),x], null),sablono$core$unordered_list50433_$_iter__50435(cljs.core.rest(s__50436__$2)));
}
} else {
return null;
}
