...
var fexpr__55001 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__55001.cljs$core$IFn$_invoke$arity$1 ? fexpr__55001.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55001.call(null,type));
});
...
var G__55029 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__55029;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__55002 = spec_tools.impl.normalize_symbol(x);
var G__55003 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55002,G__55003) : spec_tools.parse.parse_form.call(null,G__55002,G__55003));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__55004 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__55005 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55004,G__55005) : spec_tools.parse.parse_form.call(null,G__55004,G__55005));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__55030 = cljs.spec.alpha.form(x);
x = G__55030;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__55006 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__55007 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55006,G__55007) : spec_tools.parse.parse_form.call(null,G__55006,G__55007));
} else {
...
var G__55008 = parse_data;
var G__55008__$1 = (((G__55008 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__55008));
var G__55008__$2 = (((G__55008__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__55008__$1));
var G__55008__$3 = (((G__55008__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__55008__$2));
var G__55008__$4 = (((G__55008__$3 == null))?null:cljs.core.seq(G__55008__$3));
if((G__55008__$4 == null)){
return null;
} else {
return cljs.core.set(G__55008__$4);
}
}
});
...
var map__55014 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55014__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55014__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55014__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55014__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55014__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
...
var G__55016__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55016,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__55016);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55016__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__55016__$1;
}
}));
...
var map__55017 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55017__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__55019 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55019__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__55021){
var vec__55022 = p__55021;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55022,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55022,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55022,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__55025){
...
var ___$1 = first__55028;
var values = seq__55027__$1;
