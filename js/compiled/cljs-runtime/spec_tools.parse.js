...
var fexpr__54957 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__54957.cljs$core$IFn$_invoke$arity$1 ? fexpr__54957.cljs$core$IFn$_invoke$arity$1(type) : fexpr__54957.call(null,type));
});
...
var G__54985 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__54985;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__54958 = spec_tools.impl.normalize_symbol(x);
var G__54959 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54958,G__54959) : spec_tools.parse.parse_form.call(null,G__54958,G__54959));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__54960 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__54961 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54960,G__54961) : spec_tools.parse.parse_form.call(null,G__54960,G__54961));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__54986 = cljs.spec.alpha.form(x);
x = G__54986;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__54962 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__54963 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__54962,G__54963) : spec_tools.parse.parse_form.call(null,G__54962,G__54963));
} else {
...
var G__54964 = parse_data;
var G__54964__$1 = (((G__54964 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__54964));
var G__54964__$2 = (((G__54964__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__54964__$1));
var G__54964__$3 = (((G__54964__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__54964__$2));
var G__54964__$4 = (((G__54964__$3 == null))?null:cljs.core.seq(G__54964__$3));
if((G__54964__$4 == null)){
return null;
} else {
return cljs.core.set(G__54964__$4);
}
}
});
...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__54965 = cljs.core.get_global_hierarchy;
return (fexpr__54965.cljs$core$IFn$_invoke$arity$0 ? fexpr__54965.cljs$core$IFn$_invoke$arity$0() : fexpr__54965.call(null));
})());
...
var map__54970 = spec_tools.impl.parse_keys(form);
var map__54970__$1 = (((((!((map__54970 == null))))?(((((map__54970.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54970.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54970):map__54970);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54970__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__54972 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__54972__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54972,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__54972);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__54972__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__54972__$1;
}
}));
...
var map__54973 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__54973__$1 = (((((!((map__54973 == null))))?(((((map__54973.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__54973.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__54973):map__54973);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54973__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__54975 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__54975__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__54977){
var vec__54978 = p__54977;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54978,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54978,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54978,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__54981){
var vec__54982 = p__54981;
var seq__54983 = cljs.core.seq(vec__54982);
var first__54984 = cljs.core.first(seq__54983);
var seq__54983__$1 = cljs.core.next(seq__54983);
var ___$1 = first__54984;
var values = seq__54983__$1;
