...
var fexpr__55060 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__55060.cljs$core$IFn$_invoke$arity$1 ? fexpr__55060.cljs$core$IFn$_invoke$arity$1(type) : fexpr__55060.call(null,type));
});
...
var G__55088 = cljs.spec.alpha.form(cljs.spec.alpha.get_spec(x));
x = G__55088;
continue;
} else {
if((x instanceof cljs.core.Symbol)){
var G__55061 = spec_tools.impl.normalize_symbol(x);
var G__55062 = null;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55061,G__55062) : spec_tools.parse.parse_form.call(null,G__55061,G__55062));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__55063 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__55064 = x;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$2(G__55063,G__55064) : spec_tools.parse.parse_form.call(null,G__55063,G__55064));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__55089 = cljs.spec.alpha.form(x);
x = G__55089;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__55065 = (spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1 ? spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x) : spec_tools.form.resolve_form.call(null,x));
var G__55066 = null;
...
var map__55073 = spec_tools.impl.parse_keys(form);
...
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55073__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__55075 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__55075__$1 = (cljs.core.truth_((function (){var or__4185__auto__ = req;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55075,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__55075);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__55075__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__55075__$1;
}
}));
...
var map__55076 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55076__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__55078 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
...
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55078__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__55080){
var vec__55081 = p__55080;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55081,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55081,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__55081,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__55084){
var vec__55085 = p__55084;
var seq__55086 = cljs.core.seq(vec__55085);
var first__55087 = cljs.core.first(seq__55086);
var seq__55086__$1 = cljs.core.next(seq__55086);
var ___$1 = first__55087;
var values = seq__55086__$1;
