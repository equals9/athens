...
var G__20920 = (i__4790__auto___20918 + (1));
i__4790__auto___20918 = G__20920;
continue;
} else {
}
break;
...
var vec__20898 = (((cljs.core.count(xrel) <= cljs.core.count(yrel)))?new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [xrel,yrel,clojure.set.map_invert(km)], null):new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [yrel,xrel,km], null));
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20898,(0),null);
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20898,(1),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20898,(2),null);
...
return (((cljs.core.count(set1) <= cljs.core.count(set2))) && (cljs.core.every_QMARK_((function (p1__20903_SHARP_){
return cljs.core.contains_QMARK_(set2,p1__20903_SHARP_);
}),set1)));
});
/**
...
return cljs.core.contains_QMARK_(set1,p1__20909_SHARP_);
}),set2)));
});
