...
return (((cljs.core.count(set1) >= cljs.core.count(set2))) && (cljs.core.every_QMARK_((function (p1__20976_SHARP_){
return cljs.core.contains_QMARK_(set1,p1__20976_SHARP_);
}),set2)));
});
