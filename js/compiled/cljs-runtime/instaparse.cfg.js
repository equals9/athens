...
var G__64710 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64710)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64710)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64710)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64710)].join('')));
...
var G__64758 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64757;
v = G__64758;
continue;
} else {
var G__64759 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64760 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64759;
v = G__64760;
continue;
}
...
var G__64762 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64761;
v = G__64762;
continue;
...
break;
default:
var G__64763 = cljs.core.next(sq);
var G__64764 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64763;
v = G__64764;
continue;
...
while(true){
var G__64723 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64723__$1 = (((G__64723 instanceof cljs.core.Keyword))?G__64723.fqn:null);
switch (G__64723__$1) {
case "rule":
var vec__64724 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64724,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64724,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64727 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64727) : instaparse.cfg.content.call(null,G__64727));
...
break;
case "paren":
var G__64767 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64767;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64728 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64729 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__64730 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64731 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__64732 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64732) : instaparse.cfg.build_rule.call(null,G__64732));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64733 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64733) : instaparse.cfg.build_rule.call(null,G__64733));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64723__$1)].join('')));
...
while(true){
var G__64734 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__64734__$1 = (((G__64734 instanceof cljs.core.Keyword))?G__64734.fqn:null);
switch (G__64734__$1) {
case "nt":
...
case "neg":
case "rep":
var G__64769 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64769;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64734__$1)].join('')));
...
var valid_nts_64770 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64735_64771 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64736_64772 = null;
var count__64737_64773 = (0);
var i__64738_64774 = (0);
while(true){
if((i__64738_64774 < count__64737_64773)){
var nt_64775 = chunk__64736_64772.cljs$core$IIndexed$_nth$arity$2(null,i__64738_64774);
if(cljs.core.truth_((valid_nts_64770.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64770.cljs$core$IFn$_invoke$arity$1(nt_64775) : valid_nts_64770.call(null,nt_64775)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64775),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64776 = seq__64735_64771;
var G__64777 = chunk__64736_64772;
var G__64778 = count__64737_64773;
var G__64779 = (i__64738_64774 + (1));
seq__64735_64771 = G__64776;
chunk__64736_64772 = G__64777;
count__64737_64773 = G__64778;
i__64738_64774 = G__64779;
continue;
} else {
var temp__5735__auto___64780 = cljs.core.seq(seq__64735_64771);
if(temp__5735__auto___64780){
var seq__64735_64781__$1 = temp__5735__auto___64780;
if(cljs.core.chunked_seq_QMARK_(seq__64735_64781__$1)){
var c__4609__auto___64782 = cljs.core.chunk_first(seq__64735_64781__$1);
var G__64783 = cljs.core.chunk_rest(seq__64735_64781__$1);
var G__64784 = c__4609__auto___64782;
var G__64785 = cljs.core.count(c__4609__auto___64782);
var G__64786 = (0);
seq__64735_64771 = G__64783;
chunk__64736_64772 = G__64784;
count__64737_64773 = G__64785;
i__64738_64774 = G__64786;
continue;
} else {
var nt_64787 = cljs.core.first(seq__64735_64781__$1);
if(cljs.core.truth_((valid_nts_64770.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64770.cljs$core$IFn$_invoke$arity$1(nt_64787) : valid_nts_64770.call(null,nt_64787)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64787),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64792 = cljs.core.next(seq__64735_64781__$1);
var G__64793 = null;
var G__64794 = (0);
var G__64795 = (0);
seq__64735_64771 = G__64792;
chunk__64736_64772 = G__64793;
count__64737_64773 = G__64794;
i__64738_64774 = G__64795;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64739_64803 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64740_64804 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64741_64805 = true;
var _STAR_print_fn_STAR__temp_val__64742_64806 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64741_64805);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64742_64806);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64740_64804);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64739_64803);
}
...
var len__4789__auto___64825 = arguments.length;
var i__4790__auto___64826 = (0);
while(true){
if((i__4790__auto___64826 < len__4789__auto___64825)){
args__4795__auto__.push((arguments[i__4790__auto___64826]));

var G__64827 = (i__4790__auto___64826 + (1));
i__4790__auto___64826 = G__64827;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64745){
...
var opts = map__64746__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64748 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64749 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64749);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64750_64841 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64751_64842 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64752_64843 = true;
var _STAR_print_fn_STAR__temp_val__64753_64844 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64752_64843);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64753_64844);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64751_64842);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64750_64841);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64748);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64743){
var G__64744 = cljs.core.first(seq64743);
var seq64743__$1 = cljs.core.next(seq64743);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64744,seq64743__$1);
}));
