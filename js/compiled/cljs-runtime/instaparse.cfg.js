...
var G__64728 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64728)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64728)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64728)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64728)].join('')));
...
var G__64776 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64777 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64776;
v = G__64777;
continue;
} else {
var G__64778 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64779 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64778;
v = G__64779;
continue;
}
...
break;
case "\"":
var G__64780 = cljs.core.next(sq);
var G__64781 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64780;
v = G__64781;
continue;
...
break;
default:
var G__64782 = cljs.core.next(sq);
var G__64783 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64782;
v = G__64783;
continue;
...
while(true){
var G__64737 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64737__$1 = (((G__64737 instanceof cljs.core.Keyword))?G__64737.fqn:null);
switch (G__64737__$1) {
case "rule":
var vec__64738 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64738,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64738,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64741 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64741) : instaparse.cfg.content.call(null,G__64741));
...
break;
case "paren":
var G__64786 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64786;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64742 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64742) : instaparse.cfg.build_rule.call(null,G__64742));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64743 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64743) : instaparse.cfg.build_rule.call(null,G__64743));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64744 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64744) : instaparse.cfg.build_rule.call(null,G__64744));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64745 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64745) : instaparse.cfg.build_rule.call(null,G__64745));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64750 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64750) : instaparse.cfg.build_rule.call(null,G__64750));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64751 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64751) : instaparse.cfg.build_rule.call(null,G__64751));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64737__$1)].join('')));
...
while(true){
var G__64752 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__64752__$1 = (((G__64752 instanceof cljs.core.Keyword))?G__64752.fqn:null);
switch (G__64752__$1) {
case "nt":
...
case "neg":
case "rep":
var G__64788 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64788;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64752__$1)].join('')));
...
var valid_nts_64789 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64754_64790 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64755_64791 = null;
var count__64756_64792 = (0);
var i__64757_64793 = (0);
while(true){
if((i__64757_64793 < count__64756_64792)){
var nt_64794 = chunk__64755_64791.cljs$core$IIndexed$_nth$arity$2(null,i__64757_64793);
if(cljs.core.truth_((valid_nts_64789.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64789.cljs$core$IFn$_invoke$arity$1(nt_64794) : valid_nts_64789.call(null,nt_64794)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64794),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64795 = seq__64754_64790;
var G__64796 = chunk__64755_64791;
var G__64797 = count__64756_64792;
var G__64798 = (i__64757_64793 + (1));
seq__64754_64790 = G__64795;
chunk__64755_64791 = G__64796;
count__64756_64792 = G__64797;
i__64757_64793 = G__64798;
continue;
} else {
var temp__5735__auto___64799 = cljs.core.seq(seq__64754_64790);
if(temp__5735__auto___64799){
var seq__64754_64800__$1 = temp__5735__auto___64799;
if(cljs.core.chunked_seq_QMARK_(seq__64754_64800__$1)){
var c__4609__auto___64801 = cljs.core.chunk_first(seq__64754_64800__$1);
var G__64802 = cljs.core.chunk_rest(seq__64754_64800__$1);
var G__64803 = c__4609__auto___64801;
var G__64804 = cljs.core.count(c__4609__auto___64801);
var G__64805 = (0);
seq__64754_64790 = G__64802;
chunk__64755_64791 = G__64803;
count__64756_64792 = G__64804;
i__64757_64793 = G__64805;
continue;
} else {
var nt_64806 = cljs.core.first(seq__64754_64800__$1);
if(cljs.core.truth_((valid_nts_64789.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64789.cljs$core$IFn$_invoke$arity$1(nt_64806) : valid_nts_64789.call(null,nt_64806)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64806),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64807 = cljs.core.next(seq__64754_64800__$1);
var G__64808 = null;
var G__64809 = (0);
var G__64810 = (0);
seq__64754_64790 = G__64807;
chunk__64755_64791 = G__64808;
count__64756_64792 = G__64809;
i__64757_64793 = G__64810;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64758_64811 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64759_64812 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64760_64813 = true;
var _STAR_print_fn_STAR__temp_val__64761_64814 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64760_64813);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64761_64814);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64759_64812);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64758_64811);
}
...
var len__4789__auto___64836 = arguments.length;
var i__4790__auto___64837 = (0);
while(true){
if((i__4790__auto___64837 < len__4789__auto___64836)){
args__4795__auto__.push((arguments[i__4790__auto___64837]));

var G__64838 = (i__4790__auto___64837 + (1));
i__4790__auto___64837 = G__64838;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64764){
...
var opts = map__64765__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64767 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64768 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64768);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64769_64847 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64770_64848 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64771_64849 = true;
var _STAR_print_fn_STAR__temp_val__64772_64850 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64771_64849);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64772_64850);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64770_64848);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64769_64847);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64767);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64762){
var G__64763 = cljs.core.first(seq64762);
var seq64762__$1 = cljs.core.next(seq64762);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64763,seq64762__$1);
}));
