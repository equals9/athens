...
var G__64511 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64511)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64511)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64511)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64511)].join('')));
...
var G__64559 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64560 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64559;
v = G__64560;
continue;
} else {
var G__64561 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64562 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64561;
v = G__64562;
continue;
}
...
break;
case "\"":
var G__64563 = cljs.core.next(sq);
var G__64564 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64563;
v = G__64564;
continue;
...
break;
default:
var G__64565 = cljs.core.next(sq);
var G__64566 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64565;
v = G__64566;
continue;
...
while(true){
var G__64524 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64524__$1 = (((G__64524 instanceof cljs.core.Keyword))?G__64524.fqn:null);
switch (G__64524__$1) {
case "rule":
var vec__64525 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64525,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64525,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64528 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64528) : instaparse.cfg.content.call(null,G__64528));
...
break;
case "paren":
var G__64569 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64569;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64530 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64531 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__64532 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64533 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__64534 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64535 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64524__$1)].join('')));
...
case "neg":
case "rep":
var G__64571 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64571;
continue;
...
var valid_nts_64572 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64537_64573 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64538_64574 = null;
var count__64539_64575 = (0);
var i__64540_64576 = (0);
while(true){
if((i__64540_64576 < count__64539_64575)){
var nt_64577 = chunk__64538_64574.cljs$core$IIndexed$_nth$arity$2(null,i__64540_64576);
if(cljs.core.truth_((valid_nts_64572.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64572.cljs$core$IFn$_invoke$arity$1(nt_64577) : valid_nts_64572.call(null,nt_64577)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64577),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64578 = seq__64537_64573;
var G__64579 = chunk__64538_64574;
var G__64580 = count__64539_64575;
var G__64581 = (i__64540_64576 + (1));
seq__64537_64573 = G__64578;
chunk__64538_64574 = G__64579;
count__64539_64575 = G__64580;
i__64540_64576 = G__64581;
continue;
} else {
var temp__5735__auto___64582 = cljs.core.seq(seq__64537_64573);
if(temp__5735__auto___64582){
var seq__64537_64583__$1 = temp__5735__auto___64582;
if(cljs.core.chunked_seq_QMARK_(seq__64537_64583__$1)){
var c__4609__auto___64584 = cljs.core.chunk_first(seq__64537_64583__$1);
var G__64585 = cljs.core.chunk_rest(seq__64537_64583__$1);
var G__64586 = c__4609__auto___64584;
var G__64587 = cljs.core.count(c__4609__auto___64584);
var G__64588 = (0);
seq__64537_64573 = G__64585;
chunk__64538_64574 = G__64586;
count__64539_64575 = G__64587;
i__64540_64576 = G__64588;
continue;
} else {
var nt_64589 = cljs.core.first(seq__64537_64583__$1);
if(cljs.core.truth_((valid_nts_64572.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64572.cljs$core$IFn$_invoke$arity$1(nt_64589) : valid_nts_64572.call(null,nt_64589)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64589),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64590 = cljs.core.next(seq__64537_64583__$1);
var G__64591 = null;
var G__64592 = (0);
var G__64593 = (0);
seq__64537_64573 = G__64590;
chunk__64538_64574 = G__64591;
count__64539_64575 = G__64592;
i__64540_64576 = G__64593;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64541_64594 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64542_64595 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64543_64596 = true;
var _STAR_print_fn_STAR__temp_val__64544_64597 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64543_64596);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64544_64597);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64542_64595);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64541_64594);
}
...
var len__4789__auto___64598 = arguments.length;
var i__4790__auto___64599 = (0);
while(true){
if((i__4790__auto___64599 < len__4789__auto___64598)){
args__4795__auto__.push((arguments[i__4790__auto___64599]));

var G__64600 = (i__4790__auto___64599 + (1));
i__4790__auto___64599 = G__64600;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64547){
...
var opts = map__64548__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64550 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64551 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64551);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64552_64601 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64553_64602 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64554_64603 = true;
var _STAR_print_fn_STAR__temp_val__64555_64604 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64554_64603);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64555_64604);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64553_64602);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64552_64601);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64550);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64545){
var G__64546 = cljs.core.first(seq64545);
var seq64545__$1 = cljs.core.next(seq64545);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64546,seq64545__$1);
}));
