...
var G__64812 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64811;
v = G__64812;
continue;
} else {
var G__64813 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64814 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64813;
v = G__64814;
continue;
}
...
var G__64816 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64815;
v = G__64816;
continue;
...
break;
default:
var G__64817 = cljs.core.next(sq);
var G__64818 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64817;
v = G__64818;
continue;
...
var G__64770 = null;
var G__64771 = null;
return (read_string_STAR__64819.cljs$core$IFn$_invoke$arity$4 ? read_string_STAR__64819.cljs$core$IFn$_invoke$arity$4(G__64768,G__64769,G__64770,G__64771) : read_string_STAR__64819.call(null,G__64768,G__64769,G__64770,G__64771));
});
/**
...
while(true){
var G__64777 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64777__$1 = (((G__64777 instanceof cljs.core.Keyword))?G__64777.fqn:null);
switch (G__64777__$1) {
case "rule":
var vec__64778 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64778,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64778,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64781 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64781) : instaparse.cfg.content.call(null,G__64781));
...
break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64782 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64783 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__64784 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64784) : instaparse.cfg.build_rule.call(null,G__64784));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64785 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64785) : instaparse.cfg.build_rule.call(null,G__64785));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64786 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64787 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64787) : instaparse.cfg.build_rule.call(null,G__64787));
})());
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64777__$1)].join('')));
...
while(true){
var G__64788 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
var G__64788__$1 = (((G__64788 instanceof cljs.core.Keyword))?G__64788.fqn:null);
switch (G__64788__$1) {
case "nt":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64788__$1)].join('')));
...
var len__4789__auto___64871 = arguments.length;
var i__4790__auto___64872 = (0);
while(true){
if((i__4790__auto___64872 < len__4789__auto___64871)){
args__4795__auto__.push((arguments[i__4790__auto___64872]));

var G__64873 = (i__4790__auto___64872 + (1));
i__4790__auto___64872 = G__64873;
continue;
} else {
}
break;
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64804_64886 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64805_64887 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64806_64888 = true;
var _STAR_print_fn_STAR__temp_val__64807_64889 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64806_64888);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64807_64889);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64805_64887);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64804_64886);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
