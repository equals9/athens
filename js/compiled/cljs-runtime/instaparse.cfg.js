...
var G__64578 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64578)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64578)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64578)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64578)].join('')));
...
var G__64626 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64627 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64626;
v = G__64627;
continue;
} else {
var G__64628 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64629 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64628;
v = G__64629;
continue;
}
...
break;
case "\"":
var G__64630 = cljs.core.next(sq);
var G__64631 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64630;
v = G__64631;
continue;
...
break;
default:
var G__64632 = cljs.core.next(sq);
var G__64633 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64632;
v = G__64633;
continue;
...
while(true){
var G__64591 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64591__$1 = (((G__64591 instanceof cljs.core.Keyword))?G__64591.fqn:null);
switch (G__64591__$1) {
case "rule":
var vec__64593 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64593,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64593,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64596 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64596) : instaparse.cfg.content.call(null,G__64596));
...
break;
case "paren":
var G__64636 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64636;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64597 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64597) : instaparse.cfg.build_rule.call(null,G__64597));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64598 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "star":
return instaparse.combinators_source.star((function (){var G__64599 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64600 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "look":
return instaparse.combinators_source.look((function (){var G__64601 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64602 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
...
while(true){
var G__64603 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64638 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64638;
continue;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64603__$1)].join('')));
...
var valid_nts_64639 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64604_64640 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64605_64641 = null;
var count__64606_64642 = (0);
var i__64607_64643 = (0);
while(true){
if((i__64607_64643 < count__64606_64642)){
var nt_64644 = chunk__64605_64641.cljs$core$IIndexed$_nth$arity$2(null,i__64607_64643);
if(cljs.core.truth_((valid_nts_64639.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64639.cljs$core$IFn$_invoke$arity$1(nt_64644) : valid_nts_64639.call(null,nt_64644)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64644),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64645 = seq__64604_64640;
var G__64646 = chunk__64605_64641;
var G__64647 = count__64606_64642;
var G__64648 = (i__64607_64643 + (1));
seq__64604_64640 = G__64645;
chunk__64605_64641 = G__64646;
count__64606_64642 = G__64647;
i__64607_64643 = G__64648;
continue;
} else {
var temp__5735__auto___64649 = cljs.core.seq(seq__64604_64640);
if(temp__5735__auto___64649){
var seq__64604_64650__$1 = temp__5735__auto___64649;
if(cljs.core.chunked_seq_QMARK_(seq__64604_64650__$1)){
var c__4609__auto___64651 = cljs.core.chunk_first(seq__64604_64650__$1);
var G__64652 = cljs.core.chunk_rest(seq__64604_64650__$1);
var G__64653 = c__4609__auto___64651;
var G__64654 = cljs.core.count(c__4609__auto___64651);
var G__64655 = (0);
seq__64604_64640 = G__64652;
chunk__64605_64641 = G__64653;
count__64606_64642 = G__64654;
i__64607_64643 = G__64655;
continue;
} else {
var nt_64656 = cljs.core.first(seq__64604_64650__$1);
if(cljs.core.truth_((valid_nts_64639.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64639.cljs$core$IFn$_invoke$arity$1(nt_64656) : valid_nts_64639.call(null,nt_64656)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64656),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64657 = cljs.core.next(seq__64604_64650__$1);
var G__64658 = null;
var G__64659 = (0);
var G__64660 = (0);
seq__64604_64640 = G__64657;
chunk__64605_64641 = G__64658;
count__64606_64642 = G__64659;
i__64607_64643 = G__64660;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64608_64661 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64609_64662 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64610_64663 = true;
var _STAR_print_fn_STAR__temp_val__64611_64664 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64610_64663);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64611_64664);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64609_64662);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64608_64661);
}
...
var len__4789__auto___64665 = arguments.length;
var i__4790__auto___64666 = (0);
while(true){
if((i__4790__auto___64666 < len__4789__auto___64665)){
args__4795__auto__.push((arguments[i__4790__auto___64666]));

var G__64667 = (i__4790__auto___64666 + (1));
i__4790__auto___64666 = G__64667;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64614){
...
var opts = map__64615__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64617 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64618 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64618);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64619_64668 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64620_64669 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64621_64670 = true;
var _STAR_print_fn_STAR__temp_val__64622_64671 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64621_64670);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64622_64671);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64620_64669);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64619_64668);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64617);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64612){
var G__64613 = cljs.core.first(seq64612);
var seq64612__$1 = cljs.core.next(seq64612);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64613,seq64612__$1);
}));
