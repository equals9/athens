...
var G__64560 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__64560)){
return instaparse.combinators_source.string_ci(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__64560)){
return instaparse.combinators_source.string(s);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"default","default",-1987822328),G__64560)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__64560)].join('')));
...
var G__64607 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64608 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c2);
sq = G__64607;
v = G__64608;
continue;
} else {
var G__64609 = cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),sq);
var G__64610 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,c,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([c2], 0));
sq = G__64609;
v = G__64610;
continue;
}
...
break;
case "\"":
var G__64612 = cljs.core.next(sq);
var G__64613 = cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(v,"\\",cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["\""], 0));
sq = G__64612;
v = G__64613;
continue;
...
break;
default:
var G__64614 = cljs.core.next(sq);
var G__64615 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(v,c);
sq = G__64614;
v = G__64615;
continue;
...
while(true){
var G__64573 = (instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.tag.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.tag.call(null,tree));
var G__64573__$1 = (((G__64573 instanceof cljs.core.Keyword))?G__64573.fqn:null);
switch (G__64573__$1) {
case "rule":
var vec__64574 = (instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.contents.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.contents.call(null,tree));
var nt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64574,(0),null);
var alt_or_ord = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64574,(1),null);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.cljs$core$IFn$_invoke$arity$1((function (){var G__64577 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(nt) : instaparse.cfg.content.call(null,nt));
return (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(G__64577) : instaparse.cfg.content.call(null,G__64577));
...
break;
case "paren":
var G__64618 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
tree = G__64618;
continue;

break;
case "hide":
return instaparse.combinators_source.hide((function (){var G__64578 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64578) : instaparse.cfg.build_rule.call(null,G__64578));
})());
...
break;
case "opt":
return instaparse.combinators_source.opt((function (){var G__64579 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64579) : instaparse.cfg.build_rule.call(null,G__64579));
})());

break;
case "star":
return instaparse.combinators_source.star((function (){var G__64581 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64581) : instaparse.cfg.build_rule.call(null,G__64581));
})());

break;
case "plus":
return instaparse.combinators_source.plus((function (){var G__64582 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64582) : instaparse.cfg.build_rule.call(null,G__64582));
})());

break;
case "look":
return instaparse.combinators_source.look((function (){var G__64583 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64583) : instaparse.cfg.build_rule.call(null,G__64583));
})());

break;
case "neg":
return instaparse.combinators_source.neg((function (){var G__64584 = (instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.content.cljs$core$IFn$_invoke$arity$1(tree) : instaparse.cfg.content.call(null,tree));
return (instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1 ? instaparse.cfg.build_rule.cljs$core$IFn$_invoke$arity$1(G__64584) : instaparse.cfg.build_rule.call(null,G__64584));
})());
...
while(true){
var G__64585 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(parser);
...
case "neg":
case "rep":
var G__64620 = new cljs.core.Keyword(null,"parser","parser",-1543495310).cljs$core$IFn$_invoke$arity$1(parser);
parser = G__64620;
continue;
...
var valid_nts_64621 = cljs.core.set(cljs.core.keys(grammar_map));
var seq__64586_64622 = cljs.core.seq(cljs.core.distinct.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic(instaparse.cfg.seq_nt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.vals(grammar_map)], 0))));
var chunk__64587_64623 = null;
var count__64588_64624 = (0);
var i__64589_64625 = (0);
while(true){
if((i__64589_64625 < count__64588_64624)){
var nt_64626 = chunk__64587_64623.cljs$core$IIndexed$_nth$arity$2(null,i__64589_64625);
if(cljs.core.truth_((valid_nts_64621.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64621.cljs$core$IFn$_invoke$arity$1(nt_64626) : valid_nts_64621.call(null,nt_64626)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64626),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64627 = seq__64586_64622;
var G__64628 = chunk__64587_64623;
var G__64629 = count__64588_64624;
var G__64630 = (i__64589_64625 + (1));
seq__64586_64622 = G__64627;
chunk__64587_64623 = G__64628;
count__64588_64624 = G__64629;
i__64589_64625 = G__64630;
continue;
} else {
var temp__5735__auto___64631 = cljs.core.seq(seq__64586_64622);
if(temp__5735__auto___64631){
var seq__64586_64632__$1 = temp__5735__auto___64631;
if(cljs.core.chunked_seq_QMARK_(seq__64586_64632__$1)){
var c__4609__auto___64633 = cljs.core.chunk_first(seq__64586_64632__$1);
var G__64634 = cljs.core.chunk_rest(seq__64586_64632__$1);
var G__64635 = c__4609__auto___64633;
var G__64636 = cljs.core.count(c__4609__auto___64633);
var G__64637 = (0);
seq__64586_64622 = G__64634;
chunk__64587_64623 = G__64635;
count__64588_64624 = G__64636;
i__64589_64625 = G__64637;
continue;
} else {
var nt_64638 = cljs.core.first(seq__64586_64632__$1);
if(cljs.core.truth_((valid_nts_64621.cljs$core$IFn$_invoke$arity$1 ? valid_nts_64621.cljs$core$IFn$_invoke$arity$1(nt_64638) : valid_nts_64621.call(null,nt_64638)))){
} else {
instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.subs.cljs$core$IFn$_invoke$arity$2(cljs.core.str.cljs$core$IFn$_invoke$arity$1(nt_64638),(1))," occurs on the right-hand side of your grammar, but not on the left"], 0));
}


var G__64639 = cljs.core.next(seq__64586_64632__$1);
var G__64640 = null;
var G__64641 = (0);
var G__64642 = (0);
seq__64586_64622 = G__64639;
chunk__64587_64623 = G__64640;
count__64588_64624 = G__64641;
i__64589_64625 = G__64642;
continue;
}
} else {
}
...
var _STAR_print_newline_STAR__orig_val__64590_64643 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64591_64644 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64592_64645 = true;
var _STAR_print_fn_STAR__temp_val__64593_64646 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64592_64645);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64593_64646);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64591_64644);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64590_64643);
}
...
var len__4789__auto___64647 = arguments.length;
var i__4790__auto___64648 = (0);
while(true){
if((i__4790__auto___64648 < len__4789__auto___64647)){
args__4795__auto__.push((arguments[i__4790__auto___64648]));

var G__64649 = (i__4790__auto___64648 + (1));
i__4790__auto___64648 = G__64649;
continue;
} else {
}
break;
...
(instaparse.cfg.ebnf.cljs$core$IFn$_invoke$arity$variadic = (function (spec,p__64596){
var map__64597 = p__64596;
var map__64597__$1 = (((((!((map__64597 == null))))?(((((map__64597.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__64597.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__64597):map__64597);
var opts = map__64597__$1;
var _STAR_case_insensitive_literals_STAR__orig_val__64599 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__64600 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(opts,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__64600);
...
if((rules instanceof instaparse.gll.Failure)){
return instaparse.util.throw_runtime_exception.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["Error parsing grammar specification:\n",(function (){var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__64601_64650 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__64602_64651 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__64603_64652 = true;
var _STAR_print_fn_STAR__temp_val__64604_64653 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__64603_64652);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__64604_64653);

try{cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([rules], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__64602_64651);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__64601_64650);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
})()], 0));
} else {
...
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__64599);
}}));

(instaparse.cfg.ebnf.cljs$lang$maxFixedArity = (1));

/** @this {Function} */
(instaparse.cfg.ebnf.cljs$lang$applyTo = (function (seq64594){
var G__64595 = cljs.core.first(seq64594);
var seq64594__$1 = cljs.core.next(seq64594);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64595,seq64594__$1);
}));
