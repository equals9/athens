...
cljs.core.chunk_append(b__65571,(function (){var map__65573 = p;
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (i__65570,map__65573,map__65573__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__65571,s__65569__$2,temp__5735__auto__,map__65566,map__65566__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(i__65570,map__65573,map__65573__$1,title,uid__$1,string__$1,p,c__4580__auto__,size__4581__auto__,b__65571,s__65569__$2,temp__5735__auto__,map__65566,map__65566__$1,string,children,uid))
...
return cljs.core.cons((function (){var map__65575 = p;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65575__$1,new cljs.core.Keyword("node","title","node/title",628940777));
var uid__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65575__$1,new cljs.core.Keyword("block","uid","block/uid",-1623585167));
var string__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65575__$1,new cljs.core.Keyword("block","string","block/string",-2066596447));
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"key","key",-1516042587),uid__$1,new cljs.core.Keyword(null,"style","style",-496642736),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cursor","cursor",1011937484),"pointer"], null),new cljs.core.Keyword(null,"on-click","on-click",1632826543),((function (map__65575,map__65575__$1,title,uid__$1,string__$1,p,s__65569__$2,temp__5735__auto__,map__65566,map__65566__$1,string,children,uid){
return (function (){
return athens.router.navigate_uid(uid__$1);
});})(map__65575,map__65575__$1,title,uid__$1,string__$1,p,s__65569__$2,temp__5735__auto__,map__65566,map__65566__$1,string,children,uid))
], null),(function (){var or__4185__auto__ = string__$1;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
var G__65577 = athens.db.dsdb;
var G__65578 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("db","add","db/add",235286841),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null),new cljs.core.Keyword("block","string","block/string",-2066596447),e.target.value], null)], null);
return (posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2 ? posh.reagent.transact_BANG_.cljs$core$IFn$_invoke$arity$2(G__65577,G__65578) : posh.reagent.transact_BANG_.call(null,G__65577,G__65578));
})], null)], null)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h1","h1",-1896887462),["\u2022 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(string)].join('')], null))], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var iter__4582__auto__ = (function athens$devcards$block_page$block_page_el_$_iter__65579(s__65580){
return (new cljs.core.LazySeq(null,(function (){
var s__65580__$1 = s__65580;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__65580__$1);
if(temp__5735__auto__){
var s__65580__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__65580__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__65580__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__65582 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__65581 = (0);
while(true){
if((i__65581 < size__4581__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__65581);
cljs.core.chunk_append(b__65582,(function (){var map__65583 = child;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__65582),athens$devcards$block_page$block_page_el_$_iter__65579(cljs.core.chunk_rest(s__65580__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__65582),null);
}
} else {
var child = cljs.core.first(s__65580__$2);
...
return cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [athens.devcards.blocks.block_el,child], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),id], null));
})(),athens$devcards$block_page$block_page_el_$_iter__65579(cljs.core.rest(s__65580__$2)));
}
} else {
return null;
}
