...
while(true){
if((i__40995__auto___41102 < n__4666__auto___41100)){
...
var G__41269 = (node.pointers[idx]);
var G__41270 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41271 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41269;
path = G__41270;
level = G__41271;
continue;
...
var pos_41291 = (0);
while(true){
var rest_41292 = (len - pos_41291);
if((rest_41292 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41291));
} else {
if((rest_41292 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41291,(pos_41291 + chunk_len)));

var G__41293 = (pos_41291 + chunk_len);
pos_41291 = G__41293;
continue;
} else {
var piece_len_41294 = (rest_41292 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41291,(pos_41291 + piece_len_41294)));

var G__41297 = (pos_41291 + piece_len_41294);
pos_41291 = G__41297;
continue;
...
var G__41305 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41306 = (i + (1));
var G__41307 = e;
acc = G__41305;
i = G__41306;
