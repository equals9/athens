...
while(true){
if((level__$1 > (0))){
var G__41240 = (function (){var arr__41009__auto__ = node__$1.pointers;
return (arr__41009__auto__[(arr__41009__auto__.length - (1))]);
})();
var G__41241 = me.tonsky.persistent_sorted_set.path_set(path,level__$1,(node__$1.pointers.length - (1)));
...
var G__41296 = (left__$1 + (1));
var G__41297 = keys__$1;
var G__41298 = (idx__$1 + (1));
var G__41299 = new_acc;
left__$1 = G__41296;
keys__$1 = G__41297;
idx__$1 = G__41298;
acc = G__41299;
...
var G__41301 = new_left;
var G__41302 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41303 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
var G__41304 = new_acc;
left__$1 = G__41301;
keys__$1 = G__41302;
idx__$1 = G__41303;
acc = G__41304;
...
var G__41333 = (level__$1 - me.tonsky.persistent_sorted_set.level_shift);
var G__41334 = (res * me.tonsky.persistent_sorted_set.avg_len);
level__$1 = G__41333;
res = G__41334;
continue;
}
...
var G__41346 = (node.pointers[idx]);
var G__41347 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41348 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41346;
path = G__41347;
level = G__41348;
continue;
...
var G__41354 = (node.pointers[idx]);
var G__41355 = me.tonsky.persistent_sorted_set.path_set(path,level,idx);
var G__41356 = (level - me.tonsky.persistent_sorted_set.level_shift);
node = G__41354;
path = G__41355;
level = G__41356;
continue;
...
var pos_41369 = (0);
while(true){
var rest_41370 = (len - pos_41369);
if((rest_41370 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41369));
} else {
if((rest_41370 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41369,(pos_41369 + chunk_len)));

var G__41371 = (pos_41369 + chunk_len);
pos_41369 = G__41371;
continue;
} else {
var piece_len_41373 = (rest_41370 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41369,(pos_41369 + piece_len_41373)));

var G__41374 = (pos_41369 + piece_len_41373);
pos_41369 = G__41374;
continue;
...
var G__41401 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,e);
var G__41402 = (i + (1));
var G__41403 = e;
acc = G__41401;
i = G__41402;
...
break;
default:
var G__41466 = me.tonsky.persistent_sorted_set.arr_map_inplace(((function (current_level,shift,G__41073,leaves){
...
var G__41467 = (shift + me.tonsky.persistent_sorted_set.level_shift);
current_level = G__41466;
shift = G__41467;
continue;
...
args_arr__4810__auto__.push((arguments[i__4790__auto___41470]));
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___41482 = arguments.length;
var i__4790__auto___41484 = (0);
while(true){
if((i__4790__auto___41484 < len__4789__auto___41482)){
args_arr__4810__auto__.push((arguments[i__4790__auto___41484]));

var G__41490 = (i__4790__auto___41484 + (1));
i__4790__auto___41484 = G__41490;
continue;
} else {
}
break;
