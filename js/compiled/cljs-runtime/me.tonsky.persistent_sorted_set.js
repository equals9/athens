...
var G__41112 = (i__40995__auto___41109 + (1));
i__40995__auto___41109 = G__41112;
continue;
} else {
}
break;
...
var G__41231 = new_left;
var G__41232 = me.tonsky.persistent_sorted_set.keys_for(self__.set,new_left);
var G__41233 = me.tonsky.persistent_sorted_set.path_get(new_left,(0));
...
var pos_41304 = (0);
while(true){
var rest_41305 = (len - pos_41304);
if((rest_41305 <= max_len)){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41304));
} else {
if((rest_41305 >= (chunk_len + min_len))){
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41304,(pos_41304 + chunk_len)));

var G__41308 = (pos_41304 + chunk_len);
pos_41304 = G__41308;
continue;
} else {
var piece_len_41309 = (rest_41305 >>> (1));
cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(acc,arr.slice(pos_41304,(pos_41304 + piece_len_41309)));

var G__41310 = (pos_41304 + piece_len_41309);
pos_41304 = G__41310;
continue;
