...
var G__57973_57999 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__57974_58000 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__57973_57999,G__57974_58000) : re_frame.core.reg_sub.call(null,G__57973_57999,G__57974_58000));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__57975){
var vec__57976 = p__57975;
var seq__57977 = cljs.core.seq(vec__57976);
var first__57978 = cljs.core.first(seq__57977);
var seq__57977__$1 = cljs.core.next(seq__57977);
var ___$1 = first__57978;
var route = seq__57977__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__57979,p__57980){
var map__57981 = p__57979;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57981__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__57982 = p__57980;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57982,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57982,(1),null);
...
var G__57990_58001 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__57991_58002 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__57990_58001,G__57991_58002) : re_frame.core.reg_fx.call(null,G__57990_58001,G__57991_58002));
...
var G__57995 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57995) : re_frame.core.dispatch.call(null,G__57995));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__57996 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57996) : re_frame.core.dispatch.call(null,G__57996));
});
athens.router.navigate_uid = (function athens$router$navigate_uid(uid){
var G__57997 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57997) : re_frame.core.dispatch.call(null,G__57997));
});
