...
var G__57968_57991 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__57969_57992 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__57968_57991,G__57969_57992) : re_frame.core.reg_sub.call(null,G__57968_57991,G__57969_57992));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__57970){
var vec__57972 = p__57970;
var seq__57973 = cljs.core.seq(vec__57972);
var first__57974 = cljs.core.first(seq__57973);
var seq__57973__$1 = cljs.core.next(seq__57973);
var ___$1 = first__57974;
var route = seq__57973__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__57975,p__57976){
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__57977__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__57978 = p__57976;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57978,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__57978,(1),null);
...
var node = (function (){var G__57982 = athens.db.dsdb;
var G__57983 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__57984 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__57982,G__57983,G__57984) : posh.reagent.pull.call(null,G__57982,G__57983,G__57984));
})();
...
var G__57985_57993 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__57986_57994 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54407__auto__;
}catch (e57987){var e = e57987;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__57985_57993,G__57986_57994) : re_frame.core.reg_fx.call(null,G__57985_57993,G__57986_57994));
...
var G__57988 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
...
var G__57989 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
...
var G__57990 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__57990) : re_frame.core.dispatch.call(null,G__57990));
});
