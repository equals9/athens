...
var G__58076_58104 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__58077_58105 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__58076_58104,G__58077_58105) : re_frame.core.reg_sub.call(null,G__58076_58104,G__58077_58105));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__58078){
var vec__58079 = p__58078;
var seq__58080 = cljs.core.seq(vec__58079);
var first__58081 = cljs.core.first(seq__58080);
var seq__58080__$1 = cljs.core.next(seq__58080);
var ___$1 = first__58081;
var route = seq__58080__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__58082,p__58083){
var map__58084 = p__58082;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58084__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__58085 = p__58083;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58085,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58085,(1),null);
...
var node = (function (){var G__58089 = athens.db.dsdb;
var G__58090 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58091 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58089,G__58090,G__58091) : posh.reagent.pull.call(null,G__58089,G__58090,G__58091));
})();
...
var G__58092_58107 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__58093_58108 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54410__auto__;
}catch (e58094){var e = e58094;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__58092_58107,G__58093_58108) : re_frame.core.reg_fx.call(null,G__58092_58107,G__58093_58108));
...
var G__58096 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58096) : re_frame.core.dispatch.call(null,G__58096));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__58097 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58097) : re_frame.core.dispatch.call(null,G__58097));
});
...
var G__58101 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
...
var G__58102 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
