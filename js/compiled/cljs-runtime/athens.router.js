...
var G__58062_58087 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__58063_58088 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__58062_58087,G__58063_58088) : re_frame.core.reg_sub.call(null,G__58062_58087,G__58063_58088));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__58064){
var vec__58065 = p__58064;
var seq__58066 = cljs.core.seq(vec__58065);
var first__58067 = cljs.core.first(seq__58066);
var seq__58066__$1 = cljs.core.next(seq__58066);
var ___$1 = first__58067;
var route = seq__58066__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__58068,p__58069){
var map__58070 = p__58068;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__58070__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__58071 = p__58069;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58071,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58071,(1),null);
...
var node = (function (){var G__58075 = athens.db.dsdb;
var G__58076 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__58077 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__58075,G__58076,G__58077) : posh.reagent.pull.call(null,G__58075,G__58076,G__58077));
})();
...
var G__58078_58089 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__58079_58090 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
return result__54397__auto__;
}catch (e58080){var e = e58080;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__58078_58089,G__58079_58090) : re_frame.core.reg_fx.call(null,G__58078_58089,G__58079_58090));
...
var G__58081 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58081) : re_frame.core.dispatch.call(null,G__58081));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__58082 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__58082) : re_frame.core.dispatch.call(null,G__58082));
});
...
var G__58085 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
...
var G__58086 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
