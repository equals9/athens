...
var G__63260_63285 = new cljs.core.Keyword(null,"current-route","current-route",2067529448);
var G__63261_63286 = (function (db){
return new cljs.core.Keyword(null,"current-route","current-route",2067529448).cljs$core$IFn$_invoke$arity$1(db);
});
(re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$2(G__63260_63285,G__63261_63286) : re_frame.core.reg_sub.call(null,G__63260_63285,G__63261_63286));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigate","navigate",657596805),(function (_,p__63262){
var vec__63263 = p__63262;
var seq__63264 = cljs.core.seq(vec__63263);
var first__63265 = cljs.core.first(seq__63264);
var seq__63264__$1 = cljs.core.next(seq__63264);
var ___$1 = first__63265;
var route = seq__63264__$1;
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"navigate!","navigate!",79998348),route], null);
}));
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"navigated","navigated",540897836),(function (p__63266,p__63267){
var map__63268 = p__63266;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63268__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__63269 = p__63267;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63269,(0),null);
var new_match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63269,(1),null);
...
var node = (function (){var G__63273 = athens.db.dsdb;
var G__63274 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__63275 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"path-params","path-params",-48130597).cljs$core$IFn$_invoke$arity$1(new_match))], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__63273,G__63274,G__63275) : posh.reagent.pull.call(null,G__63273,G__63274,G__63275));
})();
...
var G__63276_63289 = new cljs.core.Keyword(null,"navigate!","navigate!",79998348);
var G__63277_63290 = ((day8.re_frame.tracing.is_trace_enabled_QMARK_())?(function (route){
...
var result__59561__auto__ = cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var opts__59560__auto____$1 = _PLUS_debux_dbg_opts_PLUS_;
var result__59561__auto__ = reitit.frontend.easy.push_state;
...
var result__59561__auto__ = route;
...
return result__59561__auto__;
}catch (e63278){var e = e63278;
throw e;
}}):(function (route){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(reitit.frontend.easy.push_state,route);
}));
(re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2 ? re_frame.core.reg_fx.cljs$core$IFn$_invoke$arity$2(G__63276_63289,G__63277_63290) : re_frame.core.reg_fx.call(null,G__63276_63289,G__63277_63290));
...
var G__63279 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigated","navigated",540897836),new_match], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__63279) : re_frame.core.dispatch.call(null,G__63279));
} else {
return null;
}
});
athens.router.navigate = (function athens$router$navigate(page){
var G__63280 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),page], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__63280) : re_frame.core.dispatch.call(null,G__63280));
});
...
var G__63283 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigate","navigate",657596805),new cljs.core.Keyword(null,"page","page",849072397),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"id","id",-1388402092),uid], null)], null);
...
var G__63284 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("right-sidebar","open-item","right-sidebar/open-item",-1234515614),uid], null);
return (re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1 ? re_frame.core.dispatch.cljs$core$IFn$_invoke$arity$1(G__63284) : re_frame.core.dispatch.call(null,G__63284));
} else {
