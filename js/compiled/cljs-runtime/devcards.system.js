...
devcards.system.card_template = (function devcards$system$card_template(state_atom,p__50656){
...
var card = map__50658__$1;
var path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50658__$1,new cljs.core.Keyword(null,"path","path",-188191168));
var options = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50658__$1,new cljs.core.Keyword(null,"options","options",99638489));
var func = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50658__$1,new cljs.core.Keyword(null,"func","func",-238706040));
return React.createElement("div",({"key": devcards.system.path__GT_unique_card_id(path), "className": "com-rigsomelight-devcard"}),sablono.interpreter.interpret((function (){var _STAR_devcard_data_STAR__orig_val__50662 = devcards.system._STAR_devcard_data_STAR_;
var _STAR_devcard_data_STAR__temp_val__50663 = card;
(devcards.system._STAR_devcard_data_STAR_ = _STAR_devcard_data_STAR__temp_val__50663);

try{return (func.cljs$core$IFn$_invoke$arity$0 ? func.cljs$core$IFn$_invoke$arity$0() : func.call(null));
}finally {(devcards.system._STAR_devcard_data_STAR_ = _STAR_devcard_data_STAR__orig_val__50662);
}})()));
});
...
devcards.system.breadcrumbs = (function devcards$system$breadcrumbs(p__50671){
...
var state = map__50673__$1;
var current_path = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50673__$1,new cljs.core.Keyword(null,"current-path","current-path",-113759954));
...
return React.createElement("div",({"key": "breadcrumbs-templ", "className": "com-rigsomelight-devcards-card-base com-rigsomelight-devcards-breadcrumbs com-rigsomelight-devcards-typog"}),sablono.interpreter.interpret(cljs.core.rest(cljs.core.interleave.cljs$core$IFn$_invoke$arity$2(cljs.core.iterate(sep_fn,sep_fn(null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__50679){
var vec__50680 = p__50679;
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50680,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50680,(1),null);
...
var statearr_50751_50931 = state_50749__$1;
(statearr_50751_50931[(2)] = inst_50745);

(statearr_50751_50931[(1)] = (3));
...
var state_50749__$1 = state_50749;
var statearr_50774_50950 = state_50749__$1;
(statearr_50774_50950[(2)] = inst_50724);

(statearr_50774_50950[(1)] = (10));
...
var statearr_50776 = [null,null,null,null,null,null,null,null,null,null,null,null];
(statearr_50776[(0)] = devcards$system$off_the_books_$_state_machine__38789__auto__);
...
var statearr_50778_50951 = state_50749;
(statearr_50778_50951[(5)] = ex__38792__auto__);
...
var c__38855__auto__ = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__38856__auto__ = (function (){var switch__38788__auto__ = (function (state_50791){
var state_val_50792 = (state_50791[(1)]);
if((state_val_50792 === (1))){
var inst_50781 = cljs.core.deref(devcards.system.app_state);
var inst_50782 = cljs.core.PersistentVector.EMPTY;
var inst_50784 = devcards.system.off_the_books(channel,inst_50781,inst_50782);
var state_50791__$1 = state_50791;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_50791__$1,(2),inst_50784);
} else {
if((state_val_50792 === (2))){
var inst_50786 = (state_50791[(2)]);
var inst_50789 = cljs.core.reset_BANG_(devcards.system.app_state,inst_50786);
var state_50791__$1 = state_50791;
...
var statearr_50795_50955 = state_50791;
...
var state__38857__auto__ = (function (){var statearr_50796 = (f__38856__auto__.cljs$core$IFn$_invoke$arity$0 ? f__38856__auto__.cljs$core$IFn$_invoke$arity$0() : f__38856__auto__.call(null));
(statearr_50796[(6)] = c__38855__auto__);
...
var c__38855__auto___50957 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__38856__auto__ = (function (){var switch__38788__auto__ = (function (state_50824){
var state_val_50825 = (state_50824[(1)]);
if((state_val_50825 === (7))){
var state_50824__$1 = state_50824;
var statearr_50826_50958 = state_50824__$1;
(statearr_50826_50958[(2)] = null);

(statearr_50826_50958[(1)] = (8));
...
var state_50824__$1 = state_50824;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_50824__$1,(2),inst_50800);
} else {
if((state_val_50825 === (4))){
var inst_50822 = (state_50824[(2)]);
var state_50824__$1 = state_50824;
return cljs.core.async.impl.ioc_helpers.return_chan(state_50824__$1,inst_50822);
} else {
if((state_val_50825 === (6))){
var inst_50809 = (state_50824[(7)]);
var inst_50811 = cljs.core.deref(devcards.system.app_state);
var inst_50812 = devcards.system.off_the_books(channel,inst_50811,inst_50809);
var state_50824__$1 = state_50824;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_50824__$1,(9),inst_50812);
} else {
if((state_val_50825 === (3))){
var state_50824__$1 = state_50824;
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_50824__$1,(5),channel);
} else {
if((state_val_50825 === (2))){
var inst_50802 = (state_50824[(2)]);
...
var state_50824__$1 = (function (){var statearr_50828 = state_50824;
(statearr_50828[(8)] = inst_50802);

(statearr_50828[(9)] = inst_50806);

(statearr_50828[(10)] = inst_50804);

return statearr_50828;
})();
var statearr_50829_50959 = state_50824__$1;
(statearr_50829_50959[(2)] = null);

(statearr_50829_50959[(1)] = (3));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_50825 === (9))){
var inst_50809 = (state_50824[(7)]);
var inst_50814 = (state_50824[(2)]);
var inst_50815 = (function (){var temp__5735__auto__ = inst_50809;
var v = inst_50809;
var new_state = inst_50814;
return (function (){
return cljs.core.reset_BANG_(devcards.system.app_state,new_state);
});
})();
var inst_50816 = setTimeout(inst_50815,(0));
var state_50824__$1 = (function (){var statearr_50832 = state_50824;
(statearr_50832[(11)] = inst_50816);

return statearr_50832;
})();
var statearr_50833_50960 = state_50824__$1;
(statearr_50833_50960[(2)] = null);

(statearr_50833_50960[(1)] = (3));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_50825 === (5))){
var inst_50809 = (state_50824[(7)]);
var inst_50809__$1 = (state_50824[(2)]);
var state_50824__$1 = (function (){var statearr_50834 = state_50824;
(statearr_50834[(7)] = inst_50809__$1);

return statearr_50834;
})();
if(cljs.core.truth_(inst_50809__$1)){
var statearr_50835_50961 = state_50824__$1;
(statearr_50835_50961[(1)] = (6));

} else {
var statearr_50836_50962 = state_50824__$1;
(statearr_50836_50962[(1)] = (7));

}

return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_50825 === (8))){
var inst_50820 = (state_50824[(2)]);
var state_50824__$1 = state_50824;
var statearr_50837_50963 = state_50824__$1;
(statearr_50837_50963[(2)] = inst_50820);

(statearr_50837_50963[(1)] = (4));
...
var devcards$system$start_ui_with_renderer_$_state_machine__38789__auto____1 = (function (state_50824){
while(true){
var ret_value__38790__auto__ = (function (){try{while(true){
var result__38791__auto__ = switch__38788__auto__(state_50824);
if(cljs.core.keyword_identical_QMARK_(result__38791__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
continue;
} else {
return result__38791__auto__;
...
var statearr_50840_50965 = state_50824;
(statearr_50840_50965[(5)] = ex__38792__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_50824);
...
if(cljs.core.keyword_identical_QMARK_(ret_value__38790__auto__,new cljs.core.Keyword(null,"recur","recur",-437573268))){
var G__50969 = state_50824;
state_50824 = G__50969;
continue;
} else {
return ret_value__38790__auto__;
}
...
devcards$system$start_ui_with_renderer_$_state_machine__38789__auto__ = function(state_50824){
switch(arguments.length){
case 0:
return devcards$system$start_ui_with_renderer_$_state_machine__38789__auto____0.call(this);
case 1:
return devcards$system$start_ui_with_renderer_$_state_machine__38789__auto____1.call(this,state_50824);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var state__38857__auto__ = (function (){var statearr_50841 = (f__38856__auto__.cljs$core$IFn$_invoke$arity$0 ? f__38856__auto__.cljs$core$IFn$_invoke$arity$0() : f__38856__auto__.call(null));
(statearr_50841[(6)] = c__38855__auto___50957);
...
var c__38855__auto___50974 = cljs.core.async.chan.cljs$core$IFn$_invoke$arity$1((1));
cljs.core.async.impl.dispatch.run((function (){
var f__38856__auto__ = (function (){var switch__38788__auto__ = (function (state_50866){
var state_val_50867 = (state_50866[(1)]);
if((state_val_50867 === (7))){
var state_50866__$1 = state_50866;
var statearr_50868_50980 = state_50866__$1;
(statearr_50868_50980[(2)] = null);

(statearr_50868_50980[(1)] = (8));
...
var state_50866__$1 = (function (){var statearr_50870 = state_50866;
...
var statearr_50871_50987 = state_50866__$1;
(statearr_50871_50987[(2)] = null);

(statearr_50871_50987[(1)] = (3));
...
var state_50866__$1 = (function (){var statearr_50872 = state_50866;
(statearr_50872[(11)] = inst_50858);

return statearr_50872;
})();
var statearr_50873_50988 = state_50866__$1;
(statearr_50873_50988[(2)] = null);

(statearr_50873_50988[(1)] = (3));
...
var state_50866__$1 = (function (){var statearr_50874 = state_50866;
(statearr_50874[(7)] = inst_50851__$1);

return statearr_50874;
})();
if(cljs.core.truth_(inst_50851__$1)){
var statearr_50875_50989 = state_50866__$1;
(statearr_50875_50989[(1)] = (6));

} else {
var statearr_50876_50990 = state_50866__$1;
(statearr_50876_50990[(1)] = (7));
...
var state_50866__$1 = state_50866;
var statearr_50877_50991 = state_50866__$1;
(statearr_50877_50991[(2)] = inst_50862);

(statearr_50877_50991[(1)] = (4));
...
var statearr_50882_50992 = state_50866;
(statearr_50882_50992[(5)] = ex__38792__auto__);
...
var state__38857__auto__ = (function (){var statearr_50883 = (f__38856__auto__.cljs$core$IFn$_invoke$arity$0 ? f__38856__auto__.cljs$core$IFn$_invoke$arity$0() : f__38856__auto__.call(null));
(statearr_50883[(6)] = c__38855__auto___50974);
