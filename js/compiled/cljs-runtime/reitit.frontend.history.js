...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k58018,else__4442__auto__){
var self__ = this;
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__58017){
var self__ = this;
var G__58017__$1 = this;
return (new cljs.core.RecordIter((0),G__58017__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this58019,other58020){
var self__ = this;
var this58019__$1 = this;
return (((!((other58020 == null)))) && ((this58019__$1.constructor === other58020.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.on_navigate,other58020.on_navigate)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.router,other58020.router)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.popstate_listener,other58020.popstate_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.hashchange_listener,other58020.hashchange_listener)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.last_fragment,other58020.last_fragment)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this58019__$1.__extmap,other58020.__extmap)));
}));
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__58017){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__58032 = cljs.core.keyword_identical_QMARK_;
var expr__58033 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__58035 = new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908);
var G__58036 = expr__58033;
return (pred__58032.cljs$core$IFn$_invoke$arity$2 ? pred__58032.cljs$core$IFn$_invoke$arity$2(G__58035,G__58036) : pred__58032.call(null,G__58035,G__58036));
})())){
return (new reitit.frontend.history.FragmentHistory(G__58017,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58037 = new cljs.core.Keyword(null,"router","router",1091916230);
var G__58038 = expr__58033;
return (pred__58032.cljs$core$IFn$_invoke$arity$2 ? pred__58032.cljs$core$IFn$_invoke$arity$2(G__58037,G__58038) : pred__58032.call(null,G__58037,G__58038));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,G__58017,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58039 = new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472);
var G__58040 = expr__58033;
return (pred__58032.cljs$core$IFn$_invoke$arity$2 ? pred__58032.cljs$core$IFn$_invoke$arity$2(G__58039,G__58040) : pred__58032.call(null,G__58039,G__58040));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,G__58017,self__.hashchange_listener,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58041 = new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801);
var G__58042 = expr__58033;
return (pred__58032.cljs$core$IFn$_invoke$arity$2 ? pred__58032.cljs$core$IFn$_invoke$arity$2(G__58041,G__58042) : pred__58032.call(null,G__58041,G__58042));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,G__58017,self__.last_fragment,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__58043 = new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173);
var G__58044 = expr__58033;
return (pred__58032.cljs$core$IFn$_invoke$arity$2 ? pred__58032.cljs$core$IFn$_invoke$arity$2(G__58043,G__58044) : pred__58032.call(null,G__58043,G__58044));
})())){
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,G__58017,self__.__meta,self__.__extmap,null));
} else {
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__58017),null));
}
}
}
}
...
(reitit.frontend.history.FragmentHistory.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__58017){
var self__ = this;
var this__4438__auto____$1 = this;
return (new reitit.frontend.history.FragmentHistory(self__.on_navigate,self__.router,self__.popstate_listener,self__.hashchange_listener,self__.last_fragment,G__58017,self__.__extmap,self__.__hash));
}));
 ...
 */
reitit.frontend.history.map__GT_FragmentHistory = (function reitit$frontend$history$map__GT_FragmentHistory(G__58021){
var extmap__4478__auto__ = (function (){var G__58045 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__58021,new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"router","router",1091916230),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173)], 0));
if(cljs.core.record_QMARK_(G__58021)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__58045);
} else {
return G__58045;
}
})();
return (new reitit.frontend.history.FragmentHistory(new cljs.core.Keyword(null,"on-navigate","on-navigate",-297227908).cljs$core$IFn$_invoke$arity$1(G__58021),new cljs.core.Keyword(null,"router","router",1091916230).cljs$core$IFn$_invoke$arity$1(G__58021),new cljs.core.Keyword(null,"popstate-listener","popstate-listener",806944472).cljs$core$IFn$_invoke$arity$1(G__58021),new cljs.core.Keyword(null,"hashchange-listener","hashchange-listener",-1234988801).cljs$core$IFn$_invoke$arity$1(G__58021),new cljs.core.Keyword(null,"last-fragment","last-fragment",-919830173).cljs$core$IFn$_invoke$arity$1(G__58021),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
