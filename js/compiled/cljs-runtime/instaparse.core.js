...
if(cljs.core.truth_((function (){var fexpr__65067 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65067.cljs$core$IFn$_invoke$arity$1 ? fexpr__65067.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65067.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65068 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65068.cljs$core$IFn$_invoke$arity$1 ? fexpr__65068.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65068.call(null,type));
})())){
} else {
...
var G__65069 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65069)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65069)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65069)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65069)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65069)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65073){
var map__65074 = p__65073;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65076 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65076) : instaparse.reduction.node_builders.call(null,G__65076));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65070){
var G__65071 = cljs.core.first(seq65070);
var seq65070__$1 = cljs.core.next(seq65070);
var G__65072 = cljs.core.first(seq65070__$1);
var seq65070__$2 = cljs.core.next(seq65070__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65071,G__65072,seq65070__$2);
}));
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65082){
var map__65084 = p__65082;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65086 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65086) : instaparse.reduction.node_builders.call(null,G__65086));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65077){
var G__65078 = cljs.core.first(seq65077);
var seq65077__$1 = cljs.core.next(seq65077);
var G__65079 = cljs.core.first(seq65077__$1);
var seq65077__$2 = cljs.core.next(seq65077__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65078,G__65079,seq65077__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65089,else__4442__auto__){
var self__ = this;
...
var h__4297__auto____$1 = (function (){var fexpr__65105 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65105(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65090,other65091){
var self__ = this;
var this65090__$1 = this;
return (((!((other65091 == null)))) && ((this65090__$1.constructor === other65091.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65090__$1.grammar,other65091.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65090__$1.start_production,other65091.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65090__$1.output_format,other65091.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65090__$1.__extmap,other65091.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65088){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65119 = cljs.core.keyword_identical_QMARK_;
var expr__65120 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65122 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__65088,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65124 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65125 = expr__65120;
return (pred__65119.cljs$core$IFn$_invoke$arity$2 ? pred__65119.cljs$core$IFn$_invoke$arity$2(G__65124,G__65125) : pred__65119.call(null,G__65124,G__65125));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65088,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65126 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65127 = expr__65120;
return (pred__65119.cljs$core$IFn$_invoke$arity$2 ? pred__65119.cljs$core$IFn$_invoke$arity$2(G__65126,G__65127) : pred__65119.call(null,G__65126,G__65127));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65088,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65088),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65088){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65088,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65133 = (arguments.length - (1));
switch (G__65133) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65095){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65095)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65092){
var extmap__4478__auto__ = (function (){var G__65150 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65092,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65092)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65150);
} else {
return G__65150;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65092),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65092),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65092),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
