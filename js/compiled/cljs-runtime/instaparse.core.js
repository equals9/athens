...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65286 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65286) : instaparse.reduction.node_builders.call(null,G__65286));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65297){
var G__65298 = cljs.core.first(seq65297);
var seq65297__$1 = cljs.core.next(seq65297);
var G__65299 = cljs.core.first(seq65297__$1);
var seq65297__$2 = cljs.core.next(seq65297__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65298,G__65299,seq65297__$2);
}));
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65324){
var vec__65327 = p__65324;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65327,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65327,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65337 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65337(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65319){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65319)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65318){
var extmap__4478__auto__ = (function (){var G__65352 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65318,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65318)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65352);
} else {
return G__65352;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65318),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65318),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65318),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
while(true){
if((i__4790__auto___65468 < len__4789__auto___65464)){
args__4795__auto__.push((arguments[i__4790__auto___65468]));

var G__65469 = (i__4790__auto___65468 + (1));
i__4790__auto___65468 = G__65469;
continue;
} else {
}
break;
