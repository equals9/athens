...
var G__65277 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65277)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65277)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65277)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65277)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65277)].join('')));
...
while(true){
if((i__4790__auto___65366 < len__4789__auto___65363)){
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65279){
var G__65280 = cljs.core.first(seq65279);
var seq65279__$1 = cljs.core.next(seq65279);
var G__65281 = cljs.core.first(seq65279__$1);
var seq65279__$2 = cljs.core.next(seq65279__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65280,G__65281,seq65279__$2);
}));
...
while(true){
if((i__4790__auto___65379 < len__4789__auto___65377)){
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65305){
var map__65306 = p__65305;
var map__65306__$1 = (((((!((map__65306 == null))))?(((((map__65306.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65306.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65306):map__65306);
var options = map__65306__$1;
if(cljs.core.contains_QMARK_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 4, [null,null,new cljs.core.Keyword(null,"tags","tags",1771418977),null,new cljs.core.Keyword(null,"content","content",15833224),null,new cljs.core.Keyword(null,"all","all",892129742),null], null), null),cljs.core.get.cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"unhide","unhide",-413983695)))){
} else {
throw (new Error("Assert failed: (contains? #{nil :tags :content :all} (get options :unhide))"));
}
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65311 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65311) : instaparse.reduction.node_builders.call(null,G__65311));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65301){
var G__65302 = cljs.core.first(seq65301);
var seq65301__$1 = cljs.core.next(seq65301);
var G__65303 = cljs.core.first(seq65301__$1);
var seq65301__$2 = cljs.core.next(seq65301__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65302,G__65303,seq65301__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65318,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__65332 = k65318;
var G__65332__$1 = (((G__65332 instanceof cljs.core.Keyword))?G__65332.fqn:null);
switch (G__65332__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65318,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65320,other65321){
var self__ = this;
var this65320__$1 = this;
return (((!((other65321 == null)))) && ((this65320__$1.constructor === other65321.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65320__$1.grammar,other65321.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65320__$1.start_production,other65321.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65320__$1.output_format,other65321.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65320__$1.__extmap,other65321.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65317){
var self__ = this;
...
return (new instaparse.core.Parser(G__65317,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__65317,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65317,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65317),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65317){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65317,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65327){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65327)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65326){
var extmap__4478__auto__ = (function (){var G__65352 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65326,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65326),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65326),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65326),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__65472 = (i__4790__auto___65468 + (1));
i__4790__auto___65468 = G__65472;
continue;
} else {
}
break;
