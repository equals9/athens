...
if(cljs.core.truth_((function (){var fexpr__65212 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__65216 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
...
var G__65217 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65217)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65217)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65217)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65217)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65217)].join('')));
...
var G__65311 = (i__4790__auto___65309 + (1));
i__4790__auto___65309 = G__65311;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65222){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65228 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65219){
var G__65220 = cljs.core.first(seq65219);
var seq65219__$1 = cljs.core.next(seq65219);
var G__65221 = cljs.core.first(seq65219__$1);
var seq65219__$2 = cljs.core.next(seq65219__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65220,G__65221,seq65219__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65321 = arguments.length;
var i__4790__auto___65322 = (0);
while(true){
if((i__4790__auto___65322 < len__4789__auto___65321)){
args__4795__auto__.push((arguments[i__4790__auto___65322]));

var G__65323 = (i__4790__auto___65322 + (1));
i__4790__auto___65322 = G__65323;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65236){
var map__65238 = p__65236;
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65247 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65247) : instaparse.reduction.node_builders.call(null,G__65247));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65229){
var G__65230 = cljs.core.first(seq65229);
var seq65229__$1 = cljs.core.next(seq65229);
var G__65231 = cljs.core.first(seq65229__$1);
var seq65229__$2 = cljs.core.next(seq65229__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65230,G__65231,seq65229__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65253,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__65259 = k65253;
var G__65259__$1 = (((G__65259 instanceof cljs.core.Keyword))?G__65259.fqn:null);
switch (G__65259__$1) {
case "grammar":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65253,else__4442__auto__);
...
var h__4297__auto____$1 = (function (){var fexpr__65276 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65276(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65254,other65255){
var self__ = this;
var this65254__$1 = this;
return (((!((other65255 == null)))) && ((this65254__$1.constructor === other65255.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65254__$1.grammar,other65255.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65254__$1.start_production,other65255.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65254__$1.output_format,other65255.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65254__$1.__extmap,other65255.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65252){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65281 = cljs.core.keyword_identical_QMARK_;
var expr__65282 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65284 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65285 = expr__65282;
return (pred__65281.cljs$core$IFn$_invoke$arity$2 ? pred__65281.cljs$core$IFn$_invoke$arity$2(G__65284,G__65285) : pred__65281.call(null,G__65284,G__65285));
})())){
return (new instaparse.core.Parser(G__65252,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65290 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65291 = expr__65282;
return (pred__65281.cljs$core$IFn$_invoke$arity$2 ? pred__65281.cljs$core$IFn$_invoke$arity$2(G__65290,G__65291) : pred__65281.call(null,G__65290,G__65291));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65252,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65292 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65293 = expr__65282;
return (pred__65281.cljs$core$IFn$_invoke$arity$2 ? pred__65281.cljs$core$IFn$_invoke$arity$2(G__65292,G__65293) : pred__65281.call(null,G__65292,G__65293));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65252,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65252),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65252){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65252,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65257){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65257)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65256){
var extmap__4478__auto__ = (function (){var G__65295 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65256,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65256)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65295);
} else {
return G__65295;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65256),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65256),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65256),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65414 = arguments.length;
var i__4790__auto___65415 = (0);
while(true){
if((i__4790__auto___65415 < len__4789__auto___65414)){
args__4795__auto__.push((arguments[i__4790__auto___65415]));

var G__65416 = (i__4790__auto___65415 + (1));
i__4790__auto___65415 = G__65416;
continue;
} else {
}
break;
