...
if(cljs.core.truth_((function (){var fexpr__65171 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65171.cljs$core$IFn$_invoke$arity$1 ? fexpr__65171.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65171.call(null,type));
})())){
} else {
...
var G__65172 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65172)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65172)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65172)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65172)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65172)].join('')));
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65177){
var map__65179 = p__65177;
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65182 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65182) : instaparse.reduction.node_builders.call(null,G__65182));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65173){
var G__65174 = cljs.core.first(seq65173);
var seq65173__$1 = cljs.core.next(seq65173);
var G__65175 = cljs.core.first(seq65173__$1);
var seq65173__$2 = cljs.core.next(seq65173__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65174,G__65175,seq65173__$2);
}));
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65193 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65193) : instaparse.reduction.node_builders.call(null,G__65193));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65184){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65185,G__65186,seq65184__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65195,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65195,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65196,other65197){
var self__ = this;
var this65196__$1 = this;
return (((!((other65197 == null)))) && ((this65196__$1.constructor === other65197.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65196__$1.grammar,other65197.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65196__$1.start_production,other65197.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65196__$1.output_format,other65197.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65196__$1.__extmap,other65197.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65194){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65235 = cljs.core.keyword_identical_QMARK_;
var expr__65236 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65238 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__65194,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65240 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__65194,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65246 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65247 = expr__65236;
return (pred__65235.cljs$core$IFn$_invoke$arity$2 ? pred__65235.cljs$core$IFn$_invoke$arity$2(G__65246,G__65247) : pred__65235.call(null,G__65246,G__65247));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65194,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65194),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65194){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65194,self__.__extmap,self__.__hash));
}));
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65204){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65204)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65200){
var extmap__4478__auto__ = (function (){var G__65253 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65200,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
...
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65200),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65200),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65200),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var G__65373 = (i__4790__auto___65369 + (1));
i__4790__auto___65369 = G__65373;
continue;
} else {
}
break;
