...
if(cljs.core.truth_((function (){var fexpr__65127 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65127.cljs$core$IFn$_invoke$arity$1 ? fexpr__65127.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65127.call(null,type));
})())){
} else {
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65149){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65152 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65152) : instaparse.reduction.node_builders.call(null,G__65152));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65142){
var G__65143 = cljs.core.first(seq65142);
var seq65142__$1 = cljs.core.next(seq65142);
var G__65144 = cljs.core.first(seq65142__$1);
var seq65142__$2 = cljs.core.next(seq65142__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65143,G__65144,seq65142__$2);
}));
...
var args__4795__auto__ = [];
var len__4789__auto___65202 = arguments.length;
var i__4790__auto___65203 = (0);
while(true){
if((i__4790__auto___65203 < len__4789__auto___65202)){
args__4795__auto__.push((arguments[i__4790__auto___65203]));

var G__65204 = (i__4790__auto___65203 + (1));
i__4790__auto___65203 = G__65204;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65156){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65159 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65159) : instaparse.reduction.node_builders.call(null,G__65159));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65153){
var G__65154 = cljs.core.first(seq65153);
var seq65153__$1 = cljs.core.next(seq65153);
var G__65155 = cljs.core.first(seq65153__$1);
var seq65153__$2 = cljs.core.next(seq65153__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65154,G__65155,seq65153__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65161,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65161,else__4442__auto__);
...
var h__4297__auto____$1 = (function (){var fexpr__65171 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65171(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65162,other65163){
var self__ = this;
var this65162__$1 = this;
return (((!((other65163 == null)))) && ((this65162__$1.constructor === other65163.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65162__$1.grammar,other65163.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65162__$1.start_production,other65163.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65162__$1.output_format,other65163.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65162__$1.__extmap,other65163.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65160){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65172 = cljs.core.keyword_identical_QMARK_;
var expr__65173 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65175 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
var G__65176 = expr__65173;
return (pred__65172.cljs$core$IFn$_invoke$arity$2 ? pred__65172.cljs$core$IFn$_invoke$arity$2(G__65175,G__65176) : pred__65172.call(null,G__65175,G__65176));
})())){
return (new instaparse.core.Parser(G__65160,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65177 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
var G__65178 = expr__65173;
return (pred__65172.cljs$core$IFn$_invoke$arity$2 ? pred__65172.cljs$core$IFn$_invoke$arity$2(G__65177,G__65178) : pred__65172.call(null,G__65177,G__65178));
})())){
return (new instaparse.core.Parser(self__.grammar,G__65160,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65179 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65180 = expr__65173;
return (pred__65172.cljs$core$IFn$_invoke$arity$2 ? pred__65172.cljs$core$IFn$_invoke$arity$2(G__65179,G__65180) : pred__65172.call(null,G__65179,G__65180));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65160,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65160),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65160){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65160,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65181 = (arguments.length - (1));
switch (G__65181) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65165){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65165)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65164){
var extmap__4478__auto__ = (function (){var G__65182 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65164,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65164)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65182);
} else {
return G__65182;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65164),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65164),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65164),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65256 = arguments.length;
var i__4790__auto___65258 = (0);
while(true){
if((i__4790__auto___65258 < len__4789__auto___65256)){
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__65185){
...
var _STAR_case_insensitive_literals_STAR__orig_val__65188 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__65189 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__65189);

try{var G__65190 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65190__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__65188);
}});
...
var map__65191 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65191__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65191__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq65183){
var G__65184 = cljs.core.first(seq65183);
var seq65183__$1 = cljs.core.next(seq65183);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65184,seq65183__$1);
}));
