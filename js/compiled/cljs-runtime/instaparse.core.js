...
if(cljs.core.truth_((function (){var fexpr__65292 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65292.cljs$core$IFn$_invoke$arity$1 ? fexpr__65292.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65292.call(null,type));
})())){
} else {
...
if(cljs.core.truth_((function (){var fexpr__65293 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65293.cljs$core$IFn$_invoke$arity$1 ? fexpr__65293.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65293.call(null,type));
})())){
} else {
...
var G__65297 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65297)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65297)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65297)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65297)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65297)].join('')));
...
var G__65388 = (i__4790__auto___65387 + (1));
i__4790__auto___65387 = G__65388;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65302){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65308 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65299){
var G__65300 = cljs.core.first(seq65299);
var seq65299__$1 = cljs.core.next(seq65299);
var G__65301 = cljs.core.first(seq65299__$1);
var seq65299__$2 = cljs.core.next(seq65299__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65300,G__65301,seq65299__$2);
}));
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65309){
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65320,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65320,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__65339){
var vec__65340 = p__65339;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65340,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65340,(1),null);
...
var h__4297__auto____$1 = (function (){var fexpr__65349 = (function (coll__4436__auto__){
return (-360509877 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__65349(this__4435__auto____$1);
})();
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65321,other65322){
var self__ = this;
var this65321__$1 = this;
return (((!((other65322 == null)))) && ((this65321__$1.constructor === other65322.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65321__$1.grammar,other65322.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65321__$1.start_production,other65322.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65321__$1.output_format,other65322.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65321__$1.__extmap,other65322.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65319){
var self__ = this;
...
return (new instaparse.core.Parser(G__65319,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,G__65319,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
...
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65319,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65319),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65319){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65319,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65374 = (arguments.length - (1));
switch (G__65374) {
case (1):
...
var extmap__4478__auto__ = (function (){var G__65375 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65330,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65330)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65375);
} else {
return G__65375;
}
})();
...
var args__4795__auto__ = [];
var len__4789__auto___65462 = arguments.length;
var i__4790__auto___65463 = (0);
while(true){
if((i__4790__auto___65463 < len__4789__auto___65462)){
args__4795__auto__.push((arguments[i__4790__auto___65463]));

var G__65467 = (i__4790__auto___65463 + (1));
i__4790__auto___65463 = G__65467;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__65378){
var map__65379 = p__65378;
...
var _STAR_case_insensitive_literals_STAR__orig_val__65381 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__65382 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__65382);

try{var G__65383 = input_format;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65383__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__65381);
}});
...
var map__65384 = temp__5733__auto__;
...
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65384__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65384__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq65376){
var G__65377 = cljs.core.first(seq65376);
var seq65376__$1 = cljs.core.next(seq65376);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65377,seq65376__$1);
}));
