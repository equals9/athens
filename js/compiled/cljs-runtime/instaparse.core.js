...
if(cljs.core.truth_((function (){var fexpr__65314 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
...
if(cljs.core.truth_((function (){var fexpr__65315 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"ebnf","ebnf",31967825),null,new cljs.core.Keyword(null,"abnf","abnf",-152462052),null], null), null);
return (fexpr__65315.cljs$core$IFn$_invoke$arity$1 ? fexpr__65315.cljs$core$IFn$_invoke$arity$1(type) : fexpr__65315.call(null,type));
})())){
} else {
...
var G__65320 = unhide;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__65320)){
return parser;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"content","content",15833224),G__65320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tags","tags",1771418977),G__65320)){
...
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"all","all",892129742),G__65320)){
...
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65320)].join('')));
...
var G__65372 = (i__4790__auto___65369 + (1));
i__4790__auto___65369 = G__65372;
continue;
} else {
}
break;
...
(instaparse.core.parse.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65324){
...
return instaparse.gll.parse_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65327 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65327) : instaparse.reduction.node_builders.call(null,G__65327));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parse.cljs$lang$applyTo = (function (seq65321){
...
var args__4795__auto__ = [];
var len__4789__auto___65382 = arguments.length;
var i__4790__auto___65383 = (0);
while(true){
if((i__4790__auto___65383 < len__4789__auto___65382)){
args__4795__auto__.push((arguments[i__4790__auto___65383]));

var G__65385 = (i__4790__auto___65383 + (1));
i__4790__auto___65383 = G__65385;
continue;
} else {
}
break;
...
(instaparse.core.parses.cljs$core$IFn$_invoke$arity$variadic = (function (parser,text,p__65331){
...
var parser__$1 = instaparse.core.unhide_parser(parser,unhide);
if(cljs.core.truth_(new cljs.core.Keyword(null,"total","total",1916810418).cljs$core$IFn$_invoke$arity$1(options))){
return instaparse.gll.parses_total(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(parser__$1),start_production,text,partial_QMARK_,(function (){var G__65334 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(parser__$1);
return (instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1 ? instaparse.reduction.node_builders.cljs$core$IFn$_invoke$arity$1(G__65334) : instaparse.reduction.node_builders.call(null,G__65334));
})());
} else {
...
/** @this {Function} */
(instaparse.core.parses.cljs$lang$applyTo = (function (seq65328){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65329,G__65330,seq65328__$2);
}));
...
(instaparse.core.Parser.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k65336,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k65336,else__4442__auto__);
...
(instaparse.core.Parser.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this65337,other65338){
var self__ = this;
var this65337__$1 = this;
return (((!((other65338 == null)))) && ((this65337__$1.constructor === other65338.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65337__$1.grammar,other65338.grammar)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65337__$1.start_production,other65338.start_production)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65337__$1.output_format,other65338.output_format)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this65337__$1.__extmap,other65338.__extmap)));
}));
...
(instaparse.core.Parser.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__65335){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__65347 = cljs.core.keyword_identical_QMARK_;
var expr__65348 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__65350 = new cljs.core.Keyword(null,"grammar","grammar",1881328267);
...
return (new instaparse.core.Parser(G__65335,self__.start_production,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65352 = new cljs.core.Keyword(null,"start-production","start-production",687546537);
...
return (new instaparse.core.Parser(self__.grammar,G__65335,self__.output_format,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__65354 = new cljs.core.Keyword(null,"output-format","output-format",-1826382676);
var G__65355 = expr__65348;
return (pred__65347.cljs$core$IFn$_invoke$arity$2 ? pred__65347.cljs$core$IFn$_invoke$arity$2(G__65354,G__65355) : pred__65347.call(null,G__65354,G__65355));
})())){
return (new instaparse.core.Parser(self__.grammar,self__.start_production,G__65335,self__.__meta,self__.__extmap,null));
} else {
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__65335),null));
}
}
}
}));
...
(instaparse.core.Parser.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__65335){
var self__ = this;
var this__4438__auto____$1 = this;
return (new instaparse.core.Parser(self__.grammar,self__.start_production,self__.output_format,G__65335,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var self__ = this;
var G__65356 = (arguments.length - (1));
switch (G__65356) {
case (1):
...
(instaparse.core.Parser.prototype.apply = (function (self__,args65340){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args65340)));
}));
 ...
 */
instaparse.core.map__GT_Parser = (function instaparse$core$map__GT_Parser(G__65339){
var extmap__4478__auto__ = (function (){var G__65357 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__65339,new cljs.core.Keyword(null,"grammar","grammar",1881328267),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"start-production","start-production",687546537),new cljs.core.Keyword(null,"output-format","output-format",-1826382676)], 0));
if(cljs.core.record_QMARK_(G__65339)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__65357);
} else {
return G__65357;
}
})();
return (new instaparse.core.Parser(new cljs.core.Keyword(null,"grammar","grammar",1881328267).cljs$core$IFn$_invoke$arity$1(G__65339),new cljs.core.Keyword(null,"start-production","start-production",687546537).cljs$core$IFn$_invoke$arity$1(G__65339),new cljs.core.Keyword(null,"output-format","output-format",-1826382676).cljs$core$IFn$_invoke$arity$1(G__65339),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
var args__4795__auto__ = [];
var len__4789__auto___65476 = arguments.length;
var i__4790__auto___65477 = (0);
while(true){
if((i__4790__auto___65477 < len__4789__auto___65476)){
args__4795__auto__.push((arguments[i__4790__auto___65477]));

var G__65482 = (i__4790__auto___65477 + (1));
i__4790__auto___65477 = G__65482;
continue;
} else {
}
break;
...
(instaparse.core.parser.cljs$core$IFn$_invoke$arity$variadic = (function (grammar_specification,p__65360){
...
var _STAR_case_insensitive_literals_STAR__orig_val__65363 = instaparse.cfg._STAR_case_insensitive_literals_STAR_;
var _STAR_case_insensitive_literals_STAR__temp_val__65364 = new cljs.core.Keyword(null,"string-ci","string-ci",374631805).cljs$core$IFn$_invoke$arity$2(options,new cljs.core.Keyword(null,"default","default",-1987822328));
(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__temp_val__65364);

try{var G__65365 = input_format;
var G__65365__$1 = (((G__65365 instanceof cljs.core.Keyword))?G__65365.fqn:null);
switch (G__65365__$1) {
case "abnf":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__65365__$1)].join('')));

}
}finally {(instaparse.cfg._STAR_case_insensitive_literals_STAR_ = _STAR_case_insensitive_literals_STAR__orig_val__65363);
}});
...
var map__65366 = temp__5733__auto__;
var map__65366__$1 = (((((!((map__65366 == null))))?(((((map__65366.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__65366.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__65366):map__65366);
var ws_grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65366__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var ws_start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65366__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
...
/** @this {Function} */
(instaparse.core.parser.cljs$lang$applyTo = (function (seq65358){
var G__65359 = cljs.core.first(seq65358);
var seq65358__$1 = cljs.core.next(seq65358);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__65359,seq65358__$1);
}));
