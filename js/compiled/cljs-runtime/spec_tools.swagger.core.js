...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56183 = cljs.core.get_global_hierarchy;
return (fexpr__56183.cljs$core$IFn$_invoke$arity$0 ? fexpr__56183.cljs$core$IFn$_invoke$arity$0() : fexpr__56183.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56184){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56185__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56185__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56187,(1),null);
...
var map__56193 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56193__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56193__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56195){
var vec__56196 = p__56195;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56196,(0),null);
var map__56199 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56196,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56201 = cljs.core.get_global_hierarchy;
return (fexpr__56201.cljs$core$IFn$_invoke$arity$0 ? fexpr__56201.cljs$core$IFn$_invoke$arity$0() : fexpr__56201.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__56203(s__56204){
return (new cljs.core.LazySeq(null,(function (){
var s__56204__$1 = s__56204;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__56204__$1);
if(temp__5735__auto__){
var s__56204__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__56204__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__56204__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56206 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56205 = (0);
while(true){
if((i__56205 < size__4581__auto__)){
var vec__56207 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56205);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56207,(1),null);
cljs.core.chunk_append(b__56206,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56206),spec_tools$swagger$core$iter__56203(cljs.core.chunk_rest(s__56204__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56206),null);
}
} else {
var vec__56210 = cljs.core.first(s__56204__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56210,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56210,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56203(cljs.core.rest(s__56204__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56213){
var vec__56214 = p__56213;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56214,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56214,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56217,p){
var vec__56218 = p__56217;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56218,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56218,(1),null);
var acc__$1 = vec__56218;
