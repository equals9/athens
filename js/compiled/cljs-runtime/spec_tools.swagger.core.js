...
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56157 = cljs.core.get_global_hierarchy;
return (fexpr__56157.cljs$core$IFn$_invoke$arity$0 ? fexpr__56157.cljs$core$IFn$_invoke$arity$0() : fexpr__56157.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56158){
...
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56159__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56159__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56161,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56166 = cljs.core.get_global_hierarchy;
...
var map__56167 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56167__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56167__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56169){
...
var schema = map__56173__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56173__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56175 = cljs.core.get_global_hierarchy;
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__56176(s__56177){
...
var c__4580__auto__ = cljs.core.chunk_first(s__56177__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__56179 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__56178 = (0);
while(true){
if((i__56178 < size__4581__auto__)){
var vec__56181 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__56178);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56181,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56181,(1),null);
cljs.core.chunk_append(b__56179,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56179),spec_tools$swagger$core$iter__56176(cljs.core.chunk_rest(s__56177__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__56179),null);
}
} else {
var vec__56184 = cljs.core.first(s__56177__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56184,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56184,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56176(cljs.core.rest(s__56177__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56187){
var vec__56188 = p__56187;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56188,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56188,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56191,p){
var vec__56192 = p__56191;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56192,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56192,(1),null);
var acc__$1 = vec__56192;
