...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__56313){
var map__56314 = p__56313;
var map__56314__$1 = (((((!((map__56314 == null))))?(((((map__56314.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56314.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56314):map__56314);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56314__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56314__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__56316 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56316,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56316,(1),null);
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56321 = cljs.core.get_global_hierarchy;
return (fexpr__56321.cljs$core$IFn$_invoke$arity$0 ? fexpr__56321.cljs$core$IFn$_invoke$arity$0() : fexpr__56321.call(null));
})());
...
var map__56322 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
...
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56322__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56322__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__56324){
var vec__56325 = p__56324;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56325,(0),null);
var map__56328 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56325,(1),null);
...
var schema = map__56328__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56328__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4674__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4675__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4676__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__56330 = cljs.core.get_global_hierarchy;
return (fexpr__56330.cljs$core$IFn$_invoke$arity$0 ? fexpr__56330.cljs$core$IFn$_invoke$arity$0() : fexpr__56330.call(null));
})());
...
})(),(function (){var iter__4582__auto__ = (function spec_tools$swagger$core$iter__56331(s__56332){
...
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56335,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56335,(1),null);
cljs.core.chunk_append(b__56334,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__56334),spec_tools$swagger$core$iter__56331(cljs.core.chunk_rest(s__56332__$2)));
} else {
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__56331(cljs.core.rest(s__56332__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__56343){
var vec__56344 = p__56343;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56344,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56344,(1),null);
...
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__56347,p){
var vec__56348 = p__56347;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56348,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56348,(1),null);
var acc__$1 = vec__56348;
