...
G__35819.cljs$lang$applyTo = (function (arglist__35823){
var x = cljs.core.first(arglist__35823);
arglist__35823 = cljs.core.next(arglist__35823);
var y = cljs.core.first(arglist__35823);
var more = cljs.core.rest(arglist__35823);
...
var G__35826 = null;
if (arguments.length > 2) {
var G__35827__i = 0, G__35827__a = new Array(arguments.length -  2);
while (G__35827__i < G__35827__a.length) {G__35827__a[G__35827__i] = arguments[G__35827__i + 2]; ++G__35827__i;}
G__35826 = new cljs.core.IndexedSeq(G__35827__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__35826);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
