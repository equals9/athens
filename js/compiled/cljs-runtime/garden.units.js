...
var G__35790__delegate = function (x,y,more){
...
while (G__35793__i < G__35793__a.length) {G__35793__a[G__35793__i] = arguments[G__35793__i + 2]; ++G__35793__i;}
  more = new cljs.core.IndexedSeq(G__35793__a,0,null);
} 
...
G__35795 = new cljs.core.IndexedSeq(G__35796__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__35795);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__35804);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
while (G__35812__i < G__35812__a.length) {G__35812__a[G__35812__i] = arguments[G__35812__i + 2]; ++G__35812__i;}
  more = new cljs.core.IndexedSeq(G__35812__a,0,null);
} 
...
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__35814);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
