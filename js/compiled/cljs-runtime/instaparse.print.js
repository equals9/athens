...
if(cljs.core.truth_(((cljs.core.not(hidden_QMARK_))?(function (){var G__63548 = (function (){var G__63549 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
return (parser.cljs$core$IFn$_invoke$arity$1 ? parser.cljs$core$IFn$_invoke$arity$1(G__63549) : parser.call(null,G__63549));
})();
return (tag_set.cljs$core$IFn$_invoke$arity$1 ? tag_set.cljs$core$IFn$_invoke$arity$1(G__63548) : tag_set.call(null,G__63548));
})():false))){
...
instaparse.print.char_range__GT_str = (function instaparse$print$char_range__GT_str(p__63552){
...
var lo = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63553__$1,new cljs.core.Keyword(null,"lo","lo",-931799889));
var hi = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63553__$1,new cljs.core.Keyword(null,"hi","hi",-1821422114));
...
(instaparse.print.combinators__GT_str.cljs$core$IFn$_invoke$arity$2 = (function (p__63559,hidden_QMARK_){
...
var p = map__63560__$1;
var parser = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63560__$1,new cljs.core.Keyword(null,"parser","parser",-1543495310));
var parser1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63560__$1,new cljs.core.Keyword(null,"parser1","parser1",-439601422));
var parser2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63560__$1,new cljs.core.Keyword(null,"parser2","parser2",1013754688));
var parsers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63560__$1,new cljs.core.Keyword(null,"parsers","parsers",-804353827));
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63560__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
...
var _STAR_print_newline_STAR__orig_val__63567_63592 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63568_63593 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63569_63594 = true;
var _STAR_print_fn_STAR__temp_val__63570_63595 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63569_63594);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63570_63595);
...
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63568_63593);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63567_63592);
}
...
case "string-ci":
var sb__4720__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR__orig_val__63571_63596 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__63572_63597 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__63573_63598 = true;
var _STAR_print_fn_STAR__temp_val__63574_63599 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__63573_63598);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__63574_63599);

try{cljs.core.pr.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"string","string",-1989541586).cljs$core$IFn$_invoke$arity$1(p)], 0));
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__63572_63597);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__63571_63596);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4720__auto__);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__63566__$1)].join('')));
 ...
 */
instaparse.print.Parser__GT_str = (function instaparse$print$Parser__GT_str(p__63575){
...
var grammar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63576__$1,new cljs.core.Keyword(null,"grammar","grammar",1881328267));
var start = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__63576__$1,new cljs.core.Keyword(null,"start-production","start-production",687546537));
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.cons(instaparse.print.rule__GT_str(start,(grammar.cljs$core$IFn$_invoke$arity$1 ? grammar.cljs$core$IFn$_invoke$arity$1(start) : grammar.call(null,start))),(function (){var iter__4582__auto__ = (function instaparse$print$Parser__GT_str_$_iter__63578(s__63579){
...
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63582,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63582,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
cljs.core.chunk_append(b__63581,instaparse.print.rule__GT_str(non_terminal,parser));

var G__63600 = (i__63580 + (1));
i__63580 = G__63600;
continue;
} else {
var G__63601 = (i__63580 + (1));
i__63580 = G__63601;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63581),instaparse$print$Parser__GT_str_$_iter__63578(cljs.core.chunk_rest(s__63579__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63581),null);
}
} else {
var vec__63585 = cljs.core.first(s__63579__$2);
var non_terminal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63585,(0),null);
var parser = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__63585,(1),null);
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(non_terminal,start)){
return cljs.core.cons(instaparse.print.rule__GT_str(non_terminal,parser),instaparse$print$Parser__GT_str_$_iter__63578(cljs.core.rest(s__63579__$2)));
} else {
var G__63602 = cljs.core.rest(s__63579__$2);
s__63579__$1 = G__63602;
continue;
}
}
} else {
