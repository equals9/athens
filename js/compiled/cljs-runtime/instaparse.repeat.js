...
var vec__64981 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64981,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64981,(1),null);
...
var vec__64984 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64984,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64984,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__64987 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64987,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64987,(1),null);
...
var G__65048 = cljs.core.next(parses__$1);
parses__$1 = G__65048;
continue;
}
...
var G__64995 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64996 = G__64995;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64996,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64996,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64996,(2),null);
var selection = vec__64996;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64995__$1 = G__64995;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65002 = G__64995__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65002,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65002,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65002,(2),null);
var selection__$1 = vec__65002;
...
var G__65010 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65011 = G__65010;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65011,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65011,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65011,(2),null);
var selection = vec__65011;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65010__$1 = G__65010;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65017 = G__65010__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65017,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65017,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65017,(2),null);
var selection__$1 = vec__65017;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__65025 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65026 = G__65025;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65026,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65026,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65026,(2),null);
var selection = vec__65026;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65025__$1 = G__65025;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65032 = G__65025__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65032,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65032,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65032,(2),null);
var selection__$1 = vec__65032;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65058 = cljs.core.long$(end__$1);
var G__65059 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65060 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65058;
parses__$1 = G__65059;
G__65025__$1 = G__65060;
continue;
...
if(cljs.core.truth_((function (){var fexpr__65037 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65037.cljs$core$IFn$_invoke$arity$1 ? fexpr__65037.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__65037.call(null,output_format));
})())){
} else {
...
var G__65038 = output_format;
var G__65038__$1 = (((G__65038 instanceof cljs.core.Keyword))?G__65038.fqn:null);
switch (G__65038__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__65046 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__65045 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__65045.cljs$core$IFn$_invoke$arity$1 ? fexpr__65045.cljs$core$IFn$_invoke$arity$1(G__65046) : fexpr__65045.call(null,G__65046));
})();
