...
var vec__64932 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64932,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64932,(1),null);
...
var vec__64935 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64935,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64935,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__64938 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64938,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64938,(1),null);
...
var G__64999 = cljs.core.next(parses__$1);
parses__$1 = G__64999;
continue;
}
...
var G__64946 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64947 = G__64946;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(2),null);
var selection = vec__64947;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64946__$1 = G__64946;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64953 = G__64946__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64953,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64953,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64953,(2),null);
var selection__$1 = vec__64953;
...
var G__64961 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64962 = G__64961;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(2),null);
var selection = vec__64962;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64961__$1 = G__64961;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64968 = G__64961__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64968,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64968,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64968,(2),null);
var selection__$1 = vec__64968;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65005 = cljs.core.long$(end__$1);
var G__65006 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65007 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65005;
parses__$1 = G__65006;
G__64961__$1 = G__65007;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__64976 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64977 = G__64976;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64977,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64977,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64977,(2),null);
var selection = vec__64977;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64976__$1 = G__64976;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64983 = G__64976__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64983,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64983,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64983,(2),null);
var selection__$1 = vec__64983;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65009 = cljs.core.long$(end__$1);
var G__65010 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65011 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65009;
parses__$1 = G__65010;
G__64976__$1 = G__65011;
continue;
...
if(cljs.core.truth_((function (){var fexpr__64988 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__64988.cljs$core$IFn$_invoke$arity$1 ? fexpr__64988.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__64988.call(null,output_format));
})())){
} else {
...
var G__64989 = output_format;
var G__64989__$1 = (((G__64989 instanceof cljs.core.Keyword))?G__64989.fqn:null);
switch (G__64989__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__64997 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__64996 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__64996.cljs$core$IFn$_invoke$arity$1 ? fexpr__64996.cljs$core$IFn$_invoke$arity$1(G__64997) : fexpr__64996.call(null,G__64997));
})();
