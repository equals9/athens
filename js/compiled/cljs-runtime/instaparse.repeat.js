...
var vec__64911 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64911,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64911,(1),null);
...
var vec__64914 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64914,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64914,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__64917 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64917,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64917,(1),null);
...
var G__64978 = cljs.core.next(parses__$1);
parses__$1 = G__64978;
continue;
}
...
var G__64925 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64926 = G__64925;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64926,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64926,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64926,(2),null);
var selection = vec__64926;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64925__$1 = G__64925;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64932 = G__64925__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64932,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64932,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64932,(2),null);
var selection__$1 = vec__64932;
...
var G__64980 = cljs.core.long$(end__$1);
var G__64981 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__64982 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__64980;
parses__$1 = G__64981;
G__64925__$1 = G__64982;
continue;
...
var G__64940 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64941 = G__64940;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64941,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64941,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64941,(2),null);
var selection = vec__64941;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64940__$1 = G__64940;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64947 = G__64940__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64947,(2),null);
var selection__$1 = vec__64947;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__64984 = cljs.core.long$(end__$1);
var G__64985 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__64986 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__64984;
parses__$1 = G__64985;
G__64940__$1 = G__64986;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__64955 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__64956 = G__64955;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64956,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64956,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64956,(2),null);
var selection = vec__64956;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__64955__$1 = G__64955;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__64962 = G__64955__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64962,(2),null);
var selection__$1 = vec__64962;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__64988 = cljs.core.long$(end__$1);
var G__64989 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__64990 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__64988;
parses__$1 = G__64989;
G__64955__$1 = G__64990;
continue;
...
if(cljs.core.truth_((function (){var fexpr__64967 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__64967.cljs$core$IFn$_invoke$arity$1 ? fexpr__64967.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__64967.call(null,output_format));
})())){
} else {
...
var G__64968 = output_format;
var G__64968__$1 = (((G__64968 instanceof cljs.core.Keyword))?G__64968.fqn:null);
switch (G__64968__$1) {
case "enlive":
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__64976 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__64975 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__64975.cljs$core$IFn$_invoke$arity$1 ? fexpr__64975.cljs$core$IFn$_invoke$arity$1(G__64976) : fexpr__64975.call(null,G__64976));
})();
