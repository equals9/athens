...
var vec__65140 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65140,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65140,(1),null);
...
var vec__65143 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65143,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65143,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__65146 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65146,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65146,(1),null);
...
var G__65207 = cljs.core.next(parses__$1);
parses__$1 = G__65207;
continue;
}
...
var G__65154 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65155 = G__65154;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65155,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65155,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65155,(2),null);
var selection = vec__65155;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65154__$1 = G__65154;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65161 = G__65154__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65161,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65161,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65161,(2),null);
var selection__$1 = vec__65161;
...
var G__65209 = cljs.core.long$(end__$1);
var G__65210 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65211 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65209;
parses__$1 = G__65210;
G__65154__$1 = G__65211;
continue;
...
var G__65169 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65170 = G__65169;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65170,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65170,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65170,(2),null);
var selection = vec__65170;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65169__$1 = G__65169;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65176 = G__65169__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65176,(2),null);
var selection__$1 = vec__65176;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65213 = cljs.core.long$(end__$1);
var G__65214 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65215 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65213;
parses__$1 = G__65214;
G__65169__$1 = G__65215;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__65184 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65185 = G__65184;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65185,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65185,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65185,(2),null);
var selection = vec__65185;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65184__$1 = G__65184;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65191 = G__65184__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65191,(2),null);
var selection__$1 = vec__65191;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65217 = cljs.core.long$(end__$1);
var G__65218 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65219 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65217;
parses__$1 = G__65218;
G__65184__$1 = G__65219;
continue;
...
if(cljs.core.truth_((function (){var fexpr__65196 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65196.cljs$core$IFn$_invoke$arity$1 ? fexpr__65196.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__65196.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__65205 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__65204 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__65204.cljs$core$IFn$_invoke$arity$1 ? fexpr__65204.cljs$core$IFn$_invoke$arity$1(G__65205) : fexpr__65204.call(null,G__65205));
})();
