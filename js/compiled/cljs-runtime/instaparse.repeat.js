...
var vec__65126 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65126,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65126,(1),null);
...
var vec__65129 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65129,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65129,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__65132 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65132,(0),null);
...
var G__65193 = cljs.core.next(parses__$1);
parses__$1 = G__65193;
continue;
}
...
var G__65140 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65141 = G__65140;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65141,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65141,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65141,(2),null);
var selection = vec__65141;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65140__$1 = G__65140;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65147 = G__65140__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65147,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65147,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65147,(2),null);
var selection__$1 = vec__65147;
...
var G__65195 = cljs.core.long$(end__$1);
var G__65196 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65197 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65195;
parses__$1 = G__65196;
G__65140__$1 = G__65197;
continue;
...
var G__65155 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65156 = G__65155;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65156,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65156,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65156,(2),null);
var selection = vec__65156;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65155__$1 = G__65155;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65162 = G__65155__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65162,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65162,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65162,(2),null);
var selection__$1 = vec__65162;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65199 = cljs.core.long$(end__$1);
var G__65200 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65201 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65199;
parses__$1 = G__65200;
G__65155__$1 = G__65201;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__65170 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__65171 = G__65170;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65171,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65171,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65171,(2),null);
var selection = vec__65171;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__65170__$1 = G__65170;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__65177 = G__65170__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65177,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65177,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__65177,(2),null);
var selection__$1 = vec__65177;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__65203 = cljs.core.long$(end__$1);
var G__65204 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__65205 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__65203;
parses__$1 = G__65204;
G__65170__$1 = G__65205;
continue;
...
if(cljs.core.truth_((function (){var fexpr__65182 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__65182.cljs$core$IFn$_invoke$arity$1 ? fexpr__65182.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__65182.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__65191 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__65190 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__65190.cljs$core$IFn$_invoke$arity$1 ? fexpr__65190.cljs$core$IFn$_invoke$arity$1(G__65191) : fexpr__65190.call(null,G__65191));
})();
