...
var G__65816 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65817 = n;
var G__65818 = cljs.core.nnext(bs);
var G__65819 = true;
ret = G__65816;
n = G__65817;
bs = G__65818;
seen_rest_QMARK_ = G__65819;
continue;
} else {
...
});})(G__65806,gmap,defaults,pvec,bents))
;
return fexpr__65805(G__65806);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65795_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65795_SHARP_);
}
})(),cljs.core.name(p1__65795_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65796_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65796_SHARP_);
}
})(),cljs.core.name(p1__65796_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65797_SHARP_,p2__65798_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65797_SHARP_,p2__65798_SHARP_,(function (){var fexpr__65807 = cljs.core.val(entry);
return (fexpr__65807.cljs$core$IFn$_invoke$arity$1 ? fexpr__65807.cljs$core$IFn$_invoke$arity$1(p2__65798_SHARP_) : fexpr__65807.call(null,p2__65798_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65808 = cljs.core.key(entry);
return (fexpr__65808.cljs$core$IFn$_invoke$arity$1 ? fexpr__65808.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65808.call(null,bes));
})());
...
var G__65827 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65828 = cljs.core.next(bes);
ret = G__65827;
bes = G__65828;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65799_SHARP_){
return (cljs.core.first(p1__65799_SHARP_) instanceof cljs.core.Keyword);
}),bents));
