...
var G__65803 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65804 = n;
var G__65805 = cljs.core.nnext(bs);
var G__65806 = true;
ret = G__65803;
n = G__65804;
bs = G__65805;
seen_rest_QMARK_ = G__65806;
continue;
} else {
...
});})(G__65799,gmap,defaults,pvec,bents))
;
return fexpr__65798(G__65799);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65779_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65779_SHARP_);
}
})(),cljs.core.name(p1__65779_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65781_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65781_SHARP_);
}
})(),cljs.core.name(p1__65781_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65782_SHARP_,p2__65783_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65782_SHARP_,p2__65783_SHARP_,(function (){var fexpr__65800 = cljs.core.val(entry);
return (fexpr__65800.cljs$core$IFn$_invoke$arity$1 ? fexpr__65800.cljs$core$IFn$_invoke$arity$1(p2__65783_SHARP_) : fexpr__65800.call(null,p2__65783_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65801 = cljs.core.key(entry);
return (fexpr__65801.cljs$core$IFn$_invoke$arity$1 ? fexpr__65801.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65801.call(null,bes));
})());
...
var G__65811 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65812 = cljs.core.next(bes);
ret = G__65811;
bes = G__65812;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65784_SHARP_){
return (cljs.core.first(p1__65784_SHARP_) instanceof cljs.core.Keyword);
}),bents));
