...
var G__65856 = sci$impl$destructure$destructure_STAR__$_pb(ret,cljs.core.second(bs),gseq);
var G__65857 = n;
var G__65858 = cljs.core.nnext(bs);
var G__65859 = true;
ret = G__65856;
n = G__65857;
bs = G__65858;
seen_rest_QMARK_ = G__65859;
continue;
} else {
...
var G__65861 = (n + (1));
var G__65862 = cljs.core.next(bs);
var G__65863 = seen_rest_QMARK_;
ret = G__65860;
n = G__65861;
bs = G__65862;
seen_rest_QMARK_ = G__65863;
continue;
}
...
});})(G__65852,gmap,defaults,pvec,bents))
;
return fexpr__65851(G__65852);
})();
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65841_SHARP_){
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65841_SHARP_);
}
})(),cljs.core.name(p1__65841_SHARP_));
}));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(mkn,"syms")){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(transforms,mk,(function (p1__65842_SHARP_){
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$2((function (){var or__4185__auto__ = mkns;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return cljs.core.namespace(p1__65842_SHARP_);
}
})(),cljs.core.name(p1__65842_SHARP_));
}));
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__65843_SHARP_,p2__65844_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__65843_SHARP_,p2__65844_SHARP_,(function (){var fexpr__65853 = cljs.core.val(entry);
return (fexpr__65853.cljs$core$IFn$_invoke$arity$1 ? fexpr__65853.cljs$core$IFn$_invoke$arity$1(p2__65844_SHARP_) : fexpr__65853.call(null,p2__65844_SHARP_));
})());
}),cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(bes,cljs.core.key(entry)),(function (){var fexpr__65854 = cljs.core.key(entry);
return (fexpr__65854.cljs$core$IFn$_invoke$arity$1 ? fexpr__65854.cljs$core$IFn$_invoke$arity$1(bes) : fexpr__65854.call(null,bes));
})());
...
var G__65864 = (((((bb instanceof cljs.core.Keyword)) || ((bb instanceof cljs.core.Symbol))))?cljs.core.conj.cljs$core$IFn$_invoke$arity$variadic(ret,local,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([bv], 0)):sci$impl$destructure$destructure_STAR__$_pb(ret,bb,bv));
var G__65865 = cljs.core.next(bes);
ret = G__65864;
bes = G__65865;
continue;
} else {
...
var temp__5733__auto__ = cljs.core.seq(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__65845_SHARP_){
return (cljs.core.first(p1__65845_SHARP_) instanceof cljs.core.Keyword);
}),bents));
