...
var G__52105 = new cljs.core.Keyword(null,"events","events",1792552201).cljs$core$IFn$_invoke$arity$1(task);
var G__52106 = now_seen_events;
var fexpr__52104 = new cljs.core.Keyword(null,"when","when",-576417306).cljs$core$IFn$_invoke$arity$1(task);
return (fexpr__52104.cljs$core$IFn$_invoke$arity$2 ? fexpr__52104.cljs$core$IFn$_invoke$arity$2(G__52105,G__52106) : fexpr__52104.call(null,G__52105,G__52106));
...
var G__52120 = "async-flow: rule can only specify one of :dispatch, :dispatch-n and :dispatch-fn. Got more than one: ";
var G__52121 = rule;
...
var G__52122 = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__4185__auto__ = id;
...
var G__52122__$1 = (cljs.core.truth_(dispatch_fn)?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52122,new cljs.core.Keyword(null,"dispatch-fn","dispatch-fn",1253347614),dispatch_fn):G__52122);
if(cljs.core.not(dispatch_fn)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__52122__$1,new cljs.core.Keyword(null,"dispatch-n","dispatch-n",-504469236),(cljs.core.truth_(dispatch_n)?dispatch_n:(cljs.core.truth_(dispatch)?(new cljs.core.List(null,dispatch,null,(1),null)):cljs.core.List.EMPTY
)));
} else {
return G__52122__$1;
}
...
return (function day8$re_frame$async_flow_fx$make_flow_event_handler_$_async_flow_event_handler(p__52144,p__52145){
var map__52148 = p__52144;
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52148__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__52149 = p__52145;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52149,(0),null);
var event_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52149,(1),null);
var event_v = vec__52149;
...
var vec__52162 = event_v;
var ___$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(0),null);
var forwarded_event = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__52162,(1),null);
var map__52165 = (get_state.cljs$core$IFn$_invoke$arity$1 ? get_state.cljs$core$IFn$_invoke$arity$1(db) : get_state.call(null,db));
var map__52165__$1 = (((((!((map__52165 == null))))?(((((map__52165.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__52165.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__52165):map__52165);
var seen_events = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52165__$1,new cljs.core.Keyword(null,"seen-events","seen-events",1607648392));
var rules_fired = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__52165__$1,new cljs.core.Keyword(null,"rules-fired","rules-fired",-1669838140));
