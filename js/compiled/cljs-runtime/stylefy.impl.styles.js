...
var G__40548_40621 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40548_40621) : style_created_handler.call(null,G__40548_40621));
...
var G__40563_40623 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40564_40624 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40563_40623,G__40564_40624) : stylefy.impl.styles.create_style_BANG_.call(null,G__40563_40623,G__40564_40624));


var G__40626 = seq__40549;
var G__40627 = chunk__40550;
var G__40628 = count__40551;
var G__40629 = (i__40552 + (1));
seq__40549 = G__40626;
chunk__40550 = G__40627;
count__40551 = G__40628;
i__40552 = G__40629;
continue;
} else {
...
var G__40631 = cljs.core.chunk_rest(seq__40549__$1);
var G__40632 = c__4609__auto__;
var G__40633 = cljs.core.count(c__4609__auto__);
var G__40634 = (0);
seq__40549 = G__40631;
chunk__40550 = G__40632;
count__40551 = G__40633;
i__40552 = G__40634;
continue;
} else {
var sub_style = cljs.core.first(seq__40549__$1);
var G__40570_40635 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40571_40636 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40570_40635,G__40571_40636) : stylefy.impl.styles.create_style_BANG_.call(null,G__40570_40635,G__40571_40636));


var G__40638 = cljs.core.next(seq__40549__$1);
var G__40639 = null;
var G__40640 = (0);
var G__40641 = (0);
seq__40549 = G__40638;
chunk__40550 = G__40639;
count__40551 = G__40640;
i__40552 = G__40641;
continue;
}
} else {
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40574_SHARP_){
return ((typeof p1__40574_SHARP_ === 'string') || ((p1__40574_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40574_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40574#] (or (string? p1__40574#) (keyword? p1__40574#) (nil? p1__40574#))) class)))"].join('')));
}
});
/**
...
var G__40662 = (i__4790__auto___40660 + (1));
i__4790__auto___40660 = G__40662;
continue;
} else {
}
break;
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40581_SHARP_,p2__40583_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40581_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40583_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
/** @this {Function} */
(stylefy.impl.styles.sub_style.cljs$lang$applyTo = (function (seq40584){
var G__40585 = cljs.core.first(seq40584);
var seq40584__$1 = cljs.core.next(seq40584);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40585,seq40584__$1);
}));
...
var map__40595__$1 = (((((!((map__40595 == null))))?(((((map__40595.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__40595.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__40595):map__40595);
var options = map__40595__$1;
var request_dom_update_after_done_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40595__$1,new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510));
var styles_40668__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40598_40669 = cljs.core.seq(styles_40668__$1);
var chunk__40599_40670 = null;
var count__40600_40671 = (0);
var i__40601_40672 = (0);
while(true){
if((i__40601_40672 < count__40600_40671)){
var style_40673 = chunk__40599_40670.cljs$core$IIndexed$_nth$arity$2(null,i__40601_40672);
...
var G__40676 = seq__40598_40669;
var G__40677 = chunk__40599_40670;
var G__40678 = count__40600_40671;
var G__40679 = (i__40601_40672 + (1));
seq__40598_40669 = G__40676;
chunk__40599_40670 = G__40677;
count__40600_40671 = G__40678;
i__40601_40672 = G__40679;
continue;
} else {
var temp__5735__auto___40680 = cljs.core.seq(seq__40598_40669);
...
var G__40686 = (0);
seq__40598_40669 = G__40683;
chunk__40599_40670 = G__40684;
count__40600_40671 = G__40685;
i__40601_40672 = G__40686;
continue;
} else {
...
var G__40692 = (0);
var G__40693 = (0);
seq__40598_40669 = G__40690;
chunk__40599_40670 = G__40691;
count__40600_40671 = G__40692;
i__40601_40672 = G__40693;
continue;
}
} else {
}
