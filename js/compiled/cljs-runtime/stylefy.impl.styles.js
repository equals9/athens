...
stylefy.impl.styles.create_style_BANG_ = (function stylefy$impl$styles$create_style_BANG_(p__40567,style_created_handler){
...
var style = map__40568__$1;
var props = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40568__$1,new cljs.core.Keyword(null,"props","props",453281727));
var hash = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40568__$1,new cljs.core.Keyword(null,"hash","hash",-13781596));
var style_css = stylefy.impl.conversion.style__GT_css.cljs$core$IFn$_invoke$arity$1(style);
var G__40572_40653 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"css","css",1135045163),style_css,new cljs.core.Keyword(null,"hash","hash",-13781596),hash], null);
(style_created_handler.cljs$core$IFn$_invoke$arity$1 ? style_created_handler.cljs$core$IFn$_invoke$arity$1(G__40572_40653) : style_created_handler.call(null,G__40572_40653));
...
var G__40584_40654 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40585_40655 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40584_40654,G__40585_40655) : stylefy.impl.styles.create_style_BANG_.call(null,G__40584_40654,G__40585_40655));
...
var G__40587_40664 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"props","props",453281727),sub_style,new cljs.core.Keyword(null,"hash","hash",-13781596),stylefy.impl.hashing.hash_style(sub_style)], null);
var G__40588_40665 = style_created_handler;
(stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2 ? stylefy.impl.styles.create_style_BANG_.cljs$core$IFn$_invoke$arity$2(G__40587_40664,G__40588_40665) : stylefy.impl.styles.create_style_BANG_.call(null,G__40587_40664,G__40588_40665));
...
if((((class$ == null)) || (typeof class$ === 'string') || ((class$ instanceof cljs.core.Keyword)) || (((cljs.core.vector_QMARK_(class$)) && (cljs.core.every_QMARK_((function (p1__40591_SHARP_){
return ((typeof p1__40591_SHARP_ === 'string') || ((p1__40591_SHARP_ instanceof cljs.core.Keyword)) || ((p1__40591_SHARP_ == null)));
}),class$)))))){
return null;
} else {
throw (new Error(["Assert failed: ",["Unsupported ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(origin)," type. It should be nil, keyword, string or vector of strings/keywords). Got: ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([class$], 0))].join(''),"\n","(or (nil? class) (string? class) (keyword? class) (and (vector? class) (every? (fn* [p1__40591#] (or (string? p1__40591#) (keyword? p1__40591#) (nil? p1__40591#))) class)))"].join('')));
}
});
/**
...
var resolved_sub_style = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__40618_SHARP_,p2__40619_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(p1__40618_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432),p2__40619_SHARP_], null));
}),style,sub_styles);
if(cljs.core.truth_(resolved_sub_style)){
...
var styles_40689__$1 = cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,styles);
var seq__40640_40691 = cljs.core.seq(styles_40689__$1);
var chunk__40641_40692 = null;
var count__40642_40693 = (0);
var i__40643_40694 = (0);
while(true){
if((i__40643_40694 < count__40642_40693)){
var style_40696 = chunk__40641_40692.cljs$core$IIndexed$_nth$arity$2(null,i__40643_40694);
stylefy.impl.styles.use_style_BANG_(style_40696,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40697 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40696));
if(cljs.core.truth_(temp__5735__auto___40697)){
var sub_styles_40698 = temp__5735__auto___40697;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40698,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40699 = seq__40640_40691;
var G__40700 = chunk__40641_40692;
var G__40701 = count__40642_40693;
var G__40702 = (i__40643_40694 + (1));
seq__40640_40691 = G__40699;
chunk__40641_40692 = G__40700;
count__40642_40693 = G__40701;
i__40643_40694 = G__40702;
continue;
} else {
var temp__5735__auto___40704 = cljs.core.seq(seq__40640_40691);
if(temp__5735__auto___40704){
var seq__40640_40706__$1 = temp__5735__auto___40704;
if(cljs.core.chunked_seq_QMARK_(seq__40640_40706__$1)){
var c__4609__auto___40707 = cljs.core.chunk_first(seq__40640_40706__$1);
var G__40708 = cljs.core.chunk_rest(seq__40640_40706__$1);
var G__40709 = c__4609__auto___40707;
var G__40710 = cljs.core.count(c__4609__auto___40707);
var G__40711 = (0);
seq__40640_40691 = G__40708;
chunk__40641_40692 = G__40709;
count__40642_40693 = G__40710;
i__40643_40694 = G__40711;
continue;
} else {
var style_40713 = cljs.core.first(seq__40640_40706__$1);
stylefy.impl.styles.use_style_BANG_(style_40713,cljs.core.PersistentArrayMap.EMPTY,stylefy.impl.dom.save_style_BANG_);

var temp__5735__auto___40714__$1 = cljs.core.vals(new cljs.core.Keyword("stylefy.core","sub-styles","stylefy.core/sub-styles",-1546489432).cljs$core$IFn$_invoke$arity$1(style_40713));
if(cljs.core.truth_(temp__5735__auto___40714__$1)){
var sub_styles_40716 = temp__5735__auto___40714__$1;
stylefy.impl.styles.prepare_styles.cljs$core$IFn$_invoke$arity$2(sub_styles_40716,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"request-dom-update-after-done?","request-dom-update-after-done?",199142510),false], null));
} else {
}


var G__40717 = cljs.core.next(seq__40640_40706__$1);
var G__40718 = null;
var G__40719 = (0);
var G__40720 = (0);
seq__40640_40691 = G__40717;
chunk__40641_40692 = G__40718;
count__40642_40693 = G__40719;
i__40643_40694 = G__40720;
continue;
}
} else {
}
