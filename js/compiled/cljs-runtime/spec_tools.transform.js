...
if((x instanceof cljs.core.Keyword)){
var G__60274 = spec;
var G__60275 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__60274,G__60275) : f.call(null,G__60274,G__60275));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__60276 = spec;
var G__60277 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__60276,G__60277) : f.call(null,G__60276,G__60277));
} else {
return x;
...
}catch (e60278){if((e60278 instanceof Error)){
var ___$1 = e60278;
return x;
} else {
throw e60278;
...
}catch (e60279){if((e60279 instanceof Error)){
var ___$1 = e60279;
return x;
} else {
throw e60279;
...
}catch (e60280){if((e60280 instanceof Error)){
var ___$1 = e60280;
return x;
} else {
throw e60280;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__60283,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60284__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__60286,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60287__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__60289,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__60290__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
