...
if((x instanceof cljs.core.Keyword)){
var G__55090 = spec;
var G__55091 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55090,G__55091) : f.call(null,G__55090,G__55091));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__55092 = spec;
var G__55093 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__55092,G__55093) : f.call(null,G__55092,G__55093));
} else {
return x;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__55099,x){
var map__55100 = p__55099;
var map__55100__$1 = (((((!((map__55100 == null))))?(((((map__55100.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__55100.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__55100):map__55100);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55100__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__55102,x){
...
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55103__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__55105,x){
...
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__55106__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
