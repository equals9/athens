...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k30127,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k30127,else__4442__auto__);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__30126){
var self__ = this;
var G__30126__$1 = this;
return (new cljs.core.RecordIter((0),G__30126__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this30128,other30129){
var self__ = this;
var this30128__$1 = this;
return (((!((other30129 == null)))) && ((this30128__$1.constructor === other30129.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.tag,other30129.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.wrap_fn,other30129.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.wrap_length,other30129.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.seq_fn,other30129.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.children,other30129.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this30128__$1.__extmap,other30129.__extmap)));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__30126){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__30140 = cljs.core.keyword_identical_QMARK_;
var expr__30141 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__30143 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
...
return (new rewrite_clj.node.seq.SeqNode(G__30126,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30145 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
...
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__30126,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30147 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__30148 = expr__30141;
return (pred__30140.cljs$core$IFn$_invoke$arity$2 ? pred__30140.cljs$core$IFn$_invoke$arity$2(G__30147,G__30148) : pred__30140.call(null,G__30147,G__30148));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__30126,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30149 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__30150 = expr__30141;
return (pred__30140.cljs$core$IFn$_invoke$arity$2 ? pred__30140.cljs$core$IFn$_invoke$arity$2(G__30149,G__30150) : pred__30140.call(null,G__30149,G__30150));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__30126,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__30151 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__30152 = expr__30141;
return (pred__30140.cljs$core$IFn$_invoke$arity$2 ? pred__30140.cljs$core$IFn$_invoke$arity$2(G__30151,G__30152) : pred__30140.call(null,G__30151,G__30152));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__30126,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__30126),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__30126){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__30126,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__30130){
var extmap__4478__auto__ = (function (){var G__30153 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__30130,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__30130)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__30153);
} else {
return G__30153;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__30130),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__30130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__30130),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__30130),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__30130),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
