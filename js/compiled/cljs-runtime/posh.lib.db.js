...
var G__46884 = cljs.core.cons(pdb,path);
var G__46885 = posh.lib.db.get_parent_db(pdb);
path = G__46884;
pdb = G__46885;
continue;
} else {
...
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__46860 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46860.cljs$core$IFn$_invoke$arity$2 ? fexpr__46860.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__46860.call(null,db__$1,since));
})():db__$1);
