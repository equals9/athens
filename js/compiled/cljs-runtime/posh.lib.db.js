...
var G__46902 = cljs.core.cons(pdb,path);
var G__46903 = posh.lib.db.get_parent_db(pdb);
path = G__46902;
pdb = G__46903;
continue;
} else {
...
var G__46909 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__46909;
continue;
}
break;
...
var fexpr__46880 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46880.cljs$core$IFn$_invoke$arity$1 ? fexpr__46880.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__46880.call(null,conn));
}
})();
...
var G__46891 = (function (){var G__46893 = posh_tree;
var G__46894 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__46893,G__46894) : posh.lib.db.poshdb__GT_db.call(null,G__46893,G__46894));
})();
var G__46892 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__46890 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46890.cljs$core$IFn$_invoke$arity$2 ? fexpr__46890.cljs$core$IFn$_invoke$arity$2(G__46891,G__46892) : fexpr__46890.call(null,G__46891,G__46892));
}
});
