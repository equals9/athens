...
var G__46860 = cljs.core.first(poshdb);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46860__$1)].join('')));
...
var G__46906 = cljs.core.cons(pdb,path);
var G__46907 = posh.lib.db.get_parent_db(pdb);
path = G__46906;
pdb = G__46907;
continue;
} else {
...
var G__46910 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__46910;
continue;
}
break;
...
var filter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46871__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var as_of = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46871__$1,new cljs.core.Keyword(null,"as-of","as-of",-1841962382));
var since = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46871__$1,new cljs.core.Keyword(null,"since","since",315379842));
var with$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46871__$1,new cljs.core.Keyword(null,"with","with",-1536296876));
var db__$1 = (function (){var or__4185__auto__ = db;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var fexpr__46874 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46874.cljs$core$IFn$_invoke$arity$1 ? fexpr__46874.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__46874.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__46881 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46881.cljs$core$IFn$_invoke$arity$2 ? fexpr__46881.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__46881.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__46882 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46882.cljs$core$IFn$_invoke$arity$2 ? fexpr__46882.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__46882.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__46883 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46883.cljs$core$IFn$_invoke$arity$2 ? fexpr__46883.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__46883.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__46885 = db__$4;
var G__46886 = (((filter instanceof cljs.core.Symbol))?null:filter);
var fexpr__46884 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46884.cljs$core$IFn$_invoke$arity$2 ? fexpr__46884.cljs$core$IFn$_invoke$arity$2(G__46885,G__46886) : fexpr__46884.call(null,G__46885,G__46886));
})():db__$4);
return db__$5;
}));
...
posh.lib.db.poshdb__GT_db = (function posh$lib$db$poshdb__GT_db(p__46887,poshdb){
...
var cache = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__46888__$1,new cljs.core.Keyword(null,"cache","cache",-1237023054));
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.first(poshdb),new cljs.core.Keyword(null,"db","db",993250759))){
return posh.lib.db.db_id__GT_db(posh_tree,cljs.core.second(poshdb));
} else {
var G__46893 = (function (){var G__46895 = posh_tree;
var G__46896 = posh.lib.db.get_parent_db(poshdb);
return (posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2 ? posh.lib.db.poshdb__GT_db.cljs$core$IFn$_invoke$arity$2(G__46895,G__46896) : posh.lib.db.poshdb__GT_db.call(null,G__46895,G__46896));
})();
var G__46894 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__46892 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46892.cljs$core$IFn$_invoke$arity$2 ? fexpr__46892.cljs$core$IFn$_invoke$arity$2(G__46893,G__46894) : fexpr__46892.call(null,G__46893,G__46894));
}
});
