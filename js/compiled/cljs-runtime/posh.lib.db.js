...
var G__46898 = cljs.core.cons(pdb,path);
var G__46899 = posh.lib.db.get_parent_db(pdb);
path = G__46898;
pdb = G__46899;
continue;
} else {
...
var G__46902 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__46902;
continue;
}
break;
...
var G__46888 = (function (){var G__46893 = posh_tree;
...
var G__46889 = posh.lib.db.make_filter_pred(new cljs.core.Keyword(null,"pass-patterns","pass-patterns",1090887263).cljs$core$IFn$_invoke$arity$1(cljs.core.get.cljs$core$IFn$_invoke$arity$2(cache,poshdb)));
var fexpr__46886 = new cljs.core.Keyword(null,"filter","filter",-948537934).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46886.cljs$core$IFn$_invoke$arity$2 ? fexpr__46886.cljs$core$IFn$_invoke$arity$2(G__46888,G__46889) : fexpr__46886.call(null,G__46888,G__46889));
}
});
