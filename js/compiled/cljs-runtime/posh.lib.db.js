...
var G__46858 = cljs.core.first(poshdb);
...
var G__46900 = cljs.core.cons(pdb,path);
var G__46901 = posh.lib.db.get_parent_db(pdb);
path = G__46900;
pdb = G__46901;
continue;
} else {
...
var G__46905 = posh.lib.db.get_parent_db(poshdb);
poshdb = G__46905;
continue;
}
break;
...
var fexpr__46873 = new cljs.core.Keyword(null,"db","db",993250759).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46873.cljs$core$IFn$_invoke$arity$1 ? fexpr__46873.cljs$core$IFn$_invoke$arity$1(conn) : fexpr__46873.call(null,conn));
}
})();
var db__$2 = (cljs.core.truth_(since)?(function (){var fexpr__46874 = new cljs.core.Keyword(null,"since","since",315379842).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46874.cljs$core$IFn$_invoke$arity$2 ? fexpr__46874.cljs$core$IFn$_invoke$arity$2(db__$1,since) : fexpr__46874.call(null,db__$1,since));
})():db__$1);
var db__$3 = (cljs.core.truth_(as_of)?(function (){var fexpr__46875 = new cljs.core.Keyword(null,"as-of","as-of",-1841962382).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46875.cljs$core$IFn$_invoke$arity$2 ? fexpr__46875.cljs$core$IFn$_invoke$arity$2(db__$2,as_of) : fexpr__46875.call(null,db__$2,as_of));
})():db__$2);
var db__$4 = (cljs.core.truth_(with$)?new cljs.core.Keyword(null,"db-after","db-after",-571884666).cljs$core$IFn$_invoke$arity$1((function (){var fexpr__46876 = new cljs.core.Keyword(null,"with","with",-1536296876).cljs$core$IFn$_invoke$arity$1(dcfg);
return (fexpr__46876.cljs$core$IFn$_invoke$arity$2 ? fexpr__46876.cljs$core$IFn$_invoke$arity$2(db__$3,with$) : fexpr__46876.call(null,db__$3,with$));
})()):db__$3);
var db__$5 = (cljs.core.truth_(filter)?(function (){var G__46878 = db__$4;
var G__46879 = (((filter instanceof cljs.core.Symbol))?null:filter);
