...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k29852,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k29852,else__4442__auto__);
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__29851){
var self__ = this;
var G__29851__$1 = this;
return (new cljs.core.RecordIter((0),G__29851__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this29853,other29854){
var self__ = this;
var this29853__$1 = this;
return (((!((other29854 == null)))) && ((this29853__$1.constructor === other29854.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29853__$1.children,other29854.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this29853__$1.__extmap,other29854.__extmap)));
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__29851){
var self__ = this;
...
return (new rewrite_clj.node.forms.FormsNode(G__29851,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__29851),null));
}
}));
...
(rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__29851){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__29851,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__29855){
var extmap__4478__auto__ = (function (){var G__29868 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__29855,new cljs.core.Keyword(null,"children","children",-940561982));
...
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__29855),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
