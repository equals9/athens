...
var G__59478 = cljs.core.rest(s__59163__$2);
s__59163__$1 = G__59478;
continue;
}
} else {
var G__59479 = cljs.core.rest(s__59163__$2);
s__59163__$1 = G__59479;
continue;
}
}
} else {
...
var G__59480 = cljs.core.rest(s__59161__$1);
s__59161__$1 = G__59480;
continue;
}
} else {
return null;
...
var x__$1 = this;
var G__59200 = (tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2 ? tick.interval.basic_relation.cljs$core$IFn$_invoke$arity$2(x__$1,y) : tick.interval.basic_relation.call(null,x__$1,y));
var fexpr__59199 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.meets_QMARK_,tick.interval.precedes_QMARK_]);
...
var fexpr__59212 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_]);
...
var fexpr__59220 = cljs.core.PersistentHashSet.createAsIfByAssoc([tick.interval.started_by_QMARK_,tick.interval.equals_QMARK_,tick.interval.met_by_QMARK_,tick.interval.preceded_by_QMARK_,tick.interval.overlapped_by_QMARK_,tick.interval.finishes_QMARK_]);
...
var x__$1 = first__59244;
var xs__$1 = seq__59243__$1;
...
var vec__59261 = s;
var initial = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59261,(0),null);
var subsequent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59261,(1),null);
...
var G__59502 = (i__59322 + (1));
i__59322 = G__59502;
continue;
} else {
var G__59503 = (i__59322 + (1));
i__59322 = G__59503;
continue;
}
} else {
...
var G__59510 = cljs.core.rest(s__59321__$2);
s__59321__$1 = G__59510;
continue;
}
}
} else {
...
var G__59340 = tick.interval.relation(x,y);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__59340__$1)].join('')));
...
/** @this {Function} */
(tick.interval.intersection.cljs$lang$applyTo = (function (seq59329){
...
return tick.core.min.cljs$core$IFn$_invoke$arity$variadic(tick.core.forward_duration(p1__59387_SHARP_,period),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([tick.core.end(ival)], 0));
...
break;
case "started-by":
var vec__59413 = tick.interval.split_with_assert(ival,tick.core.end(group));
var seg1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59413,(0),null);
var seg2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__59413,(1),null);
...
break;
case "overlapped-by":
var vec__59416 = tick.interval.split_with_assert(ival,tick.core.end(group));
...
goog.object.set(G__59426_59588,G__59427_59589,G__59428_59590);
