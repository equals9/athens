...
var G__65678 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65696__delegate = function (contents){
...
var G__65696 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__65697__i = 0, G__65697__a = new Array(arguments.length -  0);
while (G__65697__i < G__65697__a.length) {G__65697__a[G__65697__i] = arguments[G__65697__i + 0]; ++G__65697__i;}
  contents = new cljs.core.IndexedSeq(G__65697__a,0,null);
} 
return G__65696__delegate.call(this,contents);};
G__65696.cljs$lang$maxFixedArity = 0;
G__65696.cljs$lang$applyTo = (function (arglist__65698){
var contents = cljs.core.seq(arglist__65698);
return G__65696__delegate(contents);
});
...
var node = (function (){var G__65680 = athens.db.dsdb;
var G__65681 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65682 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
...
var block = (function (){var G__65683 = athens.db.dsdb;
var G__65684 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65685 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65683,G__65684,G__65685) : posh.reagent.pull.call(null,G__65683,G__65684,G__65685));
})();
...
})], null),(function (){var G__65686 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65686) : athens.parse_renderer.parse_and_render.call(null,G__65686));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65687 = athens.db.dsdb;
var G__65688 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65689 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65687,G__65688,G__65689) : posh.reagent.pull.call(null,G__65687,G__65688,G__65689));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65690){
var map__65691 = p__65690;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65691__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65691__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65693,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65694__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65679 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65678,G__65679) : instaparse.core.transform.call(null,G__65678,G__65679));
});
/**
