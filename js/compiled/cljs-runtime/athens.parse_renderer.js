...
var G__65484 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65502__delegate = function (contents){
...
var G__65502 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__65503__i = 0, G__65503__a = new Array(arguments.length -  0);
while (G__65503__i < G__65503__a.length) {G__65503__a[G__65503__i] = arguments[G__65503__i + 0]; ++G__65503__i;}
  contents = new cljs.core.IndexedSeq(G__65503__a,0,null);
} 
return G__65502__delegate.call(this,contents);};
G__65502.cljs$lang$maxFixedArity = 0;
G__65502.cljs$lang$applyTo = (function (arglist__65504){
var contents = cljs.core.seq(arglist__65504);
return G__65502__delegate(contents);
});
G__65502.cljs$core$IFn$_invoke$arity$variadic = G__65502__delegate;
return G__65502;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__65486 = athens.db.dsdb;
var G__65487 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65488 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65486,G__65487,G__65488) : posh.reagent.pull.call(null,G__65486,G__65487,G__65488));
})();
...
var block = (function (){var G__65489 = athens.db.dsdb;
var G__65490 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65491 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65489,G__65490,G__65491) : posh.reagent.pull.call(null,G__65489,G__65490,G__65491));
})();
...
})], null),(function (){var G__65492 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65492) : athens.parse_renderer.parse_and_render.call(null,G__65492));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65493 = athens.db.dsdb;
var G__65494 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65495 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65493,G__65494,G__65495) : posh.reagent.pull.call(null,G__65493,G__65494,G__65495));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65496){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65497__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65497__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65499,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65500__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65485 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65484,G__65485) : instaparse.core.transform.call(null,G__65484,G__65485));
});
/**
