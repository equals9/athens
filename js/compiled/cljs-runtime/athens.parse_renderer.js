...
var G__65631 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65649__delegate = function (contents){
...
var G__65649 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__65650__i = 0, G__65650__a = new Array(arguments.length -  0);
while (G__65650__i < G__65650__a.length) {G__65650__a[G__65650__i] = arguments[G__65650__i + 0]; ++G__65650__i;}
  contents = new cljs.core.IndexedSeq(G__65650__a,0,null);
} 
return G__65649__delegate.call(this,contents);};
G__65649.cljs$lang$maxFixedArity = 0;
G__65649.cljs$lang$applyTo = (function (arglist__65651){
var contents = cljs.core.seq(arglist__65651);
return G__65649__delegate(contents);
});
G__65649.cljs$core$IFn$_invoke$arity$variadic = G__65649__delegate;
return G__65649;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__65633 = athens.db.dsdb;
...
var G__65635 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
...
var block = (function (){var G__65636 = athens.db.dsdb;
var G__65637 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65638 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65636,G__65637,G__65638) : posh.reagent.pull.call(null,G__65636,G__65637,G__65638));
})();
...
})], null),(function (){var G__65639 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65639) : athens.parse_renderer.parse_and_render.call(null,G__65639));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65640 = athens.db.dsdb;
var G__65641 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65642 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65640,G__65641,G__65642) : posh.reagent.pull.call(null,G__65640,G__65641,G__65642));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65643){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65644__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65644__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65646,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65647__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65632 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65631,G__65632) : instaparse.core.transform.call(null,G__65631,G__65632));
});
/**
