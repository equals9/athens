...
var G__65596 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65614__delegate = function (contents){
...
var G__65614 = function (var_args){
var contents = null;
if (arguments.length > 0) {
var G__65615__i = 0, G__65615__a = new Array(arguments.length -  0);
while (G__65615__i < G__65615__a.length) {G__65615__a[G__65615__i] = arguments[G__65615__i + 0]; ++G__65615__i;}
  contents = new cljs.core.IndexedSeq(G__65615__a,0,null);
} 
return G__65614__delegate.call(this,contents);};
G__65614.cljs$lang$maxFixedArity = 0;
G__65614.cljs$lang$applyTo = (function (arglist__65616){
var contents = cljs.core.seq(arglist__65616);
return G__65614__delegate(contents);
});
G__65614.cljs$core$IFn$_invoke$arity$variadic = G__65614__delegate;
return G__65614;
})()
,new cljs.core.Keyword(null,"page-link","page-link",-169621200),(function (title){
var node = (function (){var G__65598 = athens.db.dsdb;
var G__65599 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65600 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65598,G__65599,G__65600) : posh.reagent.pull.call(null,G__65598,G__65599,G__65600));
})();
...
var block = (function (){var G__65601 = athens.db.dsdb;
var G__65602 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65603 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65601,G__65602,G__65603) : posh.reagent.pull.call(null,G__65601,G__65602,G__65603));
})();
...
})], null),(function (){var G__65604 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65604) : athens.parse_renderer.parse_and_render.call(null,G__65604));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65605 = athens.db.dsdb;
var G__65606 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65607 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65605,G__65606,G__65607) : posh.reagent.pull.call(null,G__65605,G__65606,G__65607));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65608){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65609__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65609__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65611,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65612__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65597 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65596,G__65597) : instaparse.core.transform.call(null,G__65596,G__65597));
});
/**
