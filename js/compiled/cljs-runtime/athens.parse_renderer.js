...
var G__65659 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65677__delegate = function (contents){
...
while (G__65678__i < G__65678__a.length) {G__65678__a[G__65678__i] = arguments[G__65678__i + 0]; ++G__65678__i;}
  contents = new cljs.core.IndexedSeq(G__65678__a,0,null);
} 
return G__65677__delegate.call(this,contents);};
G__65677.cljs$lang$maxFixedArity = 0;
G__65677.cljs$lang$applyTo = (function (arglist__65679){
var contents = cljs.core.seq(arglist__65679);
return G__65677__delegate(contents);
});
...
var node = (function (){var G__65661 = athens.db.dsdb;
var G__65662 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65663 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65661,G__65662,G__65663) : posh.reagent.pull.call(null,G__65661,G__65662,G__65663));
})();
...
var block = (function (){var G__65664 = athens.db.dsdb;
var G__65665 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65666 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65664,G__65665,G__65666) : posh.reagent.pull.call(null,G__65664,G__65665,G__65666));
})();
...
})], null),(function (){var G__65667 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65667) : athens.parse_renderer.parse_and_render.call(null,G__65667));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65668 = athens.db.dsdb;
var G__65669 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65670 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65668,G__65669,G__65670) : posh.reagent.pull.call(null,G__65668,G__65669,G__65670));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65671){
var map__65672 = p__65671;
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65672__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65674,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65675__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65660 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65659,G__65660) : instaparse.core.transform.call(null,G__65659,G__65660));
});
/**
