...
var G__65692 = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"block","block",664686210),(function() { 
var G__65710__delegate = function (contents){
...
while (G__65711__i < G__65711__a.length) {G__65711__a[G__65711__i] = arguments[G__65711__i + 0]; ++G__65711__i;}
  contents = new cljs.core.IndexedSeq(G__65711__a,0,null);
} 
return G__65710__delegate.call(this,contents);};
G__65710.cljs$lang$maxFixedArity = 0;
G__65710.cljs$lang$applyTo = (function (arglist__65712){
var contents = cljs.core.seq(arglist__65712);
return G__65710__delegate(contents);
});
...
var node = (function (){var G__65694 = athens.db.dsdb;
var G__65695 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65696 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),title], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65694,G__65695,G__65696) : posh.reagent.pull.call(null,G__65694,G__65695,G__65696));
})();
...
var block = (function (){var G__65697 = athens.db.dsdb;
var G__65698 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65699 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("block","uid","block/uid",-1623585167),uid], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65697,G__65698,G__65699) : posh.reagent.pull.call(null,G__65697,G__65698,G__65699));
})();
...
})], null),(function (){var G__65700 = new cljs.core.Keyword("block","string","block/string",-2066596447).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(block));
return (athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1 ? athens.parse_renderer.parse_and_render.cljs$core$IFn$_invoke$arity$1(G__65700) : athens.parse_renderer.parse_and_render.call(null,G__65700));
})()], null)], null);
}),new cljs.core.Keyword(null,"hashtag","hashtag",-529028899),(function (tag_name){
var node = (function (){var G__65701 = athens.db.dsdb;
var G__65702 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"*","*",345799209,null)], null);
var G__65703 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("node","title","node/title",628940777),tag_name], null);
return (posh.reagent.pull.cljs$core$IFn$_invoke$arity$3 ? posh.reagent.pull.cljs$core$IFn$_invoke$arity$3(G__65701,G__65702,G__65703) : posh.reagent.pull.call(null,G__65701,G__65702,G__65703));
})();
...
}),new cljs.core.Keyword(null,"url-image","url-image",535142411),(function (p__65704){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65705__$1,new cljs.core.Keyword(null,"url","url",276297046));
var alt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65705__$1,new cljs.core.Keyword(null,"alt","alt",-3214426));
...
}),new cljs.core.Keyword(null,"url-link","url-link",1615670141),(function (p__65707,text){
...
var url = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65708__$1,new cljs.core.Keyword(null,"url","url",276297046));
...
var G__65693 = tree;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__65692,G__65693) : instaparse.core.transform.call(null,G__65692,G__65693));
});
/**
