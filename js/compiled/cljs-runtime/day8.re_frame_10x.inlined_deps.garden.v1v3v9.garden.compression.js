 ...
 */
day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.token_fn = (function day8$re_frame_10x$inlined_deps$garden$v1v3v9$garden$compression$token_fn(p__25732){
var vec__25733 = p__25732;
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25733,(0),null);
var re = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25733,(1),null);
return (function (s){
...
var len__4789__auto___25746 = arguments.length;
var i__4790__auto___25747 = (0);
while(true){
if((i__4790__auto___25747 < len__4789__auto___25746)){
args__4795__auto__.push((arguments[i__4790__auto___25747]));

var G__25748 = (i__4790__auto___25747 + (1));
i__4790__auto___25747 = G__25748;
continue;
} else {
}
break;
...
return (function (s){
return cljs.core.some((function (p1__25736_SHARP_){
return (p1__25736_SHARP_.cljs$core$IFn$_invoke$arity$1 ? p1__25736_SHARP_.cljs$core$IFn$_invoke$arity$1(s) : p1__25736_SHARP_.call(null,s));
}),fs);
});
}));
...
/** @this {Function} */
(day8.re_frame_10x.inlined_deps.garden.v1v3v9.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq25737){
...
var map__25739 = temp__5733__auto__;
...
var tag = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25739__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25739__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25739__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__25763 = cljs.core.subs.cljs$core$IFn$_invoke$arity$2(s1,size);
var G__25764 = [s2,cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__25742 = tag;
